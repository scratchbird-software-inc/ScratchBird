...
# SBsql Language Reference — Functions

*ScratchBird documentation — draft*

## Who this book is for

Developers using built-in functions, operators, aggregates, and windows.

## About this book

This volume is the SBsql functional reference: the built-in function packages, operators, aggregates, window functions, and special forms, grouped by namespace. It is split into one file per namespace group; this index lists them. It is the third of three SBsql reference volumes.
...
This volume is split into one file per namespace group. The files, in order:

- **Functional Reference Index** — `v2c-sbsql-function-reference-01-overview.md`
- **SB Core Functional Reference** — `v2c-sbsql-function-reference-02-sb_core.md`
- **SB Crypto Functional Reference** — `v2c-sbsql-function-reference-03-sb_crypto.md`
- **SB Cursor Functional Reference** — `v2c-sbsql-function-reference-04-sb_cursor.md`
- **SB Diagnostic Functional Reference** — `v2c-sbsql-function-reference-05-sb_diagnostic.md`
- **SB JSON Functional Reference** — `v2c-sbsql-function-reference-06-sb_json.md`
- **SB LOB Functional Reference** — `v2c-sbsql-function-reference-07-sb_lob.md`
- **SB Operator Functional Reference** — `v2c-sbsql-function-reference-08-sb_operator.md`
- **SB Range Functional Reference** — `v2c-sbsql-function-reference-09-sb_range.md`
- **SB Regex Functional Reference** — `v2c-sbsql-function-reference-10-sb_regex.md`
- **SB Rowset Functional Reference** — `v2c-sbsql-function-reference-11-sb_rowset.md`
- **SB Spatial Functional Reference** — `v2c-sbsql-function-reference-12-sb_spatial.md`
- **SB Temporal Functional Reference** — `v2c-sbsql-function-reference-13-sb_temporal.md`
- **SB Timeseries Functional Reference** — `v2c-sbsql-function-reference-14-sb_timeseries.md`
- **SB UUID Functional Reference** — `v2c-sbsql-function-reference-15-sb_uuid.md`
- **SB Vector Functional Reference** — `v2c-sbsql-function-reference-16-sb_vector.md`
- **SB XML Functional Reference** — `v2c-sbsql-function-reference-17-sb_xml.md`
