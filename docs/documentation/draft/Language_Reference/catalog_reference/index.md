...
| `sys.catalog.reference_type_mapping` | [sys_catalog_donor_type_mapping.md](sys_catalog_donor_type_mapping.md) |
...
| `sys.security.protected_material_catalog` | [sys_security_protected_material_catalog.md](sys_security_protected_material_catalog.md) |
| `sys.security.protected_material_version` | [sys_security_protected_material_version.md](sys_security_protected_material_version.md) |
| `sys.security.protected_material_policy_binding` | [sys_security_protected_material_policy_binding.md](sys_security_protected_material_policy_binding.md) |
| `sys.security.protected_material_audit` | [sys_security_protected_material_audit.md](sys_security_protected_material_audit.md) |
