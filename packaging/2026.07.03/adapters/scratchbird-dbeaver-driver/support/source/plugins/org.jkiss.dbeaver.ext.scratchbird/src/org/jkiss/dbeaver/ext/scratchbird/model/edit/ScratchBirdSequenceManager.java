...
public class ScratchBirdSequenceManager extends GenericSequenceManager {
    ...
    protected void addObjectCreateActions(
        ...
        actions.add(new SQLDatabasePersistAction(
            "Create sequence",
            "CREATE SEQUENCE " + sequence.getFullyQualifiedName(DBPEvaluationContext.DDL) +
                " START WITH " + sequence.getLastValue() +
                " INCREMENT BY " + sequence.getIncrementBy() +
