...
_TOOL_DESCRIPTORS: dict[str, dict[str, Any]] = {
    ...
    "get_sbsql_language_resource_manifest": {
        ...
        "tool_version": TOOL_DESCRIPTOR_VERSION,
        "description": "Return the verified shared SBsql language-resource manifest summary.",
        "input_schema": {
            "type": "object",
            "properties": {"verify_hashes": {"type": "boolean"}},
            "additionalProperties": False,
        },
        "output_mode": "json_object",
        "output_schema": None,
        "required_security_scopes": [],
        "mode_constraints": ["ai_analysis", "ai_mutation_pending_approval", "ai_mutation_approved"],
        "operation_mapping": "discover_language_resources",
        "retryable": False,
    },
    "list_sbsql_language_profiles": {
        "tool_name": "list_sbsql_language_profiles",
        "tool_version": TOOL_DESCRIPTOR_VERSION,
        "description": "List shared SBsql language profiles supported by this release package.",
        "input_schema": {
            "type": "object",
            "properties": {"verify_hashes": {"type": "boolean"}},
            "additionalProperties": False,
    ...
    "get_sbsql_predictive_grammar": {
        ...
        "tool_version": TOOL_DESCRIPTOR_VERSION,
        "description": "Return the shared SBsql predictive grammar resource used by parsers and drivers.",
        "input_schema": {
            "type": "object",
            "properties": {"verify_hashes": {"type": "boolean"}},
            "additionalProperties": False,
        ...
        "required_security_scopes": [],
        "mode_constraints": ["ai_analysis", "ai_mutation_pending_approval", "ai_mutation_approved"],
        "operation_mapping": "predictive_sbsql_prompting",
        "retryable": False,
    },
    "get_metadata_resolution_contract": {
        "tool_name": "get_metadata_resolution_contract",
        "tool_version": TOOL_DESCRIPTOR_VERSION,
        "description": "Return the server-authorized UUID/path metadata resolution contract.",
        "input_schema": {
            "type": "object",
            "properties": {"security_context": _SECURITY_CONTEXT_SCHEMA},
            "additionalProperties": False,
        },
        "output_mode": "json_object",
        "output_schema": None,
        ...
        "mode_constraints": ["ai_analysis", "ai_mutation_pending_approval", "ai_mutation_approved"],
        "operation_mapping": "metadata_resolution_contract",
        "retryable": False,
    },
    "generate_ai_mcp_support_bundle": {
        "tool_name": "generate_ai_mcp_support_bundle",
        "tool_version": TOOL_DESCRIPTOR_VERSION,
        "description": "Generate or return a redacted AI MCP support-bundle manifest.",
        "input_schema": {
            "type": "object",
        ...
        "output_mode": "json_object",
        "output_schema": None,
        "required_security_scopes": ["admin:diagnostics"],
        "mode_constraints": ["ai_analysis", "ai_mutation_pending_approval", "ai_mutation_approved"],
        "operation_mapping": "support_bundle",
        "retryable": False,
    },
