...
exports.normalizeNativeProtocol = normalizeNativeProtocol;
exports.normalizeFrontDoorMode = normalizeFrontDoorMode;
exports.parseDsn = parseDsn;
function normalizeNativeProtocol(value) {
...
function normalizeFrontDoorMode(value) {
    const normalized = (value ?? "").trim().toLowerCase();
