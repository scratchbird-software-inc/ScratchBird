...
beta_supported_targets:
  ...
  - target_id: "macos-x86_64-darwin-core"
    ...
    architecture: "x86_64"
    runtime: "libc++"
    native_runner_required: "macos-15-intel"
...
explicit_waivers_and_skips:
  - waiver_id: "architecture_not_listed_in_beta_supported_targets"
    applies_to: "architecture not listed in beta_supported_targets"
