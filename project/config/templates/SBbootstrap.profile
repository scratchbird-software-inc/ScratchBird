...
# before invoking SBsql bootstrap (or the identical SBsec bootstrap entry
# point). The only accepted service identities are
...
# handoff, and process execution. SBsql/SBsec bootstrap creates the explicitly
# requested first database principal through the engine-owned MGA bootstrap
# transaction.
