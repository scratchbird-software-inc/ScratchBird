...
typedef enum sb_engine_diagnostic_severity_t {
  ...
  SB_ENGINE_DIAGNOSTIC_FATAL = 3,
  SB_ENGINE_DIAGNOSTIC_SECURITY = 4,
  SB_ENGINE_DIAGNOSTIC_CRITICAL = 5,
  SB_ENGINE_DIAGNOSTIC_CORRUPTION = 6,
  SB_ENGINE_DIAGNOSTIC_PANIC = 7,
  SB_ENGINE_DIAGNOSTIC_DEBUG = 8,
  SB_ENGINE_DIAGNOSTIC_NOTICE = 9,
  SB_ENGINE_DIAGNOSTIC_AUDIT = 10,
  SB_ENGINE_DIAGNOSTIC_SUPPORT = 11,
  SB_ENGINE_DIAGNOSTIC_INTERNAL = 12
