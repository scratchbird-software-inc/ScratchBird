...
This directory holds execution_plan execution artifacts for the FirebirdSQL parser, parser-support UDR, emulation, donor-native regression, and CTest closure effort.
...
Firebird QA donor replay scaffold artifacts:

- `FIREBIRD_QA_DONOR_REPLAY_MANIFEST.csv`: `1949` candidate-indexed tests grouped by top-level path and replay family.
- `FIREBIRD_QA_DONOR_REPLAY_FAMILY_MANIFEST.csv`: `6` replay families covering `tests/bugs` and `tests/functional`.
