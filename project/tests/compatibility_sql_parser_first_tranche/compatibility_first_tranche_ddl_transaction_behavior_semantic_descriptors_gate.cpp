...
bool ExpectDdlTxnEvidence(std::string_view payload,
  ...
  ok &= ExpectField(
      ...
      "compatibility_ddl_transaction_behavior_semantic_descriptor_evidence.v1", label);
  ok &= ExpectField(payload, "descriptor_resolution", "uuid_required", label);
  ...
  ok &= ExpectField(
      ...
      "parser_ddl_transaction_behavior_descriptor_recorded_runtime_equivalence_verified",
      label);
  ok &= ExpectField(payload, "enterprise_readiness", "reference_parser_implementation_proven",
                    label);
...
bool MysqlChecks() {
  ...
  ok &= RunDdlTxnCase(
      ...
      {"mysql",
       ...
       "SBLR_COMPATIBILITY_MYSQL_DDL_CREATE",
       "EngineDdlCreate",
  ...
  ok &= RunDdlTxnCase(
      ...
      {"mysql",
       ...
       "mysql_ddl_transaction_behavior_diagnostic_map",
       "mysql_connected_database_root_uuid_required_temp_shadowing_root_local",
       "SBLR_COMPATIBILITY_MYSQL_DDL_ALTER",
       "EngineDdlAlter",
...
bool PostgresqlChecks() {
  ...
  ok &= RunDdlTxnCase(
      ...
      {"postgresql",
       ...
       "SBLR_COMPATIBILITY_POSTGRESQL_DDL_CREATE",
       "EngineDdlCreate",
       true, false, false, true, false, false, false, true, false},
  ...
  ok &= RunDdlTxnCase(
      ...
      {"postgresql",
       ...
       "postgresql_ddl_transaction_behavior_diagnostic_map",
       "postgresql_connected_database_schema_root_uuid_required_pg_temp_root_local",
       "SBLR_COMPATIBILITY_POSTGRESQL_INDEX_CREATE",
