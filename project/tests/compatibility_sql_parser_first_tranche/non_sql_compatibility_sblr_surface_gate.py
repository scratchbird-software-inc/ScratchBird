...
"""Non-SQL compatibility SBLR surface proof gate.
...
* every non-cluster admitted route must emit a compatibility SBLR operation;
* parser-support UDR routes must emit a compatibility SBLR operation;
...
* every non-cluster compatibility route must have an explicit SBLR or parser-support route.
"""
...
DIALECTS = {
    "cassandra": {
        "source": "project/src/parsers/compatibility/cassandra/cassandra_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "CASSANDRA.AUTHORITY.UNSUPPORTED_DENIED",
        },
    },
    "mongodb": {
        "source": "project/src/parsers/compatibility/mongodb/mongodb_dialect.cpp",
        "cluster_reserved_diagnostics": {
    ...
    "redis": {
        "source": "project/src/parsers/compatibility/redis/redis_dialect.cpp",
        "cluster_reserved_diagnostics": {
    ...
    "opensearch_sql_ppl": {
        "source": "project/src/parsers/compatibility/opensearch_sql_ppl/opensearch_sql_ppl_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "OPENSEARCH_SQL_PPL.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "opensearch": {
        "source": "project/src/parsers/compatibility/opensearch/opensearch_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "OPENSEARCH.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "neo4j": {
        "source": "project/src/parsers/compatibility/neo4j/neo4j_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "NEO4J.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "influxdb": {
        "source": "project/src/parsers/compatibility/influxdb/influxdb_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "INFLUXDB.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "milvus": {
        "source": "project/src/parsers/compatibility/milvus/milvus_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "MILVUS.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "apache_ignite": {
        "source": "project/src/parsers/compatibility/apache_ignite/apache_ignite_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "APACHE_IGNITE.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "tikv": {
        "source": "project/src/parsers/compatibility/tikv/tikv_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "TIKV.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "foundationdb": {
        "source": "project/src/parsers/compatibility/foundationdb/foundationdb_dialect.cpp",
        "cluster_reserved_diagnostics": {
            "FOUNDATIONDB.AUTHORITY.CLUSTER_CONTROL_RESERVED",
        },
    },
    "xtdb": {
        "source": "project/src/parsers/compatibility/xtdb/xtdb_dialect.cpp",
        "cluster_reserved_diagnostics": {
...
def main() -> int:
    ...
    evidence: dict[str, object] = {
        "gate": "non_sql_compatibility_sblr_surface_gate",
        "status": "passed",
        ...
        "sblr_registration_rule": {
            ...
            "compatibility_symbols": SBSQL_COMPATIBILITY_BACKFILL_REGISTER,
        },
        "dialects": {},
    }
