...
bool ExpectIdentifierEvidence(std::string_view payload,
                              ...
                              bool release_profile_variant_bound_to_base_compatibility,
                              std::string_view label) {
  bool ok = true;
  ...
  ok &= ExpectField(payload, "evidence_contract",
                    "compatibility_identifier_name_resolution_evidence.v1", label);
  ok &= ExpectField(payload, "descriptor_resolution", "uuid_required", label);
  ...
  ok &= ExpectBool(payload, "release_profile_variant_bound_to_base_compatibility",
                   release_profile_variant_bound_to_base_compatibility, label);
