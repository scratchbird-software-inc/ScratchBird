...
bool ExpectSystemCatalogEvidence(std::string_view payload,
  ...
  ok &= ExpectField(
      ...
      "compatibility_system_catalog_defaults_semantic_descriptor_evidence.v1", label);
...
Expected FirebirdExpected(std::string_view operation_family) {
  return {"firebird",
          ...
          "SBLR_COMPATIBILITY_FIREBIRD_CATALOG_PROJECT",
...
Expected MysqlExpected(std::string_view statement_family,
  ...
  return {"mysql",
          ...
          "SBLR_COMPATIBILITY_MYSQL_CATALOG_PROJECT",
...
Expected PostgresqlExpected(std::string_view operation_id) {
  return {"postgresql",
          ...
          "SBLR_COMPATIBILITY_POSTGRESQL_CATALOG_PROJECT",
