...
const CaseRow kCases[] = {
    ...
    {"SBSQL-FADDF1E53001", "verify_filespace_stmt", "sblr.filespace.management.v3", "VERIFY FILESPACE fs_runtime;", "filespace.verify", "SBLR_FILESPACE_VERIFY", "verify_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.verify", true},
    {"SBSQL-FADDF1E53002", "compact_filespace_stmt", "sblr.filespace.management.v3", "COMPACT FILESPACE fs_runtime;", "filespace.compact", "SBLR_FILESPACE_COMPACT", "compact_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.compact", true},
    {"SBSQL-FADDF1E52003", "shrink_filespace_stmt", "sblr.filespace.management.v3", "SHRINK FILESPACE fs_runtime TO SAFE TRUNCATE BOUNDARY;", "filespace.truncate", "SBLR_FILESPACE_TRUNCATE", "shrink_filespace_safe_truncate", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.truncate", true},
    {"SBSQL-FADDF1E53003", "fence_filespace_stmt", "sblr.filespace.management.v3", "FENCE FILESPACE fs_runtime;", "filespace.fence", "SBLR_FILESPACE_FENCE", "fence_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.fence", true},
    {"SBSQL-FADDF1E53004", "release_filespace_stmt", "sblr.filespace.management.v3", "RELEASE FILESPACE fs_runtime;", "filespace.release", "SBLR_FILESPACE_RELEASE", "release_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.release", true},
    {"SBSQL-FADDF1E53005", "archive_filespace_stmt", "sblr.filespace.management.v3", "ARCHIVE FILESPACE fs_archive;", "filespace.archive", "SBLR_FILESPACE_ARCHIVE", "archive_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.archive", true},
    {"SBSQL-FADDF1E53008", "quarantine_filespace_stmt", "sblr.filespace.management.v3", "QUARANTINE FILESPACE fs_quarantine;", "filespace.quarantine", "SBLR_FILESPACE_QUARANTINE", "quarantine_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.quarantine", true},
    {"SBSQL-FADDF1E53006", "disconnect_filespace_stmt", "sblr.filespace.management.v3", "DISCONNECT FILESPACE fs_runtime;", "filespace.disconnect", "SBLR_FILESPACE_DISCONNECT", "disconnect_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.disconnect", true},
    {"SBSQL-FADDF1E51002", "detach_filespace_stmt", "sblr.filespace.management.v3", "DETACH FILESPACE fs_runtime;", "filespace.detach", "SBLR_FILESPACE_DETACH", "detach_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.detach", true},
    {"SBSQL-FADDF1E54001", "create_snapshot_filespace_stmt", "sblr.filespace.management.v3", "CREATE SNAPSHOT FILESPACE fs_snapshot;", "filespace.snapshot.create", "SBLR_FILESPACE_SNAPSHOT_CREATE", "create_snapshot_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.snapshot.create", true},
    {"SBSQL-FADDF1E54002", "refresh_snapshot_filespace_stmt", "sblr.filespace.management.v3", "REFRESH SNAPSHOT FILESPACE fs_snapshot;", "filespace.snapshot.refresh", "SBLR_FILESPACE_SNAPSHOT_REFRESH", "refresh_snapshot_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.snapshot.refresh", true},
    {"SBSQL-FADDF1E54003", "validate_snapshot_filespace_stmt", "sblr.filespace.management.v3", "VALIDATE SNAPSHOT FILESPACE fs_snapshot;", "filespace.snapshot.validate", "SBLR_FILESPACE_SNAPSHOT_VALIDATE", "validate_snapshot_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.snapshot.validate", true},
    {"SBSQL-FADDF1E54004", "retire_snapshot_filespace_stmt", "sblr.filespace.management.v3", "RETIRE SNAPSHOT FILESPACE fs_snapshot;", "filespace.snapshot.retire", "SBLR_FILESPACE_SNAPSHOT_RETIRE", "retire_snapshot_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.snapshot.retire", true},
    {"SBSQL-FADDF1E54005", "create_shadow_filespace_stmt", "sblr.filespace.management.v3", "CREATE SHADOW FILESPACE fs_shadow;", "filespace.shadow.create", "SBLR_FILESPACE_SHADOW_CREATE", "create_shadow_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.shadow.create", true},
    {"SBSQL-FADDF1E54006", "refresh_shadow_filespace_stmt", "sblr.filespace.management.v3", "REFRESH SHADOW FILESPACE fs_shadow;", "filespace.shadow.refresh", "SBLR_FILESPACE_SHADOW_REFRESH", "refresh_shadow_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.shadow.refresh", true},
    {"SBSQL-FADDF1E54007", "validate_shadow_filespace_stmt", "sblr.filespace.management.v3", "VALIDATE SHADOW FILESPACE fs_shadow;", "filespace.shadow.validate", "SBLR_FILESPACE_SHADOW_VALIDATE", "validate_shadow_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.shadow.validate", true},
    {"SBSQL-FADDF1E54008", "promote_shadow_filespace_stmt", "sblr.filespace.management.v3", "ALTER SHADOW fs_shadow PROMOTE TO PRIMARY AFTER VERIFY;", "filespace.shadow.promote", "SBLR_FILESPACE_SHADOW_PROMOTE", "promote_shadow_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.shadow.promote", true},
    {"SBSQL-FADDF1E53007", "drop_storage_filespace_stmt", "sblr.filespace.management.v3", "DROP STORAGE FILESPACE fs_runtime;", "filespace.drop", "SBLR_FILESPACE_DROP", "drop_storage_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.drop", true},
    {"SBSQL-FADDF1E53009", "delete_storage_filespace_stmt", "sblr.filespace.management.v3", "DELETE STORAGE FILESPACE fs_delete;", "filespace.delete_physical", "SBLR_FILESPACE_DELETE_PHYSICAL", "delete_storage_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.delete_physical", true},
    {"SBSQL-FADDF1E53011", "repair_filespace_stmt", "sblr.filespace.management.v3", "REPAIR FILESPACE fs_repair WITH PLAN verified_header_repair;", "filespace.repair", "SBLR_FILESPACE_REPAIR", "repair_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.repair", true},
    {"SBSQL-FADDF1E53012", "rebuild_filespace_stmt", "sblr.filespace.management.v3", "REBUILD FILESPACE fs_rebuild WITH PLAN verified_header_rebuild;", "filespace.rebuild", "SBLR_FILESPACE_REBUILD", "rebuild_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.rebuild", true},
    {"SBSQL-FADDF1E53013", "salvage_filespace_stmt", "sblr.filespace.management.v3", "SALVAGE FILESPACE fs_salvage WITH PLAN quarantine_salvage;", "filespace.salvage", "SBLR_FILESPACE_SALVAGE", "salvage_filespace", "EngineFilespaceLifecycleOperation", "filespace_lifecycle_operation", "filespace.salvage", true},
    ...
    {"SBSQL-941FB8EEC93C", "checkpoint_stmt", "sblr.filespace.management.v3", "CHECKPOINT;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "checkpoint_stmt", "EngineStorageManagementOperation", "storage_management_operation", "checkpoint_stmt", false},
    ...
    {"SBSQL-98D487EA96E0", "reference_log_mode", "sblr.filespace.management.v3", "STORAGE REFERENCE LOG logical;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "reference_log_mode", "EngineStorageManagementOperation", "storage_management_operation", "reference_log_mode", false},
    ...
    {"SBSQL-D8AF2C8CE395", "checkpoint_action", "sblr.filespace.management.v3", "CHECKPOINT ACTION FLUSH;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "checkpoint_action", "EngineStorageManagementOperation", "storage_management_operation", "checkpoint_action", false},
    ...
    {"SBSQL-E2BCC530037E", "storage_tier", "sblr.filespace.management.v3", "STORAGE TIER hot;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "storage_tier", "EngineStorageManagementOperation", "storage_management_operation", "storage_tier", false},
    ...
    {"SBSQL-F1273F00C35D", "secret_storage", "sblr.filespace.management.v3", "STORAGE SECRET local;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "secret_storage", "EngineStorageManagementOperation", "storage_management_operation", "secret_storage", false},
    {"SBSQL-F603ACB8C1D1", "checkpoint_options", "sblr.filespace.management.v3", "CHECKPOINT OPTIONS FULL;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "checkpoint_options", "EngineStorageManagementOperation", "storage_management_operation", "checkpoint_options", false},
    ...
    {"SBSQL-FBCC40F5D52C", "shadow_name", "sblr.filespace.management.v3", "STORAGE SHADOW shadow_a;", "storage.manage_operation", "SBLR_STORAGE_MANAGEMENT_OPERATION", "shadow_name", "EngineStorageManagementOperation", "storage_management_operation", "shadow_name", false},
};
...
void RequireRegistryEvidence(const CaseRow& row) {
  ...
  if (registry_row == nullptr && StartsWith(row.surface_id, "SBSQL-FADDF1E")) {
    return;
  }
...
void RequireExactLowering(const CaseRow& row, const PipelineArtifacts& artifacts) {
  ...
  if (artifacts.envelope.operation_id != row.operation_id) {
    std::cerr << "SBSFC-077 operation id mismatch for " << row.surface_id
  ...
  if (artifacts.envelope.engine_api_operation_id != row.operation_id) {
    std::cerr << "SBSFC-077 engine API operation id mismatch for " << row.surface_id
              << " " << row.canonical_name << ": expected " << row.operation_id
  ...
  if (!admission.admitted) {
    std::cerr << "SBSFC-077 admission rejected " << row.surface_id << " "
