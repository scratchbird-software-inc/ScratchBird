...
scratchbird::engine::sblr::SblrResult Run(const FunctionRegistry& registry,
  ...
  request.context.sblr_context.database_uuid = scratchbird::tests::FixtureUuid(1156, 5);
  request.context.sblr_context.transaction_uuid = scratchbird::tests::FixtureUuid(1156, 6);
