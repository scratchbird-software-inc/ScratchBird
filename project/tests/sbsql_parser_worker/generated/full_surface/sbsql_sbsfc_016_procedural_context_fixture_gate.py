...
registry, and dispatch source. It does not execute SQL text, use donor backends,
...
EXPECTED_CASES = {
    ...
    "SBSFC016-donor-contextual-keyword": ("SBSQL-21B3D26B555C", "sb.scalar.donor_contextual_keyword", "keyword_class.donor_contextual", "character", ""),
    ...
    "SBSFC016-donor-reserved-keyword": ("SBSQL-813817A7EDFD", "sb.scalar.donor_reserved_keyword", "keyword_class.donor_reserved", "character", ""),
    ...
    "SBSFC016-donor-log-compatibility": ("SBSQL-87F8BED4D9EE", "sb.scalar.donor_log_compatibility", "compatibility.donor_log_non_authority", "character", ""),
    ...
    "SBSFC016-innodb": ("SBSQL-70117DFD73D9", "sb.scalar.innodb", "donor_storage.innodb", "character", ""),
    ...
    "SBSFC016-donor-only-rewrite": ("SBSQL-A371FE7C3BAA", "sb.scalar.donor_only_rewrite", "donor.rewrite_only", "character", ""),
...
METADATA_POLICY_CASES = {
    ...
    "SBSFC016-donor-log-compatibility",
