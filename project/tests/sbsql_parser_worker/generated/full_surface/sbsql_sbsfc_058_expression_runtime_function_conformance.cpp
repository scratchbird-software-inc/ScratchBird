...
scratchbird::engine::sblr::SblrResult Run(const FunctionRegistry& registry,
  ...
  request.context.sblr_context.database_uuid = scratchbird::tests::FixtureUuid(1156, 41);
  request.context.sblr_context.transaction_uuid = scratchbird::tests::FixtureUuid(1156, 42);
...
int main() {
  scratchbird::tests::RegisterSequenceFixtures({
      "SBSFC058_gen",
      "SBSFC058_seq_curr_bare",
      "SBSFC058_seq_curr_sig",
      "SBSFC058_seq_next_bare",
      "SBSFC058_seq_next_sig",
      "SBSFC058_seq_set_bare",
      "SBSFC058_seq_set_sig"}, 5858);
