...
sblr::SblrExecutionContext BaseSblrContext() {
  ...
  context.session_uuid = scratchbird::tests::FixtureUuidLiteral("019f5500-0000-7000-8000-000000000002");
  context.user_uuid = scratchbird::tests::FixtureUuidLiteral("019f5500-0000-7000-8000-000000000003");
...
api::EngineRequestContext ProjectionContext() {
  ...
  context.session_uuid = scratchbird::tests::FixtureUuidLiteral("019f5500-0000-7000-8000-000000000002");
  context.principal_uuid = scratchbird::tests::FixtureUuidLiteral("019f5500-0000-7000-8000-000000000003");
  context.local_transaction_id = kLocalTransactionId;
  context.snapshot_visible_through_local_transaction_id = kLocalTransactionId;
  context.application_name = "sbsfc055-lob-locator";
  context.security_context_present = true;
