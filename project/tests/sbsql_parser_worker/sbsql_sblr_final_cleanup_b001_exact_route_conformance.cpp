...
constexpr std::array<B001Row, 50> kRows{{
    ...
    {"AUDIT-0489", "SHOW AUDIT", "op.show.audit", "SBLR_OP_SHOW_AUDIT", "sblr.security.mutation_or_inspect.v3", "rs.security.policy.v1", "", "", ""},
    ...
    {"AUDIT-0484", "SHOW DISCOVERY RIGHTS FOR principal_admin", "op.show.discovery_rights", "SBLR_OP_SHOW_DISCOVERY_RIGHTS", "sblr.security.mutation_or_inspect.v3", "rs.security.grant.v1", "principal_admin", "principal", ""},
    ...
    {"AUDIT-0482", "SHOW GRANTS FOR principal_admin", "op.show.grants", "SBLR_OP_SHOW_GRANTS", "sblr.security.mutation_or_inspect.v3", "rs.security.grant.v1", "principal_admin", "principal", ""},
    {"AUDIT-0480", "SHOW GROUPS", "op.show.groups", "SBLR_OP_SHOW_GROUPS", "sblr.security.mutation_or_inspect.v3", "rs.security.principal.v1", "", "", ""},
    {"AUDIT-0481", "SHOW IDENTITY PROVIDERS", "op.show.identity_providers", "SBLR_OP_SHOW_IDENTITY_PROVIDERS", "sblr.security.mutation_or_inspect.v3", "rs.security.principal.v1", "", "", ""},
