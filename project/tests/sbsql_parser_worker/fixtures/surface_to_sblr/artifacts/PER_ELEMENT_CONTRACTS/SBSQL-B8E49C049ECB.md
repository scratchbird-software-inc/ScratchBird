# SBSQL-B8E49C049ECB — error_diagnostic_uuid()
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B8E49C049ECB |
| Fixed UUID v7 | 019dffbb-f000-7f80-a299-20123268aea3 |
| Canonical name | error_diagnostic_uuid() |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B9AF718D3C25 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B8E49C049ECB |
