...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9485F8985BD3 |
| Fixed UUID v7 | 019dffbb-f000-7b6e-bb99-8c97efa14e1a |
| Canonical name | sb.session.current_user |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A2DB261B65BE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9485F8985BD3 |
