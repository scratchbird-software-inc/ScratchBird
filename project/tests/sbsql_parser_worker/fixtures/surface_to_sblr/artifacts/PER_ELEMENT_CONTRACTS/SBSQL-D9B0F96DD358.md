# SBSQL-D9B0F96DD358 — sb.aggregate.sum
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D9B0F96DD358 |
| Fixed UUID v7 | 019dffbb-f000-79d0-ae24-876730a8cd92 |
| Canonical name | sb.aggregate.sum |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C3D64AAF5733 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D9B0F96DD358 |
