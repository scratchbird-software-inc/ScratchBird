...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6D4DE2A31C56 |
| Fixed UUID v7 | 019dffbb-f000-761a-b306-e36f371f135a |
| Canonical name | param_mode |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5D50B2CDCE50 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6D4DE2A31C56 |
