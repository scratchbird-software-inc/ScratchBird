# SBSQL-723E5CADA519 — jsonb_set(document,path,value[,create_missing])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-723E5CADA519 |
| Fixed UUID v7 | 019dffbb-f000-77c7-9eb0-8251bb0601f2 |
| Canonical name | jsonb_set(document,path,value[,create_missing]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8A05597B54E1 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-723E5CADA519 |
