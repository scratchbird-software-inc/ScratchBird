# SBSQL-B06FC349B4A1 — table_sample_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B06FC349B4A1 |
| Fixed UUID v7 | 019dffbb-f000-760c-87fd-296aa06d7f2f |
| Canonical name | table_sample_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2DE381581F19 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B06FC349B4A1 |
