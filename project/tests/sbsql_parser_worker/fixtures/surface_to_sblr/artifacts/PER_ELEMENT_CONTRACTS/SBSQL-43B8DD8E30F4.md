# SBSQL-43B8DD8E30F4 — create_operator_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-43B8DD8E30F4 |
| Fixed UUID v7 | 019dffbb-f000-7213-b57b-0f630cf340b5 |
| Canonical name | create_operator_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6DCDF4712ABC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-43B8DD8E30F4 |
