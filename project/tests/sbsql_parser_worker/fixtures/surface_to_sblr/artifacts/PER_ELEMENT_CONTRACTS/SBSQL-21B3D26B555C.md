# SBSQL-21B3D26B555C — reference_contextual_keyword
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-21B3D26B555C |
| Fixed UUID v7 | 019dffbb-f000-7219-b58a-93be3af6dcde |
| Canonical name | reference_contextual_keyword |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D373473B3A1D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-21B3D26B555C |
