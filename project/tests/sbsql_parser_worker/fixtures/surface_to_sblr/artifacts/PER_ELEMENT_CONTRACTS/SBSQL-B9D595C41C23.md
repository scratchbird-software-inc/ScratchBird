# SBSQL-B9D595C41C23 — variable_scope
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B9D595C41C23 |
| Fixed UUID v7 | 019dffbb-f000-7d19-a489-66daadf44dca |
| Canonical name | variable_scope |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-874FD2DF1763 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B9D595C41C23 |
