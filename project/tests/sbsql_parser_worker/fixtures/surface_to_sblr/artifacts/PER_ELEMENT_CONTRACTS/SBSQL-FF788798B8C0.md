...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FF788798B8C0 |
| Fixed UUID v7 | 019dffbb-f000-762f-a330-04d0fdb4a8dc |
| Canonical name | quarter(date) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E0F1A6C4775F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-FF788798B8C0 |
