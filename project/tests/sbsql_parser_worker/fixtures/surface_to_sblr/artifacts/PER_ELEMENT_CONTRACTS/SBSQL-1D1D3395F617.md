# SBSQL-1D1D3395F617 — cursor_type
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1D1D3395F617 |
| Fixed UUID v7 | 019dffbb-f000-7a5e-8d8e-548bb2841070 |
| Canonical name | cursor_type |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AB56CFBD73ED |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1D1D3395F617 |
