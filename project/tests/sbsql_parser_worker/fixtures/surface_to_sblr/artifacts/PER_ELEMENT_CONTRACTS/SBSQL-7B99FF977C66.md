# SBSQL-7B99FF977C66 — json_build_array
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7B99FF977C66 |
| Fixed UUID v7 | 019dffbb-f000-78d1-9b2b-664e70ca5351 |
| Canonical name | json_build_array |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BB3B5374165F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7B99FF977C66 |
