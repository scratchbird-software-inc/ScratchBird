# SBSQL-9EB9F7780F49 — bridge_cutover
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9EB9F7780F49 |
| Fixed UUID v7 | 019e14c1-68a5-78ec-8dad-fbe04ad0bec4 |
| Canonical name | bridge_cutover |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9EB9F7780F49 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9EB9F7780F49 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_CUTOVER, UDR operation cutover, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
