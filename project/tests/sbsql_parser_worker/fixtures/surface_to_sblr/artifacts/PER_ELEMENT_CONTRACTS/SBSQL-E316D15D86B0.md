# SBSQL-E316D15D86B0 — variance(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E316D15D86B0 |
| Fixed UUID v7 | 019dffbb-f000-7c81-89a5-68c7ac07f92b |
| Canonical name | variance(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F462D692A633 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-E316D15D86B0 |
