# SBSQL-F603ACB8C1D1 — checkpoint_options
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F603ACB8C1D1 |
| Fixed UUID v7 | 019dffbb-f000-7ff5-83d0-4ed7ef27c7af |
| Canonical name | checkpoint_options |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-09B38A59B278 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F603ACB8C1D1 |
