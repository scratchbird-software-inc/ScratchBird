# SBSQL-B3EEE62CD7B0 — crc32(binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B3EEE62CD7B0 |
| Fixed UUID v7 | 019dffbb-f000-7403-adc3-dfb1c90a2973 |
| Canonical name | crc32(binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8204724D2C2D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B3EEE62CD7B0 |
