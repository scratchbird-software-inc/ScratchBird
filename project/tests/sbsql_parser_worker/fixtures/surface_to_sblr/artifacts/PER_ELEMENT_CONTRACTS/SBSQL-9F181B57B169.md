# SBSQL-9F181B57B169 — pg_advisory_lock(key)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9F181B57B169 |
| Fixed UUID v7 | 019dffbb-f000-7679-88f6-9fb6958295eb |
| Canonical name | pg_advisory_lock(key) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-20F6B3E60D37 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-9F181B57B169 |
