# SBSQL-4CFCAC326BFB — jsonb_pretty(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4CFCAC326BFB |
| Fixed UUID v7 | 019dffbb-f000-7890-bd38-ba8d326cd14c |
| Canonical name | jsonb_pretty(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3E6563DAFE9A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4CFCAC326BFB |
