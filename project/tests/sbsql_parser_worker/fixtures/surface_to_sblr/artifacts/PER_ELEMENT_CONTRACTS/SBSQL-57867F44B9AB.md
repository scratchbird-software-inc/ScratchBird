# SBSQL-57867F44B9AB — percentile_cont(fraction)WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-57867F44B9AB |
| Fixed UUID v7 | 019dffbb-f000-780d-b5ce-c1bae5a500b1 |
| Canonical name | percentile_cont(fraction)WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-03786D3289A3 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-57867F44B9AB |
