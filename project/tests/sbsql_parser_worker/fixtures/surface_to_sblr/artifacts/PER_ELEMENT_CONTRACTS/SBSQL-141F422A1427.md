...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-141F422A1427 |
| Fixed UUID v7 | 019dffbb-f000-7aea-8810-86b17b7126fd |
| Canonical name | week(date) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0332DB8D3277 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-141F422A1427 |
