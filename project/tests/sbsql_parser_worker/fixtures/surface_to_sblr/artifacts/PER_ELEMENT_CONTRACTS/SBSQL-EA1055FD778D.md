# SBSQL-EA1055FD778D — current_capability_set
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EA1055FD778D |
| Fixed UUID v7 | 019dffbb-f000-7aaa-88a3-9cee2d24206e |
| Canonical name | current_capability_set |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EC4CEB0D03AA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EA1055FD778D |
