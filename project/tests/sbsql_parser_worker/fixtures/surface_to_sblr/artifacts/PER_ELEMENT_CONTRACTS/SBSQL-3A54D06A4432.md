# SBSQL-3A54D06A4432 — count(*)\|count([DISTINCT]expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3A54D06A4432 |
| Fixed UUID v7 | 019dffbb-f000-702f-a7ab-e57e2f249380 |
| Canonical name | count(*)\\\|count([DISTINCT]expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-74B1E97F09E9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3A54D06A4432 |
