# SBSQL-5708DF455B5D — server_version
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5708DF455B5D |
| Fixed UUID v7 | 019dffbb-f000-78a5-bd48-99786bcfbb1b |
| Canonical name | server_version |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2F111C3A317D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5708DF455B5D |
