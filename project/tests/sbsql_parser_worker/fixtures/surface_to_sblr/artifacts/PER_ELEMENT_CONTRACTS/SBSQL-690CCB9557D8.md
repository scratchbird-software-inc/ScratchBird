# SBSQL-690CCB9557D8 — vindex_name
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-690CCB9557D8 |
| Fixed UUID v7 | 019dffbb-f000-7420-8d80-86bfb52f69a3 |
| Canonical name | vindex_name |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CA54A5E67288 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-690CCB9557D8 |
