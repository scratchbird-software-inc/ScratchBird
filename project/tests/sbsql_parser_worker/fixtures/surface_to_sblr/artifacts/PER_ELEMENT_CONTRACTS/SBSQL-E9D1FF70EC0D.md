# SBSQL-E9D1FF70EC0D — EXPLAIN(REFERENCE_LOG_COMPATIBILITYTRUE)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E9D1FF70EC0D |
| Fixed UUID v7 | 019dffbb-f000-7303-af5a-1679f0ce5c80 |
| Canonical name | EXPLAIN(REFERENCE_LOG_COMPATIBILITYTRUE) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2923AD77DEEF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E9D1FF70EC0D |
