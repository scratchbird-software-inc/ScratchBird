# SBSQL-ABCDC5A9E27A — select_statement
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-ABCDC5A9E27A |
| Fixed UUID v7 | 019dffbb-f000-7051-aaf5-f23c93d638e0 |
| Canonical name | select_statement |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7B465418A763 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-ABCDC5A9E27A |
