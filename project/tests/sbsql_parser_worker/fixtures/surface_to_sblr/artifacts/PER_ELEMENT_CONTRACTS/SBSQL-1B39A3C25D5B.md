# SBSQL-1B39A3C25D5B — position(bit_stringINbit_string)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1B39A3C25D5B |
| Fixed UUID v7 | 019dffbb-f000-76b4-a037-e1829f1cc9e4 |
| Canonical name | position(bit_stringINbit_string) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FE7B39A03EBA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-1B39A3C25D5B |
