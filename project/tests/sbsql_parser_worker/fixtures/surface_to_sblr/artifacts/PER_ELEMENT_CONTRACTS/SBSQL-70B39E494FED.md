# SBSQL-70B39E494FED — cume_dist(expr)WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-70B39E494FED |
| Fixed UUID v7 | 019dffbb-f000-7919-8b81-fe498f16321c |
| Canonical name | cume_dist(expr)WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0EFD0E909A3B |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-70B39E494FED |
