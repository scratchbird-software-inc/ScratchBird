# SBSQL-96E89F3A2DAD — iif(boolean,a,b)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-96E89F3A2DAD |
| Fixed UUID v7 | 019dffbb-f000-705e-af62-ca6bc806d066 |
| Canonical name | iif(boolean,a,b) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7FBD2D95DE01 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-96E89F3A2DAD |
