# SBSQL-4016AFBC31B8 — st_perimeter(geometry)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4016AFBC31B8 |
| Fixed UUID v7 | 019dffbb-f000-7dcd-8c79-2345c86a1ff1 |
| Canonical name | st_perimeter(geometry) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9D720A576AC6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4016AFBC31B8 |
