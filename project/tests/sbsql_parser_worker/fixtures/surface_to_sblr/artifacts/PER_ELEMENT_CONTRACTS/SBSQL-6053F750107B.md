# SBSQL-6053F750107B — jaro_winkler_similarity(text,text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6053F750107B |
| Fixed UUID v7 | 019dffbb-f000-7eea-a6d1-c3f46917f3c7 |
| Canonical name | jaro_winkler_similarity(text,text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-719EB596DBF7 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6053F750107B |
