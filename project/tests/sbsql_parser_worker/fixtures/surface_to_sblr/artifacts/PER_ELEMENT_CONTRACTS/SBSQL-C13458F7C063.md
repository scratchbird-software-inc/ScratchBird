# SBSQL-C13458F7C063 — stddev(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C13458F7C063 |
| Fixed UUID v7 | 019dffbb-f000-7d0b-8d04-42857d89f416 |
| Canonical name | stddev(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-18CEAAF06FC8 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C13458F7C063 |
