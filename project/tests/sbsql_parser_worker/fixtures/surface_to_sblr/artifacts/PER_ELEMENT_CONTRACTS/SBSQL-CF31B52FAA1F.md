# SBSQL-CF31B52FAA1F — st_asgeojson
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CF31B52FAA1F |
| Fixed UUID v7 | 019dffbb-f000-7621-b37a-ae7e3283fea8 |
| Canonical name | st_asgeojson |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-95D9D43982D3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CF31B52FAA1F |
