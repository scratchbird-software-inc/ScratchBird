# SBSQL-1076274FA39A — localized_label_max_length_bytes
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1076274FA39A |
| Fixed UUID v7 | 019dffbb-f000-7a29-b6f2-a2f943cbb0c8 |
| Canonical name | localized_label_max_length_bytes |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F2EB6AE9123C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1076274FA39A |
