# SBSQL-83DF52C71DB1 — date_add(date\|timestamp,interval)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-83DF52C71DB1 |
| Fixed UUID v7 | 019dffbb-f000-7c56-8534-53f08809dfc4 |
| Canonical name | date_add(date\\\|timestamp,interval) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C306B6AA5FF2 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-83DF52C71DB1 |
