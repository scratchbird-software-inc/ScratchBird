# SBSQL-326152468215 — strpos(string,substring)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-326152468215 |
| Fixed UUID v7 | 019dffbb-f000-7168-84ad-bcf211d352e2 |
| Canonical name | strpos(string,substring) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CE1F1435E23F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-326152468215 |
