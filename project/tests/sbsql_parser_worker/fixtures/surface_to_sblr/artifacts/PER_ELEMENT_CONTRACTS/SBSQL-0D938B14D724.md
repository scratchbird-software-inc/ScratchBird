# SBSQL-0D938B14D724 — vector_cast_int8(vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0D938B14D724 |
| Fixed UUID v7 | 019dffbb-f000-7af1-b253-9b357755f484 |
| Canonical name | vector_cast_int8(vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C55EBE9AA67A |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0D938B14D724 |
