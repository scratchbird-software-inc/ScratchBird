# SBSQL-0061DA1A97F9 — refusal_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0061DA1A97F9 |
| Fixed UUID v7 | 019dffbb-f000-74db-a101-be963bcbdfe0 |
| Canonical name | refusal_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F2C358D7B3BA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0061DA1A97F9 |
