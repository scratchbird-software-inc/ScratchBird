...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1A0000000002 |
| Fixed UUID v7 | 019e0f00-0000-7002-8000-000000000002 |
| Canonical name | alter_migration |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1A0000000002 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1A0000000002 |
| Expected result summary | expected parser migration route, SBLR opcode SBLR_MIGRATION_ALTER, API EngineAlterMigration, result shape rs.migration.status.v1, diagnostics, and executable behavior derived from Gate 004 evidence |
