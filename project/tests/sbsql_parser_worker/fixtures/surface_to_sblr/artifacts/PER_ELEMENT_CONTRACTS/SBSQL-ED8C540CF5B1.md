# SBSQL-ED8C540CF5B1 — date_sub(date\|timestamp,interval)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-ED8C540CF5B1 |
| Fixed UUID v7 | 019dffbb-f000-745b-9041-a2d4a4c6f36b |
| Canonical name | date_sub(date\\\|timestamp,interval) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F84C04A4DDAD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-ED8C540CF5B1 |
