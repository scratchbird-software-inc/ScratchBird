# SBSQL-0125E8D0A6D1 — event_trigger_filter
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0125E8D0A6D1 |
| Fixed UUID v7 | 019dffbb-f000-75d9-a6fc-19420e0a26cc |
| Canonical name | event_trigger_filter |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D068DF1ED6F2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0125E8D0A6D1 |
