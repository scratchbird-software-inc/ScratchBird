# SBSQL-3C0839E8B792 — regr_count(y,x)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3C0839E8B792 |
| Fixed UUID v7 | 019dffbb-f000-7ee1-beb4-01cd055ab526 |
| Canonical name | regr_count(y,x) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3A36C1725795 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-3C0839E8B792 |
