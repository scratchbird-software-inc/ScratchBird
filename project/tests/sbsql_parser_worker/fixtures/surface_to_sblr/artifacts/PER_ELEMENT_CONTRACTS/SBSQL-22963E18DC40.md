# SBSQL-22963E18DC40 — JSON_TABLE(document,jsonpathCOLUMNS(...))
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-22963E18DC40 |
| Fixed UUID v7 | 019dffbb-f000-7768-94d1-cef75c84ae7e |
| Canonical name | JSON_TABLE(document,jsonpathCOLUMNS(...)) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9AE6BC099FBE |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-22963E18DC40 |
