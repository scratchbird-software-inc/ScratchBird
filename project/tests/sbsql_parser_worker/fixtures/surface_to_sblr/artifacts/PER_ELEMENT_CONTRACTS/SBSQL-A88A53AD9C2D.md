# SBSQL-A88A53AD9C2D — has_function_privilege([user,]function_name,privilege)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A88A53AD9C2D |
| Fixed UUID v7 | 019dffbb-f000-7492-8e0b-824e585544d4 |
| Canonical name | has_function_privilege([user,]function_name,privilege) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-70A6A24B1337 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A88A53AD9C2D |
