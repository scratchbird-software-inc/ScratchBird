# SBSQL-B5E19A3E35A7 — comment_on_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B5E19A3E35A7 |
| Fixed UUID v7 | 019dffbb-f000-70e3-b7e1-c0e99664f9a2 |
| Canonical name | comment_on_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-716DFE515307 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B5E19A3E35A7 |
