# SBSQL-6C87F2E4972C — cursor_open
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6C87F2E4972C |
| Fixed UUID v7 | 019dffbb-f000-75d7-b434-542598b842ec |
| Canonical name | cursor_open |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-438C36CE7D30 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6C87F2E4972C |
