# SBSQL-2EDA1021123C — to_boolean(text\|integer)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2EDA1021123C |
| Fixed UUID v7 | 019dffbb-f000-7f6f-9c3a-86cf8a434251 |
| Canonical name | to_boolean(text\\\|integer) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EF057902E612 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-2EDA1021123C |
