# SBSQL-837F23FAC0D1 — right(text,n)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-837F23FAC0D1 |
| Fixed UUID v7 | 019dffbb-f000-7a46-beee-8dcba999e3e3 |
| Canonical name | right(text,n) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6198A48BB434 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-837F23FAC0D1 |
