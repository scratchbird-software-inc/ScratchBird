# SBSQL-71A081B78B8A — cluster_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-71A081B78B8A |
| Fixed UUID v7 | 019dffbb-f000-7660-a89b-000e58b619ce |
| Canonical name | cluster_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-40A55099CD5A |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-71A081B78B8A |
