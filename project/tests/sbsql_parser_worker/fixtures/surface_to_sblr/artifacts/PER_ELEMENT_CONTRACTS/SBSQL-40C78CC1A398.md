# SBSQL-40C78CC1A398 — xml_type_modifier
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-40C78CC1A398 |
| Fixed UUID v7 | 019dffbb-f000-7917-bd58-2ec907db10eb |
| Canonical name | xml_type_modifier |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3285488565EE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-40C78CC1A398 |
