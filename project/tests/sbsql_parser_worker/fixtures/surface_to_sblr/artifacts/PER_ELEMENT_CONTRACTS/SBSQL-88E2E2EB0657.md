# SBSQL-88E2E2EB0657 — setval(sequence_name,n[,is_called])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-88E2E2EB0657 |
| Fixed UUID v7 | 019dffbb-f000-7a85-81b4-cf339577a8c4 |
| Canonical name | setval(sequence_name,n[,is_called]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3CF454D03AB0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-88E2E2EB0657 |
| Expected result summary | expected parse, bind, lower, result shape, diagnostic, and executable/refusal behavior derived from canonical spec and operation matrix plus SBSFC-029 sequence/generator scalar fixtures |
