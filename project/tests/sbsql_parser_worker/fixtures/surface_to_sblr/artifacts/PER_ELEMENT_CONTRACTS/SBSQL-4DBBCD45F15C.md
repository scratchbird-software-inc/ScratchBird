# SBSQL-4DBBCD45F15C — json_object(text[][,text[]])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4DBBCD45F15C |
| Fixed UUID v7 | 019dffbb-f000-7ca5-b599-7ba03c7f2c8d |
| Canonical name | json_object(text[][,text[]]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7B340C6A88BD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-4DBBCD45F15C |
