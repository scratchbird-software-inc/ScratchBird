...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0B5204549537 |
| Fixed UUID v7 | 019dffbb-f000-7c12-81b0-f6ad7033a124 |
| Canonical name | THEN |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-192A2DAD7915 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0B5204549537 |
