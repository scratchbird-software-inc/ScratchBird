# SBSQL-07E8D99F156F — log(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-07E8D99F156F |
| Fixed UUID v7 | 019dffbb-f000-7606-8182-b5a62d10684f |
| Canonical name | log(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-82D4AEE7F83F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-07E8D99F156F |
