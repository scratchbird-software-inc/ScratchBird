# SBSQL-798A9C6439FC — levenshtein_le(text,text,max)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-798A9C6439FC |
| Fixed UUID v7 | 019dffbb-f000-735d-9229-faa07a5c12d2 |
| Canonical name | levenshtein_le(text,text,max) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B871F0A358FF |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-798A9C6439FC |
