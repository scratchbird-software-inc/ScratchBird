# SBSQL-2B3B74FBBF85 — every(boolean)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2B3B74FBBF85 |
| Fixed UUID v7 | 019dffbb-f000-79f2-a618-fa3e2dca4651 |
| Canonical name | every(boolean) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EFC55B90FA22 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2B3B74FBBF85 |
