# SBSQL-3F52BDC34961 — bit_toggle(int,position)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3F52BDC34961 |
| Fixed UUID v7 | 019dffbb-f000-736b-b230-325dcf657e91 |
| Canonical name | bit_toggle(int,position) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3BCF46427481 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3F52BDC34961 |
