# SBSQL-285B2CE981EB — current_date
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-285B2CE981EB |
| Fixed UUID v7 | 019dffbb-f000-7103-9eb7-f87d62f10cd8 |
| Canonical name | current_date |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6FD55A4B293C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-285B2CE981EB |
