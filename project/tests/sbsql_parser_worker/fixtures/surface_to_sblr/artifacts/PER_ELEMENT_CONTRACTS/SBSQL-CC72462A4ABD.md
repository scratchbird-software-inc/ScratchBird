# SBSQL-CC72462A4ABD — bridge_compare_result
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CC72462A4ABD |
| Fixed UUID v7 | 019e14c1-defb-7920-8a0e-a3a626d59cfc |
| Canonical name | bridge_compare_result |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CC72462A4ABD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CC72462A4ABD |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_COMPARE_RESULT, UDR operation compare_result, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
