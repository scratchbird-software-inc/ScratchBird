# SBSQL-3278282AF7A1 — setof(T,...,ordinalitybigint)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3278282AF7A1 |
| Fixed UUID v7 | 019dffbb-f000-70f5-b358-f82a3542467b |
| Canonical name | setof(T,...,ordinalitybigint) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B09913F7F185 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-3278282AF7A1 |
