# SBSQL-67D1D3830219 — gettransactionid
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-67D1D3830219 |
| Fixed UUID v7 | 019dffbb-f000-7030-9136-060f03d288a6 |
| Canonical name | gettransactionid |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-76D2E2B5E6E2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-67D1D3830219 |
