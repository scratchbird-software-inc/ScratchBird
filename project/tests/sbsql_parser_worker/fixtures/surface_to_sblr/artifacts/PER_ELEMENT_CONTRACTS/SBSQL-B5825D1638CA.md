# SBSQL-B5825D1638CA — st_makepoint(x,y[,z[,m]])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B5825D1638CA |
| Fixed UUID v7 | 019dffbb-f000-70a8-af1f-b4afbaf8bd76 |
| Canonical name | st_makepoint(x,y[,z[,m]]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CB00521F8CC0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B5825D1638CA |
