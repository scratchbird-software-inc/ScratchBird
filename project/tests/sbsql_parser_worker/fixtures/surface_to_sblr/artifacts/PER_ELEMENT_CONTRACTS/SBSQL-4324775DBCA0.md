# SBSQL-4324775DBCA0 — json_typeof(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4324775DBCA0 |
| Fixed UUID v7 | 019dffbb-f000-771b-962b-ffba0b8e8fec |
| Canonical name | json_typeof(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-404234CBBA44 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4324775DBCA0 |
