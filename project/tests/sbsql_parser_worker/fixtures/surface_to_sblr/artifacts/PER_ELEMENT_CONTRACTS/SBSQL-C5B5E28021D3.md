# SBSQL-C5B5E28021D3 — st_makeline(point,point\|array)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C5B5E28021D3 |
| Fixed UUID v7 | 019dffbb-f000-7ab8-ba26-b5b1dd196c8b |
| Canonical name | st_makeline(point,point\\\|array) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5B9985F3255E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C5B5E28021D3 |
