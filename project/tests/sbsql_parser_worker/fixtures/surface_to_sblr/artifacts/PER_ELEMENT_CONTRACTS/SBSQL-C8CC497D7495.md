# SBSQL-C8CC497D7495 — var_default
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C8CC497D7495 |
| Fixed UUID v7 | 019dffbb-f000-719c-a36a-b34f577a6984 |
| Canonical name | var_default |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8061EB40CFDE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C8CC497D7495 |
