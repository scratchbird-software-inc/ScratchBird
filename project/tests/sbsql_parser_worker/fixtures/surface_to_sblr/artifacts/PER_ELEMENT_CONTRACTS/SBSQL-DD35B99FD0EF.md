# SBSQL-DD35B99FD0EF — to_hex(integer)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DD35B99FD0EF |
| Fixed UUID v7 | 019dffbb-f000-78b8-a2c5-14334e8176cd |
| Canonical name | to_hex(integer) |
...
| Closure action | canonical_spec_plus_sblr_matrix |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CF9F9D2444C2 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DD35B99FD0EF |
