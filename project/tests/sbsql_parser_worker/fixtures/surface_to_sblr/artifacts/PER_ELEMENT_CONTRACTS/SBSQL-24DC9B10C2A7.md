...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-24DC9B10C2A7 |
| Fixed UUID v7 | 019dffbb-f000-74eb-bc1b-03ff00f0923c |
| Canonical name | trim_form |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-443627C4CED7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-24DC9B10C2A7 |
