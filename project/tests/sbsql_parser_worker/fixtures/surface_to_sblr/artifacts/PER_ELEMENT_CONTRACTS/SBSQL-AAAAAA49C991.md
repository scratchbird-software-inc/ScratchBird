...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AAAAAA49C991 |
| Fixed UUID v7 | 019dffbb-f000-7a51-890f-af373069f225 |
| Canonical name | lo_import |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A587B91AB05E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AAAAAA49C991 |
