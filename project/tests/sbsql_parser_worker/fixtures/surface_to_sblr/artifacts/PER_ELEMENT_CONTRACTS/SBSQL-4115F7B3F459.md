# SBSQL-4115F7B3F459 — vector_dims
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4115F7B3F459 |
| Fixed UUID v7 | 019dffbb-f000-79eb-a2b4-d1c4cd23ce0c |
| Canonical name | vector_dims |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-45CB64439770 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-4115F7B3F459 |
