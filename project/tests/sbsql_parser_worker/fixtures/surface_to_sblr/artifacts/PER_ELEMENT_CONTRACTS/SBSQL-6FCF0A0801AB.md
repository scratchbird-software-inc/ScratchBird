# SBSQL-6FCF0A0801AB — psql_autonomous_block
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6FCF0A0801AB |
| Fixed UUID v7 | 019dffbb-f000-7af4-bd6d-5ffbefba662c |
| Canonical name | psql_autonomous_block |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CA19A12ABCF4 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6FCF0A0801AB |
