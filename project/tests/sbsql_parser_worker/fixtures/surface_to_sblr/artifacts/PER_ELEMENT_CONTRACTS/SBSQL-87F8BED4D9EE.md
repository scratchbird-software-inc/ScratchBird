# SBSQL-87F8BED4D9EE — REFERENCE_LOG_COMPATIBILITY
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-87F8BED4D9EE |
| Fixed UUID v7 | 019dffbb-f000-7796-a00e-93eabc2d375b |
| Canonical name | REFERENCE_LOG_COMPATIBILITY |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3F22F5DC04DF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-87F8BED4D9EE |
