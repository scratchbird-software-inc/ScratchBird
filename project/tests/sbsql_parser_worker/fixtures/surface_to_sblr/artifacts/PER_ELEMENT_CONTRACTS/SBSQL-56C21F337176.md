# SBSQL-56C21F337176 — st_envelope(geometry)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-56C21F337176 |
| Fixed UUID v7 | 019dffbb-f000-7db8-b038-25c899a67993 |
| Canonical name | st_envelope(geometry) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5835ABF46496 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-56C21F337176 |
