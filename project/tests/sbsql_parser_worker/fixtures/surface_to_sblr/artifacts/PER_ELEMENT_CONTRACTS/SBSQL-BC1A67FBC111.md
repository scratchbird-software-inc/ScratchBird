# SBSQL-BC1A67FBC111 — similar_to_escape
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BC1A67FBC111 |
| Fixed UUID v7 | 019dffbb-f000-707c-b2fd-720fea5eb1e3 |
| Canonical name | similar_to_escape |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C9D6203F31AC |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BC1A67FBC111 |
