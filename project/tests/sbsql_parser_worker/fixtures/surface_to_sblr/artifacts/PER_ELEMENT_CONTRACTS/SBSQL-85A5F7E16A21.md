# SBSQL-85A5F7E16A21 — psql_emit_channel_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-85A5F7E16A21 |
| Fixed UUID v7 | 019dffbb-f000-7965-aeb1-d700476d38e0 |
| Canonical name | psql_emit_channel_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-21B79ACE30BB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-85A5F7E16A21 |
