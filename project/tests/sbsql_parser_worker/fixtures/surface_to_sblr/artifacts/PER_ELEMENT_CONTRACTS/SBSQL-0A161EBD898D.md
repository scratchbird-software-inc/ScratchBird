# SBSQL-0A161EBD898D — make_time(hour,minute,second)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0A161EBD898D |
| Fixed UUID v7 | 019dffbb-f000-7e67-9752-0d1a7526f80d |
| Canonical name | make_time(hour,minute,second) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2005ECB1FF2C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0A161EBD898D |
