# SBSQL-CB6DFFF585E7 — bridge_close_session
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CB6DFFF585E7 |
| Fixed UUID v7 | 019e14c1-5a63-7eae-876d-8b01b211d6e4 |
| Canonical name | bridge_close_session |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CB6DFFF585E7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CB6DFFF585E7 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_CLOSE_SESSION, UDR operation close_session, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
