# SBSQL-B0A110B28BF7 — cbrt(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B0A110B28BF7 |
| Fixed UUID v7 | 019dffbb-f000-7352-8768-22e05b635bc2 |
| Canonical name | cbrt(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-178EF9F49560 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B0A110B28BF7 |
