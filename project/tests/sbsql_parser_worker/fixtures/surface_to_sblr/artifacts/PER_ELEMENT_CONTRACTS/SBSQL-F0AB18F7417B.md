# SBSQL-F0AB18F7417B — to_json(any)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F0AB18F7417B |
| Fixed UUID v7 | 019dffbb-f000-730e-b72e-2218f399e153 |
| Canonical name | to_json(any) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B7BDBBE37213 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F0AB18F7417B |
