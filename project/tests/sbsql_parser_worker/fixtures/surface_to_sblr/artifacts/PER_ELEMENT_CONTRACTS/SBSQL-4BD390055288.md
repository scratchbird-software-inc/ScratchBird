# SBSQL-4BD390055288 — bridge_detach
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4BD390055288 |
| Fixed UUID v7 | 019e14c1-be4a-71ca-81f3-6b4bbdd0726e |
| Canonical name | bridge_detach |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4BD390055288 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4BD390055288 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_CLOSE_SESSION, UDR operation detach, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
