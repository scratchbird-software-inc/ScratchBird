# SBSQL-892AE352BD3A — rowset_to_cursor(rowset)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-892AE352BD3A |
| Fixed UUID v7 | 019dffbb-f000-77f7-8648-8a8e9eea7c96 |
| Canonical name | rowset_to_cursor(rowset) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B773C22F4A0C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-892AE352BD3A |
