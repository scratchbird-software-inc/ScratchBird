# SBSQL-F36C85C9C652 — approx_percentile_cont(fraction)WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F36C85C9C652 |
| Fixed UUID v7 | 019dffbb-f000-7b03-adf6-01df71f4cdfa |
| Canonical name | approx_percentile_cont(fraction)WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3D153391CCF4 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F36C85C9C652 |
