# SBSQL-5A2E7551B74D — regexp_count(string,pattern[,flags])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5A2E7551B74D |
| Fixed UUID v7 | 019dffbb-f000-7182-843b-d2b503ce48fd |
| Canonical name | regexp_count(string,pattern[,flags]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1CC8C7960DA9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5A2E7551B74D |
