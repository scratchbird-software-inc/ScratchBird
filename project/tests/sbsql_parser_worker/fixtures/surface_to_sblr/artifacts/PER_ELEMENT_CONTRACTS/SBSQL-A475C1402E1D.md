# SBSQL-A475C1402E1D — armor(binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A475C1402E1D |
| Fixed UUID v7 | 019dffbb-f000-77be-91e5-aeeac55d9b74 |
| Canonical name | armor(binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-73179706E270 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A475C1402E1D |
