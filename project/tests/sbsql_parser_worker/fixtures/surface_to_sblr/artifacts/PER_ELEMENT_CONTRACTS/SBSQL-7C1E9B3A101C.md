# SBSQL-7C1E9B3A101C — to_char(temporal\|numeric,format)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7C1E9B3A101C |
| Fixed UUID v7 | 019dffbb-f000-7006-922c-69bbc9fc9f54 |
| Canonical name | to_char(temporal\\\|numeric,format) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CC153730146D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7C1E9B3A101C |
