# SBSQL-CD6D9CB540EC — psql_if_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CD6D9CB540EC |
| Fixed UUID v7 | 019dffbb-f000-708f-a2a6-e73e1a06df00 |
| Canonical name | psql_if_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4643CD8B2920 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CD6D9CB540EC |
