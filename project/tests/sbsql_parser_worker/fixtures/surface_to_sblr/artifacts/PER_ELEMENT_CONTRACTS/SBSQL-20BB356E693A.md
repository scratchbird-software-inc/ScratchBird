...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-20BB356E693A |
| Fixed UUID v7 | 019dffbb-f000-7ded-bc16-a1b61e07c9dc |
| Canonical name | SYS_CONTEXT('USERENV','SESSION_USER') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AAB6D64B5D0D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-20BB356E693A |
