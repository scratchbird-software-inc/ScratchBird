# SBSQL-96DE0F2265B6 — lob_locator_to_binary(locator)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-96DE0F2265B6 |
| Fixed UUID v7 | 019dffbb-f000-73e8-af02-4bc400f024e7 |
| Canonical name | lob_locator_to_binary(locator) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8E44B7205460 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-96DE0F2265B6 |
