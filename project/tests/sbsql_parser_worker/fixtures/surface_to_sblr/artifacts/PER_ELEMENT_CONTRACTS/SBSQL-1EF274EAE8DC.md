# SBSQL-1EF274EAE8DC — ntile(n)OVER(...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1EF274EAE8DC |
| Fixed UUID v7 | 019dffbb-f000-7448-90ae-d5282a6bfb7f |
| Canonical name | ntile(n)OVER(...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3172F2913635 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1EF274EAE8DC |
