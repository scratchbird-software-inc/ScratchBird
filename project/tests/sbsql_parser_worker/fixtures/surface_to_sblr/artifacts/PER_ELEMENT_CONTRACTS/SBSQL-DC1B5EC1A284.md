...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DC1B5EC1A284 |
| Fixed UUID v7 | 019dffbb-f000-71c1-9df7-938c0cbb9efb |
| Canonical name | where |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ECA6B6B00FAD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DC1B5EC1A284 |
