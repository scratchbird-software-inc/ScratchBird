# SBSQL-F7B4F498213C — lead(expr[,offset[,default]])OVER(...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F7B4F498213C |
| Fixed UUID v7 | 019dffbb-f000-7e70-b5d7-2f5469224b78 |
| Canonical name | lead(expr[,offset[,default]])OVER(...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CC79C1A30BA2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F7B4F498213C |
