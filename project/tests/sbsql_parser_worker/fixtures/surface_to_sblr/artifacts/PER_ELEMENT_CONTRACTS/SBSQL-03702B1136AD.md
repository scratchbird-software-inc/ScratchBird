# SBSQL-03702B1136AD — aggregate_attr
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-03702B1136AD |
| Fixed UUID v7 | 019dffbb-f000-7269-8403-a162180cd80e |
| Canonical name | aggregate_attr |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C6D4C16ACAE5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-03702B1136AD |
