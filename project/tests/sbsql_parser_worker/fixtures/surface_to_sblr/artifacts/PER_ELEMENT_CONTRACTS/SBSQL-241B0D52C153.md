# SBSQL-241B0D52C153 — uuid_generate_v4
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-241B0D52C153 |
| Fixed UUID v7 | 019dffbb-f000-7e63-b855-587564821ba2 |
| Canonical name | uuid_generate_v4 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1C827C8BB04B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-241B0D52C153 |
