# SBSQL-769B003AF4F3 — package_body_item
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-769B003AF4F3 |
| Fixed UUID v7 | 019dffbb-f000-78f6-9e3a-1aaa4b5a66fc |
| Canonical name | package_body_item |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EEB234322FB1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-769B003AF4F3 |
