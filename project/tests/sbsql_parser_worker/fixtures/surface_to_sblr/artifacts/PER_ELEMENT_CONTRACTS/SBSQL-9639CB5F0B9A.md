# SBSQL-9639CB5F0B9A — st_intersects(g1,g2)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9639CB5F0B9A |
| Fixed UUID v7 | 019dffbb-f000-70c2-86a8-116036bfee0a |
| Canonical name | st_intersects(g1,g2) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-053DB332A2DE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9639CB5F0B9A |
