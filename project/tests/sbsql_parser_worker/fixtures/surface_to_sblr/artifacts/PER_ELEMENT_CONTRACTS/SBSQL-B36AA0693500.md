# SBSQL-B36AA0693500 — TIMESTAMP(6)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B36AA0693500 |
| Fixed UUID v7 | 019dffbb-f000-7841-93c8-98fb631d678a |
| Canonical name | TIMESTAMP(6) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8A8E0CF80014 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B36AA0693500 |
