...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0086682C61B3 |
| Fixed UUID v7 | 019dffbb-f000-7728-b9c4-23295ba8b93d |
| Canonical name | bit_count |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1FA826971085 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0086682C61B3 |
