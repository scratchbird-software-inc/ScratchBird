...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D9E42211F7B8 |
| Fixed UUID v7 | 019dffbb-f000-75de-bbff-7b0d19b47c7a |
| Canonical name | to_char |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-66692294AEF0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D9E42211F7B8 |
