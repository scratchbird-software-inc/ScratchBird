# SBSQL-902AB93C9666 — transaction_timeout
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-902AB93C9666 |
| Fixed UUID v7 | 019dffbb-f000-771e-94d5-bede9abcd06c |
| Canonical name | transaction_timeout |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7C9866B762A0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-902AB93C9666 |
