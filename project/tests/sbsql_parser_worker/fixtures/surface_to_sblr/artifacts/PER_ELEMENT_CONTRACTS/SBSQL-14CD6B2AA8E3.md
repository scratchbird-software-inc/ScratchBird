# SBSQL-14CD6B2AA8E3 — st_geometrytype(geometry)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-14CD6B2AA8E3 |
| Fixed UUID v7 | 019dffbb-f000-77dd-ac54-85767abb9926 |
| Canonical name | st_geometrytype(geometry) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-47DF5C2A3490 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-14CD6B2AA8E3 |
