# SBSQL-54EBF8EDE58A — XMLELEMENT(NAMEname[,namespaces][,attrs][,content_list])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-54EBF8EDE58A |
| Fixed UUID v7 | 019dffbb-f000-7ecd-ac64-30f2e5814c94 |
| Canonical name | XMLELEMENT(NAMEname[,namespaces][,attrs][,content_list]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-17AF578968CE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-54EBF8EDE58A |
