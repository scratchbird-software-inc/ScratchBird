# SBSQL-564BD6C7C93C — transaction_mode_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-564BD6C7C93C |
| Fixed UUID v7 | 019dffbb-f000-74e8-9a47-5fbf0def1a81 |
| Canonical name | transaction_mode_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-231AAFA76600 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-564BD6C7C93C |
