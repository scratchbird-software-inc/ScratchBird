# SBSQL-FC06D12DAC16 — lob_read(locator,offset,length)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FC06D12DAC16 |
| Fixed UUID v7 | 019dffbb-f000-708d-abc1-d9878fb4be65 |
| Canonical name | lob_read(locator,offset,length) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0B548C175D93 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-FC06D12DAC16 |
