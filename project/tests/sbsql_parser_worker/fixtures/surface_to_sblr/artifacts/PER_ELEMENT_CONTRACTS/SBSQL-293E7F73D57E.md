...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-293E7F73D57E |
| Fixed UUID v7 | 019dffbb-f000-7a3a-b91c-c410a41e4bee |
| Canonical name | set_config |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EBAB04479EB6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-293E7F73D57E |
