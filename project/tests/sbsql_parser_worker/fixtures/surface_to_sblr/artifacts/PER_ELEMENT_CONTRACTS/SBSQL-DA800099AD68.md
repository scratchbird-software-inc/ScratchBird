# SBSQL-DA800099AD68 — reverse(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DA800099AD68 |
| Fixed UUID v7 | 019dffbb-f000-78d4-b1fe-a9f1fcce34d7 |
| Canonical name | reverse(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AEA6D49DB70A |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DA800099AD68 |
