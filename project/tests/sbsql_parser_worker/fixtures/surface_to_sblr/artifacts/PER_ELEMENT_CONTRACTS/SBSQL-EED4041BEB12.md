...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EED4041BEB12 |
| Fixed UUID v7 | 019dffbb-f000-7630-b21b-7f9939f2a6a8 |
| Canonical name | @@SERVERNAME |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8EFE5B9367AD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EED4041BEB12 |
