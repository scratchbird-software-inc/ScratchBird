# SBSQL-C3C1B9ED259C — trigger_event
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C3C1B9ED259C |
| Fixed UUID v7 | 019dffbb-f000-795e-be24-7666527e4d6e |
| Canonical name | trigger_event |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F4018A69FB2A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C3C1B9ED259C |
