# SBSQL-1D78D4177491 — strict_typing_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1D78D4177491 |
| Fixed UUID v7 | 019dffbb-f000-7361-a875-87993bc5e647 |
| Canonical name | strict_typing_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-88DBE04988C0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1D78D4177491 |
