# SBSQL-D2FCB9E1F0D6 — pk_column_spec
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D2FCB9E1F0D6 |
| Fixed UUID v7 | 019dffbb-f000-758c-9ece-d585cbe17fd3 |
| Canonical name | pk_column_spec |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-123C472BE107 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D2FCB9E1F0D6 |
