# SBSQL-C9163A071EA7 — COALESCE(a,b,...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C9163A071EA7 |
| Fixed UUID v7 | 019dffbb-f000-7909-bf77-22f64b1ffccf |
| Canonical name | COALESCE(a,b,...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A05730917A5E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C9163A071EA7 |
