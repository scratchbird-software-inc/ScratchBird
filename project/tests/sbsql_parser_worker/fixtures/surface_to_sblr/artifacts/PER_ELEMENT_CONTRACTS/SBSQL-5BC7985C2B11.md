# SBSQL-5BC7985C2B11 — activate_policy_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5BC7985C2B11 |
| Fixed UUID v7 | 019dffbb-f000-731b-a968-8a775f4fc217 |
| Canonical name | activate_policy_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-786868226156 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5BC7985C2B11 |
