# SBSQL-D26A0353E396 — catalog_object_owner(uuid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D26A0353E396 |
| Fixed UUID v7 | 019dffbb-f000-7733-afc5-f24c52bd2e05 |
| Canonical name | catalog_object_owner(uuid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0C0CB65A0BBD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D26A0353E396 |
