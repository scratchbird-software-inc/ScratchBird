# SBSQL-6E2D0E0B0110 — get_lock(name,timeout)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6E2D0E0B0110 |
| Fixed UUID v7 | 019dffbb-f000-7ab0-9e11-000000000110 |
| Canonical name | get_lock(name,timeout) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6E2D0E0B0110 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6E2D0E0B0110 |
| Expected result summary | expected parser projection, SBLR expression runtime binding, named-lock scalar result shape, diagnostics, and executable behavior derived from Gate 011 evidence |
