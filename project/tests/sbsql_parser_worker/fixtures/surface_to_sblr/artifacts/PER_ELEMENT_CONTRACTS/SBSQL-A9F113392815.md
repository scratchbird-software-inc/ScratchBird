# SBSQL-A9F113392815 — catalog_object_class(uuid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A9F113392815 |
| Fixed UUID v7 | 019dffbb-f000-7dc6-80a4-c75320540f26 |
| Canonical name | catalog_object_class(uuid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E77BEDF6282E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A9F113392815 |
