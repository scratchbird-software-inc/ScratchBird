...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B66B527161BA |
| Fixed UUID v7 | 019dffbb-f000-7cdf-a97b-209c87ddb350 |
| Canonical name | corr(y,x) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-997F36E8F79A |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B66B527161BA |
