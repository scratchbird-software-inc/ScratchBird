# SBSQL-18B3E6720DDA — json_get_expr
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-18B3E6720DDA |
| Fixed UUID v7 | 019dffbb-f000-77d3-a887-d4cc337497ef |
| Canonical name | json_get_expr |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0FEC27CF3A0C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-18B3E6720DDA |
