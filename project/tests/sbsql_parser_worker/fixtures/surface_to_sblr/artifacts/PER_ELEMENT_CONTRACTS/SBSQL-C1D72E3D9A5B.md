# SBSQL-C1D72E3D9A5B — create_transform_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C1D72E3D9A5B |
| Fixed UUID v7 | 019dffbb-f000-75b6-a545-4391c0d739f9 |
| Canonical name | create_transform_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-36781942FCC5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C1D72E3D9A5B |
