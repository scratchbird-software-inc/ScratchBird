# SBSQL-048498BB9A7F — jsonb_typeof
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-048498BB9A7F |
| Fixed UUID v7 | 019dffbb-f000-798e-b268-bb4dbd8e612d |
| Canonical name | jsonb_typeof |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5ED179D9E221 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-048498BB9A7F |
