# SBSQL-7C500BA126F0 — position(substringINstring)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7C500BA126F0 |
| Fixed UUID v7 | 019dffbb-f000-70f1-9243-7ffedb620ff6 |
| Canonical name | position(substringINstring) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BEDA928CB873 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7C500BA126F0 |
