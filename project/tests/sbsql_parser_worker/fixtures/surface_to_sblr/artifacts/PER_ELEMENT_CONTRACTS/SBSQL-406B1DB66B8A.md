# SBSQL-406B1DB66B8A — SBSQL.OPERATOR_OVERLOAD_UNRESOLVED
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-406B1DB66B8A |
| Fixed UUID v7 | 019dffbb-f000-72d8-8528-2100b06d763c |
| Canonical name | SBSQL.OPERATOR_OVERLOAD_UNRESOLVED |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FBA55455FCFD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-406B1DB66B8A |
