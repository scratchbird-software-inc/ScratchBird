# SBSQL-6CD48E00F9BD — TRIM([LEADING\|TRAILING\|BOTH][chars]FROMtext)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6CD48E00F9BD |
| Fixed UUID v7 | 019dffbb-f000-7c75-8a81-42f1607e2ed7 |
| Canonical name | TRIM([LEADING\\\|TRAILING\\\|BOTH][chars]FROMtext) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B4C739A28651 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6CD48E00F9BD |
