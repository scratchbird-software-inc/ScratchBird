# SBSQL-76EC89319569 — any_value(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-76EC89319569 |
| Fixed UUID v7 | 019dffbb-f000-739f-b4b5-7845010a088c |
| Canonical name | any_value(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8C98AE51F38D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-76EC89319569 |
