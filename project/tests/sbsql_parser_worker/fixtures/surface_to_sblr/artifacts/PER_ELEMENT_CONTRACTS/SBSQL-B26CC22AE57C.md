...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B26CC22AE57C |
| Fixed UUID v7 | 019dffbb-f000-7e4d-a0d8-1e5a5a688f79 |
| Canonical name | RDB$GET_CONTEXT('USER_SESSION',name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1260EDD8148F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B26CC22AE57C |
