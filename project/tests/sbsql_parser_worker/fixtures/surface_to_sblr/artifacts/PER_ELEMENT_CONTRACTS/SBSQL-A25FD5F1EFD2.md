# SBSQL-A25FD5F1EFD2 — reconcile_options
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A25FD5F1EFD2 |
| Fixed UUID v7 | 019dffbb-f000-77d6-8af0-624555ca9e81 |
| Canonical name | reconcile_options |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CDC908D0428E |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-A25FD5F1EFD2 |
