# SBSQL-2AF1625122A9 — trunc(numeric[,scale])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2AF1625122A9 |
| Fixed UUID v7 | 019dffbb-f000-7b1e-9020-aafec06eec6b |
| Canonical name | trunc(numeric[,scale]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EB71CCC10E18 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2AF1625122A9 |
