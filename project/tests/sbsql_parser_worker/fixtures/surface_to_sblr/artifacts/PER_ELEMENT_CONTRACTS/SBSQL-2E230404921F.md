# SBSQL-2E230404921F — json_insert(document,path,value)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2E230404921F |
| Fixed UUID v7 | 019dffbb-f000-7eb6-b182-3ecfdee43211 |
| Canonical name | json_insert(document,path,value) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5C7D89CC7D6D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2E230404921F |
