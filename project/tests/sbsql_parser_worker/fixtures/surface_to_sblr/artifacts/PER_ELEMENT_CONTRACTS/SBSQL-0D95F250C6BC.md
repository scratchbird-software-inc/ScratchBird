# SBSQL-0D95F250C6BC — sha224(text\|binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0D95F250C6BC |
| Fixed UUID v7 | 019dffbb-f000-7251-a436-6eb73e7228c9 |
| Canonical name | sha224(text\\\|binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3E16E4A8036F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0D95F250C6BC |
