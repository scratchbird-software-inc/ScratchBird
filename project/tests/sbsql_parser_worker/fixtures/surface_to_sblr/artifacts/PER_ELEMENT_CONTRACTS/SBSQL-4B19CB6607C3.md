# SBSQL-4B19CB6607C3 — fusion(multiset<T>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4B19CB6607C3 |
| Fixed UUID v7 | 019dffbb-f000-70b2-9c5e-e8db048341ca |
| Canonical name | fusion(multiset<T>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F5AEDB0B31B8 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-4B19CB6607C3 |
