...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CCBD33D2B10D |
| Fixed UUID v7 | 019dffbb-f000-74ae-9d12-e20c350a7fb6 |
| Canonical name | bit_clear |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9A9C17501519 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CCBD33D2B10D |
