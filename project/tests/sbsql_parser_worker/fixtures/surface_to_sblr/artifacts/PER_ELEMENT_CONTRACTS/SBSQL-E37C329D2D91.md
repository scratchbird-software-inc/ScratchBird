# SBSQL-E37C329D2D91 — listener_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E37C329D2D91 |
| Fixed UUID v7 | 019dffbb-f000-78dd-b755-77c646b63284 |
| Canonical name | listener_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B8C892E5C2CB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E37C329D2D91 |
