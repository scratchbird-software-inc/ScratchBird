# SBSQL-E8DA01F5F35C — regexp_match(string,pattern[,flags])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E8DA01F5F35C |
| Fixed UUID v7 | 019dffbb-f000-7cbf-b429-eb7e61edd2a8 |
| Canonical name | regexp_match(string,pattern[,flags]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9B2149299186 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E8DA01F5F35C |
