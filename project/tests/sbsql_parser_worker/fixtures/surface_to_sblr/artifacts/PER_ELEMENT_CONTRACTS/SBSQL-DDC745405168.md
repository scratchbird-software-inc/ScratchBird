# SBSQL-DDC745405168 — alter_view_action
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DDC745405168 |
| Fixed UUID v7 | 019dffbb-f000-7075-af27-61b759e9258c |
| Canonical name | alter_view_action |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3D9C3BCD0A9F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DDC745405168 |
