# SBSQL-01B057BBC0EA — element(multiset<T>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-01B057BBC0EA |
| Fixed UUID v7 | 019dffbb-f000-7c3e-a192-e79f26db9b80 |
| Canonical name | element(multiset<T>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1E555F08D4E6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-01B057BBC0EA |
