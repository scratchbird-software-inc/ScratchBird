# SBSQL-6B9810626A72 — intersection(multiset<T>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6B9810626A72 |
| Fixed UUID v7 | 019dffbb-f000-7968-9b55-2bdbfa60c297 |
| Canonical name | intersection(multiset<T>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ED6016D5D6D4 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6B9810626A72 |
