...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CCE5CAC9861B |
| Fixed UUID v7 | 019dffbb-f000-7c13-930f-6452499bdc47 |
| Canonical name | row_count() |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FF79580B8C21 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CCE5CAC9861B |
