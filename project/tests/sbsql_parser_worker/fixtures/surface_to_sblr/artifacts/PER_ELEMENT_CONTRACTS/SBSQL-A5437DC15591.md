# SBSQL-A5437DC15591 — raise_option
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A5437DC15591 |
| Fixed UUID v7 | 019dffbb-f000-73f1-84d8-b2090994dff8 |
| Canonical name | raise_option |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-644F77C5E29F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A5437DC15591 |
