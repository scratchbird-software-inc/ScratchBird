# SBSQL-DB2A1F4D9627 — alter_parser_action
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DB2A1F4D9627 |
| Fixed UUID v7 | 019dffbb-f000-7e0a-96ed-8a4e59b6c39e |
| Canonical name | alter_parser_action |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9322898F3CAD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DB2A1F4D9627 |
