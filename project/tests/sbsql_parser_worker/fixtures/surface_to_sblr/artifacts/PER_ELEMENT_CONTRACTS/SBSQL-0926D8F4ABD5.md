# SBSQL-0926D8F4ABD5 — json_object
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0926D8F4ABD5 |
| Fixed UUID v7 | 019dffbb-f000-742d-a516-9d49f41ba62b |
| Canonical name | json_object |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-574D56FC47A1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0926D8F4ABD5 |
