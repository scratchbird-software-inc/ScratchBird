# SBSQL-2E73B3E7CB0A — colon_variable
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2E73B3E7CB0A |
| Fixed UUID v7 | 019dffbb-f000-7436-92af-836dfe03cab8 |
| Canonical name | colon_variable |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CF0D7A204A34 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-2E73B3E7CB0A |
