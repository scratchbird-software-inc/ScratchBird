# SBSQL-C167CB99BFAD — table_size(table_uuid[,include_indexes])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C167CB99BFAD |
| Fixed UUID v7 | 019dffbb-f000-7b2a-a480-d68abae89a51 |
| Canonical name | table_size(table_uuid[,include_indexes]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EE7F79F68C50 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C167CB99BFAD |
