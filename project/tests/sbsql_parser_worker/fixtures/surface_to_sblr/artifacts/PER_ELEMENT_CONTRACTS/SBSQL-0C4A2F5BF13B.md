# SBSQL-0C4A2F5BF13B — temporal_type
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0C4A2F5BF13B |
| Fixed UUID v7 | 019dffbb-f000-7b87-b297-f5b84e3f3856 |
| Canonical name | temporal_type |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-22F96E978291 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0C4A2F5BF13B |
