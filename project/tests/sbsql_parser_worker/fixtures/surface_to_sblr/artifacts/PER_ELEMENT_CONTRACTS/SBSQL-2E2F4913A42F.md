# SBSQL-2E2F4913A42F — lob_close(locator)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2E2F4913A42F |
| Fixed UUID v7 | 019dffbb-f000-7c37-b7a6-1d69430cc6d1 |
| Canonical name | lob_close(locator) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CD53A471B8B4 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2E2F4913A42F |
