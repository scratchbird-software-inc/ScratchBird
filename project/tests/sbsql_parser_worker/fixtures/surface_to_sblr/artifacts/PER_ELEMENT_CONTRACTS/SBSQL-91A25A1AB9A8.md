# SBSQL-91A25A1AB9A8 — parser_type
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-91A25A1AB9A8 |
| Fixed UUID v7 | 019dffbb-f000-74a4-b521-9f942d98272c |
| Canonical name | parser_type |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-88F03C96DF02 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-91A25A1AB9A8 |
