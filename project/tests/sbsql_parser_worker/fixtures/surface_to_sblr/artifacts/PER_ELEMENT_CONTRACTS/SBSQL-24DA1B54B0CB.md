# SBSQL-24DA1B54B0CB — word_similarity(text,text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-24DA1B54B0CB |
| Fixed UUID v7 | 019dffbb-f000-798d-b543-fba5c8ddaf39 |
| Canonical name | word_similarity(text,text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5F1288E89FFA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-24DA1B54B0CB |
