...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D437EC74B872 |
| Fixed UUID v7 | 019dffbb-f000-74d5-a5b7-1dc1ec04476d |
| Canonical name | security |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-031A2E6CF9B3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D437EC74B872 |
