# SBSQL-AE071DCD88A8 — cursor_scrollability(cursor)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AE071DCD88A8 |
| Fixed UUID v7 | 019dffbb-f000-72e1-8b59-a79299b79fe9 |
| Canonical name | cursor_scrollability(cursor) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-22429DC73585 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-AE071DCD88A8 |
