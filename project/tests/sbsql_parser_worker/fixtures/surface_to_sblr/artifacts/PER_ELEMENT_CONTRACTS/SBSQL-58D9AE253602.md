# SBSQL-58D9AE253602 — jaro_similarity(text,text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-58D9AE253602 |
| Fixed UUID v7 | 019dffbb-f000-7ad8-9c88-9cd64c99f456 |
| Canonical name | jaro_similarity(text,text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BB7DAEBBC7D3 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-58D9AE253602 |
