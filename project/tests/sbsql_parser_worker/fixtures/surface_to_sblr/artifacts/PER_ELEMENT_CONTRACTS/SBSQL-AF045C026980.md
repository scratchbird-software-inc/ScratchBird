# SBSQL-AF045C026980 — json_insert
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AF045C026980 |
| Fixed UUID v7 | 019dffbb-f000-77f8-afca-320e3246bd12 |
| Canonical name | json_insert |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D3E43C69C284 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-AF045C026980 |
