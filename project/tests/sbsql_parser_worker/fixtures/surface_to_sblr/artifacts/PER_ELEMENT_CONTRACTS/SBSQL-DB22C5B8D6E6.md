# SBSQL-DB22C5B8D6E6 — st_covers(g1,g2)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DB22C5B8D6E6 |
| Fixed UUID v7 | 019dffbb-f000-7955-9e61-8402ca2baf2c |
| Canonical name | st_covers(g1,g2) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-848E54BDA7DC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DB22C5B8D6E6 |
