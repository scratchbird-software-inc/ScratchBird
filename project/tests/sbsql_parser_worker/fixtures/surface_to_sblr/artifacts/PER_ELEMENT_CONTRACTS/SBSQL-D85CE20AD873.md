# SBSQL-D85CE20AD873 — zone_setting_assign
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D85CE20AD873 |
| Fixed UUID v7 | 019dffbb-f000-70dd-98f2-16410b0651fa |
| Canonical name | zone_setting_assign |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AA5306750955 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D85CE20AD873 |
