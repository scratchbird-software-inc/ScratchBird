# SBSQL-062A23531925 — operator_token
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-062A23531925 |
| Fixed UUID v7 | 019dffbb-f000-707d-8fea-989b40be4a44 |
| Canonical name | operator_token |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2391B6A8D5E3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-062A23531925 |
