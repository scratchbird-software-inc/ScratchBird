# SBSQL-B684AF9349FE — regexp_split_to_table(text,pattern)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B684AF9349FE |
| Fixed UUID v7 | 019dffbb-f000-7541-9166-4666c6cb205c |
| Canonical name | regexp_split_to_table(text,pattern) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4AF3A925F38C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B684AF9349FE |
