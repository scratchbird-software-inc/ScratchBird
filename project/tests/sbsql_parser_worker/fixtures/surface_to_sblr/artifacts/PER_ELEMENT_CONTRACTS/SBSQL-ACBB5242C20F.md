# SBSQL-ACBB5242C20F — damerau_levenshtein(text,text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-ACBB5242C20F |
| Fixed UUID v7 | 019dffbb-f000-7093-80aa-fc609bed807c |
| Canonical name | damerau_levenshtein(text,text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BC84A3FE0949 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-ACBB5242C20F |
