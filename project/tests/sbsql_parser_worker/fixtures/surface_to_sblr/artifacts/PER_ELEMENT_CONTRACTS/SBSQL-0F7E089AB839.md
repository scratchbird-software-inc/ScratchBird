# SBSQL-0F7E089AB839 — lag(expr[,offset[,default]])OVER(...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0F7E089AB839 |
| Fixed UUID v7 | 019dffbb-f000-7620-8518-11bffdd5b94b |
| Canonical name | lag(expr[,offset[,default]])OVER(...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EE53B1142525 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0F7E089AB839 |
