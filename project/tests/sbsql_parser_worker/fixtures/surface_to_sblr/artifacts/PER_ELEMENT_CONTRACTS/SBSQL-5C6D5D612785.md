# SBSQL-5C6D5D612785 — make_timestamptz(...,timezone)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5C6D5D612785 |
| Fixed UUID v7 | 019dffbb-f000-7108-9003-8d0e83098d51 |
| Canonical name | make_timestamptz(...,timezone) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D389672C066C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5C6D5D612785 |
