# SBSQL-8E8A494388C0 — dcl_security_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8E8A494388C0 |
| Fixed UUID v7 | 019dffbb-f000-75d7-9db1-8e8b2f54ad62 |
| Canonical name | dcl_security_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4194E4B2EA3D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8E8A494388C0 |
