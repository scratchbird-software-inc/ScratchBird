...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-ACB31A992444 |
| Fixed UUID v7 | 019dffbb-f000-7ea9-9f23-3fdc4ae3c86d |
| Canonical name | uuid_v4 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FEF8772412C4 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-ACB31A992444 |
