# SBSQL-40A96CD37D67 — bridge_stream_read
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-40A96CD37D67 |
| Fixed UUID v7 | 019e14c1-d312-71ad-80d2-f96f24753d37 |
| Canonical name | bridge_stream_read |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-40A96CD37D67 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-40A96CD37D67 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_STREAM_READ, UDR operation stream_read, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
