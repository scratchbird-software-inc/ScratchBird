# SBSQL-FC9B0CD1F5DB — uuid_generate_v1
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FC9B0CD1F5DB |
| Fixed UUID v7 | 019dffbb-f000-7ebb-8eec-060c8b4adbb9 |
| Canonical name | uuid_generate_v1 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2C01ACF07ED9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FC9B0CD1F5DB |
