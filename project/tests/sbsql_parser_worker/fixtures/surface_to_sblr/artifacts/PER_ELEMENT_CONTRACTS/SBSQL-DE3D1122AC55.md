# SBSQL-DE3D1122AC55 — delete_statement
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DE3D1122AC55 |
| Fixed UUID v7 | 019dffbb-f000-70d0-a9b3-20e5a3028be4 |
| Canonical name | delete_statement |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-86D79593C245 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DE3D1122AC55 |
