# SBSQL-35F0E9FF7755 — json_extract(document,path)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-35F0E9FF7755 |
| Fixed UUID v7 | 019dffbb-f000-7881-a8a9-d580e7b60fb4 |
| Canonical name | json_extract(document,path) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B4D8FC10A921 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-35F0E9FF7755 |
