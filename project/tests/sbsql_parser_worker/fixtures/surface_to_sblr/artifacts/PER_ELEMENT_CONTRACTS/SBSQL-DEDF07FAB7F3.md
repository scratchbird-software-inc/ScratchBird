# SBSQL-DEDF07FAB7F3 — json_array_length(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DEDF07FAB7F3 |
| Fixed UUID v7 | 019dffbb-f000-776c-85ee-a0a2ef294b3b |
| Canonical name | json_array_length(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BBE0B6EB3938 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DEDF07FAB7F3 |
