# SBSQL-61FABBFAE0A2 — psql_select_into
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-61FABBFAE0A2 |
| Fixed UUID v7 | 019dffbb-f000-7898-81a1-bc91b163587b |
| Canonical name | psql_select_into |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3C1DB75CE2A0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-61FABBFAE0A2 |
