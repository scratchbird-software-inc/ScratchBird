# SBSQL-E4EB3BEDAA0A — st_convexhull(geometry)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E4EB3BEDAA0A |
| Fixed UUID v7 | 019dffbb-f000-752c-af7d-d4599e5b45fe |
| Canonical name | st_convexhull(geometry) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EFE9766C0C39 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E4EB3BEDAA0A |
