# SBSQL-777A3A7148F0 — window_frame_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-777A3A7148F0 |
| Fixed UUID v7 | 019dffbb-f000-7d7e-9dc0-030901ba3c2a |
| Canonical name | window_frame_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-95326B631260 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-777A3A7148F0 |
