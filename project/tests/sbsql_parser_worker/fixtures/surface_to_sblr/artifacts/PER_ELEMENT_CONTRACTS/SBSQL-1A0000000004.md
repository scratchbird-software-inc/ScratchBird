...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1A0000000004 |
| Fixed UUID v7 | 019e0f00-0000-7004-8000-000000000004 |
| Canonical name | show_migrations |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1A0000000004 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1A0000000004 |
| Expected result summary | expected parser migration route, SBLR opcode SBLR_SHOW_MIGRATIONS, API EngineShowMigrations, result shape rs.migration.list.v1, diagnostics, and executable behavior derived from Gate 004 evidence |
