# SBSQL-C4FAF4EDAF96 — nextval(sequence_name)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C4FAF4EDAF96 |
| Fixed UUID v7 | 019dffbb-f000-70cf-9776-90d9c9b91d6c |
| Canonical name | nextval(sequence_name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0576F4A54B36 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C4FAF4EDAF96 |
