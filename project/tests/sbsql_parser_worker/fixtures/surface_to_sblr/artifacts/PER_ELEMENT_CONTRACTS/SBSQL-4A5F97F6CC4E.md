# SBSQL-4A5F97F6CC4E — create_function_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4A5F97F6CC4E |
| Fixed UUID v7 | 019dffbb-f000-73ff-beab-94b5ee9cd611 |
| Canonical name | create_function_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F4AD1748A90B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4A5F97F6CC4E |
