# SBSQL-DC8507F9B9C5 — json_query(document,jsonpath...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DC8507F9B9C5 |
| Fixed UUID v7 | 019dffbb-f000-7ed1-bdb3-373d748c28d2 |
| Canonical name | json_query(document,jsonpath...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-25B18CE386C5 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DC8507F9B9C5 |
