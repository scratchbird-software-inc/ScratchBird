# SBSQL-BD65B1E34D96 — inner_product(vector,vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BD65B1E34D96 |
| Fixed UUID v7 | 019dffbb-f000-71a6-be3d-67445161b3c2 |
| Canonical name | inner_product(vector,vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-29CC0C7AA7F9 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BD65B1E34D96 |
