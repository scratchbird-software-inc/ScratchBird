# SBSQL-48A533677977 — sweep_control_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-48A533677977 |
| Fixed UUID v7 | 019dffbb-f000-7bba-b152-1a6028b61ad5 |
| Canonical name | sweep_control_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C772B36967C2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-48A533677977 |
