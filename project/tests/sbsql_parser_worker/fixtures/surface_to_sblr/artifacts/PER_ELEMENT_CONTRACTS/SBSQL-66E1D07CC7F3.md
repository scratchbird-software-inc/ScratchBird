# SBSQL-66E1D07CC7F3 — bit_test(int,position)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-66E1D07CC7F3 |
| Fixed UUID v7 | 019dffbb-f000-7096-a478-9476d0c018e2 |
| Canonical name | bit_test(int,position) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-896AD2AE4B6E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-66E1D07CC7F3 |
