# SBSQL-CBD9B6358B34 — geom_extent
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CBD9B6358B34 |
| Fixed UUID v7 | 019dffbb-f000-70bd-8e6e-d5d551136df4 |
| Canonical name | geom_extent |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E83228FEC0ED |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CBD9B6358B34 |
