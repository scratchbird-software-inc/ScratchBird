# SBSQL-C41110D1C709 — built_in_function_shadow_rule
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C41110D1C709 |
| Fixed UUID v7 | 019dffbb-f000-7840-85c2-a683b98fa9e0 |
| Canonical name | built_in_function_shadow_rule |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B24C81A43C58 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C41110D1C709 |
