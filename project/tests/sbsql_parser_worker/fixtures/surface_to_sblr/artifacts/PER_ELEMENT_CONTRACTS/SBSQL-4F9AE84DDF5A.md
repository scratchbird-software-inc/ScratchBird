# SBSQL-4F9AE84DDF5A — XMLNAMESPACES(decl_list)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4F9AE84DDF5A |
| Fixed UUID v7 | 019dffbb-f000-71ac-b506-8bae25259611 |
| Canonical name | XMLNAMESPACES(decl_list) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5B8DAB1E4CEC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4F9AE84DDF5A |
