# SBSQL-4640811DBAC8 — json_build_array(args...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4640811DBAC8 |
| Fixed UUID v7 | 019dffbb-f000-7daa-b4a9-b3244e7f0083 |
| Canonical name | json_build_array(args...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-145121DEA07E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-4640811DBAC8 |
