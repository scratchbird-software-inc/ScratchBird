# SBSQL-B4CF3C70B1D3 — json_remove(document,path)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B4CF3C70B1D3 |
| Fixed UUID v7 | 019dffbb-f000-7590-96de-f7ab253db2c8 |
| Canonical name | json_remove(document,path) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8C04AC1636AB |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B4CF3C70B1D3 |
