# SBSQL-16DADF94E1FE — log_message
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-16DADF94E1FE |
| Fixed UUID v7 | 019dffbb-f000-77ba-b761-3dcee6d9e2d7 |
| Canonical name | log_message |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8B5A2A0B0344 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-16DADF94E1FE |
