# SBSQL-1F3BD16B9450 — SUBSTRING(textFROMstart[FORlength])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1F3BD16B9450 |
| Fixed UUID v7 | 019dffbb-f000-7a18-a1d5-b1420e81ef62 |
| Canonical name | SUBSTRING(textFROMstart[FORlength]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1BF736311A9F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1F3BD16B9450 |
