# SBSQL-CDF9CAB99BFE — create_collation_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CDF9CAB99BFE |
| Fixed UUID v7 | 019dffbb-f000-7041-8397-eb809ef732be |
| Canonical name | create_collation_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F2F0CAE8B4EA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CDF9CAB99BFE |
