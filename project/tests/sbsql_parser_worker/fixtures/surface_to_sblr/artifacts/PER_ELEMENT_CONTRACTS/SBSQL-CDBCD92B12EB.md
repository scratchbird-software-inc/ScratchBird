# SBSQL-CDBCD92B12EB — reranker_spec
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CDBCD92B12EB |
| Fixed UUID v7 | 019dffbb-f000-7948-b4e9-10feb47b6de4 |
| Canonical name | reranker_spec |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-660EDB592FA7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CDBCD92B12EB |
