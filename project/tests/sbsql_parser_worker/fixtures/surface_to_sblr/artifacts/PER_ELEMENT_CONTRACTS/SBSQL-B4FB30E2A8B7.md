# SBSQL-B4FB30E2A8B7 — cypher_subquery_expr
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B4FB30E2A8B7 |
| Fixed UUID v7 | 019dffbb-f000-783e-9588-62f214315437 |
| Canonical name | cypher_subquery_expr |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-769273265062 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B4FB30E2A8B7 |
