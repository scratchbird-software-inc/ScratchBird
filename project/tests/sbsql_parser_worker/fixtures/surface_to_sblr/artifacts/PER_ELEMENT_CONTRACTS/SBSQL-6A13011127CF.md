# SBSQL-6A13011127CF — diagnostic_field(name)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6A13011127CF |
| Fixed UUID v7 | 019dffbb-f000-701a-b6b5-fd91d799e570 |
| Canonical name | diagnostic_field(name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AED00B98E54C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6A13011127CF |
