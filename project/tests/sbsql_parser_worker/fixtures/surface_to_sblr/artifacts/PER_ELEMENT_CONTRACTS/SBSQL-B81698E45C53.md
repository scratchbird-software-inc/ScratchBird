# SBSQL-B81698E45C53 — pg_terminate_backend(pid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B81698E45C53 |
| Fixed UUID v7 | 019dffbb-f000-785f-8546-242367d0d3d3 |
| Canonical name | pg_terminate_backend(pid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-27C12B9C0785 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B81698E45C53 |
