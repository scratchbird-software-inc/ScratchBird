# SBSQL-06A3D89BD9C6 — bridge_stream_open_logical_restore
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-06A3D89BD9C6 |
| Fixed UUID v7 | 019e14c1-17ac-7418-8a11-8de5eadac7fc |
| Canonical name | bridge_stream_open_logical_restore |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-06A3D89BD9C6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-06A3D89BD9C6 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_STREAM_OPEN, UDR operation stream_open, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
