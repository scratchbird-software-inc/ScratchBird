# SBSQL-B3CBDBCA5C65 — xml_namespaces_form
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B3CBDBCA5C65 |
| Fixed UUID v7 | 019dffbb-f000-7909-bce6-f238d3b906ab |
| Canonical name | xml_namespaces_form |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-852F0ADF62E3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B3CBDBCA5C65 |
