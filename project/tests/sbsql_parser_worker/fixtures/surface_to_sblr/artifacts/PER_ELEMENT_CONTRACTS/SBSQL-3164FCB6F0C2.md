# SBSQL-3164FCB6F0C2 — locator_class
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3164FCB6F0C2 |
| Fixed UUID v7 | 019dffbb-f000-7df5-b0b4-4f47ce37d1d8 |
| Canonical name | locator_class |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-93E23B00EC5E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3164FCB6F0C2 |
