# SBSQL-026A4D4C039B — psql_repeat_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-026A4D4C039B |
| Fixed UUID v7 | 019dffbb-f000-7f14-9bfc-111b1a82aa81 |
| Canonical name | psql_repeat_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E5D45E8C90D1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-026A4D4C039B |
