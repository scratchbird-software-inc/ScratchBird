# SBSQL-A9DAC3CABD67 — radians(degrees)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A9DAC3CABD67 |
| Fixed UUID v7 | 019dffbb-f000-728e-94d7-3ae92ae374aa |
| Canonical name | radians(degrees) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F3D59E21AEBD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A9DAC3CABD67 |
