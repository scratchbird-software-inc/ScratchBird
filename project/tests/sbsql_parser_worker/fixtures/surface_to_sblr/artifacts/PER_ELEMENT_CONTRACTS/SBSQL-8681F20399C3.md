# SBSQL-8681F20399C3 — digest(text\|binary,algo)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8681F20399C3 |
| Fixed UUID v7 | 019dffbb-f000-79df-817f-0d6e1cad7691 |
| Canonical name | digest(text\\\|binary,algo) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8D6E16B6068D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-8681F20399C3 |
