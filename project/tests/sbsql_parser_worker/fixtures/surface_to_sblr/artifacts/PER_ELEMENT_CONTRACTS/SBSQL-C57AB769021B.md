# SBSQL-C57AB769021B — pg_read_server_files
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C57AB769021B |
| Fixed UUID v7 | 019dffbb-f000-7945-8abd-ae3f46788999 |
| Canonical name | pg_read_server_files |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3795BBA21DCA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C57AB769021B |
