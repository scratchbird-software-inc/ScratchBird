...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B4E283C07390 |
| Fixed UUID v7 | 019dffbb-f000-7c50-a67a-7f774aa6317d |
| Canonical name | to_date |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-75E8652295AB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B4E283C07390 |
