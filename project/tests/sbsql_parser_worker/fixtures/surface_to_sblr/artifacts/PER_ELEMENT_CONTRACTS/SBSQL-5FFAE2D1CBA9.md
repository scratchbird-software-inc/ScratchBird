# SBSQL-5FFAE2D1CBA9 — vector_search_target
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5FFAE2D1CBA9 |
| Fixed UUID v7 | 019dffbb-f000-7031-b49a-33588041e8a6 |
| Canonical name | vector_search_target |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-10C2774AF9A6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5FFAE2D1CBA9 |
