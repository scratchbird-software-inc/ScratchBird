# SBSQL-A1B94C83C5F1 — collect(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A1B94C83C5F1 |
| Fixed UUID v7 | 019dffbb-f000-7ebf-842f-2d93584f078f |
| Canonical name | collect(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6718C00853F5 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A1B94C83C5F1 |
