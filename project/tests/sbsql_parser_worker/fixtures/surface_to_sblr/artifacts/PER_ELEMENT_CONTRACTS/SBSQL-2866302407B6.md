# SBSQL-2866302407B6 — array_to_json
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2866302407B6 |
| Fixed UUID v7 | 019dffbb-f000-7b62-a578-bf3c272ee775 |
| Canonical name | array_to_json |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-33479552B162 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2866302407B6 |
