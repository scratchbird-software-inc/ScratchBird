# SBSQL-FC78A3D1CF86 — covar_samp(y,x)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FC78A3D1CF86 |
| Fixed UUID v7 | 019dffbb-f000-7a99-864e-35fc55ec7715 |
| Canonical name | covar_samp(y,x) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3A03D39D58E1 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-FC78A3D1CF86 |
