# SBSQL-B9BA63C166A2 — stream_to_rowset(stream[,max_rows])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B9BA63C166A2 |
| Fixed UUID v7 | 019dffbb-f000-74dd-96d1-db2c655b0acc |
| Canonical name | stream_to_rowset(stream[,max_rows]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-328AC98AAB87 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B9BA63C166A2 |
