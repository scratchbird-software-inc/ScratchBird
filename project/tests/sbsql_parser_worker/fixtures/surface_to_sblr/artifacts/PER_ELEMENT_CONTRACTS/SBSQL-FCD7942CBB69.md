# SBSQL-FCD7942CBB69 — cursor_state(cursor)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FCD7942CBB69 |
| Fixed UUID v7 | 019dffbb-f000-7b13-9aee-f2e30c57cd5e |
| Canonical name | cursor_state(cursor) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B03BA410514A |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-FCD7942CBB69 |
