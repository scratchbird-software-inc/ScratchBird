# SBSQL-D873CD6AEFCF — member_role
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D873CD6AEFCF |
| Fixed UUID v7 | 019dffbb-f000-7a09-b641-7d542b1f9b37 |
| Canonical name | member_role |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A456959A5CA1 |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-D873CD6AEFCF |
