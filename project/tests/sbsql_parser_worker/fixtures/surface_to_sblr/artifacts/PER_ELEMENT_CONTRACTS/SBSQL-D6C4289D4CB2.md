# SBSQL-D6C4289D4CB2 — xml_validate_form
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D6C4289D4CB2 |
| Fixed UUID v7 | 019dffbb-f000-7373-80ae-4808698f6e9e |
| Canonical name | xml_validate_form |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-86404E9F0730 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D6C4289D4CB2 |
