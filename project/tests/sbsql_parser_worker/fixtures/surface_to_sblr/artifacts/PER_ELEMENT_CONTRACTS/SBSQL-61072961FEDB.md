# SBSQL-61072961FEDB — catalog_object_name(uuid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-61072961FEDB |
| Fixed UUID v7 | 019dffbb-f000-7ab3-b915-5cc73a346260 |
| Canonical name | catalog_object_name(uuid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0FD0F027A143 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-61072961FEDB |
