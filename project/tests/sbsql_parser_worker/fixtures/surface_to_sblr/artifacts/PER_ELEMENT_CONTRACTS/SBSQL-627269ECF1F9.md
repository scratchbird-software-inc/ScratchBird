# SBSQL-627269ECF1F9 — cluster_prepare_options
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-627269ECF1F9 |
| Fixed UUID v7 | 019dffbb-f000-7ff2-8d4e-23fd416d6155 |
| Canonical name | cluster_prepare_options |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FE545AA682C1 |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-627269ECF1F9 |
