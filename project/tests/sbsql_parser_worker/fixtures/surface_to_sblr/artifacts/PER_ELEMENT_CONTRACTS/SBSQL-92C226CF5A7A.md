# SBSQL-92C226CF5A7A — FAIL_CLOSED
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-92C226CF5A7A |
| Fixed UUID v7 | 019dffbb-f000-721c-986a-3e9e3f0d4965 |
| Canonical name | FAIL_CLOSED |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-84E6D5A379F7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-92C226CF5A7A |
