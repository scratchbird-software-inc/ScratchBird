# SBSQL-1F38A5CF36B0 — alter_database_action
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1F38A5CF36B0 |
| Fixed UUID v7 | 019dffbb-f000-79d1-990f-3a551f2267fd |
| Canonical name | alter_database_action |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-23AEE0990C4C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1F38A5CF36B0 |
