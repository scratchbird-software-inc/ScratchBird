# SBSQL-254DFA81AAEB — approx_median(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-254DFA81AAEB |
| Fixed UUID v7 | 019dffbb-f000-70d8-a0b9-ca5ce8eac512 |
| Canonical name | approx_median(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-62B6081E7A05 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-254DFA81AAEB |
