# SBSQL-387A13A6980A — interval_unit
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-387A13A6980A |
| Fixed UUID v7 | 019dffbb-f000-7f48-80c0-c4ad79b1def0 |
| Canonical name | interval_unit |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-445E9901D9E7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-387A13A6980A |
