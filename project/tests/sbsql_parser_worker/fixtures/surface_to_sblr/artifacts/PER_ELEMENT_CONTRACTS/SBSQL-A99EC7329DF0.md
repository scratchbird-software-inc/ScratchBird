# SBSQL-A99EC7329DF0 — cursor_to_rowset(cursor[,max_rows])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A99EC7329DF0 |
| Fixed UUID v7 | 019dffbb-f000-7101-a3b0-1016341a99e5 |
| Canonical name | cursor_to_rowset(cursor[,max_rows]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A83AA6D65DC6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A99EC7329DF0 |
