# SBSQL-A383B9185803 — range_upper_inc
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A383B9185803 |
| Fixed UUID v7 | 019dffbb-f000-75dc-bf43-b957d26590a9 |
| Canonical name | range_upper_inc |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-090B96B326A8 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A383B9185803 |
