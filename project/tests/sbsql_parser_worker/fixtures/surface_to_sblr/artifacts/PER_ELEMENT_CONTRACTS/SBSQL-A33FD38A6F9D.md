# SBSQL-A33FD38A6F9D — create_principal_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A33FD38A6F9D |
| Fixed UUID v7 | 019dffbb-f000-7623-b381-09ac68fad031 |
| Canonical name | create_principal_stmt |
...
| SBLR operation family | sblr.security.mutation.v3 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6C54A420B42B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A33FD38A6F9D |
