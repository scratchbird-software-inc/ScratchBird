# SBSQL-191DB8E6ABA8 — to_integer(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-191DB8E6ABA8 |
| Fixed UUID v7 | 019dffbb-f000-7da5-8fc5-397cd6c340b7 |
| Canonical name | to_integer(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CE6D2D60060E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-191DB8E6ABA8 |
