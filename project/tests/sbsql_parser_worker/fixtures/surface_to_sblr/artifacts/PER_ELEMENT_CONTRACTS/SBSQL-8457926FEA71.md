# SBSQL-8457926FEA71 — to_date(text,format)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8457926FEA71 |
| Fixed UUID v7 | 019dffbb-f000-75ed-bd00-316f77bfb21b |
| Canonical name | to_date(text,format) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DEA26226B986 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8457926FEA71 |
