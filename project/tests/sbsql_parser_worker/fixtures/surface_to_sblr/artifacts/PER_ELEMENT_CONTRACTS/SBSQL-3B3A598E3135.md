# SBSQL-3B3A598E3135 — length(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3B3A598E3135 |
| Fixed UUID v7 | 019dffbb-f000-790d-ab6b-31c19ff7d5aa |
| Canonical name | length(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4C1E4FC92273 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3B3A598E3135 |
