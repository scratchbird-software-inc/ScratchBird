# SBSQL-F0AB7D8C3DF6 — create_schedule_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F0AB7D8C3DF6 |
| Fixed UUID v7 | 019dffbb-f000-7e17-82c9-2801dc55da72 |
| Canonical name | create_schedule_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A51925003601 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F0AB7D8C3DF6 |
