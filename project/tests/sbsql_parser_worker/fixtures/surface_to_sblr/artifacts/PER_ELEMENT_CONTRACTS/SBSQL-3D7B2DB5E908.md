# SBSQL-3D7B2DB5E908 — GEOMETRYCOLLECTION
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3D7B2DB5E908 |
| Fixed UUID v7 | 019dffbb-f000-7df0-ac88-be19b447e74a |
| Canonical name | GEOMETRYCOLLECTION |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B1D4CDB69E1C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3D7B2DB5E908 |
