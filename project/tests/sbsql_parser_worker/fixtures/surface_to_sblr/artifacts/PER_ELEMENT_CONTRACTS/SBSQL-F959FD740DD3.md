# SBSQL-F959FD740DD3 — cume_dist()OVER(...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F959FD740DD3 |
| Fixed UUID v7 | 019dffbb-f000-7bc9-b4d8-e1c1cfa83cf0 |
| Canonical name | cume_dist()OVER(...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A1DF62032721 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F959FD740DD3 |
