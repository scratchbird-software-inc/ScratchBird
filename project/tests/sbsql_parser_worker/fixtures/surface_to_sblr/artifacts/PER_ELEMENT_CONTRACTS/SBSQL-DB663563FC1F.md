# SBSQL-DB663563FC1F — has_schema_privilege([user,]schema_name,privilege)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DB663563FC1F |
| Fixed UUID v7 | 019dffbb-f000-72a2-8e5f-9d0b7dc321ae |
| Canonical name | has_schema_privilege([user,]schema_name,privilege) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8163173610C9 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DB663563FC1F |
