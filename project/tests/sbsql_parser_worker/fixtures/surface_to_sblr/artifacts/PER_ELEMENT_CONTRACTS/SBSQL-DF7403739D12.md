# SBSQL-DF7403739D12 — format(template,args...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DF7403739D12 |
| Fixed UUID v7 | 019dffbb-f000-76b7-b591-bdedea361715 |
| Canonical name | format(template,args...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DBE34CA2A141 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DF7403739D12 |
