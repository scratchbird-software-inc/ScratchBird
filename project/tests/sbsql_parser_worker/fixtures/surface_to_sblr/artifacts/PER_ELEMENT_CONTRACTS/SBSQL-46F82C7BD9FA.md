...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-46F82C7BD9FA |
| Fixed UUID v7 | 019dffbb-f000-720d-a8f1-db8c713b8558 |
| Canonical name | table_def |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-78728D3F6C88 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-46F82C7BD9FA |
