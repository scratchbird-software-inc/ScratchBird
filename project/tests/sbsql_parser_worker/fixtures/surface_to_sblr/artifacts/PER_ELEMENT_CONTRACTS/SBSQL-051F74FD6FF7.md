# SBSQL-051F74FD6FF7 — uuid_to_string(uuid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-051F74FD6FF7 |
| Fixed UUID v7 | 019dffbb-f000-7a88-8da9-79da4f0ba7bd |
| Canonical name | uuid_to_string(uuid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D42CBE6FC609 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-051F74FD6FF7 |
