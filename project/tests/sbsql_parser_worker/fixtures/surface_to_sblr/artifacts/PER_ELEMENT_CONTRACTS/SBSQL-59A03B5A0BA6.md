# SBSQL-59A03B5A0BA6 — sb.operator.less
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-59A03B5A0BA6 |
| Fixed UUID v7 | 019dffbb-f000-7fe9-ba37-5a2a95a2c62c |
| Canonical name | sb.operator.less |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A80921BA1C39 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-59A03B5A0BA6 |
