# SBSQL-EF85496DB350 — drop_principal_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EF85496DB350 |
| Fixed UUID v7 | 019dffbb-f000-7f82-99a4-b4915d9cf141 |
| Canonical name | drop_principal_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D62BD391B79E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EF85496DB350 |
