# SBSQL-2F78C18D9292 — jsonb_typeof(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2F78C18D9292 |
| Fixed UUID v7 | 019dffbb-f000-72d1-94a3-736607accdb8 |
| Canonical name | jsonb_typeof(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-89732E98C032 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2F78C18D9292 |
