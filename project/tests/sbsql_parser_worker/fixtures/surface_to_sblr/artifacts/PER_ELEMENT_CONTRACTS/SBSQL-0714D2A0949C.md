# SBSQL-0714D2A0949C — regexp_split_to_array(text,pattern)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0714D2A0949C |
| Fixed UUID v7 | 019dffbb-f000-768d-ba16-82f73bff43ba |
| Canonical name | regexp_split_to_array(text,pattern) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-263D54713B10 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0714D2A0949C |
