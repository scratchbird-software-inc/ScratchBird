# SBSQL-276FACC8D892 — sb.operator.unary_minus
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-276FACC8D892 |
| Fixed UUID v7 | 019dffbb-f000-7219-a08f-5b2e49ba7e93 |
| Canonical name | sb.operator.unary_minus |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-60526EB42773 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-276FACC8D892 |
