# SBSQL-8467B84B58DF — table_value_new(<row_shape>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8467B84B58DF |
| Fixed UUID v7 | 019dffbb-f000-77cb-8647-695ba279791b |
| Canonical name | table_value_new(<row_shape>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7D797F8A0BD8 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-8467B84B58DF |
