# SBSQL-6BF92553FF34 — similarity(text,text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6BF92553FF34 |
| Fixed UUID v7 | 019dffbb-f000-7b1b-82e0-7c732f837de4 |
| Canonical name | similarity(text,text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AEE079047136 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6BF92553FF34 |
