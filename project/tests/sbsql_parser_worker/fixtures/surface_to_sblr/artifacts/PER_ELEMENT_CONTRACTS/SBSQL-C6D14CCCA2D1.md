# SBSQL-C6D14CCCA2D1 — st_geomfromtext(wkt[,srid])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C6D14CCCA2D1 |
| Fixed UUID v7 | 019dffbb-f000-7523-b845-f54264567253 |
| Canonical name | st_geomfromtext(wkt[,srid]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-05346100E9AD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C6D14CCCA2D1 |
