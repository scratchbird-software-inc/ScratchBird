# SBSQL-FDB2AC4910D6 — ignite_zone_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FDB2AC4910D6 |
| Fixed UUID v7 | 019dffbb-f000-7672-925f-94cebe32722b |
| Canonical name | ignite_zone_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5AED4AE7A5F9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FDB2AC4910D6 |
