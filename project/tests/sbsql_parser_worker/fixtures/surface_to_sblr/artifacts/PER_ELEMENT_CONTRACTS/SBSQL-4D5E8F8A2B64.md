# SBSQL-4D5E8F8A2B64 — current_setting('var')
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4D5E8F8A2B64 |
| Fixed UUID v7 | 019dffbb-f000-7e5e-be45-0db61db8b2a2 |
| Canonical name | current_setting('var') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4A7A2F5C7FDE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4D5E8F8A2B64 |
