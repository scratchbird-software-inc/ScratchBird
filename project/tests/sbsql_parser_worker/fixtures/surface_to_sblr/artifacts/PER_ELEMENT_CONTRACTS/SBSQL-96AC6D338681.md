# SBSQL-96AC6D338681 — current_engine_version
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-96AC6D338681 |
| Fixed UUID v7 | 019dffbb-f000-7ac8-a771-0b934399b674 |
| Canonical name | current_engine_version |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B12CC2329A14 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-96AC6D338681 |
