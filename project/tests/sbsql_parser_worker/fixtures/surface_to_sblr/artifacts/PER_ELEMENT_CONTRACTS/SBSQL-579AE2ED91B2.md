# SBSQL-579AE2ED91B2 — array_to_json(array[,pretty])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-579AE2ED91B2 |
| Fixed UUID v7 | 019dffbb-f000-7a4a-bcb1-9148b138a9aa |
| Canonical name | array_to_json(array[,pretty]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1F12D936F23D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-579AE2ED91B2 |
