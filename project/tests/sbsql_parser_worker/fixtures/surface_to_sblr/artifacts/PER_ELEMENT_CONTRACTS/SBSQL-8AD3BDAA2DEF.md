# SBSQL-8AD3BDAA2DEF — channel_name
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8AD3BDAA2DEF |
| Fixed UUID v7 | 019dffbb-f000-7787-adaa-1644a1cab3e2 |
| Canonical name | channel_name |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-560BAA7C1E0A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8AD3BDAA2DEF |
