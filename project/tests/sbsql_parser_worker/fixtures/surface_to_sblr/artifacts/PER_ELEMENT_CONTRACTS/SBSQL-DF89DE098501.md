...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DF89DE098501 |
| Fixed UUID v7 | 019dffbb-f000-7a11-a540-e6c1f5bffd0f |
| Canonical name | lob_close |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7ACA4699503D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DF89DE098501 |
