# SBSQL-3F84A2CEBD71 — geom_union(geometry)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3F84A2CEBD71 |
| Fixed UUID v7 | 019dffbb-f000-799f-9304-e40550ef7024 |
| Canonical name | geom_union(geometry) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BBB1395445FE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3F84A2CEBD71 |
