...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0F1A2CA1C1B3 |
| Fixed UUID v7 | 019dffbb-f000-70e0-b7bc-120f0dc563ba |
| Canonical name | label_ref |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-05DF2B1CEF9B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0F1A2CA1C1B3 |
