# SBSQL-F3BF05CB160D — sb.operator.not
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F3BF05CB160D |
| Fixed UUID v7 | 019dffbb-f000-75e8-8c25-11719a7cd06c |
| Canonical name | sb.operator.not |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0A4D5731D6B2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F3BF05CB160D |
