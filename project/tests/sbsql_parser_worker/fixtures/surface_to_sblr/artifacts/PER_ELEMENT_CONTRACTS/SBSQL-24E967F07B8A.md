# SBSQL-24E967F07B8A — table_value_append(tv,row)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-24E967F07B8A |
| Fixed UUID v7 | 019dffbb-f000-7964-a593-29c73da6e1b9 |
| Canonical name | table_value_append(tv,row) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E6FA4D89D80E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-24E967F07B8A |
