# SBSQL-802635EDBB3A — signal_info_assignment
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-802635EDBB3A |
| Fixed UUID v7 | 019dffbb-f000-7619-88fc-7f29f4665bd4 |
| Canonical name | signal_info_assignment |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F9DCB2B4A99A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-802635EDBB3A |
