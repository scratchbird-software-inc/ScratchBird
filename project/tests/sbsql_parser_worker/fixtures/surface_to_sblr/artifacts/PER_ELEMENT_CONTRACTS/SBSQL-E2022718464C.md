# SBSQL-E2022718464C — XMLATTRIBUTES(expr[ASname],...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E2022718464C |
| Fixed UUID v7 | 019dffbb-f000-7b4d-86a8-09f4aea538fd |
| Canonical name | XMLATTRIBUTES(expr[ASname],...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AE7B034E52F5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E2022718464C |
