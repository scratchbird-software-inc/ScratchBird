# SBSQL-9D88B076B01B — cypher_pattern
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9D88B076B01B |
| Fixed UUID v7 | 019dffbb-f000-716a-9aa4-8603cff0b11f |
| Canonical name | cypher_pattern |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AFD6A2DAA8DE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9D88B076B01B |
