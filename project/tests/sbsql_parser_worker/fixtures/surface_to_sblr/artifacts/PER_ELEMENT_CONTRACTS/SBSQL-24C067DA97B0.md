# SBSQL-24C067DA97B0 — XMLSERIALIZE
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-24C067DA97B0 |
| Fixed UUID v7 | 019dffbb-f000-7738-8a13-ac4492ba366e |
| Canonical name | XMLSERIALIZE |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F8E8A7F8ADBE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-24C067DA97B0 |
