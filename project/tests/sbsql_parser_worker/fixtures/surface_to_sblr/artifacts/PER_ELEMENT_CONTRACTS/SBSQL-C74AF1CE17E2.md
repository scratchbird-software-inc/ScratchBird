...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C74AF1CE17E2 |
| Fixed UUID v7 | 019dffbb-f000-78a9-9f66-cb12083d0016 |
| Canonical name | bit_xor(int) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D35D76C6168C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C74AF1CE17E2 |
