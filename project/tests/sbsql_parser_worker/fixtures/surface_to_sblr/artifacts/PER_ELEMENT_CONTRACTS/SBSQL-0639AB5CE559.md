# SBSQL-0639AB5CE559 — to_numeric(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0639AB5CE559 |
| Fixed UUID v7 | 019dffbb-f000-7c2f-85e1-80246cbfdd7b |
| Canonical name | to_numeric(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7E8D69F4B93A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0639AB5CE559 |
