# SBSQL-405CA73B58F3 — mode()WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-405CA73B58F3 |
| Fixed UUID v7 | 019dffbb-f000-7955-b2c0-13017564baf8 |
| Canonical name | mode()WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FCFA683748A5 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-405CA73B58F3 |
