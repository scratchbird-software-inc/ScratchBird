# SBSQL-B9CAFA029514 — cluster_throttle_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B9CAFA029514 |
| Fixed UUID v7 | 019dffbb-f000-77dc-b204-f4e899c3b6c2 |
| Canonical name | cluster_throttle_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CC50A7A55AF3 |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-B9CAFA029514 |
