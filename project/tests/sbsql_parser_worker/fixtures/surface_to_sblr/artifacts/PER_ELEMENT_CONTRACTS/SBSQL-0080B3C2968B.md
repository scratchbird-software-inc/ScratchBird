# SBSQL-0080B3C2968B — lock_timeout_default
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0080B3C2968B |
| Fixed UUID v7 | 019dffbb-f000-7884-8cb8-cad2c5b26037 |
| Canonical name | lock_timeout_default |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-84EFB322CBB8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0080B3C2968B |
