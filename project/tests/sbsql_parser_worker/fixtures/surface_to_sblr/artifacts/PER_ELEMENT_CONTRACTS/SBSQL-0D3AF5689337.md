# SBSQL-0D3AF5689337 — mga_isolation_profile
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0D3AF5689337 |
| Fixed UUID v7 | 019dffbb-f000-7088-a176-9d566089d2d4 |
| Canonical name | mga_isolation_profile |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-086EF2A197F8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0D3AF5689337 |
