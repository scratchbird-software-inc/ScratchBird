# SBSQL-A209C2B5CDDD — index_descriptor(index_uuid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A209C2B5CDDD |
| Fixed UUID v7 | 019dffbb-f000-7f54-afd7-17fee7bad0c5 |
| Canonical name | index_descriptor(index_uuid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C459C3B36624 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A209C2B5CDDD |
