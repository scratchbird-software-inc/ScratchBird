# SBSQL-C128B0E7BACF — refresh_materialized_view_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C128B0E7BACF |
| Fixed UUID v7 | 019dffbb-f000-71ff-b197-3bd9fb1bb079 |
| Canonical name | refresh_materialized_view_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4FC721EB0BD1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C128B0E7BACF |
