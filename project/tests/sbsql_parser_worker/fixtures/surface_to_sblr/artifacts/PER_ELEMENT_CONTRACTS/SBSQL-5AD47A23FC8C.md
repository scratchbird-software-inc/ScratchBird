# SBSQL-5AD47A23FC8C — decode(text,format)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5AD47A23FC8C |
| Fixed UUID v7 | 019dffbb-f000-795e-97b8-a3e8c5745c2a |
| Canonical name | decode(text,format) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C4FAAEDB9206 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5AD47A23FC8C |
