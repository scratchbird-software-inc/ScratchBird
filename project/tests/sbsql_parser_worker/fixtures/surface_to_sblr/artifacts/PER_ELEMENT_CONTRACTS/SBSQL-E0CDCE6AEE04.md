# SBSQL-E0CDCE6AEE04 — sha512(text\|binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E0CDCE6AEE04 |
| Fixed UUID v7 | 019dffbb-f000-768e-8359-9f84b7e0f33c |
| Canonical name | sha512(text\\\|binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0C34C4D4EE95 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-E0CDCE6AEE04 |
