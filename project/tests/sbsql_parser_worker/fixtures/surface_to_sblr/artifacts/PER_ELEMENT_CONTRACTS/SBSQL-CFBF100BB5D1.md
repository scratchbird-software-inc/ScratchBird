# SBSQL-CFBF100BB5D1 — pg_advisory_xact_lock
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CFBF100BB5D1 |
| Fixed UUID v7 | 019dffbb-f000-70a8-8fa9-5767fb871532 |
| Canonical name | pg_advisory_xact_lock |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3051EECCEE34 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-CFBF100BB5D1 |
