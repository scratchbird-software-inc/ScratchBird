# SBSQL-28C3EDBAFC8A — width_bucket
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-28C3EDBAFC8A |
| Fixed UUID v7 | 019dffbb-f000-75ed-8097-552db6faee8d |
| Canonical name | width_bucket |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-66F4560AFA6B |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-28C3EDBAFC8A |
