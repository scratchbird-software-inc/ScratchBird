# SBSQL-9B34B7BF03F1 — cypher_where_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9B34B7BF03F1 |
| Fixed UUID v7 | 019dffbb-f000-7e35-90ce-bc4a47e678ed |
| Canonical name | cypher_where_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-19B5E9CB8864 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9B34B7BF03F1 |
