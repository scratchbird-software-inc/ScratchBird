# SBSQL-316F518F1992 — lpad(text,length[,fill])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-316F518F1992 |
| Fixed UUID v7 | 019dffbb-f000-7e62-8bf1-a6bf61b1f4aa |
| Canonical name | lpad(text,length[,fill]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2D43EC8F7167 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-316F518F1992 |
