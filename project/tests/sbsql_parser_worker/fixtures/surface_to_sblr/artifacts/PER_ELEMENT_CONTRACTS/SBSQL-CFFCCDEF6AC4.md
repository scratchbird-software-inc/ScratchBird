# SBSQL-CFFCCDEF6AC4 — drop_object_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CFFCCDEF6AC4 |
| Fixed UUID v7 | 019dffbb-f000-7a65-ba98-c1efa1b54cb6 |
| Canonical name | drop_object_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6AF1F9269F93 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CFFCCDEF6AC4 |
