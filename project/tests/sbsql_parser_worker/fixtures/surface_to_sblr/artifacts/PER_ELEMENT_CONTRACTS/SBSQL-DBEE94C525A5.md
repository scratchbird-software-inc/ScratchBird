# SBSQL-DBEE94C525A5 — identifier_max_length_chars
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DBEE94C525A5 |
| Fixed UUID v7 | 019dffbb-f000-73b3-b87a-3a23d5c1e488 |
| Canonical name | identifier_max_length_chars |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C1FD8910B76A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DBEE94C525A5 |
