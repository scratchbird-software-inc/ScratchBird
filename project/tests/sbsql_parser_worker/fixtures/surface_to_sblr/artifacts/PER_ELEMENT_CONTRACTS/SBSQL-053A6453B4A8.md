...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-053A6453B4A8 |
| Fixed UUID v7 | 019dffbb-f000-792d-8c50-ebd2c9ac0627 |
| Canonical name | sb.special.trim_keyword |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3ABDCFA91405 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-053A6453B4A8 |
