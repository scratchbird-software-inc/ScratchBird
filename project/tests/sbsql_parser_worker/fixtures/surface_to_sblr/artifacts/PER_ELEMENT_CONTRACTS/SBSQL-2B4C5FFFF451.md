# SBSQL-2B4C5FFFF451 — timezone(zone,timestamp)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2B4C5FFFF451 |
| Fixed UUID v7 | 019dffbb-f000-7b76-9402-514a200a39a5 |
| Canonical name | timezone(zone,timestamp) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-158442A1AD06 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2B4C5FFFF451 |
