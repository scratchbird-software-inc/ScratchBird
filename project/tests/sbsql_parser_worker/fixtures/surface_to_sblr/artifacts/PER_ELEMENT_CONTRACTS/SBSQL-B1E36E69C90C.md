# SBSQL-B1E36E69C90C — pg_advisory_unlock(key)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B1E36E69C90C |
| Fixed UUID v7 | 019dffbb-f000-70f1-b555-9a326605ec2f |
| Canonical name | pg_advisory_unlock(key) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1AB5DF475423 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B1E36E69C90C |
