# SBSQL-B0757C84F3DF — param_type_or_shape
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B0757C84F3DF |
| Fixed UUID v7 | 019dffbb-f000-749d-a4d7-0d4eac4efd5f |
| Canonical name | param_type_or_shape |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B5038588D140 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B0757C84F3DF |
