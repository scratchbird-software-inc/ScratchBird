# SBSQL-25B1F64966AD — current_catalog
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-25B1F64966AD |
| Fixed UUID v7 | 019dffbb-f000-7002-b6cd-3a9d37008e2f |
| Canonical name | current_catalog |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BF5BAE7FD048 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-25B1F64966AD |
