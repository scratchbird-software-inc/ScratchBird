# SBSQL-243B7D1E55C5 — pg_read_binary_file
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-243B7D1E55C5 |
| Fixed UUID v7 | 019dffbb-f000-7a9e-96c7-f2f3884ffbc0 |
| Canonical name | pg_read_binary_file |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-59D58D7D42F7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-243B7D1E55C5 |
