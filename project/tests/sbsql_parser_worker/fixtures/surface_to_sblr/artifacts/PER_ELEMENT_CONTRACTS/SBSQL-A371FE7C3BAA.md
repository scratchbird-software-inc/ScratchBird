# SBSQL-A371FE7C3BAA — reference_only(rewrite)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A371FE7C3BAA |
| Fixed UUID v7 | 019dffbb-f000-7611-9a93-8f0bfc2391c5 |
| Canonical name | reference_only(rewrite) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1F274F39249C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A371FE7C3BAA |
