# SBSQL-C44E7F61A475 — st_geometrytype
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C44E7F61A475 |
| Fixed UUID v7 | 019dffbb-f000-7889-b48a-26341999141c |
| Canonical name | st_geometrytype |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A4DC9D25C3E7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C44E7F61A475 |
