# SBSQL-5A8AC604250A — map_constructor
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5A8AC604250A |
| Fixed UUID v7 | 019dffbb-f000-716a-a924-b7426c325ad5 |
| Canonical name | map_constructor |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-91D9F40C6711 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5A8AC604250A |
