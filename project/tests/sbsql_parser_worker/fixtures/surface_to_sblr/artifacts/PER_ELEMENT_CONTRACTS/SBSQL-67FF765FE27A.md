# SBSQL-67FF765FE27A — convert_from(binary,encoding)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-67FF765FE27A |
| Fixed UUID v7 | 019dffbb-f000-7363-9c9b-1238da484970 |
| Canonical name | convert_from(binary,encoding) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2E37AD9D1CD9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-67FF765FE27A |
