# SBSQL-AF5A2B51B726 — acos(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AF5A2B51B726 |
| Fixed UUID v7 | 019dffbb-f000-78b4-9218-df6dc13ed5c3 |
| Canonical name | acos(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AF840613D93F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-AF5A2B51B726 |
