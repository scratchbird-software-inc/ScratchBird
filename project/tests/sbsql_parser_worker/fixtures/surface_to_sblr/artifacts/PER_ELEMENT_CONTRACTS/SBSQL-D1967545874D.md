# SBSQL-D1967545874D — current_setting('timezone')
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D1967545874D |
| Fixed UUID v7 | 019dffbb-f000-71f7-8d7e-6c551c444bad |
| Canonical name | current_setting('timezone') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B00D4F016129 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D1967545874D |
