...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F7963EDAA8C1 |
| Fixed UUID v7 | 019dffbb-f000-71e3-95c5-f2829a4d69b2 |
| Canonical name | floor(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C270F44ACB34 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F7963EDAA8C1 |
