# SBSQL-8AB61EB176C5 — unpivot_pivot_column
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8AB61EB176C5 |
| Fixed UUID v7 | 019dffbb-f000-75ba-b924-01e2a09f7e7e |
| Canonical name | unpivot_pivot_column |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FE7B566FC1B6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8AB61EB176C5 |
