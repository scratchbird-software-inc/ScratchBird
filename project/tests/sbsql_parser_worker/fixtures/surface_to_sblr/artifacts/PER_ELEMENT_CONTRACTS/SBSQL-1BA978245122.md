...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1BA978245122 |
| Fixed UUID v7 | 019dffbb-f000-7a1b-b7a9-f6653036408c |
| Canonical name | add_months(date,n) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1B8ECABAD731 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-1BA978245122 |
