# SBSQL-3E3BA120C541 — JSON_EXISTS(doc,path[PASSING...][ONERROR])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3E3BA120C541 |
| Fixed UUID v7 | 019dffbb-f000-77ab-8585-1d09fc2fe5db |
| Canonical name | JSON_EXISTS(doc,path[PASSING...][ONERROR]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F52B3754B087 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-3E3BA120C541 |
