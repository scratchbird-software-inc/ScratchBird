# SBSQL-5B10D7D3D141 — pg_try_advisory_lock
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5B10D7D3D141 |
| Fixed UUID v7 | 019dffbb-f000-7023-98ab-6977caf6fe6a |
| Canonical name | pg_try_advisory_lock |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-292F6B0EA385 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5B10D7D3D141 |
