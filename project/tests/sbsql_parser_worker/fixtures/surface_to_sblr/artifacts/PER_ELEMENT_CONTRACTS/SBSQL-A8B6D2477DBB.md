# SBSQL-A8B6D2477DBB — skip_index_type
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A8B6D2477DBB |
| Fixed UUID v7 | 019dffbb-f000-7c3d-84c0-48573ce5d9ef |
| Canonical name | skip_index_type |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E71FC19C5371 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A8B6D2477DBB |
