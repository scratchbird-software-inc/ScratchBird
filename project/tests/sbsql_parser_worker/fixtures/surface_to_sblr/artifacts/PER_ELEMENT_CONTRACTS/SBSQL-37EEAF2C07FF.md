# SBSQL-37EEAF2C07FF — consistency_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-37EEAF2C07FF |
| Fixed UUID v7 | 019dffbb-f000-7d97-bd36-e6eb0dfb7038 |
| Canonical name | consistency_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1A33BAD42A3E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-37EEAF2C07FF |
