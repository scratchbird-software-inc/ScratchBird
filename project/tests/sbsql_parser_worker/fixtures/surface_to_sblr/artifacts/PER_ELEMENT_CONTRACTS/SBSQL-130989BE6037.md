# SBSQL-130989BE6037 — md5(text\|binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-130989BE6037 |
| Fixed UUID v7 | 019dffbb-f000-70f9-ac1b-2e695dc38071 |
| Canonical name | md5(text\\\|binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B8D5B4728B1A |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-130989BE6037 |
