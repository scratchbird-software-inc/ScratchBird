# SBSQL-D2C72368C35A — into_target
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D2C72368C35A |
| Fixed UUID v7 | 019dffbb-f000-7b54-9b6a-1652283aff4c |
| Canonical name | into_target |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-34404DC39363 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D2C72368C35A |
