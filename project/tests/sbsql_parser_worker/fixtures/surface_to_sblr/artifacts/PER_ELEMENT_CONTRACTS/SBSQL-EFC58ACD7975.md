# SBSQL-EFC58ACD7975 — cursor_active(name)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EFC58ACD7975 |
| Fixed UUID v7 | 019dffbb-f000-71e4-b9ad-2b91e8164f17 |
| Canonical name | cursor_active(name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F4D8E4EE0170 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-EFC58ACD7975 |
