# SBSQL-A39DC4358469 — jobs_scheduler_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A39DC4358469 |
| Fixed UUID v7 | 019dffbb-f000-79d4-8e82-ad1937c8f98c |
| Canonical name | jobs_scheduler_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C3F513883598 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A39DC4358469 |
