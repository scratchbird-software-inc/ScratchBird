# SBSQL-7E7F908D3782 — st_geomfromgeojson(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7E7F908D3782 |
| Fixed UUID v7 | 019dffbb-f000-72b5-b56a-b7993e3a9844 |
| Canonical name | st_geomfromgeojson(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DEC8334D2644 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7E7F908D3782 |
