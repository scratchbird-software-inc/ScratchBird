# SBSQL-82517404B2BD — uuid_reference
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-82517404B2BD |
| Fixed UUID v7 | 019dffbb-f000-73fc-92f5-f7dfbf5fb633 |
| Canonical name | uuid_reference |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1B6C5B46A5B2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-82517404B2BD |
