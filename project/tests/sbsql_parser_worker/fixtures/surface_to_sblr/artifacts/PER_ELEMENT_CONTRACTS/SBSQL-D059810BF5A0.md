# SBSQL-D059810BF5A0 — handle_kind(handle)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D059810BF5A0 |
| Fixed UUID v7 | 019dffbb-f000-7721-8680-85be472db2e4 |
| Canonical name | handle_kind(handle) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FFD49F067843 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D059810BF5A0 |
