# SBSQL-34E0B31299B8 — current_transaction_id
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-34E0B31299B8 |
| Fixed UUID v7 | 019dffbb-f000-7504-ae59-80be8a0ef10a |
| Canonical name | current_transaction_id |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4A71BCD774C1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-34E0B31299B8 |
