# SBSQL-5623B939FC0B — count(*)OVER(PARTITIONBY...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5623B939FC0B |
| Fixed UUID v7 | 019dffbb-f000-7bd4-b9f9-8132a11c91ce |
| Canonical name | count(*)OVER(PARTITIONBY...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E49384E98CB7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5623B939FC0B |
