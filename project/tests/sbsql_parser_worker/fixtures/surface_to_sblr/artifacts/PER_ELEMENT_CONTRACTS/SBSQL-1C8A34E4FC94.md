# SBSQL-1C8A34E4FC94 — LowCardinality(T)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1C8A34E4FC94 |
| Fixed UUID v7 | 019dffbb-f000-7ede-a986-cf20526bcfd1 |
| Canonical name | LowCardinality(T) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1A3BBE02EFE7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1C8A34E4FC94 |
