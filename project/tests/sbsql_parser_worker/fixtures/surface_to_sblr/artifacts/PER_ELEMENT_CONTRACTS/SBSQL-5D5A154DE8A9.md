# SBSQL-5D5A154DE8A9 — optimization_level
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5D5A154DE8A9 |
| Fixed UUID v7 | 019dffbb-f000-7e1d-8082-bfef58488faf |
| Canonical name | optimization_level |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-72FC0B1FD6F8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5D5A154DE8A9 |
