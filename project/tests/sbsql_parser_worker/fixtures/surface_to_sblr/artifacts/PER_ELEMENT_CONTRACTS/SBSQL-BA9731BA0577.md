# SBSQL-BA9731BA0577 — bridge_health
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BA9731BA0577 |
| Fixed UUID v7 | 019e14c1-6095-7138-8523-da32b6ad2953 |
| Canonical name | bridge_health |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BA9731BA0577 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BA9731BA0577 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_HEALTH, UDR operation health, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
