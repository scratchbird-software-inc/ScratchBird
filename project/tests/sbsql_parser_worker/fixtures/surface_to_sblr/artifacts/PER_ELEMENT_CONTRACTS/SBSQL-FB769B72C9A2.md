# SBSQL-FB769B72C9A2 — to_bytes(text[,encoding])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FB769B72C9A2 |
| Fixed UUID v7 | 019dffbb-f000-7a75-b0ed-e4807ab7297e |
| Canonical name | to_bytes(text[,encoding]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9CF96AD494B6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FB769B72C9A2 |
