...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6421F1CDC60B |
| Fixed UUID v7 | 019dffbb-f000-70f8-b4bb-84a07686bdb7 |
| Canonical name | timezone |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-643C6828055F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6421F1CDC60B |
