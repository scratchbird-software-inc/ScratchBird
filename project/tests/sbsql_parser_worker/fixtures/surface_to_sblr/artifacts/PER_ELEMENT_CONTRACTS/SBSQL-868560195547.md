...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-868560195547 |
| Fixed UUID v7 | 019dffbb-f000-769d-9765-b8aae368e31d |
| Canonical name | LIKE |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2AE8E699D705 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-868560195547 |
