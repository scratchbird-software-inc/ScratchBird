...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A48C58E244D4 |
| Fixed UUID v7 | 019dffbb-f000-7a6d-a36a-5ad2e4f3215e |
| Canonical name | concat_ws |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-665E87C37ED5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A48C58E244D4 |
