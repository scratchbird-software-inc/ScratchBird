# SBSQL-425396530806 — pause_job_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-425396530806 |
| Fixed UUID v7 | 019dffbb-f000-7e1a-a37d-f14b29a7d138 |
| Canonical name | pause_job_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-515BF7EC0DBF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-425396530806 |
