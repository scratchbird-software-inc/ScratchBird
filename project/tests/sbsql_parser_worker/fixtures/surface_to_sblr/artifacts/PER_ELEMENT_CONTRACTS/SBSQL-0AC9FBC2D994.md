# SBSQL-0AC9FBC2D994 — bit_set(int,position)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0AC9FBC2D994 |
| Fixed UUID v7 | 019dffbb-f000-75c5-8de9-034ba5dc8f94 |
| Canonical name | bit_set(int,position) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-703A6FDCC7FC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0AC9FBC2D994 |
