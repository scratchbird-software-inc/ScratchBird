# SBSQL-538C63DF20B3 — sb.operator.regex_match
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-538C63DF20B3 |
| Fixed UUID v7 | 019dffbb-f000-7272-8555-dc403503398b |
| Canonical name | sb.operator.regex_match |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-63263AFB8904 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-538C63DF20B3 |
