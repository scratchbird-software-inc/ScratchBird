# SBSQL-D7C03289F1AA — bit_string_position
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D7C03289F1AA |
| Fixed UUID v7 | 019dffbb-f000-783c-a9bc-bc382ae9e0ee |
| Canonical name | bit_string_position |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A18A5F47CB65 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D7C03289F1AA |
