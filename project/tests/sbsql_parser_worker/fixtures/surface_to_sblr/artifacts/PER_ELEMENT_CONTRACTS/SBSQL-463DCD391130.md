...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-463DCD391130 |
| Fixed UUID v7 | 019dffbb-f000-75cf-a118-1c879315ec7a |
| Canonical name | @@SPID |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AD5546245CC9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-463DCD391130 |
