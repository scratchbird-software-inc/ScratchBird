# SBSQL-5EEA3058CDC1 — pg_try_advisory_lock(key)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5EEA3058CDC1 |
| Fixed UUID v7 | 019dffbb-f000-7040-bb2c-84260ef9488e |
| Canonical name | pg_try_advisory_lock(key) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B69C47364E8D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5EEA3058CDC1 |
