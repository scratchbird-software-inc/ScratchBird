# SBSQL-23EEDCBB8140 — json_replace(document,path,value)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-23EEDCBB8140 |
| Fixed UUID v7 | 019dffbb-f000-77ca-92d0-7110fcc7fead |
| Canonical name | json_replace(document,path,value) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BAE579FE8C62 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-23EEDCBB8140 |
