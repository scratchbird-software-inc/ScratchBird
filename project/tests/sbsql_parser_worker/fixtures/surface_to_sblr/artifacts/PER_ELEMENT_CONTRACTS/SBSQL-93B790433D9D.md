...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-93B790433D9D |
| Fixed UUID v7 | 019dffbb-f000-7605-81d2-c07ac315bc3c |
| Canonical name | RDB$GET_CONTEXT('USER_SESSION','CLIENT_PID') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-05CD4D003DB2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-93B790433D9D |
