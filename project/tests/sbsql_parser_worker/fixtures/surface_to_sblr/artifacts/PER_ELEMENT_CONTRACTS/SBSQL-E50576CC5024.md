# SBSQL-E50576CC5024 — instr(string,substring[,start[,occurrence]])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E50576CC5024 |
| Fixed UUID v7 | 019dffbb-f000-7ed7-94d1-b24855157778 |
| Canonical name | instr(string,substring[,start[,occurrence]]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F3A4D9367FCD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-E50576CC5024 |
