# SBSQL-D0FF02C4CDDE — hmac(text\|binary,key,algo)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D0FF02C4CDDE |
| Fixed UUID v7 | 019dffbb-f000-7879-8721-bdbd655a9290 |
| Canonical name | hmac(text\\\|binary,key,algo) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7D2773EA0CAD |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D0FF02C4CDDE |
