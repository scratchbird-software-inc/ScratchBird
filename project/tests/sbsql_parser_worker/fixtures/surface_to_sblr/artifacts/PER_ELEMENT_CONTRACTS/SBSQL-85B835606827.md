# SBSQL-85B835606827 — mysql_legacy_timestamp_domain
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-85B835606827 |
| Fixed UUID v7 | 019dffbb-f000-7437-97f9-b198892fe492 |
| Canonical name | mysql_legacy_timestamp_domain |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5A6F2A168A33 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-85B835606827 |
