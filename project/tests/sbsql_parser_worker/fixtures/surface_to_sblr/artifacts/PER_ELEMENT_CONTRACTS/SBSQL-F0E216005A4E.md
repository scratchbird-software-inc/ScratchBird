# SBSQL-F0E216005A4E — cursor_holdability(cursor)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F0E216005A4E |
| Fixed UUID v7 | 019dffbb-f000-73e0-b3aa-1ac1d5d5deab |
| Canonical name | cursor_holdability(cursor) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-63FA998543EA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F0E216005A4E |
