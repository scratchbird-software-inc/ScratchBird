# SBSQL-4711C0478840 — hamming_distance(bit_vector,bit_vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4711C0478840 |
| Fixed UUID v7 | 019dffbb-f000-7bec-9b83-21e52bcbdff0 |
| Canonical name | hamming_distance(bit_vector,bit_vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-793935487944 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-4711C0478840 |
