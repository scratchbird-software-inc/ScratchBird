# SBSQL-A43A427BA70A — EXECUTE_DYNAMIC_SQL
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A43A427BA70A |
| Fixed UUID v7 | 019dffbb-f000-7bb1-a136-6cf1ab8d9657 |
| Canonical name | EXECUTE_DYNAMIC_SQL |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B536B847B5B8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A43A427BA70A |
