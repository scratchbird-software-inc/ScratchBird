# SBSQL-8EA33E3F97F0 — ARRAY(SELECT...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8EA33E3F97F0 |
| Fixed UUID v7 | 019dffbb-f000-70c6-b5fb-cc59afa6e7a6 |
| Canonical name | ARRAY(SELECT...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B08160C4DD67 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8EA33E3F97F0 |
