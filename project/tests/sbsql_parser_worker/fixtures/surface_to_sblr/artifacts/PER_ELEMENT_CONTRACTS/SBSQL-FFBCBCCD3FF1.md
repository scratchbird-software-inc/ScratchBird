# SBSQL-FFBCBCCD3FF1 — TIMESTAMP(p)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FFBCBCCD3FF1 |
| Fixed UUID v7 | 019dffbb-f000-724c-8031-3e8ad595f39a |
| Canonical name | TIMESTAMP(p) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2D32DF244DA7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FFBCBCCD3FF1 |
