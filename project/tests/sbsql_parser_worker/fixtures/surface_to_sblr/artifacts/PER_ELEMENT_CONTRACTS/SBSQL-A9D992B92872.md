# SBSQL-A9D992B92872 — cosine_distance(vector,vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A9D992B92872 |
| Fixed UUID v7 | 019dffbb-f000-736b-b105-b4b2743050f7 |
| Canonical name | cosine_distance(vector,vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-83219B51C293 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A9D992B92872 |
