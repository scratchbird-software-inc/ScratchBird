# SBSQL-C0853CB531DA — shard_method
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C0853CB531DA |
| Fixed UUID v7 | 019dffbb-f000-7e90-a261-d00fc023fe89 |
| Canonical name | shard_method |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0D60C5F5B969 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C0853CB531DA |
