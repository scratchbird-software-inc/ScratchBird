# SBSQL-64177C9CCDD6 — convert_to(text,encoding)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-64177C9CCDD6 |
| Fixed UUID v7 | 019dffbb-f000-7971-8009-65303be72a8b |
| Canonical name | convert_to(text,encoding) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-15CBDE61E39D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-64177C9CCDD6 |
