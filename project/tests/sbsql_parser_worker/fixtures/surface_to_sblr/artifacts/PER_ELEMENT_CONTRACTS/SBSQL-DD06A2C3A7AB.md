# SBSQL-DD06A2C3A7AB — quantified_subquery
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DD06A2C3A7AB |
| Fixed UUID v7 | 019dffbb-f000-74b2-85c8-97242f3e5ad7 |
| Canonical name | quantified_subquery |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8C4D2BA74679 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DD06A2C3A7AB |
