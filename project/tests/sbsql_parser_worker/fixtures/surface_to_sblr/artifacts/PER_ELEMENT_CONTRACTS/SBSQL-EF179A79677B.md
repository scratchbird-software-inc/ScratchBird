# SBSQL-EF179A79677B — epoch(timestamp)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EF179A79677B |
| Fixed UUID v7 | 019dffbb-f000-7a32-bc2e-15564919f4e3 |
| Canonical name | epoch(timestamp) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-23CE7D4A8E6E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EF179A79677B |
