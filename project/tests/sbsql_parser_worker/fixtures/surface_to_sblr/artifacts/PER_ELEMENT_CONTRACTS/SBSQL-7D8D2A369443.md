# SBSQL-7D8D2A369443 — cluster_tx_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7D8D2A369443 |
| Fixed UUID v7 | 019dffbb-f000-7285-b9bf-36db52981460 |
| Canonical name | cluster_tx_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-24C2953EB3ED |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-7D8D2A369443 |
