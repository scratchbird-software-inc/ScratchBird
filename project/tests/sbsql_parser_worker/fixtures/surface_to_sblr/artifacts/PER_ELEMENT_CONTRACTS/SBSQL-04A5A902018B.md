# SBSQL-04A5A902018B — pivot_agg_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-04A5A902018B |
| Fixed UUID v7 | 019dffbb-f000-73cb-9255-ddc801cc465b |
| Canonical name | pivot_agg_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9F7E4ECFA75B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-04A5A902018B |
