# SBSQL-35C590657A1C — log2(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-35C590657A1C |
| Fixed UUID v7 | 019dffbb-f000-79df-ac1a-2d0eebb88678 |
| Canonical name | log2(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-69A6EC035981 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-35C590657A1C |
