# SBSQL-5550BDA0A76C — domain_stack
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5550BDA0A76C |
| Fixed UUID v7 | 019dffbb-f000-7ce7-9a6e-3cd8e7e65fd1 |
| Canonical name | domain_stack |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8B97A7800BFB |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5550BDA0A76C |
