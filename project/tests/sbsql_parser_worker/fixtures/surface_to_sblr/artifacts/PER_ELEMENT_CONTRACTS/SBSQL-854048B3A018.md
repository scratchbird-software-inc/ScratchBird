# SBSQL-854048B3A018 — savepoint_active(name)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-854048B3A018 |
| Fixed UUID v7 | 019dffbb-f000-7a60-aaae-ccfbe2fab1e9 |
| Canonical name | savepoint_active(name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5AA26E1E2618 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-854048B3A018 |
