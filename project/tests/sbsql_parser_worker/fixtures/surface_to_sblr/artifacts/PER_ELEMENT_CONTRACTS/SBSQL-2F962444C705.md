# SBSQL-2F962444C705 — log(base,numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2F962444C705 |
| Fixed UUID v7 | 019dffbb-f000-7607-a0f1-eea3195dc51b |
| Canonical name | log(base,numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CD0DC2506520 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2F962444C705 |
