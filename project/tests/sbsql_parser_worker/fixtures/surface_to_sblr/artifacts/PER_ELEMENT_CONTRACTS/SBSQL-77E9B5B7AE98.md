# SBSQL-77E9B5B7AE98 — cardinality(multiset<T>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-77E9B5B7AE98 |
| Fixed UUID v7 | 019dffbb-f000-7117-92e8-fde0dde09f9b |
| Canonical name | cardinality(multiset<T>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B6A109C5DBAC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-77E9B5B7AE98 |
