...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-16AC6A32C3BD |
| Fixed UUID v7 | 019dffbb-f000-7513-8e77-83deace81805 |
| Canonical name | NOT(xLIKEy) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-96D120A6D59D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-16AC6A32C3BD |
