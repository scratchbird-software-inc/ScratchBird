...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-ADF960CAF3D8 |
| Fixed UUID v7 | 019dffbb-f000-7737-9f12-2e7ad0dd3512 |
| Canonical name | VARCHAR(1) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5DB8EEC4907F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-ADF960CAF3D8 |
