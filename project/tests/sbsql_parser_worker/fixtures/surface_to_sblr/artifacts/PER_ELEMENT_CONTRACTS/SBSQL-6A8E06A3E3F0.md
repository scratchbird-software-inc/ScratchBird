...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6A8E06A3E3F0 |
| Fixed UUID v7 | 019dffbb-f000-71d0-a1a0-8669b44b09c1 |
| Canonical name | log10(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A3BFF70839CD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6A8E06A3E3F0 |
