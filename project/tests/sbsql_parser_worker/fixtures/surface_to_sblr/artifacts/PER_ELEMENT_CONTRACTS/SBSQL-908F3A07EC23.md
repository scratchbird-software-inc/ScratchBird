# SBSQL-908F3A07EC23 — psql_get_diagnostics
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-908F3A07EC23 |
| Fixed UUID v7 | 019dffbb-f000-7c76-9cd1-365cddbe9fff |
| Canonical name | psql_get_diagnostics |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A21EF466AEAE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-908F3A07EC23 |
