# SBSQL-2B38A69D425B — XMLCONCAT(expr_list)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2B38A69D425B |
| Fixed UUID v7 | 019dffbb-f000-7ad1-88c5-adf64d369ff2 |
| Canonical name | XMLCONCAT(expr_list) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AB26570E46CB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-2B38A69D425B |
