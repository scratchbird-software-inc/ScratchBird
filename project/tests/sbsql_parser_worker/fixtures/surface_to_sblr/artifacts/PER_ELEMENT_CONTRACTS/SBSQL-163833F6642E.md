# SBSQL-163833F6642E — cursor_open(<select>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-163833F6642E |
| Fixed UUID v7 | 019dffbb-f000-7166-a921-abe2128d8de2 |
| Canonical name | cursor_open(<select>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-23DF259728DE |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-163833F6642E |
