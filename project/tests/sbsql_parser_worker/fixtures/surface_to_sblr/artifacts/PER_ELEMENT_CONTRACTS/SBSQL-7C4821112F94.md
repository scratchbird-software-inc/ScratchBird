# SBSQL-7C4821112F94 — jsonb_path_match(document,jsonpath[,vars])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7C4821112F94 |
| Fixed UUID v7 | 019dffbb-f000-75e8-9ea3-170e35f5e4f2 |
| Canonical name | jsonb_path_match(document,jsonpath[,vars]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BBC9AC6E9032 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7C4821112F94 |
