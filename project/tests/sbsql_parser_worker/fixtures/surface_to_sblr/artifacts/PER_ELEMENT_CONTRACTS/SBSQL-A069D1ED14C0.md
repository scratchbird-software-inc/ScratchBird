# SBSQL-A069D1ED14C0 — RANDOM_SEED_CONTROL
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A069D1ED14C0 |
| Fixed UUID v7 | 019dffbb-f000-7fd5-b2ec-225399e79016 |
| Canonical name | RANDOM_SEED_CONTROL |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AE8257A6DAA5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A069D1ED14C0 |
