# SBSQL-C7750F0B80EB — show_plan_extended
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C7750F0B80EB |
| Fixed UUID v7 | 019dffbb-f000-7c6d-a698-4fdf32924731 |
| Canonical name | show_plan_extended |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-848C9893FA08 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C7750F0B80EB |
