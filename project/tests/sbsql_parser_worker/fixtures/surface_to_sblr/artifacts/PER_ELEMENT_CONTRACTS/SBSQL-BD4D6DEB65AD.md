# SBSQL-BD4D6DEB65AD — fulltext_agg_def
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BD4D6DEB65AD |
| Fixed UUID v7 | 019dffbb-f000-7c82-925c-6f6b2a5f092d |
| Canonical name | fulltext_agg_def |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C24EAC279302 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BD4D6DEB65AD |
