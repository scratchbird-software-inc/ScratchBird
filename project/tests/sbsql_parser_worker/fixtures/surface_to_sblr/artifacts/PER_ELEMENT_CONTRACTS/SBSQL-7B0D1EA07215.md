# SBSQL-7B0D1EA07215 — dense_rank(expr)WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7B0D1EA07215 |
| Fixed UUID v7 | 019dffbb-f000-71c9-9dcf-af244c468499 |
| Canonical name | dense_rank(expr)WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5BACD049E1D2 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7B0D1EA07215 |
