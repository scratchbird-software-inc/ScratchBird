# SBSQL-A2EAC47B5A98 — psql_searched_case_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A2EAC47B5A98 |
| Fixed UUID v7 | 019dffbb-f000-7a36-93a3-974f9d3c6cde |
| Canonical name | psql_searched_case_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-26509E05D420 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A2EAC47B5A98 |
