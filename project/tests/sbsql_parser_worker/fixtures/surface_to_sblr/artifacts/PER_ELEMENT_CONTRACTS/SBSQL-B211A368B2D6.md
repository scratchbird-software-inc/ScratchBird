# SBSQL-B211A368B2D6 — bool_and(boolean)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B211A368B2D6 |
| Fixed UUID v7 | 019dffbb-f000-7455-a1f7-724a542820bb |
| Canonical name | bool_and(boolean) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-230551C542E0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B211A368B2D6 |
