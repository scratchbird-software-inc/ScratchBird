# SBSQL-C170616B6CF5 — percentile_cont
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C170616B6CF5 |
| Fixed UUID v7 | 019dffbb-f000-7cfd-83dd-15435fe55bf5 |
| Canonical name | percentile_cont |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C0FF0DB0BE08 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C170616B6CF5 |
