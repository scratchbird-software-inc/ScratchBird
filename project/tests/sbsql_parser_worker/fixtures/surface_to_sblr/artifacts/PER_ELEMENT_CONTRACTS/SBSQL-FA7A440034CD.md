# SBSQL-FA7A440034CD — stream_type
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FA7A440034CD |
| Fixed UUID v7 | 019dffbb-f000-74b3-a616-2a917bf26108 |
| Canonical name | stream_type |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E19D080F39B1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FA7A440034CD |
