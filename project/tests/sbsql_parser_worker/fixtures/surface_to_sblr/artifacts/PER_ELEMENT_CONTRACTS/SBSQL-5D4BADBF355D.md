...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5D4BADBF355D |
| Fixed UUID v7 | 019dffbb-f000-715d-9ecf-ac7fea0ff968 |
| Canonical name | map_entry |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-22DEA271097C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5D4BADBF355D |
