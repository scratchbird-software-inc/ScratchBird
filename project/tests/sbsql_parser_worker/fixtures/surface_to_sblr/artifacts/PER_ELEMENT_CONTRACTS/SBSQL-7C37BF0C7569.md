...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7C37BF0C7569 |
| Fixed UUID v7 | 019dffbb-f000-7a2a-b6c6-497004f5cfef |
| Canonical name | interval_qualifier |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-317A4F1BF29E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7C37BF0C7569 |
