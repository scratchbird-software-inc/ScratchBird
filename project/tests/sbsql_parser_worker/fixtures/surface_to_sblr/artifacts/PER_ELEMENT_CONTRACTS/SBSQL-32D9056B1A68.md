# SBSQL-32D9056B1A68 — partition_values
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-32D9056B1A68 |
| Fixed UUID v7 | 019dffbb-f000-736c-b4ea-dc5413b9e71c |
| Canonical name | partition_values |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E02B7EB725FA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-32D9056B1A68 |
