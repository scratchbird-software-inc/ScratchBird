# SBSQL-63C1855AC02B — update_statement
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-63C1855AC02B |
| Fixed UUID v7 | 019dffbb-f000-7db8-9589-3ed1cbc27bd1 |
| Canonical name | update_statement |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-996C54248275 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-63C1855AC02B |
