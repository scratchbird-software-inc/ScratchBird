# SBSQL-D155F7EC1FE1 — stddev_samp(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D155F7EC1FE1 |
| Fixed UUID v7 | 019dffbb-f000-7380-b3cc-27de78299598 |
| Canonical name | stddev_samp(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3A37D37DE4A9 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D155F7EC1FE1 |
