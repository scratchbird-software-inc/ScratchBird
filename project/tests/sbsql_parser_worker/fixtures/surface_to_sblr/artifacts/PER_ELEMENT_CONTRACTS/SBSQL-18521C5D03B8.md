# SBSQL-18521C5D03B8 — json_each(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-18521C5D03B8 |
| Fixed UUID v7 | 019dffbb-f000-7ec4-9a19-1e309311ad69 |
| Canonical name | json_each(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1E9FFB70A228 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-18521C5D03B8 |
