# SBSQL-0112477D19BE — chr(integer)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0112477D19BE |
| Fixed UUID v7 | 019dffbb-f000-7fcb-801e-0f59a23c549e |
| Canonical name | chr(integer) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-56CA7A8FD163 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0112477D19BE |
