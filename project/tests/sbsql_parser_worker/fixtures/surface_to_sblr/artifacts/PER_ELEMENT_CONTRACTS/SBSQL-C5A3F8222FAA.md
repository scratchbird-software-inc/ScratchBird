# SBSQL-C5A3F8222FAA — refresh_strategy
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C5A3F8222FAA |
| Fixed UUID v7 | 019dffbb-f000-7b14-940f-f25477bc3a33 |
| Canonical name | refresh_strategy |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2C7FB3844D3E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C5A3F8222FAA |
