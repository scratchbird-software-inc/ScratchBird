# SBSQL-7EB6F5C24255 — encryption_options
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7EB6F5C24255 |
| Fixed UUID v7 | 019dffbb-f000-745d-a7b9-ca1dadf6527e |
| Canonical name | encryption_options |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A19C60FF9CD1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7EB6F5C24255 |
