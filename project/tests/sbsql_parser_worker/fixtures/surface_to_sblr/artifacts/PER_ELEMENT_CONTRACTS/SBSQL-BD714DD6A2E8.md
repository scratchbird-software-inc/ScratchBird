# SBSQL-BD714DD6A2E8 — vector_field_modifier
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BD714DD6A2E8 |
| Fixed UUID v7 | 019dffbb-f000-7c45-8529-a273ba207278 |
| Canonical name | vector_field_modifier |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C515391927BA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BD714DD6A2E8 |
