# SBSQL-EBE863C39BD6 — month_name(date[,locale])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EBE863C39BD6 |
| Fixed UUID v7 | 019dffbb-f000-7d06-94cd-926b11486995 |
| Canonical name | month_name(date[,locale]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-29C5332F7BB3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EBE863C39BD6 |
