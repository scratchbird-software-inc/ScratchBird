# SBSQL-1FD9B625C623 — quote_ident(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1FD9B625C623 |
| Fixed UUID v7 | 019dffbb-f000-705a-8317-cd57ca22286c |
| Canonical name | quote_ident(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EE62171EDF13 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1FD9B625C623 |
