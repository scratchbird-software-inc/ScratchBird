# SBSQL-C9B937A0E6A4 — interval_default_precision
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C9B937A0E6A4 |
| Fixed UUID v7 | 019dffbb-f000-7a7f-86b3-b8dbae5a6f74 |
| Canonical name | interval_default_precision |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7FD58FF1352B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C9B937A0E6A4 |
