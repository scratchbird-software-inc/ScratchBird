# SBSQL-C3E1013D5D56 — bucket_attr
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C3E1013D5D56 |
| Fixed UUID v7 | 019dffbb-f000-741a-9ed8-78d36db3c94e |
| Canonical name | bucket_attr |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C8EE4C6B90F6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C3E1013D5D56 |
