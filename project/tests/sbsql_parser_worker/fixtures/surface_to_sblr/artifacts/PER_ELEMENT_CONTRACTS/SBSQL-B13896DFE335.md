# SBSQL-B13896DFE335 — geometry(point)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B13896DFE335 |
| Fixed UUID v7 | 019dffbb-f000-7a53-af14-2f45674689f5 |
| Canonical name | geometry(point) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-339C941EE680 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B13896DFE335 |
