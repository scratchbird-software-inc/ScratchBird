# SBSQL-609AA171BBEC — subvector(vector,start,length)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-609AA171BBEC |
| Fixed UUID v7 | 019dffbb-f000-7b3e-ae78-5afb1f309c82 |
| Canonical name | subvector(vector,start,length) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7854E917FF35 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-609AA171BBEC |
