...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FB03794952FB |
| Fixed UUID v7 | 019dffbb-f000-7b0a-af02-3a166e6cfec7 |
| Canonical name | deallocate_stmt |
...
| SBLR operation family | sblr.session.management.v3 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-75CFE1565EDE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FB03794952FB |
