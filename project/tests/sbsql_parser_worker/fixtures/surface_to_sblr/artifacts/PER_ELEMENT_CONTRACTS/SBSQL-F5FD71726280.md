# SBSQL-F5FD71726280 — current_database
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F5FD71726280 |
| Fixed UUID v7 | 019dffbb-f000-7ef0-923f-122471670fdb |
| Canonical name | current_database |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4120A47F5984 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F5FD71726280 |
