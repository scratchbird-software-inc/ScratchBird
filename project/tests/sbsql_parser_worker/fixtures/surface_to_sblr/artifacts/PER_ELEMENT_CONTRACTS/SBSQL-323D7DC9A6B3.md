# SBSQL-323D7DC9A6B3 — colon_lambda
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-323D7DC9A6B3 |
| Fixed UUID v7 | 019dffbb-f000-7ac3-b749-cec46b554d07 |
| Canonical name | colon_lambda |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6DA5D59CB348 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-323D7DC9A6B3 |
