# SBSQL-7EE8FAD14C5A — JSON_EXISTS
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7EE8FAD14C5A |
| Fixed UUID v7 | 019dffbb-f000-7a70-bd37-7515e03f85dd |
| Canonical name | JSON_EXISTS |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0AF8A479DD98 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7EE8FAD14C5A |
