...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-971C709406A0 |
| Fixed UUID v7 | 019dffbb-f000-7ef7-8bdf-3849bb4d975e |
| Canonical name | @ |
| Surface kind | variable |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-96240D7A6CDB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-971C709406A0 |
