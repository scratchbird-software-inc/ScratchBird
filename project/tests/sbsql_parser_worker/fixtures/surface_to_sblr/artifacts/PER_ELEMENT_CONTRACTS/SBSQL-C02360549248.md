# SBSQL-C02360549248 — optional_expression_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C02360549248 |
| Fixed UUID v7 | 019dffbb-f000-78e6-9a21-ae419f296c04 |
| Canonical name | optional_expression_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3EF0744D0207 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C02360549248 |
