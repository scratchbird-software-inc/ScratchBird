# SBSQL-6E2D0E0B0111 — release_lock(name)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6E2D0E0B0111 |
| Fixed UUID v7 | 019dffbb-f000-7ab0-9e11-000000000111 |
| Canonical name | release_lock(name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6E2D0E0B0111 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6E2D0E0B0111 |
