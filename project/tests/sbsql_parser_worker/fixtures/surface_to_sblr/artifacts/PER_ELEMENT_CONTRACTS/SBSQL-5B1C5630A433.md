# SBSQL-5B1C5630A433 — use_database_alias
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5B1C5630A433 |
| Fixed UUID v7 | 019dffbb-f000-72b3-9165-8d093ebf876d |
| Canonical name | use_database_alias |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3B79DB3F0B72 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5B1C5630A433 |
