# SBSQL-9DAFD9A7D944 — create_binding_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9DAFD9A7D944 |
| Fixed UUID v7 | 019dffbb-f000-79fd-a816-48e8fff979c9 |
| Canonical name | create_binding_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B9F40805BC47 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9DAFD9A7D944 |
