# SBSQL-3EEEEB2D83A7 — schema_element
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3EEEEB2D83A7 |
| Fixed UUID v7 | 019dffbb-f000-71d8-9925-133784b7a180 |
| Canonical name | schema_element |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D8424400FC52 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3EEEEB2D83A7 |
