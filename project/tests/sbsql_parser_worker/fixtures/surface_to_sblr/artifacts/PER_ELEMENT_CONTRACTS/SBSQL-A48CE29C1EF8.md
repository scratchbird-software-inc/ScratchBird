# SBSQL-A48CE29C1EF8 — next_day(date,dow)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A48CE29C1EF8 |
| Fixed UUID v7 | 019dffbb-f000-7814-9953-64e2e5aef27a |
| Canonical name | next_day(date,dow) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CA428F5CB54E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A48CE29C1EF8 |
