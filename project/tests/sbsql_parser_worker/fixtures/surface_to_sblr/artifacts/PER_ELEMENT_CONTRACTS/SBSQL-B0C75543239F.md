# SBSQL-B0C75543239F — repeat(text,n)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B0C75543239F |
| Fixed UUID v7 | 019dffbb-f000-798b-a4b7-81db0b203705 |
| Canonical name | repeat(text,n) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E5212F0824DA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B0C75543239F |
