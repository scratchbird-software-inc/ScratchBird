# SBSQL-98D9B54A7630 — jsonb_strip_nulls(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-98D9B54A7630 |
| Fixed UUID v7 | 019dffbb-f000-7233-b69b-4bed553f6789 |
| Canonical name | jsonb_strip_nulls(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2F4A1D6052F8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-98D9B54A7630 |
