# SBSQL-3F93CC8AF7E0 — bridge_validate_connection
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3F93CC8AF7E0 |
| Fixed UUID v7 | 019e14c1-31a5-7b58-83a0-05013ce37618 |
| Canonical name | bridge_validate_connection |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3F93CC8AF7E0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3F93CC8AF7E0 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_VALIDATE, UDR operation describe_capabilities, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
