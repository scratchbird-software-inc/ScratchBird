# SBSQL-F950D94C902C — grouping_form
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F950D94C902C |
| Fixed UUID v7 | 019dffbb-f000-7e0a-bfa1-bfdcf0405340 |
| Canonical name | grouping_form |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6AA6CD885344 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F950D94C902C |
