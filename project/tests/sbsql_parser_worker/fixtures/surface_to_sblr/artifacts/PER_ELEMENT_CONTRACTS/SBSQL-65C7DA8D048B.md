# SBSQL-65C7DA8D048B — st_perimeter
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-65C7DA8D048B |
| Fixed UUID v7 | 019dffbb-f000-7f31-a657-c857f289e81c |
| Canonical name | st_perimeter |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4D7B10947CB4 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-65C7DA8D048B |
