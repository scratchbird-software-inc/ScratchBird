# SBSQL-F0CF86A4B3AF — udr_package_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F0CF86A4B3AF |
| Fixed UUID v7 | 019dffbb-f000-79e0-ae78-bd691010d1e9 |
| Canonical name | udr_package_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9084358EE3A1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F0CF86A4B3AF |
