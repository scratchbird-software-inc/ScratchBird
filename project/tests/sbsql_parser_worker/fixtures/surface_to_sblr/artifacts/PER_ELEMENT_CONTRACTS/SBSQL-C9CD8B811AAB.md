# SBSQL-C9CD8B811AAB — to_double(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C9CD8B811AAB |
| Fixed UUID v7 | 019dffbb-f000-7f55-9d2f-2eaab69969f7 |
| Canonical name | to_double(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6B5407AD027D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C9CD8B811AAB |
