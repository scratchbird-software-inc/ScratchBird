# SBSQL-D4C7802D088A — SBSQL.DEPRECATION_WARNING
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D4C7802D088A |
| Fixed UUID v7 | 019dffbb-f000-7e49-b075-9b44d6b73d7f |
| Canonical name | SBSQL.DEPRECATION_WARNING |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-39B31091047C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D4C7802D088A |
