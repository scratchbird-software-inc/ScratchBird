# SBSQL-D9693B850C39 — string_agg(expr,delimiter[ORDERBY...])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D9693B850C39 |
| Fixed UUID v7 | 019dffbb-f000-760d-86f4-b94fc91adb44 |
| Canonical name | string_agg(expr,delimiter[ORDERBY...]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C3D2B0DB9388 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D9693B850C39 |
