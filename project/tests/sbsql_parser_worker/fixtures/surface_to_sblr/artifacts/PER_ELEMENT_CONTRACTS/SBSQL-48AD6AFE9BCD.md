...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-48AD6AFE9BCD |
| Fixed UUID v7 | 019dffbb-f000-7485-85be-8a23ccadcc62 |
| Canonical name | sb.scalar.ifnull |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A7A5DFCED27F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-48AD6AFE9BCD |
