# SBSQL-0382B5F327AA — client_min_messages
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0382B5F327AA |
| Fixed UUID v7 | 019dffbb-f000-7a20-bda2-8ba1d33405bd |
| Canonical name | client_min_messages |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7833EAC30824 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0382B5F327AA |
