# SBSQL-6EF52D5CB31E — exception_condition_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6EF52D5CB31E |
| Fixed UUID v7 | 019dffbb-f000-724d-9e08-d0f8014d5251 |
| Canonical name | exception_condition_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2573F9015073 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6EF52D5CB31E |
