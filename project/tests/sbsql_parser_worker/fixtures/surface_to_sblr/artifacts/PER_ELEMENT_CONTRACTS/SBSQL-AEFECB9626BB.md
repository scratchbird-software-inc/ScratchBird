# SBSQL-AEFECB9626BB — st_difference
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AEFECB9626BB |
| Fixed UUID v7 | 019dffbb-f000-7c79-918e-3ade75cc83bf |
| Canonical name | st_difference |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-921F7D6D9583 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AEFECB9626BB |
