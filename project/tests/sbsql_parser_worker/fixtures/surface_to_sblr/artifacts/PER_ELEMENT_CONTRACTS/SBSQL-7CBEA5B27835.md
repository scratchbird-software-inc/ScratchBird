# SBSQL-7CBEA5B27835 — variance_pop(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7CBEA5B27835 |
| Fixed UUID v7 | 019dffbb-f000-7a96-b7ad-289966091ab4 |
| Canonical name | variance_pop(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-881C053BFE5C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7CBEA5B27835 |
