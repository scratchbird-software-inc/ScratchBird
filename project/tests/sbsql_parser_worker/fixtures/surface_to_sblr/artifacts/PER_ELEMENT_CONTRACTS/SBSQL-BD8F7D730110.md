# SBSQL-BD8F7D730110 — continuous_aggregate_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BD8F7D730110 |
| Fixed UUID v7 | 019dffbb-f000-770d-9f6e-f3422a83ee09 |
| Canonical name | continuous_aggregate_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-09F0A8B60DB9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BD8F7D730110 |
