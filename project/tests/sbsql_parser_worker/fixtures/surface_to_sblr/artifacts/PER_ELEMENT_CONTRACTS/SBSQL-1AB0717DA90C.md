...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1AB0717DA90C |
| Fixed UUID v7 | 019dffbb-f000-7253-b7a9-c182e0e4a04b |
| Canonical name | bit_xor |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CB0E8467D9A6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-1AB0717DA90C |
