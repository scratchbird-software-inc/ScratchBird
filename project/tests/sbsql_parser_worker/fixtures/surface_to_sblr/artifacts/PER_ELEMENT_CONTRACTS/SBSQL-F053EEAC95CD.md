# SBSQL-F053EEAC95CD — st_npoints(geometry)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F053EEAC95CD |
| Fixed UUID v7 | 019dffbb-f000-7d5c-a1c9-3da0b6b3e6d5 |
| Canonical name | st_npoints(geometry) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FF44C77747CF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F053EEAC95CD |
