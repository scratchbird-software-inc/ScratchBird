# SBSQL-A17C46CF3CC9 — truncate_statement
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A17C46CF3CC9 |
| Fixed UUID v7 | 019dffbb-f000-7983-954a-10da1603c0de |
| Canonical name | truncate_statement |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CFE6D7627B38 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A17C46CF3CC9 |
