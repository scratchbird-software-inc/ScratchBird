# SBSQL-4F59D2264C2C — pg_rotate_logfile
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4F59D2264C2C |
| Fixed UUID v7 | 019dffbb-f000-7e74-80a1-be8263dafa9c |
| Canonical name | pg_rotate_logfile |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5359A5A02052 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4F59D2264C2C |
