# SBSQL-D291129F3FD3 — regr_sxx(y,x)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D291129F3FD3 |
| Fixed UUID v7 | 019dffbb-f000-759b-953e-1eead5a5619d |
| Canonical name | regr_sxx(y,x) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-50D3F45F6ABB |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D291129F3FD3 |
