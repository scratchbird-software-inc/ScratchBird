# SBSQL-9D1418D2B716 — cypher_label_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9D1418D2B716 |
| Fixed UUID v7 | 019dffbb-f000-7160-b869-8952444d01c2 |
| Canonical name | cypher_label_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DB1D47684033 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9D1418D2B716 |
