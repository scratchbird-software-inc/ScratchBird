# SBSQL-9AFD6269AD11 — to_number(text,format)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9AFD6269AD11 |
| Fixed UUID v7 | 019dffbb-f000-7133-be4e-188aee7b9fae |
| Canonical name | to_number(text,format) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ACAFECF2C7C8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9AFD6269AD11 |
