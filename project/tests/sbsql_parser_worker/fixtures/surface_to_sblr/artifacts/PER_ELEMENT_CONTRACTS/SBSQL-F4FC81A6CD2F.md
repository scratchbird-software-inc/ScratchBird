# SBSQL-F4FC81A6CD2F — vector_search_arg
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F4FC81A6CD2F |
| Fixed UUID v7 | 019dffbb-f000-7cfb-99f0-b0efdfeb3f3e |
| Canonical name | vector_search_arg |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-93AA398B0B5D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F4FC81A6CD2F |
