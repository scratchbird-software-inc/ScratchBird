# SBSQL-504CEBDC6FE1 — TREAT(exprASsubtype)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-504CEBDC6FE1 |
| Fixed UUID v7 | 019dffbb-f000-7c7a-b60b-1d00033b9430 |
| Canonical name | TREAT(exprASsubtype) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9A18D794C12C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-504CEBDC6FE1 |
