# SBSQL-234E59C1DF96 — btrim(text[,chars])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-234E59C1DF96 |
| Fixed UUID v7 | 019dffbb-f000-7c1a-bf1a-b3c3936e7c95 |
| Canonical name | btrim(text[,chars]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7EF140458BB9 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-234E59C1DF96 |
