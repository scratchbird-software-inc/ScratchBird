...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7C99D4FC3868 |
| Fixed UUID v7 | 019dffbb-f000-73ef-8c05-e767843d0e66 |
| Canonical name | date_trunc(part,timestamp[,timezone]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-121B43143F93 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7C99D4FC3868 |
