# SBSQL-07F31F7E4962 — percentile_disc(fraction)WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-07F31F7E4962 |
| Fixed UUID v7 | 019dffbb-f000-7b20-9f06-318751187df1 |
| Canonical name | percentile_disc(fraction)WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-19A129404AD5 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-07F31F7E4962 |
