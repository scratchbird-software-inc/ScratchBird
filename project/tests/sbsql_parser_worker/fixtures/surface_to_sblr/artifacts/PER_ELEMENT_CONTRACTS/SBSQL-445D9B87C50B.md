# SBSQL-445D9B87C50B — cypher_range_spec
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-445D9B87C50B |
| Fixed UUID v7 | 019dffbb-f000-71d1-820f-3849a4f8326d |
| Canonical name | cypher_range_spec |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-83704AAA80C0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-445D9B87C50B |
