# SBSQL-044636D5F226 — pipeline_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-044636D5F226 |
| Fixed UUID v7 | 019dffbb-f000-70df-aac8-c383f762ec2f |
| Canonical name | pipeline_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-428E20B9AB9C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-044636D5F226 |
