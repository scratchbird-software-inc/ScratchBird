...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BAF3A91528AA |
| Fixed UUID v7 | 019dffbb-f000-7585-9447-d590d4168c1c |
| Canonical name | sb.window.row_number |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-883877AD5D1C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BAF3A91528AA |
