# SBSQL-12D9D5393953 — has_table_privilege
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-12D9D5393953 |
| Fixed UUID v7 | 019dffbb-f000-7da2-9e38-d4654d06dc78 |
| Canonical name | has_table_privilege |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E66715809A61 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-12D9D5393953 |
