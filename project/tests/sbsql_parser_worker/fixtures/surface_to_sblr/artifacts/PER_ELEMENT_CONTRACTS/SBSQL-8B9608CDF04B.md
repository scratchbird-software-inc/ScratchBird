...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8B9608CDF04B |
| Fixed UUID v7 | 019dffbb-f000-7e4c-a693-39bb6632d887 |
| Canonical name | sb.aggregate.string_agg |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A059DB1A2ADE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8B9608CDF04B |
