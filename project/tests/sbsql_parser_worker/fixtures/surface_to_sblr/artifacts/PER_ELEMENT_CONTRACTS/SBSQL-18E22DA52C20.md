# SBSQL-18E22DA52C20 — WITH(READPAST)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-18E22DA52C20 |
| Fixed UUID v7 | 019dffbb-f000-7626-9ba7-6b9ab0b3d18a |
| Canonical name | WITH(READPAST) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5B4CAE13A8A0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-18E22DA52C20 |
