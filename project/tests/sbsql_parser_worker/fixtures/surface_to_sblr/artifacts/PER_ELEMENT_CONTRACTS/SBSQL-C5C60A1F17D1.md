# SBSQL-C5C60A1F17D1 — unquoted_identifier_case_rule
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C5C60A1F17D1 |
| Fixed UUID v7 | 019dffbb-f000-75c8-8f4a-c71a77d00b82 |
| Canonical name | unquoted_identifier_case_rule |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A3FC3F1B5849 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C5C60A1F17D1 |
