# SBSQL-F87CEF07BC0E — topology_assign
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F87CEF07BC0E |
| Fixed UUID v7 | 019dffbb-f000-7b7e-b5c7-d8e698feb592 |
| Canonical name | topology_assign |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F38E3755B3D6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F87CEF07BC0E |
