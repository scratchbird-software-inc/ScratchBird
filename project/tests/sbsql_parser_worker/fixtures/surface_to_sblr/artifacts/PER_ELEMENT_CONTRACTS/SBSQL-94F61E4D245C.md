# SBSQL-94F61E4D245C — rowset_to_array(rowset)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-94F61E4D245C |
| Fixed UUID v7 | 019dffbb-f000-76ed-b254-f3c61dff3ed5 |
| Canonical name | rowset_to_array(rowset) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C38C55917EDE |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-94F61E4D245C |
