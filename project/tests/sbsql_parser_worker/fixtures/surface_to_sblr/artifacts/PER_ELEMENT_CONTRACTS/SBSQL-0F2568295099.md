...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0F2568295099 |
| Fixed UUID v7 | 019dffbb-f000-7ae1-88fd-d0e4a50832b4 |
| Canonical name | AS |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BD27E22C4246 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0F2568295099 |
