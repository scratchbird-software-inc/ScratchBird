# SBSQL-A0A8A427C5EC — regexp_count
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A0A8A427C5EC |
| Fixed UUID v7 | 019dffbb-f000-739b-b315-f6ecf36919ef |
| Canonical name | regexp_count |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-258472CB73A2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A0A8A427C5EC |
