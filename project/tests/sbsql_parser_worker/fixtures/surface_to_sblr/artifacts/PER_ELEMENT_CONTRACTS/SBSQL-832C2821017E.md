# SBSQL-832C2821017E — psql_while_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-832C2821017E |
| Fixed UUID v7 | 019dffbb-f000-79ef-80eb-a6312ba385e4 |
| Canonical name | psql_while_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6636B4BAFFDA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-832C2821017E |
