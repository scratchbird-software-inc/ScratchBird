...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3666F7699C5E |
| Fixed UUID v7 | 019dffbb-f000-7b6f-a7af-f28c7afcd961 |
| Canonical name | WHEN |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-25154B0C4083 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3666F7699C5E |
