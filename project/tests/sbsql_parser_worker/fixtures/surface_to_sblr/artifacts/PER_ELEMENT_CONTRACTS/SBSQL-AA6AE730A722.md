# SBSQL-AA6AE730A722 — first_value(expr)OVER(...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AA6AE730A722 |
| Fixed UUID v7 | 019dffbb-f000-7a24-88c2-7af41495fa3d |
| Canonical name | first_value(expr)OVER(...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FAC54A416DD5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AA6AE730A722 |
