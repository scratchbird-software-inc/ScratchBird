# SBSQL-7A5C9806BEF5 — descriptor_of(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7A5C9806BEF5 |
| Fixed UUID v7 | 019dffbb-f000-771c-be47-e4785800442b |
| Canonical name | descriptor_of(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EC36538F0D0B |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7A5C9806BEF5 |
