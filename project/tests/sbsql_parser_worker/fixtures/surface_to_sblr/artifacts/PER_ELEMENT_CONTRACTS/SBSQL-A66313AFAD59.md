# SBSQL-A66313AFAD59 — months_between(date,date)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A66313AFAD59 |
| Fixed UUID v7 | 019dffbb-f000-7a12-99f9-4ffc41939d3a |
| Canonical name | months_between(date,date) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D3FCC981C9FC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A66313AFAD59 |
