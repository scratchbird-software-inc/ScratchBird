# SBSQL-F985930BDD2F — st_geogfromtext(wkt)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F985930BDD2F |
| Fixed UUID v7 | 019dffbb-f000-772d-b5a3-21f9515c7e21 |
| Canonical name | st_geogfromtext(wkt) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-984AF7A43D7E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F985930BDD2F |
