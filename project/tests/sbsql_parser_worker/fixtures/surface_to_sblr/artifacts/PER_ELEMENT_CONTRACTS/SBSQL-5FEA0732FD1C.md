# SBSQL-5FEA0732FD1C — alter_cluster_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5FEA0732FD1C |
| Fixed UUID v7 | 019dffbb-f000-7a41-b810-bf60f1064a50 |
| Canonical name | alter_cluster_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EB293F6BFC85 |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-5FEA0732FD1C |
