# SBSQL-3E3527E30D5F — pg_typeof(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3E3527E30D5F |
| Fixed UUID v7 | 019dffbb-f000-7cb0-b2f5-a595c15c99a9 |
| Canonical name | pg_typeof(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-81C05D66E3E9 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-3E3527E30D5F |
