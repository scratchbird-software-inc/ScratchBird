# SBSQL-6FB5567A4945 — regexp_replace(string,pattern,replacement[,flags])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6FB5567A4945 |
| Fixed UUID v7 | 019dffbb-f000-7a3a-8876-e14a67ff86f9 |
| Canonical name | regexp_replace(string,pattern,replacement[,flags]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C3A156CDDBAE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6FB5567A4945 |
