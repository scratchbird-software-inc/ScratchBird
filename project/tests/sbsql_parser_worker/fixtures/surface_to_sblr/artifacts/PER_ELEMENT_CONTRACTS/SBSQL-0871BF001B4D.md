# SBSQL-0871BF001B4D — grantee_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0871BF001B4D |
| Fixed UUID v7 | 019dffbb-f000-709d-afce-f7192aff6d7c |
| Canonical name | grantee_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5331D6609BBC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0871BF001B4D |
