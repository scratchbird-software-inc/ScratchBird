# SBSQL-185F244A9CA1 — ltrim(text[,chars])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-185F244A9CA1 |
| Fixed UUID v7 | 019dffbb-f000-783e-8def-d1b62217de90 |
| Canonical name | ltrim(text[,chars]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-223CE435F4FC |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-185F244A9CA1 |
