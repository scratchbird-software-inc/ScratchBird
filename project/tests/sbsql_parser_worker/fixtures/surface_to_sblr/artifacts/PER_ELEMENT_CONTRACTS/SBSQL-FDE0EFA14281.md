# SBSQL-FDE0EFA14281 — bridge_cancel
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FDE0EFA14281 |
| Fixed UUID v7 | 019e14c1-d61b-78ca-8f12-f5a2cd10b55b |
| Canonical name | bridge_cancel |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FDE0EFA14281 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FDE0EFA14281 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_CANCEL, UDR operation cancel, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
