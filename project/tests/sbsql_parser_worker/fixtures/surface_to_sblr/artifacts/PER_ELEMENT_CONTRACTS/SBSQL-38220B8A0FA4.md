# SBSQL-38220B8A0FA4 — tag_options
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-38220B8A0FA4 |
| Fixed UUID v7 | 019dffbb-f000-7f71-9ce5-d16718ff8c78 |
| Canonical name | tag_options |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F34EC15326AA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-38220B8A0FA4 |
