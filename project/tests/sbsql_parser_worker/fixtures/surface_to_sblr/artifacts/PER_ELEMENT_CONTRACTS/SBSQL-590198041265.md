# SBSQL-590198041265 — has_function_privilege
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-590198041265 |
| Fixed UUID v7 | 019dffbb-f000-7e3a-a0b9-7c75989b7e24 |
| Canonical name | has_function_privilege |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0C5139C929BD |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-590198041265 |
