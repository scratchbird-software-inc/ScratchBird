...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BDC2B64DA2A9 |
| Fixed UUID v7 | 019dffbb-f000-7d6e-b0c5-c7f41af12ce0 |
| Canonical name | copy_endpoint |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3E4A9E8BADBF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BDC2B64DA2A9 |
