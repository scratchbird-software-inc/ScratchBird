# SBSQL-9F9A118F5BCC — sha384(text\|binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9F9A118F5BCC |
| Fixed UUID v7 | 019dffbb-f000-77dc-967b-766b4e232cd6 |
| Canonical name | sha384(text\\\|binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-40B968F88897 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9F9A118F5BCC |
