# SBSQL-B7E217B24869 — xml_exists_form
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B7E217B24869 |
| Fixed UUID v7 | 019dffbb-f000-7528-9ccc-5bca52aa7557 |
| Canonical name | xml_exists_form |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7D403804666F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B7E217B24869 |
