...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-333906CB50B9 |
| Fixed UUID v7 | 019dffbb-f000-748d-902f-4c382da1b5c4 |
| Canonical name | blake2b |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1BF7FEDFF4C9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-333906CB50B9 |
