...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-82082E76658A |
| Fixed UUID v7 | 019dffbb-f000-7fa3-948e-60beef6fd787 |
| Canonical name | SYS_CONTEXT('USERENV','CLIENT_INFO') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-99C60C5930EF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-82082E76658A |
