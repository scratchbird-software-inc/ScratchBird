# SBSQL-91D6ECC8969F — signal_target
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-91D6ECC8969F |
| Fixed UUID v7 | 019dffbb-f000-71d8-aff0-fe7991264560 |
| Canonical name | signal_target |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2BCACE6B2A7C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-91D6ECC8969F |
