# SBSQL-A32440FF2F9A — translate(string,from,to)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A32440FF2F9A |
| Fixed UUID v7 | 019dffbb-f000-72cf-bd40-d992df88d58f |
| Canonical name | translate(string,from,to) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-40852EA4EF71 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A32440FF2F9A |
