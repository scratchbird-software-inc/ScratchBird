# SBSQL-7D4D1330D89C — ttl_table_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7D4D1330D89C |
| Fixed UUID v7 | 019dffbb-f000-73db-8a60-347148a13a93 |
| Canonical name | ttl_table_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-286961FEC05A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7D4D1330D89C |
