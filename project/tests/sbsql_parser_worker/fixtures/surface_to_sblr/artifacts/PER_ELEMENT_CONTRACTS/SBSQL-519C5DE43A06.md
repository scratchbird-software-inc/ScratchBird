# SBSQL-519C5DE43A06 — bit_clear(int,position)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-519C5DE43A06 |
| Fixed UUID v7 | 019dffbb-f000-7728-8d75-1f389e88e9ba |
| Canonical name | bit_clear(int,position) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5AECA1DCFFC3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-519C5DE43A06 |
