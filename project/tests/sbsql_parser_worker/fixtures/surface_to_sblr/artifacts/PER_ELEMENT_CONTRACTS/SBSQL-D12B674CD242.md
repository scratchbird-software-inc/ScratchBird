# SBSQL-D12B674CD242 — cypher_use_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D12B674CD242 |
| Fixed UUID v7 | 019dffbb-f000-745c-8f90-51399aafcf6b |
| Canonical name | cypher_use_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BCD74FB64A8B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D12B674CD242 |
