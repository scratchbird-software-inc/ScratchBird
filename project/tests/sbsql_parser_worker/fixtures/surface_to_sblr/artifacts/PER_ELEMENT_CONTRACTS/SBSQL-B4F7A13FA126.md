# SBSQL-B4F7A13FA126 — make_timestamptz
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B4F7A13FA126 |
| Fixed UUID v7 | 019dffbb-f000-70b8-b32a-9b6ede7cb26d |
| Canonical name | make_timestamptz |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-08FC69549AD6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B4F7A13FA126 |
