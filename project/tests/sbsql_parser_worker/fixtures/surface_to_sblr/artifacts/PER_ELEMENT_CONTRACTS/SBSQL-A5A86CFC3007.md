...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A5A86CFC3007 |
| Fixed UUID v7 | 019dffbb-f000-7ec0-8de7-65ba686a881a |
| Canonical name | date_part(part,timestamp\\\|interval) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BA7E016F7C84 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A5A86CFC3007 |
