# SBSQL-A2B087795B49 — to_ascii(text[,encoding])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A2B087795B49 |
| Fixed UUID v7 | 019dffbb-f000-7d47-94d9-efa5c0b80fe9 |
| Canonical name | to_ascii(text[,encoding]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4DAB8042FC87 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A2B087795B49 |
