...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6986B26AD56B |
| Fixed UUID v7 | 019dffbb-f000-7e70-9853-2b849a36b908 |
| Canonical name | to_real |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6E19A2F5EAE7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6986B26AD56B |
