# SBSQL-A5AA36E99CDB — psql_return_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A5AA36E99CDB |
| Fixed UUID v7 | 019dffbb-f000-739b-94d2-7362cd7380d5 |
| Canonical name | psql_return_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-69901DFABFD9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A5AA36E99CDB |
