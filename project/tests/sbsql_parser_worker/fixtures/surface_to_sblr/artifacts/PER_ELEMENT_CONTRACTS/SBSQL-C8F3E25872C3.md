...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C8F3E25872C3 |
| Fixed UUID v7 | 019dffbb-f000-755c-ab38-c28168cb542d |
| Canonical name | sum |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0933316D2C1F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C8F3E25872C3 |
