# SBSQL-38EE3D5E1400 — generate_series(start,stop[,step])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-38EE3D5E1400 |
| Fixed UUID v7 | 019dffbb-f000-7e79-8215-e373970bf80d |
| Canonical name | generate_series(start,stop[,step]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CC65A187DECF |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-38EE3D5E1400 |
