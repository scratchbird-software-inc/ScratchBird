...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D97C1EA0B5FC |
| Fixed UUID v7 | 019dffbb-f000-781b-b634-a1dcb0f5f020 |
| Canonical name | kv_list_verb |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CFACAB01CDAF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D97C1EA0B5FC |
