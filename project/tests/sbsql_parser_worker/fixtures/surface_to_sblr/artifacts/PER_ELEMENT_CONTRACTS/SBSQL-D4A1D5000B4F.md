# SBSQL-D4A1D5000B4F — cypher_rel_detail
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D4A1D5000B4F |
| Fixed UUID v7 | 019dffbb-f000-75a1-9a22-cd3207884eb0 |
| Canonical name | cypher_rel_detail |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-570FEAC9D658 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D4A1D5000B4F |
