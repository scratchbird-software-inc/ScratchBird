# SBSQL-0EC8CCC1D528 — degrees(radians)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0EC8CCC1D528 |
| Fixed UUID v7 | 019dffbb-f000-7c24-b4a2-440eff14f969 |
| Canonical name | degrees(radians) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0E69A9B22467 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0EC8CCC1D528 |
