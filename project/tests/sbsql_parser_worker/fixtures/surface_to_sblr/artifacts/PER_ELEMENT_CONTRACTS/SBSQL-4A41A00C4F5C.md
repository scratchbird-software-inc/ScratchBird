...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4A41A00C4F5C |
| Fixed UUID v7 | 019dffbb-f000-7e25-87fc-d93dad51347b |
| Canonical name | psql_open_cursor_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0FCAA9E192EF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4A41A00C4F5C |
