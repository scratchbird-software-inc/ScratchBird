...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-594209C32142 |
| Fixed UUID v7 | 019dffbb-f000-7bdd-a415-cb30879033df |
| Canonical name | RDB$GET_CONTEXT('SYSTEM','ENGINE_VERSION') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A739721F7F38 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-594209C32142 |
