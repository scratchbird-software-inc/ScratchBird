# SBSQL-482B2C54BAF1 — variance_samp(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-482B2C54BAF1 |
| Fixed UUID v7 | 019dffbb-f000-7389-a3cc-9489a1a0b8b7 |
| Canonical name | variance_samp(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-733AFBB2539B |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-482B2C54BAF1 |
