# SBSQL-3AF5139D4E9A — existing_window_name
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3AF5139D4E9A |
| Fixed UUID v7 | 019dffbb-f000-7efc-8c04-9508187f36d2 |
| Canonical name | existing_window_name |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D61878A9F5C9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-3AF5139D4E9A |
