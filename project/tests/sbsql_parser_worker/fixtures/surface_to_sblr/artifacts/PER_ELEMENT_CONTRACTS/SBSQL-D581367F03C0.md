# SBSQL-D581367F03C0 — avg([DISTINCT]expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D581367F03C0 |
| Fixed UUID v7 | 019dffbb-f000-714a-8894-657c487ffab2 |
| Canonical name | avg([DISTINCT]expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C8EE5C26C487 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D581367F03C0 |
