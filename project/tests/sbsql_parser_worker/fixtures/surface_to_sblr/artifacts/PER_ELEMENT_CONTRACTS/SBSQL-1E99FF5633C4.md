# SBSQL-1E99FF5633C4 — row_to_json(row[,pretty])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1E99FF5633C4 |
| Fixed UUID v7 | 019dffbb-f000-7fa4-b2cb-6f2c606dd338 |
| Canonical name | row_to_json(row[,pretty]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AD2EDA1D40F3 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-1E99FF5633C4 |
