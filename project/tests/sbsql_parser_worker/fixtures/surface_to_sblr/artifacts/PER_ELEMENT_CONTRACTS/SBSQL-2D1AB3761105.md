# SBSQL-2D1AB3761105 — txid_status(bigint)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2D1AB3761105 |
| Fixed UUID v7 | 019dffbb-f000-7eef-a616-3b635cdb0812 |
| Canonical name | txid_status(bigint) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-417381A801FA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-2D1AB3761105 |
