# SBSQL-FDBD9AF96128 — subpartition_spec_list
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FDBD9AF96128 |
| Fixed UUID v7 | 019dffbb-f000-79fc-a973-9518316a88c1 |
| Canonical name | subpartition_spec_list |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-91DC5A5B0520 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FDBD9AF96128 |
