# SBSQL-95F889B45A61 — bridge_cdc_start
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-95F889B45A61 |
| Fixed UUID v7 | 019e14c1-d4c4-74f3-85c0-1e327eac5b61 |
| Canonical name | bridge_cdc_start |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-95F889B45A61 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-95F889B45A61 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_CDC_START, UDR operation cdc_start, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
