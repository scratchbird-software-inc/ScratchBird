# SBSQL-272C2607CD1A — unpivot_value_columns
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-272C2607CD1A |
| Fixed UUID v7 | 019dffbb-f000-74bc-a9c5-072d0e1673f6 |
| Canonical name | unpivot_value_columns |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-110C2B448EEF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-272C2607CD1A |
