# SBSQL-09A8779C83D6 — set_constraints_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-09A8779C83D6 |
| Fixed UUID v7 | 019dffbb-f000-7809-9faf-c10db6735cac |
| Canonical name | set_constraints_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C888A1931F68 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-09A8779C83D6 |
