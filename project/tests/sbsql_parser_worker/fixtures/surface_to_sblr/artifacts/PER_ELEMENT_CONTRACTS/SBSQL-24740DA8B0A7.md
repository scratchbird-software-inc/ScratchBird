...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-24740DA8B0A7 |
| Fixed UUID v7 | 019dffbb-f000-7e5d-8a9a-1d72a8d8cbff |
| Canonical name | sqrt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4EE9E132C517 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-24740DA8B0A7 |
