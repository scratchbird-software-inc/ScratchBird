# SBSQL-C58C9A48AB7D — json_on_empty_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C58C9A48AB7D |
| Fixed UUID v7 | 019dffbb-f000-75dd-b9c2-e564c578f44f |
| Canonical name | json_on_empty_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-11AB51D380BF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C58C9A48AB7D |
