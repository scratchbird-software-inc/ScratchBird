# SBSQL-B1DCA7AA5204 — additive_expr
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B1DCA7AA5204 |
| Fixed UUID v7 | 019dffbb-f000-7f22-a221-2183b20d65b2 |
| Canonical name | additive_expr |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F643727ECE44 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B1DCA7AA5204 |
