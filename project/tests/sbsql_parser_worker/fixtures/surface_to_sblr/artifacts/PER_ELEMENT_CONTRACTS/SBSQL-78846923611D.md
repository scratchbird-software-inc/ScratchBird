# SBSQL-78846923611D — st_geomfromwkb
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-78846923611D |
| Fixed UUID v7 | 019dffbb-f000-76ee-a6f7-dcfc7057e7e9 |
| Canonical name | st_geomfromwkb |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-629BE1EFB9A6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-78846923611D |
