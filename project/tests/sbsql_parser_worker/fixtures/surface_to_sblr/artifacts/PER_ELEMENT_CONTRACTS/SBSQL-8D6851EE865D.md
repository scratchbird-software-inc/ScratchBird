# SBSQL-8D6851EE865D — move_options
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8D6851EE865D |
| Fixed UUID v7 | 019dffbb-f000-74f0-b201-68a12175b671 |
| Canonical name | move_options |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3D6AB828922D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8D6851EE865D |
