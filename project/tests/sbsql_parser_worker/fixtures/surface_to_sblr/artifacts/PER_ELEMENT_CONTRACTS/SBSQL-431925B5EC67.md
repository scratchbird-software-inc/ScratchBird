# SBSQL-431925B5EC67 — regr_intercept
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-431925B5EC67 |
| Fixed UUID v7 | 019dffbb-f000-7c7c-b576-d67ea9d4bcbb |
| Canonical name | regr_intercept |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-681029A5B4A1 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-431925B5EC67 |
