# SBSQL-A742FEA707AC — dmetaphone_alt(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A742FEA707AC |
| Fixed UUID v7 | 019dffbb-f000-74a2-8a2c-7324183e80a4 |
| Canonical name | dmetaphone_alt(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7E98F41B2AD6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A742FEA707AC |
