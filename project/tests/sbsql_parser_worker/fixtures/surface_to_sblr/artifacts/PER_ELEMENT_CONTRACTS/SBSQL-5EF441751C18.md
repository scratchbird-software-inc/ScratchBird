# SBSQL-5EF441751C18 — render_contract_name
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5EF441751C18 |
| Fixed UUID v7 | 019dffbb-f000-70cf-af72-f4cbd318397a |
| Canonical name | render_contract_name |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-46A4C1CC22F2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5EF441751C18 |
