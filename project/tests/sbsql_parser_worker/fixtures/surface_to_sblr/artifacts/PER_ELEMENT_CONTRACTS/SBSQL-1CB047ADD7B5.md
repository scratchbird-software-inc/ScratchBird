# SBSQL-1CB047ADD7B5 — WITH(NOLOCK)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1CB047ADD7B5 |
| Fixed UUID v7 | 019dffbb-f000-78a4-97c2-202b542843a1 |
| Canonical name | WITH(NOLOCK) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E502E0E25345 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1CB047ADD7B5 |
