# SBSQL-4146FCAB1413 — json_predicate_modifier
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4146FCAB1413 |
| Fixed UUID v7 | 019dffbb-f000-7b1e-9b9d-3ea55ae7c859 |
| Canonical name | json_predicate_modifier |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BE67CA8A8E9D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4146FCAB1413 |
