# SBSQL-C549A9F3CF89 — client_address
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C549A9F3CF89 |
| Fixed UUID v7 | 019dffbb-f000-793a-a06d-8ea91e73caac |
| Canonical name | client_address |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ED421893006D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C549A9F3CF89 |
