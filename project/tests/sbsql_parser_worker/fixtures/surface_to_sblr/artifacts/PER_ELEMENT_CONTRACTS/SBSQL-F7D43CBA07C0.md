...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F7D43CBA07C0 |
| Fixed UUID v7 | 019dffbb-f000-785d-944f-5eb843f26062 |
| Canonical name | ascii |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CAE5946D40CF |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F7D43CBA07C0 |
