...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DE72B3463556 |
| Fixed UUID v7 | 019dffbb-f000-7afb-8d5f-8a125d37d1a4 |
| Canonical name | sb.temporal.current_time |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D616B1DC4724 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DE72B3463556 |
