# SBSQL-7AA44FB9077C — json_set(document,path,value)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7AA44FB9077C |
| Fixed UUID v7 | 019dffbb-f000-7a94-b13a-3fd6b3642a5a |
| Canonical name | json_set(document,path,value) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6C2B5D893071 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7AA44FB9077C |
