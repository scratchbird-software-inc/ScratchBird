# SBSQL-DCB17997FCA9 — stream_close(stream)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DCB17997FCA9 |
| Fixed UUID v7 | 019dffbb-f000-76de-b04f-9b6dd483a492 |
| Canonical name | stream_close(stream) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ACA7971398EC |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DCB17997FCA9 |
