# SBSQL-B09433FF3AB3 — json_object_agg(key,value)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B09433FF3AB3 |
| Fixed UUID v7 | 019dffbb-f000-7250-acd0-a2a8c481a908 |
| Canonical name | json_object_agg(key,value) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BBEAF28FAFDA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B09433FF3AB3 |
