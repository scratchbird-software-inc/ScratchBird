# SBSQL-1342A8B02022 — json_exists(document,jsonpath)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1342A8B02022 |
| Fixed UUID v7 | 019dffbb-f000-747b-9923-a9f8765812a9 |
| Canonical name | json_exists(document,jsonpath) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C8CFABCCE440 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-1342A8B02022 |
