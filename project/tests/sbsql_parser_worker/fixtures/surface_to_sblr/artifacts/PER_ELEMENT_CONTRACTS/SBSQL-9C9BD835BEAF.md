# SBSQL-9C9BD835BEAF — regr_syy(y,x)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9C9BD835BEAF |
| Fixed UUID v7 | 019dffbb-f000-7d53-a7f7-84a3c8dccd16 |
| Canonical name | regr_syy(y,x) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9201121B60BA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-9C9BD835BEAF |
