...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-73AAF62A5CC3 |
| Fixed UUID v7 | 019dffbb-f000-7f4f-9128-6b1fe451ae37 |
| Canonical name | SYS_CONTEXT('USERENV',name) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3E79FE63BCB2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-73AAF62A5CC3 |
