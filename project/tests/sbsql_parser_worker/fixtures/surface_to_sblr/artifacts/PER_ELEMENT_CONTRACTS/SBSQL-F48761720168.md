# SBSQL-F48761720168 — XMLPARSE(DOCUMENT|CONTENTexpr[PRESERVE|STRIPWHITESPACE])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F48761720168 |
| Fixed UUID v7 | 019dffbb-f000-71d9-9564-45dd70e370b6 |
| Canonical name | XMLPARSE(DOCUMENT\|CONTENTexpr[PRESERVE\|STRIPWHITESPACE]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4CC92A958489 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F48761720168 |
