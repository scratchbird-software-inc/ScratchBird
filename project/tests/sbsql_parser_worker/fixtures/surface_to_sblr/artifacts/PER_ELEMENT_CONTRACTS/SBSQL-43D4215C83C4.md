# SBSQL-43D4215C83C4 — subpartition_spec
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-43D4215C83C4 |
| Fixed UUID v7 | 019dffbb-f000-728c-b707-d9d40668f44e |
| Canonical name | subpartition_spec |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9F66820AF4D5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-43D4215C83C4 |
