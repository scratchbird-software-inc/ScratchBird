# SBSQL-34B32A5FF887 — st_transform(geometry,target_srid)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-34B32A5FF887 |
| Fixed UUID v7 | 019dffbb-f000-717b-b421-4f72a9d57a45 |
| Canonical name | st_transform(geometry,target_srid) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E9B4C7D170DB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-34B32A5FF887 |
