# SBSQL-38FDC3F10237 — cursor_close(cursor)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-38FDC3F10237 |
| Fixed UUID v7 | 019dffbb-f000-749a-ac45-e704d783ebb4 |
| Canonical name | cursor_close(cursor) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D461574A46D1 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-38FDC3F10237 |
