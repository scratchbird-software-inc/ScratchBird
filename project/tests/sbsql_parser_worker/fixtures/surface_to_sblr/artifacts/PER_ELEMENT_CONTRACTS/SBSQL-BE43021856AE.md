# SBSQL-BE43021856AE — regr_r2(y,x)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BE43021856AE |
| Fixed UUID v7 | 019dffbb-f000-7682-abac-7fad190f1efa |
| Canonical name | regr_r2(y,x) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A7D44CCD1E64 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BE43021856AE |
