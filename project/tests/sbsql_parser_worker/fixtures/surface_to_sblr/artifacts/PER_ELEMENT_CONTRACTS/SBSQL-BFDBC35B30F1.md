# SBSQL-BFDBC35B30F1 — placement_policy_name
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BFDBC35B30F1 |
| Fixed UUID v7 | 019dffbb-f000-79c4-b63f-5b32ed0916d9 |
| Canonical name | placement_policy_name |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-785A1A525E66 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BFDBC35B30F1 |
