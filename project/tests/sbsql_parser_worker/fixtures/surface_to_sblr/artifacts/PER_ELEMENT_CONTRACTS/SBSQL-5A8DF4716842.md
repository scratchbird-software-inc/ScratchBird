# SBSQL-5A8DF4716842 — bridge_stream_write
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5A8DF4716842 |
| Fixed UUID v7 | 019e14c1-c5c8-784f-8812-fa7a0db7f6f1 |
| Canonical name | bridge_stream_write |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5A8DF4716842 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5A8DF4716842 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_STREAM_WRITE, UDR operation stream_write, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
