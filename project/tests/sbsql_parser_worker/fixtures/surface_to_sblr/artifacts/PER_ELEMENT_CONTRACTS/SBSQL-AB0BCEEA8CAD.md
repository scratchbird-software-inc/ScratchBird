# SBSQL-AB0BCEEA8CAD — string_truncation_behavior
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AB0BCEEA8CAD |
| Fixed UUID v7 | 019dffbb-f000-7947-9f3f-e7caf34a05ee |
| Canonical name | string_truncation_behavior |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DF9DAB2A99A9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AB0BCEEA8CAD |
