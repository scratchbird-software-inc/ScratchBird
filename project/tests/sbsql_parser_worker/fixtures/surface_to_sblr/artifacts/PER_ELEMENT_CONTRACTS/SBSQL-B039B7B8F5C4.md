# SBSQL-B039B7B8F5C4 — drop_schedule_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B039B7B8F5C4 |
| Fixed UUID v7 | 019dffbb-f000-7cbd-8031-96afd3ab3e3a |
| Canonical name | drop_schedule_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C8BCA99713C9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B039B7B8F5C4 |
