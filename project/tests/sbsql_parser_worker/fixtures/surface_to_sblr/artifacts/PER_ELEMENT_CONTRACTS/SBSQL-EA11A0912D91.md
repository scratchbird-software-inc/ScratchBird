# SBSQL-EA11A0912D91 — SUBSTRING_REGEX(patternINstring[OCCURRENCEn][GROUPg][FLAGflags])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EA11A0912D91 |
| Fixed UUID v7 | 019dffbb-f000-7d05-ac02-983edaf4e41a |
| Canonical name | SUBSTRING_REGEX(patternINstring[OCCURRENCEn][GROUPg][FLAGflags]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-219F962BFBEB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EA11A0912D91 |
