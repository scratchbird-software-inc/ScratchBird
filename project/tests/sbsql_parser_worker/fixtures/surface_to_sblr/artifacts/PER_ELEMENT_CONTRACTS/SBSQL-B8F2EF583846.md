...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B8F2EF583846 |
| Fixed UUID v7 | 019dffbb-f000-7a95-b411-9a165704e0aa |
| Canonical name | SYS_CONTEXT('USERENV','SESSIONID') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8D6A917A40E4 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B8F2EF583846 |
