# SBSQL-D5E167A4984B — lob_append(locator,data)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D5E167A4984B |
| Fixed UUID v7 | 019dffbb-f000-7b2c-b668-ec7eb6bc31b8 |
| Canonical name | lob_append(locator,data) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BA8A5F3EFD31 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D5E167A4984B |
