# SBSQL-6860D73D6667 — f(name=>value)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6860D73D6667 |
| Fixed UUID v7 | 019dffbb-f000-7603-9058-232917e033b9 |
| Canonical name | f(name=>value) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-732BA5909AEF |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6860D73D6667 |
