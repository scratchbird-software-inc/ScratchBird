# SBSQL-A339D846AD19 — current_row_locator(cursor)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A339D846AD19 |
| Fixed UUID v7 | 019dffbb-f000-70a0-ae1b-b1c57c9b32e7 |
| Canonical name | current_row_locator(cursor) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-56EA535FAAC4 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A339D846AD19 |
