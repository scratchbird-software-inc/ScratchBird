# SBSQL-B8EBE8DBD77E — sha1(text\|binary)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B8EBE8DBD77E |
| Fixed UUID v7 | 019dffbb-f000-749b-8efc-c91273675b41 |
| Canonical name | sha1(text\\\|binary) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-697C946BE289 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-B8EBE8DBD77E |
