# SBSQL-832A8A3D2913 — subscription_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-832A8A3D2913 |
| Fixed UUID v7 | 019dffbb-f000-739a-86dc-591911f0ebfe |
| Canonical name | subscription_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-84AC75E4F879 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-832A8A3D2913 |
