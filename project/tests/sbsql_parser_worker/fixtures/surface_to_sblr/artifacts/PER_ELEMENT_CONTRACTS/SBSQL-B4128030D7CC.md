# SBSQL-B4128030D7CC — array_constructor
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B4128030D7CC |
| Fixed UUID v7 | 019dffbb-f000-7ea6-baee-943233ecbbba |
| Canonical name | array_constructor |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-296D65844C1B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B4128030D7CC |
