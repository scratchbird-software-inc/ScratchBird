...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C55F7ADBD13B |
| Fixed UUID v7 | 019dffbb-f000-7655-ae18-a53f11c240f5 |
| Canonical name | jsonb_set |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2952A849335C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C55F7ADBD13B |
