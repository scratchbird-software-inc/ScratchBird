# SBSQL-C90BA4944E6D — substr(text,start[,length])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C90BA4944E6D |
| Fixed UUID v7 | 019dffbb-f000-7916-bd79-729df046ed76 |
| Canonical name | substr(text,start[,length]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D8BA0408FA19 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C90BA4944E6D |
