# SBSQL-CFBAFFF843B6 — reference_profile_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CFBAFFF843B6 |
| Fixed UUID v7 | 019dffbb-f000-7d1d-9324-3553576df84e |
| Canonical name | reference_profile_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8AD7049B8D6E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CFBAFFF843B6 |
