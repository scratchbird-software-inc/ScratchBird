# SBSQL-0D13739AA895 — make_timestamp(year,month,day,hour,minute,second)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0D13739AA895 |
| Fixed UUID v7 | 019dffbb-f000-7acb-a5ff-8635e8c4c7ae |
| Canonical name | make_timestamp(year,month,day,hour,minute,second) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-549C913F8AB5 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0D13739AA895 |
