# SBSQL-4B6E0DFBB334 — with_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4B6E0DFBB334 |
| Fixed UUID v7 | 019dffbb-f000-7ae6-96a6-25fe77a1a2e5 |
| Canonical name | with_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E484A658F166 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4B6E0DFBB334 |
