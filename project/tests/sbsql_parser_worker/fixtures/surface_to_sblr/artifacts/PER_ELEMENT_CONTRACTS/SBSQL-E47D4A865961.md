# SBSQL-E47D4A865961 — cluster_node_uuid
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E47D4A865961 |
| Fixed UUID v7 | 019dffbb-f000-70a8-a054-11d142ac3a99 |
| Canonical name | cluster_node_uuid |
...
| Closure action | promote_to_cluster_private_provider_gate |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2108EC21B92E |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-E47D4A865961 |
