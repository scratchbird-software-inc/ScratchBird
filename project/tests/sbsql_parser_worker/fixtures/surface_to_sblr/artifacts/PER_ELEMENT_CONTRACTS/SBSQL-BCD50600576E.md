...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BCD50600576E |
| Fixed UUID v7 | 019dffbb-f000-7ecc-bbe7-21a395c033bd |
| Canonical name | to_hex |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EF8EC1763EFA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BCD50600576E |
