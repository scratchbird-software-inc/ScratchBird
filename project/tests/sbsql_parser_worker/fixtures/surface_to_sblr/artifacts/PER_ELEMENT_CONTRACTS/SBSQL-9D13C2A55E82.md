# SBSQL-9D13C2A55E82 — levenshtein(text,text[,ins,del,sub])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9D13C2A55E82 |
| Fixed UUID v7 | 019dffbb-f000-7d14-98df-59481bcbc9c6 |
| Canonical name | levenshtein(text,text[,ins,del,sub]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7CE6532D80AF |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-9D13C2A55E82 |
