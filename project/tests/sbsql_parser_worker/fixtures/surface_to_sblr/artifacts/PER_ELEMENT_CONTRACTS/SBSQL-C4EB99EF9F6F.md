# SBSQL-C4EB99EF9F6F — cursor_position(cursor)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C4EB99EF9F6F |
| Fixed UUID v7 | 019dffbb-f000-7d69-aff4-a50027be1d96 |
| Canonical name | cursor_position(cursor) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AD50046F41AC |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C4EB99EF9F6F |
