# SBSQL-FBF867953952 — metaphone(text[,max_length])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FBF867953952 |
| Fixed UUID v7 | 019dffbb-f000-7488-9596-7f9e0f7e79e2 |
| Canonical name | metaphone(text[,max_length]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B946768E3B1D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-FBF867953952 |
