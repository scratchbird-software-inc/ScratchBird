# SBSQL-4064D6205441 — gen_id(generator_name,increment)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4064D6205441 |
| Fixed UUID v7 | 019dffbb-f000-7187-a5eb-5f12ed5edd1c |
| Canonical name | gen_id(generator_name,increment) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2EBD1C83A790 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4064D6205441 |
