# SBSQL-8C986B530E74 — to_bigint(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-8C986B530E74 |
| Fixed UUID v7 | 019dffbb-f000-7f63-b71d-93cc4be5c405 |
| Canonical name | to_bigint(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5AE8D0A46E7D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-8C986B530E74 |
