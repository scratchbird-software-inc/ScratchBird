# SBSQL-F0DD223B3820 — CURRENT_TIMESTAMP
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F0DD223B3820 |
| Fixed UUID v7 | 019dffbb-f000-7ebb-a4ca-124c46bcbebc |
| Canonical name | CURRENT_TIMESTAMP |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-665BBA70D90A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F0DD223B3820 |
