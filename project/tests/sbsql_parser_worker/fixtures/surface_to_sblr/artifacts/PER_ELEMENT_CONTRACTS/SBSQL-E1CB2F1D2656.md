# SBSQL-E1CB2F1D2656 — catalog_object_class
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E1CB2F1D2656 |
| Fixed UUID v7 | 019dffbb-f000-76d1-878a-531764cdd04b |
| Canonical name | catalog_object_class |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-9D35B4BE9BF6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-E1CB2F1D2656 |
