# SBSQL-A4A957234B3D — management_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A4A957234B3D |
| Fixed UUID v7 | 019dffbb-f000-70d6-8828-4b4ca225aaff |
| Canonical name | management_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-67549174EB7E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A4A957234B3D |
