# SBSQL-A5103C6736BE — hash_field_value
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A5103C6736BE |
| Fixed UUID v7 | 019dffbb-f000-7dde-8468-1c1217150b80 |
| Canonical name | hash_field_value |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6D7BA0C62240 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A5103C6736BE |
