...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C9546F1DBAB1 |
| Fixed UUID v7 | 019dffbb-f000-7901-84e3-20ec852e69f3 |
| Canonical name | tan(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8DD09D5168C1 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C9546F1DBAB1 |
