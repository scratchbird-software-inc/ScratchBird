# SBSQL-52B83E6B1FF1 — current_setting('autocommit')
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-52B83E6B1FF1 |
| Fixed UUID v7 | 019dffbb-f000-7b96-80d6-add4b52d3f8f |
| Canonical name | current_setting('autocommit') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DCC689D4658F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-52B83E6B1FF1 |
