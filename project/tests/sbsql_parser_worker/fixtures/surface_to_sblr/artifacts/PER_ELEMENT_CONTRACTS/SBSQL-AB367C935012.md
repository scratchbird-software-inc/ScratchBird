# SBSQL-AB367C935012 — SUBSTRING_REGEX
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AB367C935012 |
| Fixed UUID v7 | 019dffbb-f000-7485-8ae8-900e757d3f67 |
| Canonical name | SUBSTRING_REGEX |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-96E05FCEDBFB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AB367C935012 |
