# SBSQL-190A9409E3F9 — age(timestamp[,timestamp])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-190A9409E3F9 |
| Fixed UUID v7 | 019dffbb-f000-75fd-80e2-fe968f701617 |
| Canonical name | age(timestamp[,timestamp]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2DFBC11B8D7D |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-190A9409E3F9 |
