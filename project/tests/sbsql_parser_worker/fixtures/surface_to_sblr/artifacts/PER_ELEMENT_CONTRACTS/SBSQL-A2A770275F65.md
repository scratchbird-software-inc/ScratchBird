# SBSQL-A2A770275F65 — show_trgm(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A2A770275F65 |
| Fixed UUID v7 | 019dffbb-f000-7475-854c-0509de5f8c96 |
| Canonical name | show_trgm(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4AEFE0320C39 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A2A770275F65 |
