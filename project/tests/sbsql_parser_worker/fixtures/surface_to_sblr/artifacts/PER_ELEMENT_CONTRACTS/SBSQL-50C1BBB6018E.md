# SBSQL-50C1BBB6018E — rowset_size(rowset)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-50C1BBB6018E |
| Fixed UUID v7 | 019dffbb-f000-713e-a9e7-03674521e6c9 |
| Canonical name | rowset_size(rowset) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0EA0CE1F7664 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-50C1BBB6018E |
