# SBSQL-C1D95CE89815 — default_charset
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C1D95CE89815 |
| Fixed UUID v7 | 019dffbb-f000-7081-b6ba-548ddc5e3f55 |
| Canonical name | default_charset |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B8983890D811 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C1D95CE89815 |
