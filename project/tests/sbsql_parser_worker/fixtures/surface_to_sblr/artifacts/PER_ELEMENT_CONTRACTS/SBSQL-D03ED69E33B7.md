...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D03ED69E33B7 |
| Fixed UUID v7 | 019dffbb-f000-761a-9f4d-ebdc4604f3d7 |
| Canonical name | collect |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FCECD19B4D78 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D03ED69E33B7 |
