# SBSQL-9A9A1995FC1E — admission_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9A9A1995FC1E |
| Fixed UUID v7 | 019dffbb-f000-71f8-88c3-80abd14e80c2 |
| Canonical name | admission_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A60E985E1819 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9A9A1995FC1E |
