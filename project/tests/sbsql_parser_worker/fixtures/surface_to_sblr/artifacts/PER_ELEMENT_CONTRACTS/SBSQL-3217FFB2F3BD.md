# SBSQL-3217FFB2F3BD — json_build_object(k1,v1,...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3217FFB2F3BD |
| Fixed UUID v7 | 019dffbb-f000-7700-81e4-5696c012f5af |
| Canonical name | json_build_object(k1,v1,...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F121A72591EA |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-3217FFB2F3BD |
