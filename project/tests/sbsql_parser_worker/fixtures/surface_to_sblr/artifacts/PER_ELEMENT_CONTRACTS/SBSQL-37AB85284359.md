# SBSQL-37AB85284359 — id_continue
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-37AB85284359 |
| Fixed UUID v7 | 019dffbb-f000-7098-b08c-dfebffbe033b |
| Canonical name | id_continue |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E32C4B7A2C3D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-37AB85284359 |
