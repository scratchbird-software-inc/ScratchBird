# SBSQL-D13340E9CF67 — regexp_matches(string,pattern[,flags])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D13340E9CF67 |
| Fixed UUID v7 | 019dffbb-f000-757b-9813-9fb9e703d887 |
| Canonical name | regexp_matches(string,pattern[,flags]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F48586B1C05A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D13340E9CF67 |
