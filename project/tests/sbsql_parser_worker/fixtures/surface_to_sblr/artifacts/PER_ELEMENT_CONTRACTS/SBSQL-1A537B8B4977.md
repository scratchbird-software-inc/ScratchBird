...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1A537B8B4977 |
| Fixed UUID v7 | 019dffbb-f000-7fb5-9eac-572dbeec9c1b |
| Canonical name | sb.temporal.current_timestamp |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-40253A7A0118 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1A537B8B4977 |
