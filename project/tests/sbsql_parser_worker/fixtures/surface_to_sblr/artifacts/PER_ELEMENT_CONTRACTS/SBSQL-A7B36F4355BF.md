# SBSQL-A7B36F4355BF — octet_length
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A7B36F4355BF |
| Fixed UUID v7 | 019dffbb-f000-7e84-b08a-17fe8050b1e6 |
| Canonical name | octet_length |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2699AE84ECFA |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A7B36F4355BF |
