# SBSQL-24663B96B35A — cot(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-24663B96B35A |
| Fixed UUID v7 | 019dffbb-f000-75a9-a4fc-9cdcaf14b4d2 |
| Canonical name | cot(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1292A2CF471F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-24663B96B35A |
