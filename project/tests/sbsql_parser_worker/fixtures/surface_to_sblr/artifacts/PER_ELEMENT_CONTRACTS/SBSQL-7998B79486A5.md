# SBSQL-7998B79486A5 — union_max_arms
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7998B79486A5 |
| Fixed UUID v7 | 019dffbb-f000-737c-b02e-175645feabab |
| Canonical name | union_max_arms |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-BD5AC5BEF373 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7998B79486A5 |
