# SBSQL-9C16F6BF7072 — lob_truncate(locator,length)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9C16F6BF7072 |
| Fixed UUID v7 | 019dffbb-f000-75c2-80f3-ce4b66bcf73b |
| Canonical name | lob_truncate(locator,length) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4307E9573B36 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-9C16F6BF7072 |
