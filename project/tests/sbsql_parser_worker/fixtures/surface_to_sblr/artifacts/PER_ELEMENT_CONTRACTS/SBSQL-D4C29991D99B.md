# SBSQL-D4C29991D99B — jsonb_path_exists(document,jsonpath[,vars])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D4C29991D99B |
| Fixed UUID v7 | 019dffbb-f000-7547-bec5-f6e5edb4b511 |
| Canonical name | jsonb_path_exists(document,jsonpath[,vars]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3266528D4127 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D4C29991D99B |
