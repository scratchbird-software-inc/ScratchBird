# SBSQL-0100E654C08A — pivot_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0100E654C08A |
| Fixed UUID v7 | 019dffbb-f000-75dd-a692-301a3354f89c |
| Canonical name | pivot_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DC516C4983F9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0100E654C08A |
