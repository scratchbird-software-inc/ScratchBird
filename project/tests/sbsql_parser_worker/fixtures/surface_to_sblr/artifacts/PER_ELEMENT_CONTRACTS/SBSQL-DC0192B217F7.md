# SBSQL-DC0192B217F7 — connect_session
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DC0192B217F7 |
| Fixed UUID v7 | 019dffbb-f000-7f35-bed3-667e8f203bce |
| Canonical name | connect_session |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-37892C28EF5A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DC0192B217F7 |
