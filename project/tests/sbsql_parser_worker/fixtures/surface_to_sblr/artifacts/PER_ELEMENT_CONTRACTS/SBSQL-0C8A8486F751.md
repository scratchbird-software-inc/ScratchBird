# SBSQL-0C8A8486F751 — XMLCAST(exprAStype)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0C8A8486F751 |
| Fixed UUID v7 | 019dffbb-f000-73a2-9d2c-c16a34fefe01 |
| Canonical name | XMLCAST(exprAStype) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6E8DA0690AEB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0C8A8486F751 |
