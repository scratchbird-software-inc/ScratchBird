# SBSQL-AFF3B4857945 — return_shape
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AFF3B4857945 |
| Fixed UUID v7 | 019dffbb-f000-71a9-a8ac-3bc09d6124d7 |
| Canonical name | return_shape |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B0D486C50B6A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AFF3B4857945 |
