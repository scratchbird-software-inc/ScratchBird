# SBSQL-4D4C7A74054C — cypher_with_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-4D4C7A74054C |
| Fixed UUID v7 | 019dffbb-f000-75c4-8922-8beab7e45b0d |
| Canonical name | cypher_with_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3605123511E1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-4D4C7A74054C |
