# SBSQL-AD7F131BA1B5 — dict_layout
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AD7F131BA1B5 |
| Fixed UUID v7 | 019dffbb-f000-716b-9a06-77397f01435b |
| Canonical name | dict_layout |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-58156592472B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AD7F131BA1B5 |
