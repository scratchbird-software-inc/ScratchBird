# SBSQL-6E6DF1F1D3F5 — read_only_session
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6E6DF1F1D3F5 |
| Fixed UUID v7 | 019dffbb-f000-7d0b-90ef-f87e92540dae |
| Canonical name | read_only_session |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-788F663C7530 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6E6DF1F1D3F5 |
