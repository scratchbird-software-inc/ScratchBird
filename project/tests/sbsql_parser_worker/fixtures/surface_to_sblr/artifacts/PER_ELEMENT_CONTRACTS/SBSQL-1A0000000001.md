...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1A0000000001 |
| Fixed UUID v7 | 019e0f00-0000-7001-8000-000000000001 |
| Canonical name | migrate_from_reference |
...
| SBLR operation family | sblr.migration.operation.v3 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1A0000000001 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1A0000000001 |
| Expected result summary | expected parser migration route, SBLR opcode SBLR_MIGRATION_BEGIN_FROM_REFERENCE, API EngineBeginMigration, result shape rs.migration.status.v1, diagnostics, and executable behavior derived from Gate 004 evidence |
