# SBSQL-9518445D0CD9 — alter_subject_action
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9518445D0CD9 |
| Fixed UUID v7 | 019dffbb-f000-7363-828a-6791085f42ed |
| Canonical name | alter_subject_action |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-776AFA32DA5A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9518445D0CD9 |
