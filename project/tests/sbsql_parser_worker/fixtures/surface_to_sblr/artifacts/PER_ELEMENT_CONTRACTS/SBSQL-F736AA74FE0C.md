# SBSQL-F736AA74FE0C — SBSQL.CLUSTER_AUTHORITY_REQUIRED
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F736AA74FE0C |
| Fixed UUID v7 | 019dffbb-f000-7f84-b6e5-0a8a56e5f92f |
| Canonical name | SBSQL.CLUSTER_AUTHORITY_REQUIRED |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-71E0B4BA6BA8 |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-F736AA74FE0C |
