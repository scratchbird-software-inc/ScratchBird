# SBSQL-F8B5D61CE628 — frame_bound
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F8B5D61CE628 |
| Fixed UUID v7 | 019dffbb-f000-7222-ada1-197cd0a3c792 |
| Canonical name | frame_bound |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C7993FF49523 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F8B5D61CE628 |
