# SBSQL-DC6373538835 — setof(keytext,valuedocument)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DC6373538835 |
| Fixed UUID v7 | 019dffbb-f000-7cd3-a7bf-a84f1da87607 |
| Canonical name | setof(keytext,valuedocument) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AA19FFC68E9C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-DC6373538835 |
