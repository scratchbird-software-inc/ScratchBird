# SBSQL-A1C65D80CE68 — jsonb_path_query_array
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A1C65D80CE68 |
| Fixed UUID v7 | 019dffbb-f000-7525-830b-255572ed5a0f |
| Canonical name | jsonb_path_query_array |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AE05B13ECA6C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A1C65D80CE68 |
