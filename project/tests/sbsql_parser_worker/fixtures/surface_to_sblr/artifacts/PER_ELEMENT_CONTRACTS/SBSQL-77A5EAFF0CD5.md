# SBSQL-77A5EAFF0CD5 — try_cast(exprAStype)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-77A5EAFF0CD5 |
| Fixed UUID v7 | 019dffbb-f000-7c6c-8a8d-989f1e847f22 |
| Canonical name | try_cast(exprAStype) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-94039778DD1C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-77A5EAFF0CD5 |
