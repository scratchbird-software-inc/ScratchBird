# SBSQL-D07E07A7470C — unpivot_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D07E07A7470C |
| Fixed UUID v7 | 019dffbb-f000-7248-9cb4-304d075043a3 |
| Canonical name | unpivot_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D8BE6BEFACF0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D07E07A7470C |
