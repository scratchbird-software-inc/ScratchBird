# SBSQL-F9F64D586108 — jsonb_agg(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F9F64D586108 |
| Fixed UUID v7 | 019dffbb-f000-7786-8448-2eb10405fc97 |
| Canonical name | jsonb_agg(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AA2EE3C4EB05 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F9F64D586108 |
