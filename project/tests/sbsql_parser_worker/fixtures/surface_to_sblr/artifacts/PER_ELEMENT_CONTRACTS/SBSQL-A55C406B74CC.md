# SBSQL-A55C406B74CC — soundex(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A55C406B74CC |
| Fixed UUID v7 | 019dffbb-f000-767c-90f6-115a4b7dd420 |
| Canonical name | soundex(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EED3F2465D8E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A55C406B74CC |
