# SBSQL-026D9D491FEE — regexp_like(string,pattern[,flags])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-026D9D491FEE |
| Fixed UUID v7 | 019dffbb-f000-7e9d-b153-845db60aa6f3 |
| Canonical name | regexp_like(string,pattern[,flags]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CED3D9A5228C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-026D9D491FEE |
