# SBSQL-05E62E9E2E87 — bridge_begin_transaction
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-05E62E9E2E87 |
| Fixed UUID v7 | 019e14c1-3044-77f8-8eea-18b7f6825281 |
| Canonical name | bridge_begin_transaction |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-05E62E9E2E87 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-05E62E9E2E87 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_TX_BEGIN, UDR operation begin, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
