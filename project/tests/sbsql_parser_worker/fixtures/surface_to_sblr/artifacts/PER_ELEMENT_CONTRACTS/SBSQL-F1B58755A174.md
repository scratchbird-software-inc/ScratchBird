# SBSQL-F1B58755A174 — st_makeline
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F1B58755A174 |
| Fixed UUID v7 | 019dffbb-f000-7cc9-be89-8544989ec2dc |
| Canonical name | st_makeline |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-68DA5FE51B5C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F1B58755A174 |
