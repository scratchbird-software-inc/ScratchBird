# SBSQL-6CC28005D2B9 — agent_filter
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6CC28005D2B9 |
| Fixed UUID v7 | 019dffbb-f000-7603-b15d-5379328827cd |
| Canonical name | agent_filter |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-42AE9D16C494 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6CC28005D2B9 |
