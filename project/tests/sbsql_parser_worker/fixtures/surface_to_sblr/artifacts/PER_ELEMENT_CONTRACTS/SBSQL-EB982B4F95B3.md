# SBSQL-EB982B4F95B3 — jsonb_object_keys(document)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EB982B4F95B3 |
| Fixed UUID v7 | 019dffbb-f000-7c53-b36b-28aecbd305e2 |
| Canonical name | jsonb_object_keys(document) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D7DD04CF2896 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EB982B4F95B3 |
