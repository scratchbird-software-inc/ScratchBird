# SBSQL-E062D64D0C8F — json_remove
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E062D64D0C8F |
| Fixed UUID v7 | 019dffbb-f000-7cdd-a4f2-47afb548274d |
| Canonical name | json_remove |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8DE0F2AEA4A2 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-E062D64D0C8F |
