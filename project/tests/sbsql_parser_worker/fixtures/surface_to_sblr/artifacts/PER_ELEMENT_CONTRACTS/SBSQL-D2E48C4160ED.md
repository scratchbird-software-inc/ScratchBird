# SBSQL-D2E48C4160ED — lob_create(class,[media])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D2E48C4160ED |
| Fixed UUID v7 | 019dffbb-f000-7134-a4fa-f53e6aa737d3 |
| Canonical name | lob_create(class,[media]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-883F2F5654AE |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D2E48C4160ED |
