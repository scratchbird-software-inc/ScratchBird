# SBSQL-DC524A31C9B5 — coalesce(args...)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DC524A31C9B5 |
| Fixed UUID v7 | 019dffbb-f000-7d96-828b-0e6d54a44c0d |
| Canonical name | coalesce(args...) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-206E73286C1D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DC524A31C9B5 |
