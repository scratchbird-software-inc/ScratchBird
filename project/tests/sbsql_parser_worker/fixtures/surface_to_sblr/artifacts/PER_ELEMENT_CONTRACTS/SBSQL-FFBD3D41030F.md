# SBSQL-FFBD3D41030F — document_schema_def
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FFBD3D41030F |
| Fixed UUID v7 | 019dffbb-f000-70d5-bf6f-dbf0344ef0bd |
| Canonical name | document_schema_def |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A0DA32DF5022 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FFBD3D41030F |
