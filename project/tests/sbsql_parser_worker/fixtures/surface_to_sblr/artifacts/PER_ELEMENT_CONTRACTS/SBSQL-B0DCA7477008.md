...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B0DCA7477008 |
| Fixed UUID v7 | 019dffbb-f000-7001-b653-234690430f58 |
| Canonical name | SYS_CONTEXT('USERENV','CURRENT_USER') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6164F5877556 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B0DCA7477008 |
