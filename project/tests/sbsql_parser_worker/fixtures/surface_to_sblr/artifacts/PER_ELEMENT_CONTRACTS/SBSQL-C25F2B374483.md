...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C25F2B374483 |
| Fixed UUID v7 | 019dffbb-f000-71e3-8532-0b618af3ab67 |
| Canonical name | RDB$GET_CONTEXT('SYSTEM','TRANSACTION_ID') |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-020759665048 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C25F2B374483 |
