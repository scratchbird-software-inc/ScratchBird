# SBSQL-BE412B3728C3 — ExecutionTypeDescriptor
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BE412B3728C3 |
| Fixed UUID v7 | 019dffbb-f000-7af6-8910-83fad28f8cf5 |
| Canonical name | ExecutionTypeDescriptor |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2BA49AD76409 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BE412B3728C3 |
