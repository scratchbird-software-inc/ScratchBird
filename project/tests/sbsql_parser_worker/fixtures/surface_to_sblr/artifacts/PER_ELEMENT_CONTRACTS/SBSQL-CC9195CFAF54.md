# SBSQL-CC9195CFAF54 — bridge_open_session
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CC9195CFAF54 |
| Fixed UUID v7 | 019e14c1-01a3-7a64-8e82-e8a53e18de5f |
| Canonical name | bridge_open_session |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-CC9195CFAF54 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CC9195CFAF54 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_OPEN_SESSION, UDR operation open_session, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
