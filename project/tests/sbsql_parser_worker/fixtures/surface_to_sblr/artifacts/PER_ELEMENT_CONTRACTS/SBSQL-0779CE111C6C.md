# SBSQL-0779CE111C6C — schedule_spec
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0779CE111C6C |
| Fixed UUID v7 | 019dffbb-f000-7d6d-be82-df2ba3c5aab0 |
| Canonical name | schedule_spec |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1CB73F3CA998 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0779CE111C6C |
