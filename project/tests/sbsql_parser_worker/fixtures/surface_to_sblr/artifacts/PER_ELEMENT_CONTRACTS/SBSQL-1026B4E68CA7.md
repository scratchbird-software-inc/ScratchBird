# SBSQL-1026B4E68CA7 — over_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1026B4E68CA7 |
| Fixed UUID v7 | 019dffbb-f000-7064-b669-e6436977a348 |
| Canonical name | over_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B36CE3C8A992 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1026B4E68CA7 |
