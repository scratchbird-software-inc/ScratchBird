...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A4F34F00C071 |
| Fixed UUID v7 | 019dffbb-f000-7a3a-8402-a9db0911a981 |
| Canonical name | psql_close_cursor_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-363DE439FB74 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A4F34F00C071 |
