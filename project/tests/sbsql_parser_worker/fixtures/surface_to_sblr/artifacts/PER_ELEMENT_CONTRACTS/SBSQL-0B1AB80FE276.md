# SBSQL-0B1AB80FE276 — bit_count(int)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0B1AB80FE276 |
| Fixed UUID v7 | 019dffbb-f000-7566-96ce-db4f51152aa5 |
| Canonical name | bit_count(int) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4AA90812D76B |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-0B1AB80FE276 |
