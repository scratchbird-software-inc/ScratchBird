# SBSQL-6C877B4376DE — at_time_zone
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6C877B4376DE |
| Fixed UUID v7 | 019dffbb-f000-7059-b6f7-a77a92aae5ac |
| Canonical name | at_time_zone |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FAA3FFC410B3 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6C877B4376DE |
