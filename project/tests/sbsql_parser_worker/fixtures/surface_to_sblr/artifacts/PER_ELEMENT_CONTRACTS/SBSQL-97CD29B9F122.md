# SBSQL-97CD29B9F122 — show_filespace_extended
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-97CD29B9F122 |
| Fixed UUID v7 | 019dffbb-f000-77ae-8b0f-60f7de0a23a6 |
| Canonical name | show_filespace_extended |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-5589CBC5EBDC |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-97CD29B9F122 |
