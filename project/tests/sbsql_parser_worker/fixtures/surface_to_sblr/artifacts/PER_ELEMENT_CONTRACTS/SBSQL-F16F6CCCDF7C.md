# SBSQL-F16F6CCCDF7C — xml_agg_form
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F16F6CCCDF7C |
| Fixed UUID v7 | 019dffbb-f000-7486-b03f-b94d0ec43459 |
| Canonical name | xml_agg_form |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-986233D53F41 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F16F6CCCDF7C |
