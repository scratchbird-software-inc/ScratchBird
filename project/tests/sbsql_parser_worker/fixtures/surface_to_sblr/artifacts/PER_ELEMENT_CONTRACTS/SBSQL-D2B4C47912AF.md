...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D2B4C47912AF |
| Fixed UUID v7 | 019dffbb-f000-7970-b290-a95b4496b898 |
| Canonical name | mod(a,b) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1ED78DD73A80 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D2B4C47912AF |
