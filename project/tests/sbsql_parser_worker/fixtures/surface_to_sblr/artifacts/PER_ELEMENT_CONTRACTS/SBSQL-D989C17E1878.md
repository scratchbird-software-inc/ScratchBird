# SBSQL-D989C17E1878 — collation_for(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D989C17E1878 |
| Fixed UUID v7 | 019dffbb-f000-7555-8a18-c42675e6c2f3 |
| Canonical name | collation_for(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8BE31789FA2E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-D989C17E1878 |
