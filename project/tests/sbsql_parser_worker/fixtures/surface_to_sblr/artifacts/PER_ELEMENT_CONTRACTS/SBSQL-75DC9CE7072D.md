# SBSQL-75DC9CE7072D — comparison_collation_resolution
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-75DC9CE7072D |
| Fixed UUID v7 | 019dffbb-f000-7908-8b18-d1c961b3df2e |
| Canonical name | comparison_collation_resolution |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-171A5220050F |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-75DC9CE7072D |
