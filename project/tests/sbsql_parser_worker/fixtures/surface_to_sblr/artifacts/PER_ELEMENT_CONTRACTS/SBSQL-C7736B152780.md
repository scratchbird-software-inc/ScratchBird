# SBSQL-C7736B152780 — consistency_level
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C7736B152780 |
| Fixed UUID v7 | 019dffbb-f000-731b-a317-22a154d15e8d |
| Canonical name | consistency_level |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8CED397DAAF5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C7736B152780 |
