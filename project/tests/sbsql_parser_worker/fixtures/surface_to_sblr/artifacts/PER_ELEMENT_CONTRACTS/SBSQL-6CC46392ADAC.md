# SBSQL-6CC46392ADAC — st_buffer(geometry,distance)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6CC46392ADAC |
| Fixed UUID v7 | 019dffbb-f000-7569-9eb7-eee7184c8fab |
| Canonical name | st_buffer(geometry,distance) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-394B945764F6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-6CC46392ADAC |
