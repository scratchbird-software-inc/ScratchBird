# SBSQL-6EBD4C7CB915 — vector_sum(vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6EBD4C7CB915 |
| Fixed UUID v7 | 019dffbb-f000-7872-818e-23d0a08be4e7 |
| Canonical name | vector_sum(vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F65132AE0106 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6EBD4C7CB915 |
