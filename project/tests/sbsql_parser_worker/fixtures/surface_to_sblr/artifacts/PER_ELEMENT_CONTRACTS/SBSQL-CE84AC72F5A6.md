# SBSQL-CE84AC72F5A6 — pre_split_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CE84AC72F5A6 |
| Fixed UUID v7 | 019dffbb-f000-7ad0-a0e7-e15210846978 |
| Canonical name | pre_split_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-90FD34F1B440 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-CE84AC72F5A6 |
