# SBSQL-C5D151D17944 — parameter_name
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C5D151D17944 |
| Fixed UUID v7 | 019dffbb-f000-706a-b8e3-a41f583afb88 |
| Canonical name | parameter_name |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E5E24D5AF9E3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-C5D151D17944 |
