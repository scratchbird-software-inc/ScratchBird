# SBSQL-9A5FDCD9D262 — json_object_agg
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9A5FDCD9D262 |
| Fixed UUID v7 | 019dffbb-f000-7d2c-8833-cde197e21a7f |
| Canonical name | json_object_agg |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4E8AA27BA2E3 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9A5FDCD9D262 |
