# SBSQL-EF1565632553 — null_in_unique_constraint
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-EF1565632553 |
| Fixed UUID v7 | 019dffbb-f000-7c0c-93ec-584365a461cc |
| Canonical name | null_in_unique_constraint |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-EC49BA170EB1 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-EF1565632553 |
