# SBSQL-C62D69D167C8 — lob_size(locator)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C62D69D167C8 |
| Fixed UUID v7 | 019dffbb-f000-73ed-9751-2bb7940395a1 |
| Canonical name | lob_size(locator) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-3B1E875B701A |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C62D69D167C8 |
