# SBSQL-630C9B6D7C13 — cardinality(<collection>)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-630C9B6D7C13 |
| Fixed UUID v7 | 019dffbb-f000-7c6f-bd59-78f3efe7d47d |
| Canonical name | cardinality(<collection>) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D374455EEEE0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-630C9B6D7C13 |
