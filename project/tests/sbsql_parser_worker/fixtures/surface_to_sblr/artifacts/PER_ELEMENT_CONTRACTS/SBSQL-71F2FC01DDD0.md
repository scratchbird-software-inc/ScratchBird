# SBSQL-71F2FC01DDD0 — char_length(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-71F2FC01DDD0 |
| Fixed UUID v7 | 019dffbb-f000-76a0-9746-09930b8d12ab |
| Canonical name | char_length(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7ECB0A09602F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-71F2FC01DDD0 |
