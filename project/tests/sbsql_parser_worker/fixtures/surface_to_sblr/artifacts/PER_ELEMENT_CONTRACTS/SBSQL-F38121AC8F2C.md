# SBSQL-F38121AC8F2C — current_setting(name[,missing_ok])
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F38121AC8F2C |
| Fixed UUID v7 | 019dffbb-f000-7bf7-b9ee-0185aaef7d6a |
| Canonical name | current_setting(name[,missing_ok]) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A725A3303E16 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F38121AC8F2C |
