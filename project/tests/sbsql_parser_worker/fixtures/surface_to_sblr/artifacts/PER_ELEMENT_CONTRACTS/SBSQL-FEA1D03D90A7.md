# SBSQL-FEA1D03D90A7 — quorum_rule
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FEA1D03D90A7 |
| Fixed UUID v7 | 019dffbb-f000-7acd-b44b-d59066a4ce7e |
| Canonical name | quorum_rule |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D30B9F4D2334 |
| Oracle type | cluster_profile_and_standalone_refusal_policy |
| Oracle search key | SBSQL-FEA1D03D90A7 |
