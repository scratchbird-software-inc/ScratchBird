# SBSQL-BCAC432F4C75 — array_max_element_count
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BCAC432F4C75 |
| Fixed UUID v7 | 019dffbb-f000-7a6b-996e-bfca99ec1b4d |
| Canonical name | array_max_element_count |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-41DB7AA6494E |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BCAC432F4C75 |
