# SBSQL-94114FAB3F1C — vector_cast_float16
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-94114FAB3F1C |
| Fixed UUID v7 | 019dffbb-f000-7f37-bc17-0848422018f0 |
| Canonical name | vector_cast_float16 |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B4F9FC5D7E30 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-94114FAB3F1C |
