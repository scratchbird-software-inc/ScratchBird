# SBSQL-3956A1AD000E — pg_advisory_xact_lock(key)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-3956A1AD000E |
| Fixed UUID v7 | 019dffbb-f000-79c9-83b8-39046c9a6142 |
| Canonical name | pg_advisory_xact_lock(key) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1D0E62699E32 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-3956A1AD000E |
