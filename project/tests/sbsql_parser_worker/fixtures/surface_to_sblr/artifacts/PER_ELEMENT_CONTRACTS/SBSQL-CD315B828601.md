# SBSQL-CD315B828601 — table_value_to_cursor
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-CD315B828601 |
| Fixed UUID v7 | 019dffbb-f000-7621-8bcb-dc9af37c15a9 |
| Canonical name | table_value_to_cursor |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-DA3E3744F21C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-CD315B828601 |
