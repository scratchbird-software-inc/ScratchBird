...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-2DB83873C621 |
| Fixed UUID v7 | 019dffbb-f000-72c6-8620-3a680665be48 |
| Canonical name | @@autocommit |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ECBDB0217C19 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-2DB83873C621 |
