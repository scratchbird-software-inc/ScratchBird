# SBSQL-78B6ABBE922C — diagnostic_count
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-78B6ABBE922C |
| Fixed UUID v7 | 019dffbb-f000-7787-abfc-3eeeb5f6de45 |
| Canonical name | diagnostic_count |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-704924D928A2 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-78B6ABBE922C |
