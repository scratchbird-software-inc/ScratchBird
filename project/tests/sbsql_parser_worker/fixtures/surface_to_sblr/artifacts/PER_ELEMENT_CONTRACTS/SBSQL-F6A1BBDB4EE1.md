...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F6A1BBDB4EE1 |
| Fixed UUID v7 | 019dffbb-f000-7e63-94a3-53d5b5143de4 |
| Canonical name | sb.scalar.floor |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-723297DF6271 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F6A1BBDB4EE1 |
