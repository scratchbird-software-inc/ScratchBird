# SBSQL-813817A7EDFD — reference_reserved_keyword
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-813817A7EDFD |
| Fixed UUID v7 | 019dffbb-f000-7395-ae26-804f954c291b |
| Canonical name | reference_reserved_keyword |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FD0BDBCFD01C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-813817A7EDFD |
