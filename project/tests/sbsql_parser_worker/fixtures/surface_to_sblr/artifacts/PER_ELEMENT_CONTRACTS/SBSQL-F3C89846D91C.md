# SBSQL-F3C89846D91C — st_geomfromtext
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F3C89846D91C |
| Fixed UUID v7 | 019dffbb-f000-7555-9f81-eb0963072116 |
| Canonical name | st_geomfromtext |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C7D17AA868A8 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F3C89846D91C |
