# SBSQL-33FC6A422D2A — range_contains_element
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-33FC6A422D2A |
| Fixed UUID v7 | 019dffbb-f000-74ed-91c4-1b280b76ac8a |
| Canonical name | range_contains_element |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-ACFE9D66B0A5 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-33FC6A422D2A |
