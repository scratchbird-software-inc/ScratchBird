# SBSQL-0A96CD6009B0 — numeric_division_by_zero
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-0A96CD6009B0 |
| Fixed UUID v7 | 019dffbb-f000-7baa-9cad-ac6f384f8a9e |
| Canonical name | numeric_division_by_zero |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B0EA87CDDBB9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-0A96CD6009B0 |
