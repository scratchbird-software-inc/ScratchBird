# SBSQL-A9F5EAE695BC — collate_postfix
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A9F5EAE695BC |
| Fixed UUID v7 | 019dffbb-f000-7e59-8abf-a702ccab823a |
| Canonical name | collate_postfix |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-75EA5CD75A97 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A9F5EAE695BC |
