# SBSQL-1DBECA8A20A7 — vector_metric
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1DBECA8A20A7 |
| Fixed UUID v7 | 019dffbb-f000-798a-a847-3e3923a7c328 |
| Canonical name | vector_metric |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0B0131F379F2 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1DBECA8A20A7 |
