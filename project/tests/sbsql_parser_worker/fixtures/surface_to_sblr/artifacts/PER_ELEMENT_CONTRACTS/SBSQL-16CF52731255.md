# SBSQL-16CF52731255 — cancel_job_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-16CF52731255 |
| Fixed UUID v7 | 019dffbb-f000-73b2-ac97-d187efa4416a |
| Canonical name | cancel_job_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F0AB3743980E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-16CF52731255 |
