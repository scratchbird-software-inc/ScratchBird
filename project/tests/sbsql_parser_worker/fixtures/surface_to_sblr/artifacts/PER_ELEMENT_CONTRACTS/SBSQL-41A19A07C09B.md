# SBSQL-41A19A07C09B — lob_open(locator,mode)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-41A19A07C09B |
| Fixed UUID v7 | 019dffbb-f000-7471-9f3a-64dc718e4ac8 |
| Canonical name | lob_open(locator,mode) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-03A4BA04749C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-41A19A07C09B |
