# SBSQL-7769D5002200 — localtimestamp
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7769D5002200 |
| Fixed UUID v7 | 019dffbb-f000-76e6-a33a-9f40d998a302 |
| Canonical name | localtimestamp |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C6C239E3B3D7 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-7769D5002200 |
