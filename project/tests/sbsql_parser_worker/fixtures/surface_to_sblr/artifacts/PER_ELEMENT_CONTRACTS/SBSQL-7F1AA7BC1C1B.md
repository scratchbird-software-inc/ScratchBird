# SBSQL-7F1AA7BC1C1B — st_centroid
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7F1AA7BC1C1B |
| Fixed UUID v7 | 019dffbb-f000-704c-8f3e-718258778236 |
| Canonical name | st_centroid |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-00C84E56CE7D |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7F1AA7BC1C1B |
