# SBSQL-AC7EA9FF937C — trigger_referencing
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-AC7EA9FF937C |
| Fixed UUID v7 | 019dffbb-f000-77fa-9808-d11e0ddca170 |
| Canonical name | trigger_referencing |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-8646C5D9186A |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-AC7EA9FF937C |
