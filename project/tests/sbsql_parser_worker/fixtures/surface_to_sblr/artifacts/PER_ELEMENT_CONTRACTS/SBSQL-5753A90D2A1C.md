# SBSQL-5753A90D2A1C — XMLDOCUMENT(expr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5753A90D2A1C |
| Fixed UUID v7 | 019dffbb-f000-7448-b94e-3fcb74b38284 |
| Canonical name | XMLDOCUMENT(expr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-6D4616B77CDE |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-5753A90D2A1C |
