...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B5B0AC8A7813 |
| Fixed UUID v7 | 019dffbb-f000-74fb-9258-28914b0b9e2a |
| Canonical name | sqlcode |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-940E3574DB12 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B5B0AC8A7813 |
