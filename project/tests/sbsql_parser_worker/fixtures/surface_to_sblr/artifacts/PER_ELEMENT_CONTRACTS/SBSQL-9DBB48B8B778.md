# SBSQL-9DBB48B8B778 — replace(string,from,to)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-9DBB48B8B778 |
| Fixed UUID v7 | 019dffbb-f000-7983-b8ec-38968278d94e |
| Canonical name | replace(string,from,to) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B0D772F919B9 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-9DBB48B8B778 |
