# SBSQL-D8C32B223686 — statement_terminator
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D8C32B223686 |
| Fixed UUID v7 | 019dffbb-f000-7eb6-adab-4674eff40e42 |
| Canonical name | statement_terminator |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E5AD7BFB2191 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D8C32B223686 |
