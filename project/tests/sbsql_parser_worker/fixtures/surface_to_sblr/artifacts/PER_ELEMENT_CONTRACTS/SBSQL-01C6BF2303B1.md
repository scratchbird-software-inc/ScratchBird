# SBSQL-01C6BF2303B1 — st_makepoint
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-01C6BF2303B1 |
| Fixed UUID v7 | 019dffbb-f000-7dc2-b9e7-8a2bbe620fd2 |
| Canonical name | st_makepoint |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-E1C34D6CA2CB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-01C6BF2303B1 |
