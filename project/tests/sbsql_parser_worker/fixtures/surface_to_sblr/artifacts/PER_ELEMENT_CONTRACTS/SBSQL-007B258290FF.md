# SBSQL-007B258290FF — cypher_delete_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-007B258290FF |
| Fixed UUID v7 | 019dffbb-f000-78d9-a128-8b9f6c6be2a0 |
| Canonical name | cypher_delete_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-68FE11C71F3E |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-007B258290FF |
