# SBSQL-E6D846B78614 — from_unixtime(bigint)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E6D846B78614 |
| Fixed UUID v7 | 019dffbb-f000-7368-8a97-8151f57cdaa6 |
| Canonical name | from_unixtime(bigint) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0353613FD4BB |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E6D846B78614 |
