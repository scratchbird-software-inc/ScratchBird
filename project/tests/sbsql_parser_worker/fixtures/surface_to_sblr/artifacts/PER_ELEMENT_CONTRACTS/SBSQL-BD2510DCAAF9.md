# SBSQL-BD2510DCAAF9 — doc_path_update_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BD2510DCAAF9 |
| Fixed UUID v7 | 019dffbb-f000-7d43-bd87-3251cfbd1af8 |
| Canonical name | doc_path_update_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B1C003601076 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-BD2510DCAAF9 |
