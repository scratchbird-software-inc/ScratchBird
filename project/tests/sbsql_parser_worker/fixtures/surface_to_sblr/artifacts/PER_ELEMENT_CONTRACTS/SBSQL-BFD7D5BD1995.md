# SBSQL-BFD7D5BD1995 — vector_avg(vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-BFD7D5BD1995 |
| Fixed UUID v7 | 019dffbb-f000-7a5c-8f4e-4260fb9eb913 |
| Canonical name | vector_avg(vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-0C6F137BF0DF |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-BFD7D5BD1995 |
