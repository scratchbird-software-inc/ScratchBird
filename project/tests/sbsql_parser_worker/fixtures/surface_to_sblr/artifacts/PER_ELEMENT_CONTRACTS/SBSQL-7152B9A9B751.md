# SBSQL-7152B9A9B751 — udr_entry_point
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-7152B9A9B751 |
| Fixed UUID v7 | 019dffbb-f000-799d-ba10-caf51c595e8d |
| Canonical name | udr_entry_point |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AA7130CCC0F5 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-7152B9A9B751 |
