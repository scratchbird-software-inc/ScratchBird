# SBSQL-F824C47A36A5 — array_max_dimension
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F824C47A36A5 |
| Fixed UUID v7 | 019dffbb-f000-7aaf-af64-9f214e0c09e7 |
| Canonical name | array_max_dimension |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FE4832DC4D6C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F824C47A36A5 |
