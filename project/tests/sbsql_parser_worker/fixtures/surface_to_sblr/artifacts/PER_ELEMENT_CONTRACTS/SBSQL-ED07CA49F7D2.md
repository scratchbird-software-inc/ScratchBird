# SBSQL-ED07CA49F7D2 — idle_in_transaction_session_timeout_ms
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-ED07CA49F7D2 |
| Fixed UUID v7 | 019dffbb-f000-7211-92c2-0be3cb30ce3f |
| Canonical name | idle_in_transaction_session_timeout_ms |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A8F6AF783661 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-ED07CA49F7D2 |
