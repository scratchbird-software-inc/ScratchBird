# SBSQL-E56EBC2407A0 — create_udr_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-E56EBC2407A0 |
| Fixed UUID v7 | 019dffbb-f000-79d2-be80-3fb5cd9f568b |
| Canonical name | create_udr_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D8CBFF6E8355 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-E56EBC2407A0 |
