# SBSQL-F9EF3981D275 — bridge_show_capabilities
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F9EF3981D275 |
| Fixed UUID v7 | 019e14c1-6584-70d7-8a6c-bacc38774fe9 |
| Canonical name | bridge_show_capabilities |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-F9EF3981D275 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F9EF3981D275 |
| Expected result summary | expected parser bridge command route, SBLR bridge operation envelope, opcode SBLR_BRIDGE_DESCRIBE_CAPABILITIES, UDR operation describe_capabilities, MGA-preserving local and remote transaction authority, and reference-specific rendering derived from the universal bridge ABI |
