# SBSQL-A6572A3FA0B5 — for_portion_of_clause
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A6572A3FA0B5 |
| Fixed UUID v7 | 019dffbb-f000-7ef3-94e9-6d64c6fb583b |
| Canonical name | for_portion_of_clause |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-74DA2B26E801 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-A6572A3FA0B5 |
