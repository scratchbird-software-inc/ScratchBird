# SBSQL-46D54006C21A — stddev_pop(numeric)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-46D54006C21A |
| Fixed UUID v7 | 019dffbb-f000-7a7f-9f94-e465808c3af8 |
| Canonical name | stddev_pop(numeric) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-2664CD078C91 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-46D54006C21A |
