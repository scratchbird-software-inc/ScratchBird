# SBSQL-6250A4C72894 — uuid_from_string(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-6250A4C72894 |
| Fixed UUID v7 | 019dffbb-f000-741b-8ec0-33bc11cbd646 |
| Canonical name | uuid_from_string(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-42B52E35A0B6 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-6250A4C72894 |
