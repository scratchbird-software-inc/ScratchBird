# SBSQL-A9177A9A947C — lob_write(locator,offset,data)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-A9177A9A947C |
| Fixed UUID v7 | 019dffbb-f000-76d5-8fd4-def7a55d8739 |
| Canonical name | lob_write(locator,offset,data) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D233E9B2ED8F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-A9177A9A947C |
