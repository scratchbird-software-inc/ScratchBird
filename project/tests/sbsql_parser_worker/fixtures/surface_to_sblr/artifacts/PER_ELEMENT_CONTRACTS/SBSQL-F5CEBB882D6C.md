# SBSQL-F5CEBB882D6C — vector_l2_normalize(vector)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F5CEBB882D6C |
| Fixed UUID v7 | 019dffbb-f000-7a9f-99f2-8f7a9103bcd1 |
| Canonical name | vector_l2_normalize(vector) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-98215BACEF2F |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-F5CEBB882D6C |
