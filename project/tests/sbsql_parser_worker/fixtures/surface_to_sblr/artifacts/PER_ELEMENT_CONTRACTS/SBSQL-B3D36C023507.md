# SBSQL-B3D36C023507 — unicode(text)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B3D36C023507 |
| Fixed UUID v7 | 019dffbb-f000-72c5-84bf-c48a929ce6ef |
| Canonical name | unicode(text) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-FCFE08DEB0D7 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B3D36C023507 |
