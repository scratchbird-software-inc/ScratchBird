...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F60EDC63102B |
| Fixed UUID v7 | 019dffbb-f000-75ee-abcf-a80e63d4f090 |
| Canonical name | varchar(N) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-205CC69DDAF6 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F60EDC63102B |
