# SBSQL-185C0345FDCC — sb.operator.and
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-185C0345FDCC |
| Fixed UUID v7 | 019dffbb-f000-7184-9845-fe5b75231c3e |
| Canonical name | sb.operator.and |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D9DBC9697732 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-185C0345FDCC |
