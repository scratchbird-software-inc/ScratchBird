# SBSQL-35C5F6EA0613 — savepoint_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-35C5F6EA0613 |
| Fixed UUID v7 | 019dffbb-f000-74b2-9baf-57d1e90bc63a |
| Canonical name | savepoint_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-38024C075136 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-35C5F6EA0613 |
