# SBSQL-B8F6BB0CDCFA — current_timezone
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-B8F6BB0CDCFA |
| Fixed UUID v7 | 019dffbb-f000-7787-a8f2-975e5a18f8c7 |
| Canonical name | current_timezone |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-160A5E785980 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-B8F6BB0CDCFA |
