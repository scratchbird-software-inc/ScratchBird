# SBSQL-DCB7F12CB677 — doc_pipeline_verb
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DCB7F12CB677 |
| Fixed UUID v7 | 019dffbb-f000-7f01-91f6-96eedb29c9d6 |
| Canonical name | doc_pipeline_verb |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-C02516136578 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DCB7F12CB677 |
