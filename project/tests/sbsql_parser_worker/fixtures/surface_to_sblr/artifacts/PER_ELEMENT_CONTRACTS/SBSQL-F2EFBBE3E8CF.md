# SBSQL-F2EFBBE3E8CF — identifier_delimited
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-F2EFBBE3E8CF |
| Fixed UUID v7 | 019dffbb-f000-7a5a-a927-905c4550ed22 |
| Canonical name | identifier_delimited |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-878C384BEE0B |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-F2EFBBE3E8CF |
