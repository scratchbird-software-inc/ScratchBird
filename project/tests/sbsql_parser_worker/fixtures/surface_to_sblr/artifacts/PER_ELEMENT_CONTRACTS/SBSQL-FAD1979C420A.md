# SBSQL-FAD1979C420A — EXTRACT(partFROMtemporal)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-FAD1979C420A |
| Fixed UUID v7 | 019dffbb-f000-7014-a034-7551702281e2 |
| Canonical name | EXTRACT(partFROMtemporal) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-D7EFEDCEF090 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-FAD1979C420A |
