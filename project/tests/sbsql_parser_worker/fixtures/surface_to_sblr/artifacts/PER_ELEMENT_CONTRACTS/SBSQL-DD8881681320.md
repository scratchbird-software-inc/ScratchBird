# SBSQL-DD8881681320 — idempotency_level
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-DD8881681320 |
| Fixed UUID v7 | 019dffbb-f000-7a2a-b818-4a3ebd4f65f1 |
| Canonical name | idempotency_level |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-A56BF1F1D65C |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-DD8881681320 |
