# SBSQL-809276DC4FE0 — has_table_privilege([user,]table_name,privilege)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-809276DC4FE0 |
| Fixed UUID v7 | 019dffbb-f000-77d2-8d68-0112aacf6687 |
| Canonical name | has_table_privilege([user,]table_name,privilege) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-AC58F2B22591 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-809276DC4FE0 |
