# SBSQL-5ECBB4B91523 — date_bin(stride,source,origin)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-5ECBB4B91523 |
| Fixed UUID v7 | 019dffbb-f000-7282-a41b-66fd193cd4ad |
| Canonical name | date_bin(stride,source,origin) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-4E3F8C4218B9 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-5ECBB4B91523 |
