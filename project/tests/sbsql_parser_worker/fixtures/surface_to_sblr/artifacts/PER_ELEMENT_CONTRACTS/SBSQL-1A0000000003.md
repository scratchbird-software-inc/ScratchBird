...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-1A0000000003 |
| Fixed UUID v7 | 019e0f00-0000-7003-8000-000000000003 |
| Canonical name | show_migration |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-1A0000000003 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-1A0000000003 |
| Expected result summary | expected parser migration route, SBLR opcode SBLR_SHOW_MIGRATION, API EngineShowMigration, result shape rs.migration.status.v1, diagnostics, and executable behavior derived from Gate 004 evidence |
