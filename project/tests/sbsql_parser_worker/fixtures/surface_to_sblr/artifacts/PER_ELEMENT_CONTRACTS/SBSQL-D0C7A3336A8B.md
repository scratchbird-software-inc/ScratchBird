# SBSQL-D0C7A3336A8B — alter_policy_stmt
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-D0C7A3336A8B |
| Fixed UUID v7 | 019dffbb-f000-7a86-8a93-441dbf06d0b2 |
| Canonical name | alter_policy_stmt |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-7DBBEB076EA0 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-D0C7A3336A8B |
