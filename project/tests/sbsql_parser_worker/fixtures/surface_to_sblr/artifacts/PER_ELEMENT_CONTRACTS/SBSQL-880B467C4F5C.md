# SBSQL-880B467C4F5C — approx_percentile_disc(fraction)WITHINGROUP(ORDERBYexpr)
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-880B467C4F5C |
| Fixed UUID v7 | 019dffbb-f000-7619-b1d6-3116e75e9b15 |
| Canonical name | approx_percentile_disc(fraction)WITHINGROUP(ORDERBYexpr) |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-B2D836CC9C6C |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-880B467C4F5C |
