# SBSQL-14816C2A7E33 — st_simplify
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-14816C2A7E33 |
| Fixed UUID v7 | 019dffbb-f000-7bd7-97f4-f66f545606cd |
| Canonical name | st_simplify |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-43120EAF4382 |
| Oracle type | canonical_spec_plus_sblr_matrix |
| Oracle search key | SBSQL-14816C2A7E33 |
