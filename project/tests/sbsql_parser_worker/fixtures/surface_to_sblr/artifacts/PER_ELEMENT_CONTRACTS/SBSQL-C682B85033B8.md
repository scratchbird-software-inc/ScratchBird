# SBSQL-C682B85033B8 — cursor_scrollability
...
| Field | Value |
| --- | --- |
| Surface ID | SBSQL-C682B85033B8 |
| Fixed UUID v7 | 019dffbb-f000-7967-8cca-e48403bb663b |
| Canonical name | cursor_scrollability |
...
| Field | Value |
| --- | --- |
| Fixture ID | SBSQL-SURFACE-17C7CD482875 |
| Oracle type | promotion_or_canonical_refusal_decision |
| Oracle search key | SBSQL-C682B85033B8 |
