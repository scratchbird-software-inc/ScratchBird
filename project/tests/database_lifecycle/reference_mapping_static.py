...
"""Static gate for DBLC-014 reference lifecycle mapping invariants."""
...
OWNED_SOURCE_FILES = (
    ...
    "project/src/parsers/compatibility/firebird/firebird_worker_session.hpp",
...
REQUIRED_TOKENS = {
    ...
    "project/tests/database_lifecycle/reference_mapping_conformance.cpp": (
        "DBLC_P14_REFERENCE_MAPPING_COMPLETE",
        "DBLC-014",
        "reference_engine_sql_executed",
        "parser_executes_sql",
    ...
    "artifacts/DATABASE_LIFECYCLE_REFERENCE_MAPPING_REPORT.md": (
        "DBLC_P14_REFERENCE_MAPPING_COMPLETE",
...
def main() -> int:
    ...
    try:
        ...
        print(f"DBLC_STATIC_NO_REFERENCE_ENGINE_SQL=failed: {exc}", file=sys.stderr)
        return 1

    print("DBLC_STATIC_NO_REFERENCE_ENGINE_SQL=passed")
    print("DBLC_P14_REFERENCE_MAPPING_COMPLETE=static-evidence")
    return 0
