...
| `reference_mapping_firebird_sbsql` | Reference mapping labels and `DBLC_P14_REFERENCE_MAPPING_COMPLETE` cover FirebirdSQL and SBSQL reference mapping/emulation diagnostics. |
...
| `no_reference_sql_execution` | Reference mapping static gates and parser worker replay gates reject reference SQL execution inside the engine boundary. |
