...
| Firebird and SBSQL parser mapping | Donor SQL execution, donor file effects, and source SQL leakage into admitted engine envelopes. |
...
| `donor_engine_sql_executed:false` | Donor dialect mapping has no donor SQL execution authority. |
