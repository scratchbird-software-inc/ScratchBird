...
std::string Field(const info::SysInformationProjectionRow& row, std::string_view name) {
  for (const auto& field : row.fields) {
    if (field.first == name) {
      ...
      Fail("text accessor used for native projection value");
    }
  }
  return {};
}
...
void RequireNoUuidColumnsOrValues(const info::SysInformationProjectionResult& result) {
  for (const auto& row : result.rows) {
    for (const auto& field : row.fields) {
      ...
      if (text == nullptr) {
        Require(field.first == "object_id" || field.first == "parent_object_id" ||
                field.first == "node_id" || field.first == "parent_node_id",
                "unexpected native identity field in display projection");
        continue;
      }
      Require(text->find("uuid-") == std::string::npos,
              "sys.information projection exposed a raw UUID-shaped value");
      Require(text->find("object-") == std::string::npos,
...
std::vector<info::SysInformationCatalogObjectSource> CatalogObjects() {
  return {
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 1),
       .object_class = "schema",
       .schema_uuid = {},
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 2),
       .object_class = "schema",
       .schema_uuid = {},
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 1),
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 3),
       .object_class = "schema",
       .schema_uuid = {},
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 1),
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 4),
       .object_class = "table",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 2),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 2),
       .table_type = "SYSTEM TABLE",
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 5),
       .object_class = "view",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 3),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 3),
       .table_type = "SYSTEM VIEW",
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .object_class = "schema",
       .schema_uuid = {},
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 7),
       .object_class = "schema",
       .schema_uuid = {},
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 8),
       .object_class = "schema",
       .schema_uuid = {},
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 9),
       .object_class = "schema",
       .schema_uuid = {},
       .catalog_generation_id = 1,
       .created_local_transaction_id = 1},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 10),
       .object_class = "table",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .table_type = "BASE TABLE",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 11),
       .object_class = "view",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .table_type = "VIEW",
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 12),
       .object_class = "procedure",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 13),
       .object_class = "function",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 14),
       .object_class = "package",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 15),
       .object_class = "sequence",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 16),
       .object_class = "table",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .table_type = "BASE TABLE",
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3,
       .hidden = true},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 17),
       .object_class = "table",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .table_type = "BASE TABLE",
       .catalog_generation_id = 7,
       .created_local_transaction_id = 7},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 18),
       .object_class = "table",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .table_type = "BASE TABLE",
       .catalog_generation_id = 3,
       .created_local_transaction_id = 3,
       .cluster_path = true},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 19),
       .object_class = "user",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 20),
       .object_class = "group",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 21),
       .object_class = "role",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 22),
       .object_class = "security_user_group_membership",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 20),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 19),
       .table_type = "group",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 23),
       .object_class = "security_group_user_membership",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 19),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 20),
       .table_type = "user",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 24),
       .object_class = "security_user_role_membership",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 21),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 19),
       .table_type = "role",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 25),
       .object_class = "security_role_user_membership",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 19),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 21),
       .table_type = "user",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 26),
       ...
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 27),
       ...
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 28),
       .object_class = "security_grant",
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 10),
       .parent_object_uuid = scratchbird::tests::FixtureUuid(1325, 19),
       .table_type = "principal",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 29),
       .object_class = "security_policy",
       .catalog_generation_id = 2,
       .created_local_transaction_id = 2},
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 30),
...
std::vector<info::SysInformationResolverNameSource> ResolverNames() {
  return {
      ...
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 2),
       .object_class = "schema",
       .scope_uuid = scratchbird::tests::FixtureUuid(1325, 1),
       .language_tag = "en",
       .name_class = "primary",
      ...
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 4),
       .object_class = "table",
       .scope_uuid = scratchbird::tests::FixtureUuid(1325, 2),
       .language_tag = "en",
       .name_class = "primary",
      ...
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 5),
       .object_class = "view",
       .scope_uuid = scratchbird::tests::FixtureUuid(1325, 3),
       .language_tag = "en",
       .name_class = "primary",
      ...
      {.object_uuid = scratchbird::tests::FixtureUuid(1325, 7),
       .object_class = "schema",
       .scope_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       .language_tag = "en",
       .name_class = "primary",
...
std::vector<info::SysInformationColumnSource> Columns() {
  return {
      {.relation_object_uuid = scratchbird::tests::FixtureUuid(1325, 10),
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
       ...
       .catalog_generation_id = 3},
      {.relation_object_uuid = scratchbird::tests::FixtureUuid(1325, 16),
       .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
...
std::vector<info::SysInformationAgentPolicySource> AgentPolicies() {
  return {
      {.agent_uuid = scratchbird::tests::FixtureUuid(1325, 31),
       .agent_ref = "memory_governor",
       .policy_uuid = scratchbird::tests::FixtureUuid(1325, 32),
       .policy_ref = "default_memory_policy",
       .policy_name = "default_memory_policy",
       .policy_family = "memory",
       .version_uuid = scratchbird::tests::FixtureUuid(1325, 33),
...
void TestReadableCatalogProjectionRows() {
  ...
  const auto* programmability_node_id = info::SysInformationField(programmability, "node_id");
  Require(programmability_node_id && std::holds_alternative<info::SysInformationBinaryValue>(*programmability_node_id), "node key must be binary");
  ...
  Require(info::SysInformationField(navigator_tree.rows[procedure_index], "parent_node_id") != nullptr &&
          *info::SysInformationField(navigator_tree.rows[procedure_index], "parent_node_id") == *programmability_node_id,
...
void TestSettingsAgentsAndProtectedMaterialRows() {
  ...
  Require(RowContainsFieldValue(configuration_policy_bindings, "policy_uuid", scratchbird::tests::FixtureUuid(1325, 32)),
...
void TestSessionRoleProjectionRows() {
  ...
  context.principal_uuid = scratchbird::tests::FixtureUuid(1325, 34);
  context.requested_role_name = "sysarch";
  context.active_role_name = "sysarch";
  context.active_role_uuid = scratchbird::tests::FixtureUuid(1325, 21);
  context.effective_role_names.push_back("sysarch");
  context.effective_role_uuids.push_back(scratchbird::tests::FixtureUuid(1325, 21));
  context.effective_group_uuids.push_back(scratchbird::tests::FixtureUuid(1325, 35));
...
void TestMissingNameStrictModeFailsClosed() {
  ...
  objects.push_back({.object_uuid = scratchbird::tests::FixtureUuid(1325, 36),
                     .object_class = "table",
                     .schema_uuid = scratchbird::tests::FixtureUuid(1325, 6),
                     .table_type = "BASE TABLE",
                     .catalog_generation_id = 3,
