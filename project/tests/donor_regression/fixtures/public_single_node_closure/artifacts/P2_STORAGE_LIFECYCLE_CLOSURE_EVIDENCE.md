...
${PUBLIC_TOOL_ROOT}/skills/scratchbird-mga-transaction-authority/scripts/mga_policy_gate.py --repo . project/src/storage project/src/core/metrics project/tests/database_lifecycle project/tests/donor_regression/fixtures/public_single_node_closure/public_proof
git diff --check -- project/src/storage project/src/core/metrics project/tests/database_lifecycle project/tests/donor_regression/fixtures/public_single_node_closure/public_proof
```
