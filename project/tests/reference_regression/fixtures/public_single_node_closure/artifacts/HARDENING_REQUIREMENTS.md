...
- Reference original regression must compile/use reference tools where local reference
...
- No code may add SQLite, PRAGMA, WAL, reference engine storage, parser-owned
...
- Reference incompatible feature, missing reference toolchain, reference diagnostic mapping,
