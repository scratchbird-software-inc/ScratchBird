...
- `${PUBLIC_TOOL_ROOT}/skills/scratchbird-mga-transaction-authority/scripts/mga_policy_gate.py --repo . project/src/parsers project/src/engine/sblr project/src/udr project/tests/sbsql_parser_worker project/tests/reference_regression/fixtures/public_single_node_closure/public_proof`
- `python3 -m py_compile project/tests/sbsql_parser_worker/generated/matrix/sbsql_sblr_operation_matrix_static_gate.py`
- `git diff --check -- project/src/parsers/sbsql_worker project/tests/sbsql_parser_worker project/tests/reference_regression/fixtures/public_single_node_closure/public_proof`
