...
locally installed external reference tools under the ignored `tools/` directory
and writes regenerated evidence in the build tree. If the external tools are not
installed, CTest reports this lane as skipped rather than packaging the tools in
