...
Search key: SB_REFERENCE_REFERENCE_ORACLE_EXACT_ROWSET_STATUS
...
|---|---|
| Exact default rowset missing | REFERENCE.ORACLE.CATALOG.EXACT_ROWSET_MISSING |
| Catalog column omitted | REFERENCE.ORACLE.CATALOG.COLUMN_MISSING |
| Catalog column order unknown | REFERENCE.ORACLE.CATALOG.COLUMN_ORDER_UNKNOWN |
| Package signature missing | REFERENCE.ORACLE.CATALOG.PACKAGE_SIGNATURE_MISSING |
| Raw secret copied into seed material | REFERENCE.ORACLE.CATALOG.RAW_SECRET_FORBIDDEN |
| Reference ID used as ScratchBird authority | REFERENCE.ORACLE.CATALOG.REFERENCE_ID_AUTHORITY_FORBIDDEN |
| GV$ surface exposed without cluster schema | REFERENCE.ORACLE.CATALOG.CLUSTER_SCHEMA_ABSENT |
| Source-backed pending row used as implemented | REFERENCE.ORACLE.SOURCE_BACKED_PENDING |
...
| ORACLE-SEED-002 | USER/ALL/DBA visibility differs exactly according to reference privilege rules. |
...
| ORACLE-SEED-006 | Every reference identifier maps to a ScratchBird UUID-backed object or an explicitly classified runtime alias. |
