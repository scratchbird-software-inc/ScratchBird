...
Search key: SB_REFERENCE_REFERENCE_ORACLE_BUILTIN_MAPPING_STATUS
...
- reference-rendered diagnostic vector
- conformance tests
...
|---|---|
| Exact signature missing | REFERENCE.ORACLE.BUILTIN.SIGNATURE_MISSING |
| Package surface missing | REFERENCE.ORACLE.PACKAGE.SURFACE_MISSING |
| PL/SQL construct unmapped | REFERENCE.ORACLE.PLSQL.MAPPING_MISSING |
| Ref cursor lifetime unspecified | REFERENCE.ORACLE.REF_CURSOR.LIFETIME_UNSPECIFIED |
| Oracle format model unspecified | REFERENCE.ORACLE.FORMAT_MODEL.MISSING |
| Non-C++ runtime requested | REFERENCE.ORACLE.NON_CPP_RUNTIME_FORBIDDEN |
| Source-backed pending behavior invoked as native | REFERENCE.ORACLE.SOURCE_BACKED_PENDING |
