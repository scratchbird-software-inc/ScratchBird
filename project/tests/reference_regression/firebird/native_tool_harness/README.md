...
locally installed external reference tool under the ignored `tools/` directory
and writes regenerated evidence in the build tree. If the external tool is not
