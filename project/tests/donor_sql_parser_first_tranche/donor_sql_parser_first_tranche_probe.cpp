...
#include "donor_worker_session.hpp"
...
bool ExpectCommonEnvelope(const Result& result,
  ...
  return Expect(result.ok, "parse result was not ok") &&
         ...
         Expect(Contains(result.sblr_envelope, "\"donor_engine_sql_executed\":false"),
                "donor SQL execution was not denied") &&
         Expect(Contains(result.sblr_envelope, "\"real_donor_file_effects\":false") ||
                    Contains(result.sblr_envelope, "\"real_firebird_file_effects\":false"),
                "real donor file effects were not denied") &&
...
bool ExpectDatatypeDescriptorPayload(
  ...
  ok &= Expect(Contains(payload,
                        "\"evidence_contract\":\"donor_datatype_descriptor_evidence.v1\""),
  ...
  ok &= Expect(Contains(payload, "\"donor_sql_executed\":false"),
               std::string(label) + " claimed donor SQL execution");
  ok &= Expect(Contains(payload,
...
bool DonorWorkerSessionChecks(std::string_view label,
  ...
  if (!Expect(Contains(wire, "WIRE ") &&
                  ...
                  Contains(wire, "\"donor_storage_authority\":false") &&
                  Contains(wire, "project/tests/donor_regression/" +
                                     std::string(expected_dialect) +
                                     "/wire_transcripts/connect_auth_startup/"),
              std::string(label) + " wire transcript mismatch")) return false;

  const auto resource = scratchbird::parser::donor::HandleWorkerCommand(
  ...
  const auto regression = scratchbird::parser::donor::HandleWorkerCommand(
  ...
  if (!Expect(Contains(regression, "REGRESSION ") &&
                  ...
                  Contains(regression, "project/tests/donor_regression/" +
                                         std::string(expected_dialect) +
  ...
  const auto invalid_wire = scratchbird::parser::donor::HandleWorkerCommand(
...
bool FirebirdChecks() {
  ...
  if (!Expect(replication_journal.parser_support_udr_route &&
                  ...
                  !replication_journal.donor_engine_sql_executed,
  ...
  if (!Expect(Contains(replication_journal.sblr_envelope,
                  ...
                  Contains(replication_journal.sblr_envelope,
                           "\"sblr_operation\":\"SBLR_DONOR_FIREBIRD_REPLICATION_ROUTE\"") &&
  ...
  if (!Expect(gbak_stdout.statement_family == "logical_stream_backup_restore" &&
                  ...
                  !gbak_stdout.donor_engine_sql_executed,
  ...
  if (!Expect(gbak_stdin.statement_family == "logical_stream_backup_restore" &&
                  ...
                  !gbak_stdin.donor_engine_sql_executed,
...
bool MysqlChecks() {
  ...
  if (!ExpectRoute(parse, "mysql", "drop tablespace ts",
                   ...
                   false, false, false, true)) return false;
  if (!DonorWorkerSessionChecks("MySQL", Profile(), "mysql")) return false;
...
bool PostgresqlChecks() {
  ...
  if (!ExpectRoute(parse, "postgresql", "drop tablespace ts",
                   ...
                   false, false, false, true)) return false;
  if (!DonorWorkerSessionChecks("PostgreSQL", Profile(), "postgresql")) return false;
  ...
  if (!Expect(copy_stdin.statement_family == "logical_stream_backup_restore" &&
                  ...
                  !copy_stdin.real_donor_file_effects &&
                  !copy_stdin.donor_engine_sql_executed &&
  ...
  if (!Expect(copy_stdout.statement_family == "logical_stream_backup_restore" &&
                  ...
                  !copy_stdout.real_donor_file_effects &&
                  !copy_stdout.donor_engine_sql_executed &&
...
bool SqliteChecks() {
  ...
  if (!DonorWorkerSessionChecks("SQLite", Profile(), "sqlite")) return false;
...
bool MariadbChecks() {
  ...
  if (!DonorWorkerSessionChecks("MariaDB", Profile(), "mariadb")) return false;
...
bool DuckdbChecks() {
  ...
  if (!DonorWorkerSessionChecks("DuckDB", Profile(), "duckdb")) return false;
...
bool ClickhouseChecks() {
  ...
  if (!ExpectRoute(parse, "clickhouse", "select cluster_name from system.clusters",
                   "clickhouse.query.select", "SELECT")) return false;
  if (!DonorWorkerSessionChecks("ClickHouse", Profile(), "clickhouse")) return false;
...
bool TidbChecks() {
  ...
  if (!DonorWorkerSessionChecks("TiDB", Profile(), "tidb")) return false;
...
bool VitessChecks() {
  ...
  if (!DonorWorkerSessionChecks("Vitess", Profile(), "vitess")) return false;
...
bool CockroachdbChecks() {
  ...
  if (!DonorWorkerSessionChecks("CockroachDB", Profile(), "cockroachdb")) return false;
...
bool YugabytedbChecks() {
  ...
  if (!DonorWorkerSessionChecks("YugabyteDB", Profile(), "yugabytedb")) return false;
...
bool CassandraChecks() {
  ...
  if (!ExpectUnsupportedDenied(parse, "cassandra", "nodetool repair ks",
                               ...
                               "CASSANDRA.AUTHORITY.UNSUPPORTED_DENIED")) return false;
  if (!DonorWorkerSessionChecks("Cassandra", Profile(), "cassandra")) return false;
...
bool MongodbChecks() {
  ...
  if (!DonorWorkerSessionChecks("MongoDB", Profile(), "mongodb")) return false;
...
bool RedisChecks() {
  ...
  if (!DonorWorkerSessionChecks("Redis", Profile(), "redis")) return false;
...
bool OpensearchSqlPplChecks() {
  ...
  if (!ExpectRoute(parse, "opensearch_sql_ppl", "source=idx | eval score=1 -- lookup join stats ML AD",
                   "opensearch_sql_ppl.ppl.source", "SOURCE")) return false;
  if (!DonorWorkerSessionChecks("OpenSearch SQL/PPL", Profile(), "opensearch_sql_ppl")) return false;
...
bool OpensearchChecks() {
  ...
  if (!ExpectRoute(parse, "opensearch", "POST /accounts -- _search _bulk _mget",
                   "opensearch.document.write", "POST")) return false;
  if (!DonorWorkerSessionChecks("OpenSearch", Profile(), "opensearch")) return false;
...
bool Neo4jChecks() {
  ...
  if (!DonorWorkerSessionChecks("Neo4j", Profile(), "neo4j")) return false;
...
bool InfluxdbChecks() {
  ...
  if (!DonorWorkerSessionChecks("InfluxDB", Profile(), "influxdb")) return false;
...
bool MilvusChecks() {
  ...
  if (!DonorWorkerSessionChecks("Milvus", Profile(), "milvus")) return false;
...
bool DoltChecks() {
  ...
  if (!DonorWorkerSessionChecks("Dolt", Profile(), "dolt")) return false;
...
bool ApacheIgniteChecks() {
  ...
  if (!ExpectRoute(parse, "apache_ignite", "control.sh --baseline",
                   ...
                   false, false, false, true)) return false;
  if (!DonorWorkerSessionChecks("Apache Ignite", Profile(), "apache_ignite")) return false;
...
bool TikvChecks() {
  ...
  if (!DonorWorkerSessionChecks("TiKV", Profile(), "tikv")) return false;
...
bool FoundationdbChecks() {
  ...
  if (!DonorWorkerSessionChecks("FoundationDB", Profile(), "foundationdb")) return false;
...
bool ImmudbChecks() {
  ...
  if (!DonorWorkerSessionChecks("immudb", Profile(), "immudb")) return false;
...
bool XtdbChecks() {
  ...
  if (!Expect(Contains(XtdbPackageIdentityJson(), "\"function_api_rows\":9") &&
                  Contains(XtdbPackageIdentityJson(), "\"donor_compatible_alias_rows\":5") &&
  ...
  if (!DonorWorkerSessionChecks("XTDB", Profile(), "xtdb")) return false;
