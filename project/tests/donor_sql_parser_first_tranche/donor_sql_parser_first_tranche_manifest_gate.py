...
"""Donor SQL parser manifest and execution_plan proof gate.

This gate ties donor parser/UDR runtime probes to the row-level donor parser
...
DIALECTS = {
    "firebird": {
        "display": "FirebirdSQL",
        "execution_plan": EXECUTION_PLAN_ROOT + "/donor-parser-firebird-implementation-readiness",
        "udr_source": "project/src/udr/sbu_firebird_parser_support/sbu_firebird_parser_support.cpp",
        "parser_source": "project/src/parsers/donor/firebird/firebird_dialect.cpp",
    ...
    "mysql": {
        "display": "MySQL",
        "execution_plan": EXECUTION_PLAN_ROOT + "/donor-parser-mysql-implementation-readiness",
        "udr_source": "project/src/udr/sbu_mysql_parser_support/sbu_mysql_parser_support.cpp",
        "parser_source": "project/src/parsers/donor/mysql/mysql_dialect.cpp",
        "package": "sbup_mysql",
    ...
    "postgresql": {
        "display": "PostgreSQL",
        "execution_plan": EXECUTION_PLAN_ROOT + "/donor-parser-postgresql-implementation-readiness",
        "udr_source": "project/src/udr/sbu_postgresql_parser_support/sbu_postgresql_parser_support.cpp",
        "parser_source": "project/src/parsers/donor/postgresql/postgresql_dialect.cpp",
    ...
    "sqlite": {
        ...
        "parser_source": "project/src/parsers/donor/sqlite/sqlite_dialect.cpp",
        "package": "sbup_sqlite",
    ...
    "mariadb": {
        ...
        "parser_source": "project/src/parsers/donor/mariadb/mariadb_dialect.cpp",
    ...
    "duckdb": {
        ...
        "parser_source": "project/src/parsers/donor/duckdb/duckdb_dialect.cpp",
        "package": "sbup_duckdb",
    ...
    "clickhouse": {
        ...
        "parser_source": "project/src/parsers/donor/clickhouse/clickhouse_dialect.cpp",
    ...
    "tidb": {
        ...
        "parser_source": "project/src/parsers/donor/tidb/tidb_dialect.cpp",
        "package": "sbup_tidb",
    ...
    "vitess": {
        ...
        "parser_source": "project/src/parsers/donor/vitess/vitess_dialect.cpp",
        "package": "sbup_vitess",
    ...
    "cockroachdb": {
        ...
        "parser_source": "project/src/parsers/donor/cockroachdb/cockroachdb_dialect.cpp",
    ...
    "yugabytedb": {
        ...
        "parser_source": "project/src/parsers/donor/yugabytedb/yugabytedb_dialect.cpp",
    ...
    "cassandra": {
        ...
        "parser_source": "project/src/parsers/donor/cassandra/cassandra_dialect.cpp",
    ...
    "mongodb": {
        ...
        "parser_source": "project/src/parsers/donor/mongodb/mongodb_dialect.cpp",
    ...
    "redis": {
        ...
        "parser_source": "project/src/parsers/donor/redis/redis_dialect.cpp",
        "package": "sbup_redis",
    ...
    "opensearch_sql_ppl": {
        ...
        "parser_source": "project/src/parsers/donor/opensearch_sql_ppl/opensearch_sql_ppl_dialect.cpp",
    ...
    "opensearch": {
        ...
        "parser_source": "project/src/parsers/donor/opensearch/opensearch_dialect.cpp",
        "package": "sbup_opensearch",
        "logical_package": "opensearch-v3_6",
        "routine_prefix": "sbu_opensearch",
        "test_root": "project/tests/donor_regression/opensearch/rest_dsl",
        "gate_prefix": "OSREST",
    ...
    "neo4j": {
        ...
        "parser_source": "project/src/parsers/donor/neo4j/neo4j_dialect.cpp",
        "package": "sbup_neo4j",
    ...
    "influxdb": {
        ...
        "parser_source": "project/src/parsers/donor/influxdb/influxdb_dialect.cpp",
    ...
    "milvus": {
        ...
        "parser_source": "project/src/parsers/donor/milvus/milvus_dialect.cpp",
        "package": "sbup_milvus",
    ...
    "dolt": {
        ...
        "parser_source": "project/src/parsers/donor/dolt/dolt_dialect.cpp",
        "package": "sbup_dolt",
    ...
    "apache_ignite": {
        ...
        "parser_source": "project/src/parsers/donor/apache_ignite/apache_ignite_dialect.cpp",
    ...
    "tikv": {
        ...
        "parser_source": "project/src/parsers/donor/tikv/tikv_dialect.cpp",
        "package": "sbup_tikv",
    ...
    "foundationdb": {
        ...
        "parser_source": "project/src/parsers/donor/foundationdb/foundationdb_dialect.cpp",
    ...
    "immudb": {
        ...
        "parser_source": "project/src/parsers/donor/immudb/immudb_dialect.cpp",
        "package": "sbup_immudb",
    ...
    "xtdb": {
        ...
        "parser_source": "project/src/parsers/donor/xtdb/xtdb_dialect.cpp",
        "package": "sbup_xtdb",
...
def require_management_manifest(repo_root: pathlib.Path, dialect: str) -> list[str]:
    test_root = DIALECTS[dialect].get("test_root", f"project/tests/donor_regression/{dialect}")
    path = require_file(
        repo_root,
...
def main() -> int:
    ...
    evidence: dict[str, object] = {
        "gate": "donor_sql_parser_first_tranche_manifest_gate",
        "status": "passed",
        "accepted_dialects": [],
        ...
        dialect_evidence.append(
            {
                ...
                "runtime_gate": "donor_sql_parser_first_tranche",
            }
        )
...
if __name__ == "__main__":
    try:
        ...
        print(f"donor_sql_parser_first_tranche_manifest_gate: {exc}", file=sys.stderr)
        raise SystemExit(1)
