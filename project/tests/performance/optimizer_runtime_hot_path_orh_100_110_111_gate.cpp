...
void ProveSnapshotCacheResultContractHardening() {
  ...
  Require(Contains(hit.evidence, "snapshot_cache_statement_context_match=true") &&
          ...
          "exact producing statement/catalog equality proof missing");
...
void ProveSnapshotCacheVolatilityAuthorityAndNegativeRefusals() {
  ...
  Require(authority_decision.diagnostic_code ==
          ...
          "non-engine cache authority diagnostic mismatch");
  Require(Contains(authority_decision.evidence, "cache_authority=none"),
          "cache must retain no authority booleans");
