...
agents::DurableAgentCatalogImage DurableCatalog() {
  ...
  image.authority.mga_transaction_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000001"));
  image.authority.transaction_generation = 11;
  image.authority.evidence_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000002"));
  image.authority.database_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000003"));
  image.authority.catalog_storage_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000004"));
  ...
  instance.instance_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000010"));
  instance.agent_type_id = "page_allocation_manager";
  instance.policy_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000011"));
...
agents::AgentActionAuthorityProvenance SealedAuthority() {
  ...
  authority.principal_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000020"));
  authority.scope_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000021"));
  authority.provenance_evidence_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000022"));
...
std::vector<agents::AgentObservedMetricSnapshot> ObservedMetricSnapshots(
  ...
  for (const auto& dependency : descriptor->metric_dependencies) {
    ...
    snapshot.evidence_uuid = NativeFixtureIdentity(FixtureIdentityForLabel("metric-evidence-" + std::to_string(ordinal)));
...
agents::AgentActionRequest Action(std::string uuid,
  ...
  action.instance_uuid = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000010"));
  ...
  action.inputs["evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000030"));
  action.inputs["metric_digest"] = ObservedMetricDigestForAction(authority);
  action.inputs["safety_envelope_version"] = "1";
  action.inputs["safety_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000031"));
  action.inputs["policy_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000032"));
  action.inputs["rollout_mode"] = dry_run ? "dry_run" : "live";
  action.inputs["rollout_state"] = "active";
  action.inputs["rollout_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000033"));
  ...
  action.inputs["rate_limit_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000034"));
  action.inputs["blast_radius_units"] = "1";
  action.inputs["max_blast_radius_units"] = "3";
  action.inputs["blast_radius_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000035"));
  ...
  action.inputs["backup_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000036"));
  action.inputs["checkpoint_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000037"));
  action.inputs["storage_check_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000038"));
  action.inputs["transaction_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000039"));
  action.inputs["compensation_required"] = dry_run ? "false" : "true";
  action.inputs["rollback_required"] = dry_run ? "false" : "true";
  action.inputs["compensation_plan_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-00000000003a"));
  action.inputs["rollback_plan_evidence_uuid"] = BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-00000000003b"));
...
agents::AgentActionDispatchResult Dispatch(
  ...
  if (include_provider_execution_context) {
    ...
    request.provider_execution_context.transaction_uuid =
        BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000090"));
    ...
    request.provider_execution_context.registry_evidence_uuid =
        BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000091"));
  }
...
void TestProviderRefusals() {
  ...
  const auto no_provider =
      Dispatch(&catalog, &empty_registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000040")), "idem-no-provider"));
  ...
  auto missing = Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000041")), "idem-missing");
  ...
  const auto unavailable =
      Dispatch(&catalog, &unavailable_registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000047")),
  ...
  const auto no_mutation =
      Dispatch(&catalog, &no_mutation_registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000048")),
  ...
  const auto missing_engine_context =
      Dispatch(&catalog, &registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000049")),
...
void TestLiveDispatchIdempotencyAndCatalogRecord() {
  ...
  const auto first =
      Dispatch(&catalog, &registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000043")), "idem-live"));
  ...
  const auto duplicate =
      Dispatch(&catalog, &registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000044")), "idem-live"));
...
void TestVerificationFailureRequiresCompensationOrReplay() {
  ...
  const auto failed =
      Dispatch(&catalog, &registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000045")), "idem-fail"),
               false);
...
void TestCatalogRoundTripIncludesActionExecutionFields() {
  ...
  const auto dispatched =
      Dispatch(&catalog, &registry, SealedAuthority(),
               Action(BinaryFixtureIdentity(scratchbird::tests::FixtureUuidLiteral("019f0200-0000-7000-8000-000000000046")), "idem-roundtrip"));
