...
agents::AgentRuntimeContext RuntimeContext() {
  ...
  context.principal_uuid = scratchbird::tests::FixtureUuidLiteral("019f0083-0000-7000-8000-000000000001");
  context.database_uuid = scratchbird::tests::FixtureUuidLiteral("019f0083-0000-7000-8000-000000000002");
