...
[[noreturn]] void Fail(const char* message) {
  std::cerr << "CSC-TEST-003623: " << message << '\n';
...
struct Fixture {
  ...
  ~Fixture() {
    ...
    std::filesystem::remove(
        database_path +
            ".sb.sblr_executor_availability_registry.v1.optimizer_stats_drop",
        ignored);
  }
};
...
Fixture MakeFixture() {
  ...
  fixture.database_path =
      (std::filesystem::temp_directory_path() /
       ("sb_optimizer_stats_drop_availability_" +
...
api::EngineRequestContext Context(const Fixture& fixture,
  ...
  context.database_uuid = scratchbird::tests::FixtureUuidLiteral("019d0000-0000-7000-8000-000000003623");
...
api::SblrExecutorAvailabilityRowIdentity Identity() {
  return {api::kSblrOptimizerStatsDropExecutorId,
          api::kSblrOptimizerStatsDropOpcodeCode,
          api::kSblrOptimizerStatsDropOpcodeVersion,
          api::kSblrOptimizerStatsDropOperandDescriptorId,
          api::kSblrOptimizerStatsDropResultDescriptorId,
          api::kSblrOptimizerStatsDropResultDescriptorVersion};
}
...
int main() {
  ...
  auto admission_context = Context(
      fixture, scratchbird::tests::FixtureUuidLiteral("019d0000-0000-7000-8000-000000003624"));
  ...
  Require(admitted.ok && admitted.cohort != nullptr &&
          ...
          "optimizer-stats DROP cohort was not installed");
  ...
  Require(pinned.ok && pinned.snapshot.installed &&
          ...
          "statement cohort did not retain its immutable exact DROP row");
  ...
  revoke.reason_code = "CSC-TEST-003623";
  const auto revoked =
  ...
  Require(revoked.ok && !revoked.snapshot.installed &&
          ...
          "optimizer-stats DROP executor revocation was not published");
  ...
  Require(diagnostic.code == "SBLR.OPCODE.EXECUTOR_EVIDENCE_MISSING" &&
              ...
              !current.installed,
          "pinned cohort hid current optimizer-stats DROP revocation");

  auto next_statement = Context(
      fixture, scratchbird::tests::FixtureUuidLiteral("019d0000-0000-7000-8000-000000003625"));
  ...
  Require(observed.ok && observed.cohort != nullptr &&
              ...
              observed.rows.front().snapshot.availability_state ==
                  api::SblrExecutorAvailabilityState::revoked,
          "next statement did not observe revoked DROP authority");
  return EXIT_SUCCESS;
}
