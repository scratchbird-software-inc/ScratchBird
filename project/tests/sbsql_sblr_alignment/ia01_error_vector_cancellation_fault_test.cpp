...
void VerifyRetainedReceiptCleanup(sb_engine_session_t session,
  ...
  for(bool retain : {false,true}) {
    ...
    const auto owner_uuid=RawUuid(owner.session_uuid);
