...
#include <cassert>
int main(){using namespace scratchbird::engine::internal_api;EngineRequestContext c;c.security_context_present=true;c.statement_uuid=scratchbird::tests::FixtureUuid(1154, 28);auto x=CompileSblrSessionSettingSetDescriptor(c,scratchbird::tests::FixtureUuid(1154, 28),1,1);assert(x.ok);c.query_cancellation_requested=[](){return true;};assert(!ConsumeSblrSessionSettingSetDescriptor(c,x.descriptor).ok);return 0;}
