...
def main() -> int:
    ...
    try:
        ...
        if args.operation == "source-map":
            ...
            expected = ()
        elif args.operation in ("ddl-create-aggregate", "ddl-alter-aggregate", "ddl-drop-aggregate", "ddl-purge-system-history", "ddl-set-index-optimizer-eligibility"):
            expected = ()
