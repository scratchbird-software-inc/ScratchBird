...
def main() -> int:
    ...
    try:
        ...
        if args.operation == "show-version":
            ...
            expected = ()
        elif args.operation in ("accel-llvm-invalidate", "accel-gpu-policy-set", "accel-gpu-inspect", "accel-gpu-invalidate", "bridge-describe-capabilities", "bridge-open-channel", "bridge-authenticate"):
            expected = ()
