...
def main() -> int:
    ...
    try:
        ...
        if args.operation in ("ddl-create-operator-class", "ddl-drop-operator-class", "ddl-create-operator-family", "ddl-alter-operator-family"):
