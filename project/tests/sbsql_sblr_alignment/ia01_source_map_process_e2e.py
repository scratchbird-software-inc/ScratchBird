...
def main() -> int:
    ...
    try:
        ...
        if args.operation == "show-version":
            ...
            expected = ()
        elif args.operation in ("accel-llvm-invalidate", "accel-gpu-policy-set", "accel-gpu-inspect", "accel-gpu-invalidate"):
            expected = ()
