...
scratchbird::udr::runtime::UdrStatus MysqlLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuMysqlPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_mysql_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuMysqlPackageUuid);
