...
scratchbird::udr::runtime::UdrStatus YugabytedbLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuYugabytedbPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_yugabytedb_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuYugabytedbPackageUuid);
