...
scratchbird::udr::runtime::UdrStatus SqliteLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuSqlitePackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_sqlite_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuSqlitePackageUuid);
