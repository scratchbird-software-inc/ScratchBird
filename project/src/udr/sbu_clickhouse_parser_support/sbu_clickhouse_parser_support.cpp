...
scratchbird::udr::runtime::UdrStatus ClickhouseLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuClickhousePackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_clickhouse_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuClickhousePackageUuid);
