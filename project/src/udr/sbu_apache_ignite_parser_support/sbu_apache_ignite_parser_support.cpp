...
scratchbird::udr::runtime::UdrStatus ApacheIgniteLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuApacheIgnitePackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_apache_ignite_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuApacheIgnitePackageUuid);
