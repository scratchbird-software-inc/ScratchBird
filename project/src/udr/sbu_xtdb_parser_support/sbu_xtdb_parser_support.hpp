...
UdrResult sbu_xtdb_validate_syntax(std::string_view sql_text,
                                    std::string_view profile);
UdrResult sbu_xtdb_parse_to_sblr(std::string_view sql_text,
                                  std::string_view context_packet);
UdrResult sbu_xtdb_normalize(std::string_view sql_text,
                              std::string_view profile);
UdrResult sbu_xtdb_describe_statement(std::string_view sql_text,
                                       std::string_view context_packet);
UdrResult sbu_xtdb_install_environment(std::string_view context_packet,
...
UdrResult sbu_xtdb_management_package_request(std::string_view operation_name,
                                               std::string_view context_packet);
