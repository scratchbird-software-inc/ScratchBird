...
scratchbird::udr::runtime::UdrStatus TidbLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuTidbPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_tidb_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuTidbPackageUuid);
