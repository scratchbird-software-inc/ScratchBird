...
scratchbird::udr::runtime::UdrStatus DuckdbLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuDuckdbPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_duckdb_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuDuckdbPackageUuid);
