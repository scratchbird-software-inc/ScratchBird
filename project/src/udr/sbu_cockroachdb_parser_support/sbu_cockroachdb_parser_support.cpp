...
scratchbird::udr::runtime::UdrStatus CockroachdbLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuCockroachdbPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_cockroachdb_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuCockroachdbPackageUuid);
