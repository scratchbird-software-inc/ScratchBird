...
scratchbird::udr::runtime::UdrStatus RedisLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuRedisPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_redis_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuRedisPackageUuid);
