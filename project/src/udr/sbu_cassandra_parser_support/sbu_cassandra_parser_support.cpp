...
scratchbird::udr::runtime::UdrStatus CassandraLifecycle(const scratchbird::udr::runtime::UdrUuid& package_uuid) {
  if (package_uuid != kSbuCassandraPackageIdentity) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_cassandra_package_descriptor() {
  ...
  descriptor.package_uuid = kSbuCassandraPackageIdentity;
