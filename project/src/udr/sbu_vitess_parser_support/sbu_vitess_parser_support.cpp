...
scratchbird::udr::runtime::UdrStatus VitessLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuVitessPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_vitess_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuVitessPackageUuid);
