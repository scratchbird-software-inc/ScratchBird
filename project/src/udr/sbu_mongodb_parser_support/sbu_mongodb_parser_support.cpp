...
scratchbird::udr::runtime::UdrStatus MongodbLifecycle(std::string_view package_uuid) {
  if (package_uuid != kSbuMongodbPackageUuid) {
...
scratchbird::udr::runtime::UdrPackageDescriptor sbu_mongodb_package_descriptor() {
  ...
  descriptor.package_uuid = std::string(kSbuMongodbPackageUuid);
