...
inline constexpr scratchbird::udr::runtime::UdrUuid kSbuOpensearchSqlPplPackageIdentity{{0x01, 0x9e, 0x13, 0xc0, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x10}};
