...
class SbpsClient {
 public:
  ...
  ServerVariableBindingResult CoordinateDdlDropOperatorFamily(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ...
  ServerVariableBindingResult CoordinateBitemporalAsOf(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateVerifiableHistoryProve(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateVerifyProofDescriptor(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateVersionedMerge(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateVersionedHashRead(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateVersionedStatusRead(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ...
  ServerVariableBindingResult CoordinateAccelLlvmInspect(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateAccelGpuCompile(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateAccelGpuInspect(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateAccelGpuInvalidate(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateBridgeDescribeCapabilities(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateBridgeOpenChannel(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ...
  ServerVariableBindingResult CoordinateBridgeBeginTransaction(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateBridgeCommitTransaction(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateBridgeRollbackTransaction(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ...
  ServerVariableBindingResult CoordinateDdlAlterTimeseriesValueCache(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
  ServerVariableBindingResult CoordinateDdlDropTimeseriesValueCache(const ParserSessionContext&,const std::vector<std::uint8_t>&) const;
