...
struct SblrParameterMappingV1 {std::uint64_t occurrence_id=0;std::uint32_t slot_ordinal=0;std::array<std::uint8_t,16> slot_uuid{},datatype_descriptor_uuid{};std::uint64_t datatype_descriptor_generation=0;std::uint8_t direction=0,nullable=0;};
