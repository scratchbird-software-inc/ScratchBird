...
// Executes one admitted production document source and its bounded relational
// tail. The route consumes and revalidates engine-issued MGA statement
// authority and cannot create or finalize a transaction.
