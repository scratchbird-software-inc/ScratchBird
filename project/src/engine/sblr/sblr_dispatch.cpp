...
SblrDispatchResult DispatchSblrOperation(SblrDispatchRequest request) {
  ...
  else if (op == "engine.op.security_create_privilege_template" || op == "engine.op.security_create_user" || op == "engine.op.sec_alter_user" || op == "engine.op.sec_create_role" || op == "engine.op.sec_drop_role" || op == "engine.op.sec_create_policy" || op == "engine.op.security_alter_privilege_template" || op == "engine.op.security_drop_privilege_template" || op == "engine.op.database_create_template_clone" || op == "engine.op.ddl_create_aggregate" || op == "engine.op.ddl_alter_aggregate" || op == "engine.op.ddl_drop_aggregate" || op == "engine.op.session_role_switch" || op == "engine.op.session_setting_set" || op == "engine.op.session_setting_reset" || op == "engine.op.session_setting_get" || op == "engine.op.session_default_qualifier_set") {
    result.accepted = true;
    result.dispatched_to_api = true;
    result.api_result.operation_id = op;
    result.api_result.ok = true;
