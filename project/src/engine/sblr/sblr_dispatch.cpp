...
SblrQueryPreflightResult PreflightSblrQueryOperation(
  ...
  if (exact_ddl_create_publication || exact_ddl_alter_publication || exact_ddl_drop_publication || exact_ddl_create_subscription || exact_ddl_alter_subscription || exact_ddl_drop_subscription || exact_ddl_create_operator) { result.ok=true; result.materialized_envelope=request.envelope; return result; }
