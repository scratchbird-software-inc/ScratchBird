...
CanonicalObjectFreeValuesExecutionResult ExecuteCanonicalObjectFreeLimitQuery(
    const CanonicalObjectFreeValuesExecutionRequest& request);
CanonicalObjectFreeValuesExecutionResult ExecuteCanonicalObjectFreeSortQuery(
    const CanonicalObjectFreeValuesExecutionRequest& request);
