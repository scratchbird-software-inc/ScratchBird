...
constexpr std::array<CanonicalOpcodeCodeRow, 395> kCanonicalOpcodeCodes{{
    ...
    {"SBLR_DDL_CREATE_SEQUENCE", 0x061Bu},
    ...
    {"SBLR_DDL_CREATE_AGGREGATE", 0x0634u},
    {"SBLR_DDL_DROP_AGGREGATE", 0x0635u},
    ...
    {"SBLR_DDL_CREATE_DICTIONARY", 0x0648u},
    {"SBLR_DDL_DROP_DICTIONARY", 0x0649u},
