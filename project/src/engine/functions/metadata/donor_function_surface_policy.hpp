...
enum class DonorFunctionSurfaceDecision {
...
struct DonorFunctionSurfacePolicy {
  DonorFunctionSurfaceDecision decision;
  ...
  bool donor_execution_authority_accepted;
  bool sblr_execution_authority;
};

struct DonorFunctionSurfaceRequest {
...
struct DonorFunctionSurfaceResult {
  bool recognized = false;
  bool accepted = false;
  bool denied = true;
  bool parser_shortcut_used = false;
  bool donor_execution_authority_accepted = false;
  ...
  DonorFunctionSurfaceDecision decision = DonorFunctionSurfaceDecision::kUnsupported;
