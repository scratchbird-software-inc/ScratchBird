...
namespace scratchbird::engine::internal_api { struct SblrLimitCoordinationResult { bool ok=false; scratchbird::engine::sblr::SblrLimitDescriptorV1 descriptor{}; EngineApiDiagnostic diagnostic; }; SblrLimitCoordinationResult CompileSblrLimitDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t,std::uint32_t,std::uint64_t); SblrLimitCoordinationResult ConsumeSblrLimitDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrLimitDescriptorV1&); }
