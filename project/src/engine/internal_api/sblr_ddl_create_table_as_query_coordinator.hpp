...
SblrDdlCreateTableAsQueryCoordinationResult CompileSblrDdlCreateTableAsQueryDescriptor(const EngineRequestContext&, const EngineUuid&, std::uint16_t, std::uint64_t);
