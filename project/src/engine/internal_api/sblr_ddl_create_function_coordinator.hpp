...
namespace scratchbird::engine::internal_api { using SblrDdlCreateFunctionCoordinationResult=SblrDdlCreateProcedureCoordinationResult; SblrDdlCreateFunctionCoordinationResult CompileSblrDdlCreateFunctionDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t,std::uint32_t,std::uint64_t); SblrDdlCreateFunctionCoordinationResult ConsumeSblrDdlCreateFunctionDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrDdlCreateFunctionDescriptorV1&); }
