...
inline auto CompileSblrSessionDefaultQualifierSetDescriptor(const EngineRequestContext& c,const EngineUuid& r,uint64_t o,uint64_t a){return CompileSblrSessionSettingSetDescriptor(c,r,o,a);}
