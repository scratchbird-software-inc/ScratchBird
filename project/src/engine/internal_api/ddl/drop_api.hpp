...
// SEARCH_KEY: SB_ENGINE_INTERNAL_API_DDL_DROP_API
struct EngineDropObjectRequest : EngineApiRequest {};
struct EngineDropObjectResult : EngineApiResult {};
EngineDropObjectResult EngineDropObject(const EngineDropObjectRequest& request);

struct EngineDropConstraintRequest : EngineApiRequest {};
