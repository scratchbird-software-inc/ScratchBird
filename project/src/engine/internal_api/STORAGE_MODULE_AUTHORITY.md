...
| `mga_relation_store/mga_relation_store_internal_support.hpp` | Narrow visibility projection and mutation-request validation for extracted store modules | Canonical MGA transaction inventory overlay | The bridge exposes derived visibility and validation only; it cannot publish or finalize transactions. |
