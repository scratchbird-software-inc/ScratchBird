...
inline SblrDdlRenameObjectCoordinationResult CompileSblrDdlRenameObjectDescriptor(const EngineRequestContext& c, const EngineUuid& r, std::uint64_t o, std::uint32_t object_occurrence, std::uint64_t a) {
