...
namespace scratchbird::engine::internal_api { struct SblrAccelGpuInvalidateCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrAccelGpuInvalidateDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;}; SblrAccelGpuInvalidateCoordinationResult CompileSblrAccelGpuInvalidateDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t); SblrAccelGpuInvalidateCoordinationResult ConsumeSblrAccelGpuInvalidateDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrAccelGpuInvalidateDescriptorV1&); }
