...
SblrDdlAlterPublicationCoordinationResult CompileSblrDdlAlterPublicationDescriptor(const EngineRequestContext&c,const EngineUuid&publication,std::uint64_t expected,std::uint8_t change,std::uint64_t availability){std::lock_guard l(mutex);SblrDdlAlterPublicationCoordinationResult o;if(!tag(c,"private_ddl_alter_publication_binder")||!c.statement_metadata_snapshot_engine_owned||!scratchbird::core::uuid::IsEngineIdentityUuid(publication) || publication != c.statement_uuid||!expected||change>4||!availability){o.diagnostic=diag("SBLR.OPERAND_INVALID","sblr.ddl_alter_publication.coordination_invalid");return o;}o.descriptor.body[0]=1;o.descriptor.body[16]=1;u64(o.descriptor.body,48,expected);o.descriptor.body[144]=change;u64(o.descriptor.body,272,availability);auto bytes=scratchbird::engine::sblr::EncodeSblrDdlAlterPublicationDescriptorV1(o.descriptor);if(bytes.empty()||!scratchbird::engine::sblr::DecodeSblrDdlAlterPublicationDescriptorV1(bytes.data(),bytes.size(),&o.descriptor,nullptr)){o.diagnostic=diag("SBLR.OPERAND_INVALID","sblr.ddl_alter_publication.descriptor_invalid");return o;}live[key(o.descriptor)]=o.descriptor;o.ok=true;o.diagnostic=diag("OK","ok");return o;}
