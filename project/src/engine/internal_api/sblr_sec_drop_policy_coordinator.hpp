...
namespace scratchbird::engine::internal_api { struct SblrSecDropPolicyCoordinationResult { bool ok=false; scratchbird::engine::sblr::SblrSecDropPolicyDescriptorV1 descriptor{}; EngineApiDiagnostic diagnostic{}; }; SblrSecDropPolicyCoordinationResult CompileSblrSecDropPolicyDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t,std::uint64_t); SblrSecDropPolicyCoordinationResult ConsumeSblrSecDropPolicyDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrSecDropPolicyDescriptorV1&); }
