...
namespace scratchbird::engine::internal_api { using SblrDdlAlterFunctionCoordinationResult=SblrDdlCreateFunctionCoordinationResult; SblrDdlAlterFunctionCoordinationResult CompileSblrDdlAlterFunctionDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t,std::uint32_t,std::uint64_t); SblrDdlAlterFunctionCoordinationResult ConsumeSblrDdlAlterFunctionDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrDdlAlterFunctionDescriptorV1&); }
