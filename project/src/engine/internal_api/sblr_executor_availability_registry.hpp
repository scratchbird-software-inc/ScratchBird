...
inline constexpr const char* kSblrDmlTimeseriesSchemaWriteExecutorId="engine.op.dml_timeseries_schema_write"; inline constexpr std::uint16_t kSblrDmlTimeseriesSchemaWriteOpcodeCode=1648; inline constexpr const char* kSblrDmlTimeseriesSchemaWriteOpcodeVersion="1.0"; inline constexpr const char* kSblrDmlTimeseriesSchemaWriteOperandDescriptorId="timeseries_schema_write_descriptor"; inline constexpr const char* kSblrDmlTimeseriesSchemaWriteResultDescriptorId="timeseries_write_result"; inline constexpr std::uint16_t kSblrDmlTimeseriesSchemaWriteResultDescriptorVersion=1;
...
inline constexpr const char* kSblrSystemConfigGetExecutorId="engine.op.system_config_get";inline constexpr std::uint16_t kSblrSystemConfigGetOpcodeCode=5126;inline constexpr const char* kSblrSystemConfigGetOpcodeVersion="1.0";inline constexpr const char* kSblrSystemConfigGetOperandDescriptorId="system_config_get_descriptor";inline constexpr const char* kSblrSystemConfigGetResultDescriptorId="management_result";inline constexpr std::uint16_t kSblrSystemConfigGetResultDescriptorVersion=1;
inline constexpr const char* kSblrSystemConfigResetExecutorId="engine.op.system_config_reset";inline constexpr std::uint16_t kSblrSystemConfigResetOpcodeCode=5127;inline constexpr const char* kSblrSystemConfigResetOpcodeVersion="1.0";inline constexpr const char* kSblrSystemConfigResetOperandDescriptorId="system_config_reset_descriptor";inline constexpr const char* kSblrSystemConfigResetResultDescriptorId="management_result";inline constexpr std::uint16_t kSblrSystemConfigResetResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateRuleExecutorId="engine.op.ddl_create_rule";inline constexpr std::uint16_t kSblrDdlCreateRuleOpcodeCode=1580;inline constexpr const char* kSblrDdlCreateRuleOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateRuleOperandDescriptorId="create_rule_descriptor";inline constexpr const char* kSblrDdlCreateRuleResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateRuleResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlDropRuleExecutorId="engine.op.ddl_drop_rule";inline constexpr std::uint16_t kSblrDdlDropRuleOpcodeCode=1581;inline constexpr const char* kSblrDdlDropRuleOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropRuleOperandDescriptorId="drop_rule_descriptor";inline constexpr const char* kSblrDdlDropRuleResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropRuleResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreatePublicationExecutorId="engine.op.ddl_create_publication";inline constexpr std::uint16_t kSblrDdlCreatePublicationOpcodeCode=1582;inline constexpr const char* kSblrDdlCreatePublicationOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreatePublicationOperandDescriptorId="create_publication_descriptor";inline constexpr const char* kSblrDdlCreatePublicationResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreatePublicationResultDescriptorVersion=1;
...
inline constexpr const char* kSblrDdlDropForeignTableExecutorId="engine.op.ddl_drop_foreign_table";inline constexpr std::uint16_t kSblrDdlDropForeignTableOpcodeCode=1577;inline constexpr const char* kSblrDdlDropForeignTableOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropForeignTableOperandDescriptorId="drop_foreign_table_descriptor";inline constexpr const char* kSblrDdlDropForeignTableResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropForeignTableResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateFdwExecutorId="engine.op.ddl_create_fdw";inline constexpr std::uint16_t kSblrDdlCreateFdwOpcodeCode=1578;inline constexpr const char* kSblrDdlCreateFdwOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateFdwOperandDescriptorId="create_fdw_descriptor";inline constexpr const char* kSblrDdlCreateFdwResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateFdwResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlDropFdwExecutorId="engine.op.ddl_drop_fdw";inline constexpr std::uint16_t kSblrDdlDropFdwOpcodeCode=1579;inline constexpr const char* kSblrDdlDropFdwOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropFdwOperandDescriptorId="drop_fdw_descriptor";inline constexpr const char* kSblrDdlDropFdwResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropFdwResultDescriptorVersion=1;
inline constexpr const char* kSblrSecurityCreateUserExecutorId="engine.op.sec_create_user";inline constexpr std::uint16_t kSblrSecurityCreateUserOpcodeCode=1792;inline constexpr const char* kSblrSecurityCreateUserOpcodeVersion="1.0";inline constexpr const char* kSblrSecurityCreateUserOperandDescriptorId="create_user_descriptor";inline constexpr const char* kSblrSecurityCreateUserResultDescriptorId="security_result";inline constexpr std::uint16_t kSblrSecurityCreateUserResultDescriptorVersion=1;inline constexpr const char* kSblrSecurityAlterUserExecutorId="engine.op.sec_alter_user";inline constexpr std::uint16_t kSblrSecurityAlterUserOpcodeCode=1793;inline constexpr const char* kSblrSecurityAlterUserOpcodeVersion="1.0";inline constexpr const char* kSblrSecurityAlterUserOperandDescriptorId="alter_user_descriptor";inline constexpr const char* kSblrSecurityAlterUserResultDescriptorId="security_result";inline constexpr std::uint16_t kSblrSecurityAlterUserResultDescriptorVersion=1;
inline constexpr const char* kSblrSecurityAlterPolicyExecutorId="engine.op.sec_alter_policy";inline constexpr std::uint16_t kSblrSecurityAlterPolicyOpcodeCode=1798;inline constexpr const char* kSblrSecurityAlterPolicyOpcodeVersion="1.0";inline constexpr const char* kSblrSecurityAlterPolicyOperandDescriptorId="security_policy_descriptor";inline constexpr const char* kSblrSecurityAlterPolicyResultDescriptorId="security_result";inline constexpr std::uint16_t kSblrSecurityAlterPolicyResultDescriptorVersion=1;
inline constexpr const char* kSblrSecurityPolicyShowExecutorId="security.policy.show";inline constexpr std::uint16_t kSblrSecurityPolicyShowOpcodeCode=1807;inline constexpr const char* kSblrSecurityPolicyShowOpcodeVersion="1.0";inline constexpr const char* kSblrSecurityPolicyShowOperandDescriptorId="security_policy_show_descriptor";inline constexpr const char* kSblrSecurityPolicyShowResultDescriptorId="security_policy_result";inline constexpr std::uint16_t kSblrSecurityPolicyShowResultDescriptorVersion=1;
...
inline constexpr const char* kSblrDdlDropTemporaryTableExecutorId="engine.op.ddl_drop_temporary_table";inline constexpr std::uint16_t kSblrDdlDropTemporaryTableOpcodeCode=1613;inline constexpr const char* kSblrDdlDropTemporaryTableOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropTemporaryTableOperandDescriptorId="drop_temporary_table_descriptor";inline constexpr const char* kSblrDdlDropTemporaryTableResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropTemporaryTableResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateTemporaryTableExecutorId="engine.op.ddl_create_temporary_table";inline constexpr std::uint16_t kSblrDdlCreateTemporaryTableOpcodeCode=1612;inline constexpr const char* kSblrDdlCreateTemporaryTableOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateTemporaryTableOperandDescriptorId="create_temporary_table_descriptor";inline constexpr const char* kSblrDdlCreateTemporaryTableResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateTemporaryTableResultDescriptorVersion=1;
...
inline constexpr const char* kSblrDdlRenameObjectExecutorId="engine.op.ddl_rename_object";inline constexpr std::uint16_t kSblrDdlRenameObjectOpcodeCode=1572;inline constexpr const char* kSblrDdlRenameObjectOpcodeVersion="1.0";inline constexpr const char* kSblrDdlRenameObjectOperandDescriptorId="rename_object_descriptor";inline constexpr const char* kSblrDdlRenameObjectResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlRenameObjectResultDescriptorVersion=1;
...
inline constexpr const char* kSblrDatabaseSerializeLogicalSnapshotExecutorId="engine.op.database_serialize_logical_snapshot";inline constexpr std::uint16_t kSblrDatabaseSerializeLogicalSnapshotOpcodeCode=1631;inline constexpr const char* kSblrDatabaseSerializeLogicalSnapshotOpcodeVersion="1.0";inline constexpr const char* kSblrDatabaseSerializeLogicalSnapshotOperandDescriptorId="logical_snapshot_serialization_descriptor";inline constexpr const char* kSblrDatabaseSerializeLogicalSnapshotResultDescriptorId="logical_snapshot_buffer_descriptor";inline constexpr std::uint16_t kSblrDatabaseSerializeLogicalSnapshotResultDescriptorVersion=1;
inline constexpr const char* kSblrDatabaseDeserializeLogicalSnapshotExecutorId="engine.op.database_deserialize_logical_snapshot";inline constexpr std::uint16_t kSblrDatabaseDeserializeLogicalSnapshotOpcodeCode=1632;inline constexpr const char* kSblrDatabaseDeserializeLogicalSnapshotOpcodeVersion="1.0";inline constexpr const char* kSblrDatabaseDeserializeLogicalSnapshotOperandDescriptorId="logical_snapshot_deserialization_descriptor";inline constexpr const char* kSblrDatabaseDeserializeLogicalSnapshotResultDescriptorId="management_operation_result";inline constexpr std::uint16_t kSblrDatabaseDeserializeLogicalSnapshotResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateMacroExecutorId="engine.op.ddl_create_macro";inline constexpr std::uint16_t kSblrDdlCreateMacroOpcodeCode=1633;inline constexpr const char* kSblrDdlCreateMacroOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateMacroOperandDescriptorId="macro_descriptor";inline constexpr const char* kSblrDdlCreateMacroResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateMacroResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlDropMacroExecutorId="engine.op.ddl_drop_macro";inline constexpr std::uint16_t kSblrDdlDropMacroOpcodeCode=1634;inline constexpr const char* kSblrDdlDropMacroOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropMacroOperandDescriptorId="macro_drop_descriptor";inline constexpr const char* kSblrDdlDropMacroResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropMacroResultDescriptorVersion=1;
inline constexpr const char* kSblrAdminRegisterExternalRelationResolverExecutorId="engine.op.admin_register_external_relation_resolver";inline constexpr std::uint16_t kSblrAdminRegisterExternalRelationResolverOpcodeCode=1635;inline constexpr const char* kSblrAdminRegisterExternalRelationResolverOpcodeVersion="1.0";inline constexpr const char* kSblrAdminRegisterExternalRelationResolverOperandDescriptorId="external_relation_resolver_registration_descriptor";inline constexpr const char* kSblrAdminRegisterExternalRelationResolverResultDescriptorId="management_operation_result";inline constexpr std::uint16_t kSblrAdminRegisterExternalRelationResolverResultDescriptorVersion=1;
inline constexpr const char* kSblrAdminUnregisterExternalRelationResolverExecutorId="engine.op.admin_unregister_external_relation_resolver";inline constexpr std::uint16_t kSblrAdminUnregisterExternalRelationResolverOpcodeCode=1636;inline constexpr const char* kSblrAdminUnregisterExternalRelationResolverOpcodeVersion="1.0";inline constexpr const char* kSblrAdminUnregisterExternalRelationResolverOperandDescriptorId="external_relation_resolver_unregistration_descriptor";inline constexpr const char* kSblrAdminUnregisterExternalRelationResolverResultDescriptorId="management_operation_result";inline constexpr std::uint16_t kSblrAdminUnregisterExternalRelationResolverResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateDictionaryExecutorId="engine.op.ddl_create_dictionary";inline constexpr std::uint16_t kSblrDdlCreateDictionaryOpcodeCode=1637;inline constexpr const char* kSblrDdlCreateDictionaryOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateDictionaryOperandDescriptorId="external_dictionary_descriptor";inline constexpr const char* kSblrDdlCreateDictionaryResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateDictionaryResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlDropDictionaryExecutorId="engine.op.ddl_drop_dictionary";inline constexpr std::uint16_t kSblrDdlDropDictionaryOpcodeCode=1638;inline constexpr const char* kSblrDdlDropDictionaryOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropDictionaryOperandDescriptorId="external_dictionary_drop_descriptor";inline constexpr const char* kSblrDdlDropDictionaryResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropDictionaryResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlAlterDictionaryExecutorId="engine.op.ddl_alter_dictionary";inline constexpr std::uint16_t kSblrDdlAlterDictionaryOpcodeCode=1639;inline constexpr const char* kSblrDdlAlterDictionaryOpcodeVersion="1.0";inline constexpr const char* kSblrDdlAlterDictionaryOperandDescriptorId="external_dictionary_alter_descriptor";inline constexpr const char* kSblrDdlAlterDictionaryResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlAlterDictionaryResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateContinuousViewExecutorId="engine.op.ddl_create_continuous_view";inline constexpr std::uint16_t kSblrDdlCreateContinuousViewOpcodeCode=1640;inline constexpr const char* kSblrDdlCreateContinuousViewOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateContinuousViewOperandDescriptorId="continuous_view_descriptor";inline constexpr const char* kSblrDdlCreateContinuousViewResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateContinuousViewResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlAlterContinuousViewExecutorId="engine.op.ddl_alter_continuous_view";inline constexpr std::uint16_t kSblrDdlAlterContinuousViewOpcodeCode=1641;inline constexpr const char* kSblrDdlAlterContinuousViewOpcodeVersion="1.0";inline constexpr const char* kSblrDdlAlterContinuousViewOperandDescriptorId="continuous_view_alter_descriptor";inline constexpr const char* kSblrDdlAlterContinuousViewResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlAlterContinuousViewResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlDropContinuousViewExecutorId="engine.op.ddl_drop_continuous_view";inline constexpr std::uint16_t kSblrDdlDropContinuousViewOpcodeCode=1642;inline constexpr const char* kSblrDdlDropContinuousViewOpcodeVersion="1.0";inline constexpr const char* kSblrDdlDropContinuousViewOperandDescriptorId="continuous_view_drop_descriptor";inline constexpr const char* kSblrDdlDropContinuousViewResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlDropContinuousViewResultDescriptorVersion=1;
inline constexpr const char* kSblrDmlAsyncInsertSubmitExecutorId="engine.op.dml_async_insert_submit";inline constexpr std::uint16_t kSblrDmlAsyncInsertSubmitOpcodeCode=1643;inline constexpr const char* kSblrDmlAsyncInsertSubmitOpcodeVersion="1.0";inline constexpr const char* kSblrDmlAsyncInsertSubmitOperandDescriptorId="async_insert_submission_descriptor";inline constexpr const char* kSblrDmlAsyncInsertSubmitResultDescriptorId="async_insert_operation_descriptor";inline constexpr std::uint16_t kSblrDmlAsyncInsertSubmitResultDescriptorVersion=1;
inline constexpr const char* kSblrDmlAsyncInsertStatusExecutorId="engine.op.dml_async_insert_status";inline constexpr std::uint16_t kSblrDmlAsyncInsertStatusOpcodeCode=1644;inline constexpr const char* kSblrDmlAsyncInsertStatusOpcodeVersion="1.0";inline constexpr const char* kSblrDmlAsyncInsertStatusOperandDescriptorId="async_insert_status_descriptor";inline constexpr const char* kSblrDmlAsyncInsertStatusResultDescriptorId="async_insert_operation_descriptor";inline constexpr std::uint16_t kSblrDmlAsyncInsertStatusResultDescriptorVersion=1;
inline constexpr const char* kSblrDmlAsyncInsertCancelExecutorId="engine.op.dml_async_insert_cancel";inline constexpr std::uint16_t kSblrDmlAsyncInsertCancelOpcodeCode=1645;inline constexpr const char* kSblrDmlAsyncInsertCancelOpcodeVersion="1.0";inline constexpr const char* kSblrDmlAsyncInsertCancelOperandDescriptorId="async_insert_cancel_descriptor";inline constexpr const char* kSblrDmlAsyncInsertCancelResultDescriptorId="async_insert_operation_descriptor";inline constexpr std::uint16_t kSblrDmlAsyncInsertCancelResultDescriptorVersion=1;
inline constexpr const char* kSblrDmlConditionalMutateExecutorId="engine.op.dml_conditional_mutate";inline constexpr std::uint16_t kSblrDmlConditionalMutateOpcodeCode=1646;inline constexpr const char* kSblrDmlConditionalMutateOpcodeVersion="1.0";inline constexpr const char* kSblrDmlConditionalMutateOperandDescriptorId="conditional_mutation_descriptor";inline constexpr const char* kSblrDmlConditionalMutateResultDescriptorId="conditional_mutation_result";inline constexpr std::uint16_t kSblrDmlConditionalMutateResultDescriptorVersion=1;
inline constexpr const char* kSblrDmlCounterAddExecutorId="engine.op.dml_counter_add";inline constexpr std::uint16_t kSblrDmlCounterAddOpcodeCode=1647;inline constexpr const char* kSblrDmlCounterAddOpcodeVersion="1.0";inline constexpr const char* kSblrDmlCounterAddOperandDescriptorId="counter_delta_descriptor";inline constexpr const char* kSblrDmlCounterAddResultDescriptorId="counter_result";inline constexpr std::uint16_t kSblrDmlCounterAddResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlTimeseriesSeriesCardinalityPolicyExecutorId="engine.op.ddl_set_timeseries_series_cardinality_policy";inline constexpr std::uint16_t kSblrDdlTimeseriesSeriesCardinalityPolicyOpcodeCode=1649;inline constexpr const char* kSblrDdlTimeseriesSeriesCardinalityPolicyOpcodeVersion="1.0";inline constexpr const char* kSblrDdlTimeseriesSeriesCardinalityPolicyOperandDescriptorId="timeseries_series_cardinality_policy_descriptor";inline constexpr const char* kSblrDdlTimeseriesSeriesCardinalityPolicyResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlTimeseriesSeriesCardinalityPolicyResultDescriptorVersion=1;
inline constexpr const char* kSblrDdlCreateTimeseriesValueCacheExecutorId="engine.op.ddl_create_timeseries_value_cache";inline constexpr std::uint16_t kSblrDdlCreateTimeseriesValueCacheOpcodeCode=1650;inline constexpr const char* kSblrDdlCreateTimeseriesValueCacheOpcodeVersion="1.0";inline constexpr const char* kSblrDdlCreateTimeseriesValueCacheOperandDescriptorId="timeseries_value_cache_descriptor";inline constexpr const char* kSblrDdlCreateTimeseriesValueCacheResultDescriptorId="ddl_result";inline constexpr std::uint16_t kSblrDdlCreateTimeseriesValueCacheResultDescriptorVersion=1;
