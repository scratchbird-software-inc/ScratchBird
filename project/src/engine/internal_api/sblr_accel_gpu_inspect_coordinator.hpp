...
namespace scratchbird::engine::internal_api{struct SblrAccelGpuInspectCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrAccelGpuInspectDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;};SblrAccelGpuInspectCoordinationResult CompileSblrAccelGpuInspectDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t);SblrAccelGpuInspectCoordinationResult ConsumeSblrAccelGpuInspectDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrAccelGpuInspectDescriptorV1&);}
