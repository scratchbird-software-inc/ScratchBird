...
namespace scratchbird::engine::internal_api { struct SblrBridgeCloseSessionCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrBridgeCloseSessionDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;}; SblrBridgeCloseSessionCoordinationResult CompileSblrBridgeCloseSessionDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t); SblrBridgeCloseSessionCoordinationResult ConsumeSblrBridgeCloseSessionDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrBridgeCloseSessionDescriptorV1&); }
