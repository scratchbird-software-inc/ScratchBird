...
namespace scratchbird::engine::internal_api { struct SblrBridgeBeginTransactionCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrBridgeBeginTransactionDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;}; SblrBridgeBeginTransactionCoordinationResult CompileSblrBridgeBeginTransactionDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t); SblrBridgeBeginTransactionCoordinationResult ConsumeSblrBridgeBeginTransactionDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrBridgeBeginTransactionDescriptorV1&); }
