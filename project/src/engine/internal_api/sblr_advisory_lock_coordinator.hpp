...
namespace scratchbird::engine::internal_api{struct SblrAdvisoryLockCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrAdvisoryLockDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;};SblrAdvisoryLockCoordinationResult CompileSblrAdvisoryLockDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t,std::uint32_t,std::uint64_t);SblrAdvisoryLockCoordinationResult ConsumeSblrAdvisoryLockDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrAdvisoryLockDescriptorV1&);}
