...
namespace scratchbird::engine::internal_api{struct SblrDdlCreateNamedCollectionCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrDdlCreateNamedCollectionDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;};SblrDdlCreateNamedCollectionCoordinationResult CompileSblrDdlCreateNamedCollectionDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t);SblrDdlCreateNamedCollectionCoordinationResult ConsumeSblrDdlCreateNamedCollectionDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrDdlCreateNamedCollectionDescriptorV1&);}
