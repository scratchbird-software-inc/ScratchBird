...
using namespace mga_update_durable_detail;

// SEARCH_KEY: SB_ENGINE_MGA_UPDATE_DURABLE_STORE_IMPLEMENTATION_AUTHORITY
// Owns durable UPDATE operation-chain transitions, statement-barrier records,
// authenticated recovery coordination, instrumentation and append/fsync
// sequencing. It consumes the extracted frame store; all records remain
// mutation/recovery evidence subordinate to durable transaction inventory
// finality.
