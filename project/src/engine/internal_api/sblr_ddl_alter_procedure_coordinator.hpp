...
namespace scratchbird::engine::internal_api { using SblrDdlAlterProcedureCoordinationResult=SblrDdlCreateProcedureCoordinationResult; SblrDdlAlterProcedureCoordinationResult CompileSblrDdlAlterProcedureDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t,std::uint32_t,std::uint64_t); SblrDdlAlterProcedureCoordinationResult ConsumeSblrDdlAlterProcedureDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrDdlAlterProcedureDescriptorV1&); }
