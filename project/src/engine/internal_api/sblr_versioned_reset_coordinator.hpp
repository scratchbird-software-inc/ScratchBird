...
namespace scratchbird::engine::internal_api{struct SblrVersionedResetCoordinationResult{bool ok=false;scratchbird::engine::sblr::SblrVersionedResetDescriptorV1 descriptor{};EngineApiDiagnostic diagnostic;};SblrVersionedResetCoordinationResult CompileSblrVersionedResetDescriptor(const EngineRequestContext&,const EngineUuid&,std::uint64_t);SblrVersionedResetCoordinationResult ConsumeSblrVersionedResetDescriptor(const EngineRequestContext&,const scratchbird::engine::sblr::SblrVersionedResetDescriptorV1&);}
