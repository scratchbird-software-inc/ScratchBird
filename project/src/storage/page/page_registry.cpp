...
const std::vector<PageFamilyDescriptor>& BuiltinPageFamilyRegistry() {
  static const std::vector<PageFamilyDescriptor> registry = {
      ...
      Descriptor(PageType::index_hash, PageFamily::index, PageRegistryStatus::implemented, "index_hash", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-HASH-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_bitmap, PageFamily::index, PageRegistryStatus::implemented, "index_bitmap", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-BITMAP-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_summary, PageFamily::index, PageRegistryStatus::implemented, "index_summary", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-SUMMARY-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_inverted, PageFamily::index, PageRegistryStatus::implemented, "index_inverted", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-INVERTED-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_spatial, PageFamily::index, PageRegistryStatus::implemented, "index_spatial", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-SPATIAL-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_vector, PageFamily::index, PageRegistryStatus::implemented, "index_vector", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-VECTOR-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_graph, PageFamily::index, PageRegistryStatus::implemented, "index_graph", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-GRAPH-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_temporary, PageFamily::index, PageRegistryStatus::implemented, "index_temporary", true, true, TemporaryRoles(), "PAGE-REG-IMPLEMENTED-TEMPORARY-INDEX", false, false, true, true, true),
      Descriptor(PageType::index_statistics, PageFamily::index, PageRegistryStatus::implemented, "index_statistics", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-INDEX-STATISTICS", false, false, true, true, true),
      Descriptor(PageType::index_special_root, PageFamily::index, PageRegistryStatus::implemented, "index_special_root", true, true, IndexRoles(), "PAGE-REG-IMPLEMENTED-INDEX-SPECIAL-ROOT", false, false, true, true, true),
      ...
      Descriptor(PageType::archive, PageFamily::archive, PageRegistryStatus::implemented, "archive", true, true, ArchiveRoles(), "PAGE-REG-IMPLEMENTED-ARCHIVE"),
      Descriptor(PageType::columnar, PageFamily::columnar, PageRegistryStatus::implemented, "columnar", true, true, DataRoles(), "PAGE-REG-IMPLEMENTED-COLUMNAR", false, false, false, true, true),
      Descriptor(PageType::vector, PageFamily::vector, PageRegistryStatus::implemented, "vector", true, true, DataRoles(), "PAGE-REG-IMPLEMENTED-VECTOR", false, false, false, true, true),
      Descriptor(PageType::graph, PageFamily::graph, PageRegistryStatus::implemented, "graph", true, true, DataRoles(), "PAGE-REG-IMPLEMENTED-GRAPH", false, false, false, true, true),
