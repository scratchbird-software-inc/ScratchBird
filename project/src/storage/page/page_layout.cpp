...
const std::vector<PageLayoutDescriptor>& BuiltinPageLayoutRegistry() {
  static const std::vector<PageLayoutDescriptor> layouts = {
      ...
      Layout(PageType::filespace_directory, PageFamily::filespace_control, "filespace_directory", 64, 16, PageBodyGrowthDirection::append_segments, true, true, true),
      ...
      Layout(PageType::filespace_lifecycle_state, PageFamily::filespace_control, "filespace_lifecycle_state", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::filespace_operation_record, PageFamily::filespace_control, "filespace_operation_record", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::filespace_prealloc_map, PageFamily::filespace_control, "filespace_prealloc_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::filespace_quarantine_fence, PageFamily::filespace_control, "filespace_quarantine_fence", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::shard_placement_map, PageFamily::shard_placement, "shard_placement_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::shard_extent_map, PageFamily::shard_placement, "shard_extent_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::shard_operation_state, PageFamily::shard_placement, "shard_operation_state", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::cluster_member_placement, PageFamily::shard_placement, "cluster_member_placement", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::archive_manifest, PageFamily::import_export, "archive_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::foreign_import_manifest, PageFamily::import_export, "foreign_import_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::export_package_manifest, PageFamily::import_export, "export_package_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::import_reconciliation_map, PageFamily::import_export, "import_reconciliation_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::uuid_remap_conflict, PageFamily::import_export, "uuid_remap_conflict", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::snapshot_manifest, PageFamily::import_export, "snapshot_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::shadow_manifest, PageFamily::import_export, "shadow_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::protected_material_root, PageFamily::protected_material, "protected_material_root", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::protected_material_version, PageFamily::protected_material, "protected_material_version", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::protected_material_chunk, PageFamily::protected_material, "protected_material_chunk", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::protected_material_policy, PageFamily::protected_material, "protected_material_policy", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::audit_chain, PageFamily::audit, "audit_chain", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::system_journal, PageFamily::audit, "system_journal", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::repair_manifest, PageFamily::repair, "repair_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::rebuild_manifest, PageFamily::repair, "rebuild_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::salvage_manifest, PageFamily::repair, "salvage_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::damage_map, PageFamily::repair, "damage_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::reachability_map, PageFamily::repair, "reachability_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::typed_payload_dependency, PageFamily::typed_dependency, "typed_payload_dependency", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::type_migration_state, PageFamily::typed_dependency, "type_migration_state", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::resource_dependency_map, PageFamily::typed_dependency, "resource_dependency_map", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::index_resource_state, PageFamily::typed_dependency, "index_resource_state", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::type_statistics_state, PageFamily::typed_dependency, "type_statistics_state", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::derived_structure_manifest, PageFamily::typed_dependency, "derived_structure_manifest", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
      Layout(PageType::name_registry_superseded, PageFamily::superseded, "name_registry_superseded", 0, 0, PageBodyGrowthDirection::opaque, false, false, false),
