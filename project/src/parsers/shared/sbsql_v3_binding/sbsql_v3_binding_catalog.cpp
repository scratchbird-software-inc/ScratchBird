...
BindingProfile BindingProfileForCommandFamily(std::string_view command_family) {
  static const std::map<std::string_view, BindingProfile> profiles = {
      ...
      {"sbsql.dml", {"sbsql.dml", "DATA_MUTATION", "object_scope", "dml_descriptor_binding", "target_columns_predicate_returning_descriptors", true, true, false, false}},
      {"sbsql.dml_upsert_variants", {"sbsql.dml_upsert_variants", "DATA_MUTATION", "object_scope", "dml_descriptor_binding", "upsert_merge_excluded_returning_descriptors", true, true, false, false}},
      {"sbsql.temporal", {"sbsql.temporal", "TEMPORAL_HISTORY_READ_OR_ADMIN", "object_history_scope", "temporal_catalog", "period_history_mga_snapshot_descriptors", true, true, false, false}},
      {"sbsql.temporal_bitemporal", {"sbsql.temporal_bitemporal", "TEMPORAL_HISTORY_READ_OR_ADMIN", "object_history_scope", "temporal_catalog", "period_history_mga_snapshot_descriptors", true, true, false, false}},
      {"sbsql.versioned_history_mutate", {"sbsql.versioned_history_mutate", "TEMPORAL_HISTORY_ADMIN", "object_history_scope", "versioned_history_catalog", "proof_merge_tag_revert_descriptors", true, true, false, false}},
      {"sbsql.structured_type", {"sbsql.structured_type", "TYPE_DDL", "database_type_scope", "structured_type_catalog", "constructor_cast_comparison_serialization_descriptors", true, true, false, false}},
      {"sbsql.structured_types", {"sbsql.structured_types", "TYPE_DDL", "database_type_scope", "structured_type_catalog", "constructor_cast_comparison_serialization_descriptors", true, true, false, false}},
      {"sbsql.kv_structured_read", {"sbsql.kv_structured_read", "DATA_ACCESS", "object_scope", "kv_structured_catalog", "key_projection_snapshot_descriptors", true, true, false, false}},
      {"sbsql.kv_structured_mutate", {"sbsql.kv_structured_mutate", "DATA_MUTATION", "object_scope", "kv_structured_catalog", "key_mutation_conflict_descriptors", true, true, false, false}},
      ...
      {"sbsql.ddl_catalog", {"sbsql.ddl_catalog", "CATALOG_DDL", "catalog_scope", "catalog_mutation_catalog", "lifecycle_mga_root_audit_descriptors", true, true, false, false}},
      {"sbsql.ddl_catalog_gaps", {"sbsql.ddl_catalog_gaps", "CATALOG_DDL", "catalog_scope", "catalog_mutation_catalog", "lifecycle_mga_root_audit_descriptors", true, true, false, false}},
      {"sbsql.bulk", {"sbsql.bulk", "BULK_IMPORT_EXPORT", "object_or_job_scope", "bulk_stream_catalog", "format_frame_reject_job_descriptors", true, true, false, false}},
      {"sbsql.bulk_import_export", {"sbsql.bulk_import_export", "BULK_IMPORT_EXPORT", "object_or_job_scope", "bulk_stream_catalog", "format_frame_reject_job_descriptors", true, true, false, false}},
      {"sbsql.bulk_export", {"sbsql.bulk_export", "BULK_IMPORT_EXPORT", "object_or_job_scope", "bulk_stream_catalog", "format_frame_redaction_job_descriptors", true, true, false, false}},
      {"sbsql.native_system_variables", {"sbsql.native_system_variables", "SESSION_VARIABLE_READ", "session_scope", "session_context", "canonical_variable_descriptor", true, true, false, false}},
      {"sbsql.last_day_builtin", {"sbsql.last_day_builtin", "EXPRESSION_EVALUATE", "expression_scope", "builtin_function_catalog", "calendar_nullability_result_descriptors", true, true, false, false}},
      ...
      {"sbsql.migration_management", {"sbsql.migration_management", "MIGRATE_DATABASE", "migration_scope", "migration_management_catalog", "reference_package_policy_capability_descriptors", true, true, false, false}},
      ...
      {"sbsql.acceleration_management", {"sbsql.acceleration_management", "ACCELERATION_INSPECT_OR_CONTROL", "capability_scope", "acceleration_catalog", "llvm_gpu_profile_cache_descriptors", true, true, false, false}},
      ...
      {"sbsql.transaction_lock_compatibility", {"sbsql.transaction_lock_compatibility", "TRANSACTION_CONTROL", "transaction_or_advisory_scope", "transaction_inventory", "lock_compatibility_policy_descriptors", true, true, false, false}},
      {"sbsql.reference_command_function_backfill", {"sbsql.reference_command_function_backfill", "COMPATIBILITY_ROUTE_VALIDATE", "reference_family_scope", "compatibility_route_catalog", "native_equivalent_or_refusal_descriptors", true, true, false, false}},
