...
class SbsqlTestWireSession {
 public:
  ...
  PipelineResult RunDdlCreateSubscriptionForWire();
  PipelineResult RunDdlAlterSubscriptionForWire();
  ...
  PipelineResult RunDdlDropCastForWire();
  PipelineResult RunDdlCreateExtensionForWire();
  PipelineResult RunDdlAlterExtensionForWire();
  PipelineResult RunDdlDropExtensionForWire();
  PipelineResult RunClusterCreatePlacementPolicyForWire();
  PipelineResult RunClusterAlterPlacementPolicyForWire();
  ...
  PipelineResult RunBridgeDescribeCapabilitiesForWire();
  PipelineResult RunBridgeOpenChannelForWire();
  PipelineResult RunBridgeAuthenticateForWire();
  PipelineResult RunBridgeOpenSessionForWire();
  ...
  PipelineResult RunBridgeRollbackTransactionForWire();
  ...
  PipelineResult RunShowMigrationForWire();
