...
std::string SbsqlPackageIdentityJson() {
  return "{\"dialect\":\"sbsql\","
         "\"display_name\":\"ScratchBird SQL\","
         "\"parser_package\":\"SBParser\","
         "\"parser_support_package\":\"SBParser_udr\","
         "\"release_profile\":\"sbsql-v3\","
         ...
         "\"parser_family_uuid\":\"parser.native.scratchbird\","
         "\"standalone_package\":true,"
         "\"cross_parser_dependency_count\":0,"
         "\"same_family_library_set\":["
         "{\"target\":\"sbp_sbsql\",\"artifact\":\"bin/SBParser\",\"owner\":\"parser.native.scratchbird\"},"
         "{\"target\":\"sbl_sbsql_parser_pipeline\",\"artifact\":\"lib/libSBParser_pipeline\",\"owner\":\"parser.native.scratchbird\"},"
         "{\"target\":\"sbl_sbsql_parser_worker_core\",\"artifact\":\"lib/libSBParser_core\",\"owner\":\"parser.native.scratchbird\"},"
         "{\"target\":\"sbu_sbsql_parser_support\",\"artifact\":\"lib/libSBParser_udr\",\"owner\":\"parser.native.scratchbird\"}],"
         ...
         "{\"target\":\"sb_core_agents\",\"artifact\":\"lib/libsb_core_agents\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_index\",\"artifact\":\"lib/libsb_core_index\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_catalog\",\"artifact\":\"lib/libsb_core_catalog\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_storage_page\",\"artifact\":\"lib/libsb_storage_page\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_resource_governance\",\"artifact\":\"lib/libsb_core_resource_governance\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_storage_filespace\",\"artifact\":\"lib/libsb_storage_filespace\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_storage_disk\",\"artifact\":\"lib/libsb_storage_disk\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_transaction_mga\",\"artifact\":\"lib/libsb_transaction_mga\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_memory\",\"artifact\":\"lib/libsb_core_memory\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_datatypes\",\"artifact\":\"lib/libsb_core_datatypes\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_metrics\",\"artifact\":\"lib/libsb_core_metrics\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_hash\",\"artifact\":\"lib/libsb_core_hash\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sbl_numeric\",\"artifact\":\"lib/libsbl_numeric\",\"owner\":\"family_neutral\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_uuid\",\"artifact\":\"lib/libsb_core_uuid\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"sb_core_platform\",\"artifact\":\"lib/libsb_core_platform\",\"owner\":\"scratchbird_engine\",\"version\":\"same-build\"},"
         "{\"target\":\"OpenSSL::SSL\",\"artifact\":\"system/libssl\",\"owner\":\"system_neutral\",\"version\":\"resolved-at-build\"},"
         "{\"target\":\"OpenSSL::Crypto\",\"artifact\":\"system/libcrypto\",\"owner\":\"system_neutral\",\"version\":\"resolved-at-build\"},"
         "{\"target\":\"Threads::Threads\",\"artifact\":\"system/threads\",\"owner\":\"system_neutral\",\"version\":\"resolved-at-build\"}],"
         "\"parser_support_udr_family_uuid\":\"parser.native.scratchbird\","
