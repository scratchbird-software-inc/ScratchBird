...
constexpr std::string_view kSblrFamily = "sblr.donor.mongodb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    {"EVAL", PatternMatch::kPrefix, "script", "mongodb.script.eval",
     ...
     "SBLR_DONOR_MONGODB_SCRIPT_ROUTE", "ParserSupportScriptRoute",
    ...
    {"MAPREDUCE", PatternMatch::kPrefix, "script", "mongodb.script.map_reduce",
     ...
     "SBLR_DONOR_MONGODB_MAP_REDUCE_ROUTE", "ParserSupportMapReduceRoute",
    ...
    {"LOAD", PatternMatch::kPrefix, "shell_file", "mongodb.shell.load",
     ...
     "SBLR_DONOR_MONGODB_CLIENT_FILE_ROUTE", "ParserSupportClientFileRoute",
    ...
    {"WATCH", PatternMatch::kPrefix, "cdc", "mongodb.cdc.watch",
     ...
     "SBLR_DONOR_MONGODB_CDC_ROUTE", "ParserSupportCdcRoute",
     "MONGODB.EMULATION.CDC_ROUTE",
     "MongoDB change-stream watch routes through the MongoDB donor UDR.", true, false},
    {"$CHANGESTREAM", PatternMatch::kContains, "cdc", "mongodb.cdc.change_stream",
     ...
     "SBLR_DONOR_MONGODB_CDC_ROUTE", "ParserSupportCdcRoute",
     "MONGODB.EMULATION.CDC_ROUTE",
     "MongoDB $changeStream pipelines route through the MongoDB donor UDR.", true, false},
    ...
    {"SERVERSTATUS", PatternMatch::kContains, "catalog_overlay", "mongodb.catalog.server_status",
     ...
     "SBLR_DONOR_MONGODB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"CREATEINDEXES", PatternMatch::kContains, "index", "mongodb.index.create",
     ...
     "SBLR_DONOR_MONGODB_INDEX_ROUTE", "ParserSupportIndexRoute", "MONGODB.EMULATION.INDEX_ROUTE",
    ...
    {"$OUT", PatternMatch::kContains, "pipeline_write", "mongodb.aggregate.out",
     ...
     "SBLR_DONOR_MONGODB_PIPELINE_WRITE_ROUTE", "ParserSupportPipelineWriteRoute", "MONGODB.EMULATION.PIPELINE_WRITE_ROUTE",
    ...
    {"CREATECOLLECTION", PatternMatch::kContains, "ddl", "mongodb.ddl.create_collection",
     ...
     "SBLR_DONOR_MONGODB_CREATE_COLLECTION", "EngineDdlCreate", "",
     "", true, true},
    ...
    {"CREATEUSER", PatternMatch::kContains, "security", "mongodb.security.create_user",
     ...
     "SBLR_DONOR_MONGODB_SECURITY_ROUTE", "ParserSupportSecurityRoute", "MONGODB.EMULATION.SECURITY_ROUTE",
