...
constexpr std::string_view kSblrFamily = "sblr.donor.tikv.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"IMPORT_SST", PatternMatch::kPrefix, "bulk_io", "tikv.import_sst",
     ...
     "SBLR_DONOR_TIKV_IMPORT_SST_ROUTE", "ParserSupportImportSstRoute", "TIKV.EMULATION.IMPORT_SST_ROUTE",
    ...
    {"COPROCESSOR", PatternMatch::kPrefix, "coprocessor", "tikv.coprocessor.request",
     ...
     "SBLR_DONOR_TIKV_COPROCESSOR_ROUTE", "ParserSupportCoprocessorRoute", "TIKV.EMULATION.COPROCESSOR_ROUTE",
    ...
    {"REGION_INFO", PatternMatch::kPrefix, "catalog_overlay", "tikv.catalog.region_info",
     ...
     "SBLR_DONOR_TIKV_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
...
std::string TikvPackageIdentityJson() { return scratchbird::parser::donor::PackageIdentityJson(kProfile); }
std::string TikvSurfaceReportJson() { return scratchbird::parser::donor::SurfaceReportJson(kProfile); }
