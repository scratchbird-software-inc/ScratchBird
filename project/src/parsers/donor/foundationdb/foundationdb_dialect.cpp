...
constexpr std::string_view kSblrFamily = "sblr.donor.foundationdb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"SET_VERSIONSTAMPED", PatternMatch::kPrefix, "kv_write", "foundationdb.kv.set_versionstamped",
     ...
     "SBLR_DONOR_FOUNDATIONDB_VERSIONSTAMP_ROUTE", "ParserSupportVersionstampRoute", "FOUNDATIONDB.EMULATION.VERSIONSTAMP_ROUTE",
    ...
    {"SET", PatternMatch::kPrefix, "kv_write", "foundationdb.kv.set",
     ...
     "SBLR_DONOR_FOUNDATIONDB_SET", "EngineKvSet", "",
     "", false, true},
    {"ATOMIC_OP", PatternMatch::kPrefix, "kv_write", "foundationdb.kv.atomic_op",
     ...
     "SBLR_DONOR_FOUNDATIONDB_ATOMIC_ROUTE", "ParserSupportAtomicRoute", "FOUNDATIONDB.EMULATION.ATOMIC_ROUTE",
    ...
    {"WATCH", PatternMatch::kPrefix, "kv_read", "foundationdb.kv.watch",
     ...
     "SBLR_DONOR_FOUNDATIONDB_WATCH_ROUTE", "ParserSupportWatchRoute", "FOUNDATIONDB.EMULATION.WATCH_ROUTE",
    ...
    {"DIRECTORY_CREATE", PatternMatch::kPrefix, "directory", "foundationdb.directory.create",
     ...
     "SBLR_DONOR_FOUNDATIONDB_DIRECTORY_ROUTE", "ParserSupportDirectoryRoute", "FOUNDATIONDB.EMULATION.DIRECTORY_ROUTE",
    ...
    {"DIRECTORY_OPEN", PatternMatch::kPrefix, "directory", "foundationdb.directory.open",
     ...
     "SBLR_DONOR_FOUNDATIONDB_DIRECTORY_ROUTE", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"TUPLE_PACK", PatternMatch::kPrefix, "tuple", "foundationdb.tuple.pack",
     ...
     "SBLR_DONOR_FOUNDATIONDB_TUPLE_ROUTE", "ParserSupportTupleRoute", "FOUNDATIONDB.EMULATION.TUPLE_ROUTE",
    ...
    {"TENANT_CREATE", PatternMatch::kPrefix, "tenant", "foundationdb.tenant.create",
     ...
     "SBLR_DONOR_FOUNDATIONDB_TENANT_ROUTE", "ParserSupportTenantRoute", "FOUNDATIONDB.EMULATION.TENANT_ROUTE",
    ...
    {"STATUS", PatternMatch::kPrefix, "catalog_overlay", "foundationdb.catalog.status",
     ...
     "SBLR_DONOR_FOUNDATIONDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
...
std::string FoundationdbPackageIdentityJson() { return scratchbird::parser::donor::PackageIdentityJson(kProfile); }
std::string FoundationdbSurfaceReportJson() { return scratchbird::parser::donor::SurfaceReportJson(kProfile); }
