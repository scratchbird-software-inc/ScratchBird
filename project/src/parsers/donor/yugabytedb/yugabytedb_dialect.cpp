...
constexpr std::string_view kSblrFamily = "sblr.donor.yugabytedb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"CREATE KEYSPACE", PatternMatch::kPrefix, "ycql", "yugabytedb.ycql.keyspace.create",
     ...
     "SBLR_DONOR_YUGABYTEDB_YCQL_ROUTE", "ParserSupportYcqlRoute", "YUGABYTEDB.EMULATION.YCQL_ROUTE",
    ...
    {"SPLIT INTO", PatternMatch::kContains, "tablet", "yugabytedb.tablet.split_into",
     ...
     "SBLR_DONOR_YUGABYTEDB_TABLET_ROUTE", "ParserSupportTabletRoute", "YUGABYTEDB.EMULATION.TABLET_ROUTE",
    ...
    {"CREATE TABLEGROUP", PatternMatch::kPrefix, "tablet", "yugabytedb.tablegroup.create",
     ...
     "SBLR_DONOR_YUGABYTEDB_TABLEGROUP_ROUTE", "ParserSupportTablegroupRoute", "YUGABYTEDB.EMULATION.TABLEGROUP_ROUTE",
    ...
    {"CREATE CDC STREAM", PatternMatch::kPrefix, "cdc", "yugabytedb.cdc.create_stream",
     ...
     "SBLR_DONOR_YUGABYTEDB_CDC_ROUTE", "ParserSupportCdcRoute",
     "YUGABYTEDB.EMULATION.CDC_ROUTE",
     "CDC stream requests route through the YugabyteDB donor UDR.", true, false},
    {"YB_SERVER_REGION", PatternMatch::kContains, "catalog_overlay", "yugabytedb.catalog_overlay.server_region",
     ...
     "SBLR_DONOR_YUGABYTEDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"COPY|| TO STDOUT", PatternMatch::kPrefixAndContains,
     ...
     "SBLR_DONOR_YUGABYTEDB_COPY_ROUTE", "ParserSupportCopyRoute",
    ...
    {"COPY", PatternMatch::kPrefix, "bulk_io", "yugabytedb.bulk_io.copy",
     ...
     "SBLR_DONOR_YUGABYTEDB_COPY_ROUTE", "ParserSupportCopyRoute", "YUGABYTEDB.EMULATION.COPY_ROUTE",
    ...
    {"CREATE FOREIGN DATA WRAPPER", PatternMatch::kPrefix, "connector", "yugabytedb.connector.fdw.create",
     ...
     "SBLR_DONOR_YUGABYTEDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "YUGABYTEDB.EMULATION.CONNECTOR_ROUTE",
     "External connector operations route through the YugabyteDB donor UDR.", true, false},
    {"CREATE SERVER", PatternMatch::kPrefix, "connector", "yugabytedb.connector.server.create",
     ...
     "SBLR_DONOR_YUGABYTEDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "YUGABYTEDB.EMULATION.CONNECTOR_ROUTE",
     "External server operations route through the YugabyteDB donor UDR.", true, false},
    {"CREATE USER MAPPING", PatternMatch::kPrefix, "connector", "yugabytedb.connector.user_mapping.create",
     ...
     "SBLR_DONOR_YUGABYTEDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "YUGABYTEDB.EMULATION.CONNECTOR_ROUTE",
     "External user mapping operations route through the YugabyteDB donor UDR.", true, false},
    {"CREATE FOREIGN TABLE", PatternMatch::kPrefix, "connector", "yugabytedb.connector.foreign_table.create",
     ...
     "SBLR_DONOR_YUGABYTEDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "YUGABYTEDB.EMULATION.CONNECTOR_ROUTE",
     "External table creation routes through the YugabyteDB donor UDR.", true, false},
    {"CREATE ROLE", PatternMatch::kPrefix, "security", "yugabytedb.security.create_role",
     ...
     "SBLR_DONOR_YUGABYTEDB_SECURITY_ROUTE", "ParserSupportSecurityRoute", "YUGABYTEDB.EMULATION.SECURITY_ROUTE",
    ...
    {"PREPARE", PatternMatch::kPrefix, "prepared_statement", "yugabytedb.prepared.prepare",
     ...
     "SBLR_DONOR_YUGABYTEDB_PREPARE", "EnginePrepareStatement", "",
     "", false, false},
    {"EXECUTE", PatternMatch::kPrefix, "prepared_statement", "yugabytedb.prepared.execute",
     ...
     "SBLR_DONOR_YUGABYTEDB_EXECUTE", "EngineExecuteStatement", "",
     "", false, true},
