...
constexpr std::string_view kSblrFamily = "sblr.donor.apache_ignite.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"CREATE CACHE", PatternMatch::kPrefix, "cache", "apache_ignite.cache.create",
     ...
     "SBLR_DONOR_APACHE_IGNITE_CACHE_ROUTE", "ParserSupportCacheRoute", "APACHE_IGNITE.EMULATION.CACHE_ROUTE",
    ...
    {"CACHE REMOVE", PatternMatch::kPrefix, "cache", "apache_ignite.cache.remove",
     ...
     "SBLR_DONOR_APACHE_IGNITE_CACHE_REMOVE", "EngineCacheRemove", "",
     "", false, true},
    {"SCAN", PatternMatch::kPrefix, "cache", "apache_ignite.cache.scan",
     ...
     "SBLR_DONOR_APACHE_IGNITE_SCAN_ROUTE", "ParserSupportScanRoute", "APACHE_IGNITE.EMULATION.SCAN_ROUTE",
    ...
    {"CONTINUOUS QUERY", PatternMatch::kPrefix, "cache", "apache_ignite.cache.continuous_query",
     ...
     "SBLR_DONOR_APACHE_IGNITE_CONTINUOUS_QUERY_ROUTE", "ParserSupportContinuousQueryRoute", "APACHE_IGNITE.EMULATION.CONTINUOUS_QUERY_ROUTE",
    ...
    {"CREATE TABLE", PatternMatch::kPrefix, "ddl", "apache_ignite.ddl.create_table",
     ...
     "SBLR_DONOR_APACHE_IGNITE_DDL_ROUTE", "EngineDdlCreate", "",
     "", true, true},
    ...
    {"DROP TABLE", PatternMatch::kPrefix, "ddl", "apache_ignite.ddl.drop_table",
     ...
     "SBLR_DONOR_APACHE_IGNITE_DDL_ROUTE", "EngineDdlDrop", "",
     "", true, true},
    ...
    {"EXPLAIN", PatternMatch::kPrefix, "optimizer", "apache_ignite.optimizer.explain",
     ...
     "SBLR_DONOR_APACHE_IGNITE_EXPLAIN", "EngineExplainPlan", "",
     "", false, false},
    {"SHOW", PatternMatch::kPrefix, "catalog_overlay", "apache_ignite.catalog.show",
     ...
     "SBLR_DONOR_APACHE_IGNITE_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"CREATE USER", PatternMatch::kPrefix, "security", "apache_ignite.security.create_user",
     ...
     "SBLR_DONOR_APACHE_IGNITE_SECURITY_ROUTE", "ParserSupportSecurityRoute", "APACHE_IGNITE.EMULATION.SECURITY_ROUTE",
    ...
    {"SET STREAMING", PatternMatch::kPrefix, "session", "apache_ignite.session.streaming",
     ...
     "SBLR_DONOR_APACHE_IGNITE_STREAMING_ROUTE", "ParserSupportStreamingRoute",
     "APACHE_IGNITE.EMULATION.STREAMING_ROUTE",
     "Apache Ignite streaming mode routes through the Apache Ignite donor UDR.", true, false},
    {"SET", PatternMatch::kPrefix, "session", "apache_ignite.session.set",
     MappingDisposition::kAdmittedSblr, "apache_ignite.session.set",
     "SBLR_DONOR_APACHE_IGNITE_SET", "EngineSessionSet", "",
     "", false, false},
...
std::string ApacheIgnitePackageIdentityJson() { return scratchbird::parser::donor::PackageIdentityJson(kProfile); }
std::string ApacheIgniteSurfaceReportJson() { return scratchbird::parser::donor::SurfaceReportJson(kProfile); }
