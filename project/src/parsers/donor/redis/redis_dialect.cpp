...
constexpr std::string_view kSblrFamily = "sblr.donor.redis.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    {"SAVE", PatternMatch::kPrefix, "persistence", "redis.persistence.save",
     ...
     "SBLR_DONOR_REDIS_PERSISTENCE_ROUTE", "ParserSupportPersistenceRoute",
    ...
    {"CONFIG", PatternMatch::kPrefix, "admin", "redis.admin.config",
     ...
     "SBLR_DONOR_REDIS_CONFIG_ROUTE", "ParserSupportConfigRoute",
    ...
    {"MODULE", PatternMatch::kPrefix, "module", "redis.module.command",
     ...
     "SBLR_DONOR_REDIS_MODULE_ROUTE", "ParserSupportModuleRoute",
    ...
    {"REPLICAOF", PatternMatch::kPrefix, "replication", "redis.replication.replicaof",
     ...
     "SBLR_DONOR_REDIS_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "REDIS.EMULATION.REPLICATION_ROUTE",
     "Replica configuration requests route through the Redis donor UDR.", true, false},
    {"SLAVEOF", PatternMatch::kPrefix, "replication", "redis.replication.slaveof",
     ...
     "SBLR_DONOR_REDIS_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "REDIS.EMULATION.REPLICATION_ROUTE",
     "Legacy replica configuration requests route through the Redis donor UDR.", true, false},
    {"FLUSHALL", PatternMatch::kPrefix, "admin", "redis.admin.flushall",
     MappingDisposition::kParserSupportUdr, "redis.udr.flush",
     "SBLR_DONOR_REDIS_FLUSH_ROUTE", "ParserSupportFlushRoute",
    ...
    {"MIGRATE", PatternMatch::kPrefix, "network", "redis.network.migrate",
     ...
     "SBLR_DONOR_REDIS_MIGRATE_ROUTE", "ParserSupportNetworkRoute",
     "REDIS.EMULATION.MIGRATE_ROUTE",
     "Donor key migration routes through trusted network policy.", true, true},
    {"EVALSHA", PatternMatch::kPrefix, "script", "redis.script.evalsha",
     MappingDisposition::kParserSupportUdr, "redis.udr.script.evalsha",
     "SBLR_DONOR_REDIS_SCRIPT_ROUTE", "ParserSupportScriptRoute", "REDIS.EMULATION.SCRIPT_ROUTE",
    ...
    {"FUNCTION", PatternMatch::kPrefix, "script", "redis.function.command",
     ...
     "SBLR_DONOR_REDIS_FUNCTION_ROUTE", "ParserSupportFunctionRoute", "REDIS.EMULATION.FUNCTION_ROUTE",
    ...
    {"ACL", PatternMatch::kPrefix, "security", "redis.security.acl",
     ...
     "SBLR_DONOR_REDIS_SECURITY_ROUTE", "ParserSupportSecurityRoute", "REDIS.EMULATION.SECURITY_ROUTE",
    ...
    {"XADD", PatternMatch::kPrefix, "stream", "redis.stream.xadd",
     ...
     "SBLR_DONOR_REDIS_STREAM_ROUTE", "ParserSupportStreamRoute",
     "REDIS.EMULATION.STREAM_ROUTE",
     "Redis stream append routes through the Redis donor UDR.", false, true},
    {"XREAD", PatternMatch::kPrefix, "stream", "redis.stream.xread",
     MappingDisposition::kParserSupportUdr, "redis.udr.stream.xread",
     "SBLR_DONOR_REDIS_STREAM_ROUTE", "ParserSupportStreamRoute",
     "REDIS.EMULATION.STREAM_ROUTE",
     "Redis stream reads route through the Redis donor UDR.", false, false},
    {"XGROUP", PatternMatch::kPrefix, "stream", "redis.stream.xgroup",
     MappingDisposition::kParserSupportUdr, "redis.udr.stream.xgroup",
     "SBLR_DONOR_REDIS_STREAM_GROUP_ROUTE", "ParserSupportStreamGroupRoute", "REDIS.EMULATION.STREAM_GROUP_ROUTE",
