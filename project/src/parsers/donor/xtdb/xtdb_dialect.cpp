...
constexpr std::string_view kSblrFamily = "sblr.donor.xtdb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"ALTER DATABASE", PatternMatch::kPrefix, "database_lifecycle", "xtdb.lifecycle.alter_database",
     ...
     "SBLR_DONOR_XTDB_DATABASE_ROUTE", "ParserSupportDatabaseRoute", "XTDB.EMULATION.DATABASE_ROUTE",
    ...
    {"XTDB_Q", PatternMatch::kPrefix, "datalog", "xtdb.datalog.query",
     ...
     "SBLR_DONOR_XTDB_DATALOG_ROUTE", "ParserSupportDatalogRoute", "XTDB.EMULATION.DATALOG_ROUTE",
    ...
    {"XTDB_SUBMIT_TX", PatternMatch::kPrefix, "entity_transaction", "xtdb.entity.submit_tx",
     ...
     "SBLR_DONOR_XTDB_ENTITY_TX_ROUTE", "ParserSupportEntityTransactionRoute", "XTDB.EMULATION.ENTITY_TX_ROUTE",
    ...
    {"VALID_TIME", PatternMatch::kContains, "bitemporal", "xtdb.time.valid_time",
     ...
     "SBLR_DONOR_XTDB_BITEMPORAL_ROUTE", "ParserSupportBitemporalRoute", "XTDB.EMULATION.BITEMPORAL_ROUTE",
     "XTDB valid-time predicates route through trusted parser support for donor-compatible temporal semantics.", true, false},
    {"SYSTEM_TIME", PatternMatch::kContains, "bitemporal", "xtdb.time.system_time",
     ...
     "SBLR_DONOR_XTDB_BITEMPORAL_ROUTE", "ParserSupportBitemporalRoute", "XTDB.EMULATION.BITEMPORAL_ROUTE",
     "XTDB system-time predicates route through trusted parser support for donor-compatible temporal semantics.", true, false},
    ...
    {"XTDB_STATUS", PatternMatch::kPrefix, "catalog_overlay", "xtdb.catalog.status",
     ...
     "SBLR_DONOR_XTDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"SELECT", PatternMatch::kPrefix, "query", "xtdb.sql.select",
     ...
     "SBLR_DONOR_XTDB_SELECT", "EngineQuerySelect", "",
     "", false, false},
    ...
    {"CREATE TABLE", PatternMatch::kPrefix, "ddl", "xtdb.sql.create_table",
     ...
     "SBLR_DONOR_XTDB_SCHEMA_ROUTE", "ParserSupportSchemaRoute", "XTDB.EMULATION.SCHEMA_ROUTE",
...
std::string XtdbPackageIdentityJson() { return scratchbird::parser::donor::PackageIdentityJson(kProfile); }
std::string XtdbSurfaceReportJson() { return scratchbird::parser::donor::SurfaceReportJson(kProfile); }
