...
constexpr std::string_view kSblrFamily = "sblr.donor.vitess.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"MOVE TABLES", PatternMatch::kPrefix, "vreplication", "vitess.vreplication.move_tables",
     ...
     "SBLR_DONOR_VITESS_VREPLICATION_ROUTE", "ParserSupportVReplicationRoute",
     "VITESS.EMULATION.VREPLICATION_ROUTE",
     "VReplication move-table requests route through the Vitess donor UDR.", true, false},
    {"RESHARD", PatternMatch::kPrefix, "vreplication", "vitess.vreplication.reshard",
     ...
     "SBLR_DONOR_VITESS_VREPLICATION_ROUTE", "ParserSupportVReplicationRoute",
     "VITESS.EMULATION.VREPLICATION_ROUTE",
     "VReplication reshard requests route through the Vitess donor UDR.", true, false},
    {"VDIFF", PatternMatch::kPrefix, "vreplication", "vitess.vreplication.vdiff",
     ...
     "SBLR_DONOR_VITESS_VREPLICATION_ROUTE", "ParserSupportVReplicationRoute",
     "VITESS.EMULATION.VREPLICATION_ROUTE",
     "VReplication diff requests route through the Vitess donor UDR.", true, false},
    {"ALTER VSCHEMA", PatternMatch::kPrefix, "vschema", "vitess.vschema.alter",
     ...
     "SBLR_DONOR_VITESS_VSCHEMA_ROUTE", "ParserSupportVSchemaRoute", "VITESS.EMULATION.VSCHEMA_ROUTE",
    ...
    {"SHOW VSCHEMA", PatternMatch::kPrefix, "catalog_overlay", "vitess.catalog_overlay.show_vschema",
     ...
     "SBLR_DONOR_VITESS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"LOAD DATA LOCAL INFILE", PatternMatch::kLoadDataLocalInfile, "bulk_io", "vitess.bulk_io.load_data_local_infile",
     ...
     "SBLR_DONOR_VITESS_ETL_ROUTE", "ParserSupportEtlRoute",
     "VITESS.EMULATION.ETL_ROUTE",
     "LOAD DATA LOCAL INFILE routes through the Vitess donor UDR as a client logical ETL stream.",
     true, true},
    ...
    {"SELECT|| INTO OUTFILE", PatternMatch::kPrefixAndContains, "bulk_io", "vitess.bulk_io.select_into_outfile",
     ...
     "", "", "VITESS.AUTHORITY.FILE_IO_DENIED",
     "Donor filesystem writes are blocked from parser authority.", true, false},
    ...
    {"CREATE USER", PatternMatch::kPrefix, "security", "vitess.security.create_user",
     ...
     "SBLR_DONOR_VITESS_SECURITY_ROUTE", "ParserSupportSecurityRoute", "VITESS.EMULATION.SECURITY_ROUTE",
    ...
    {"PREPARE", PatternMatch::kPrefix, "prepared_statement", "vitess.prepared.prepare",
     ...
     "SBLR_DONOR_VITESS_PREPARE", "EnginePrepareStatement", "",
     "", false, false},
    {"EXECUTE", PatternMatch::kPrefix, "prepared_statement", "vitess.prepared.execute",
     ...
     "SBLR_DONOR_VITESS_EXECUTE", "EngineExecuteStatement", "",
     "", false, true},
