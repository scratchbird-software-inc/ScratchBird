...
constexpr std::string_view kSblrFamily = "sblr.donor.tidb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"CREATE RESOURCE GROUP", PatternMatch::kPrefix, "resource_control", "tidb.resource_group.create",
     ...
     "SBLR_DONOR_TIDB_RESOURCE_GROUP_ROUTE", "ParserSupportResourceGroupRoute", "TIDB.EMULATION.RESOURCE_GROUP_ROUTE",
    ...
    {"TIDB_VERSION", PatternMatch::kContains, "builtin", "tidb.builtin.version",
     ...
     "SBLR_DONOR_TIDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"TICDC", PatternMatch::kPrefix, "cdc", "tidb.cdc.ticdc",
     MappingDisposition::kParserSupportUdr, "tidb.udr.cdc.ticdc",
     "SBLR_DONOR_TIDB_CDC_ROUTE", "ParserSupportCdcRoute",
     "TIDB.EMULATION.CDC_ROUTE",
     "TiCDC command surfaces route through the TiDB donor UDR.", true, false},
    {"CHANGEFEED", PatternMatch::kPrefix, "cdc", "tidb.cdc.changefeed",
     MappingDisposition::kParserSupportUdr, "tidb.udr.cdc.changefeed",
     "SBLR_DONOR_TIDB_CDC_ROUTE", "ParserSupportCdcRoute",
     "TIDB.EMULATION.CDC_ROUTE",
     "TiCDC changefeed command surfaces route through the TiDB donor UDR.", true, false},
    {"LOAD DATA LOCAL INFILE", PatternMatch::kLoadDataLocalInfile, "bulk_io", "tidb.bulk_io.load_data_local_infile",
     ...
     "SBLR_DONOR_TIDB_ETL_ROUTE", "ParserSupportEtlRoute",
     "TIDB.EMULATION.ETL_ROUTE",
     "LOAD DATA LOCAL INFILE routes through the TiDB donor UDR as a client logical ETL stream.",
     true, true},
    ...
    {"CREATE USER", PatternMatch::kPrefix, "security", "tidb.security.create_user",
     ...
     "SBLR_DONOR_TIDB_SECURITY_ROUTE", "ParserSupportSecurityRoute", "TIDB.EMULATION.SECURITY_ROUTE",
    ...
    {"PREPARE", PatternMatch::kPrefix, "prepared_statement", "tidb.prepared.prepare",
     ...
     "SBLR_DONOR_TIDB_PREPARE", "EnginePrepareStatement", "",
     "", false, false},
    {"EXECUTE", PatternMatch::kPrefix, "prepared_statement", "tidb.prepared.execute",
     ...
     "SBLR_DONOR_TIDB_EXECUTE", "EngineExecuteStatement", "",
     "", false, true},
