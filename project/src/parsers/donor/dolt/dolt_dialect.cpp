...
constexpr std::string_view kSblrFamily = "sblr.donor.dolt.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    {"PUSH", PatternMatch::kPrefix, "remote", "dolt.remote.push",
     ...
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt remote push routes through the Dolt donor UDR for remote synchronization admission.", true, false},
    {"PULL", PatternMatch::kPrefix, "remote", "dolt.remote.pull",
     MappingDisposition::kParserSupportUdr, "dolt.udr.remote.pull",
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt remote pull routes through the Dolt donor UDR for remote synchronization admission.", true, false},
    {"FETCH", PatternMatch::kPrefix, "remote", "dolt.remote.fetch",
     MappingDisposition::kParserSupportUdr, "dolt.udr.remote.fetch",
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt remote fetch routes through the Dolt donor UDR for remote synchronization admission.", true, false},
    {"CLONE", PatternMatch::kPrefix, "remote", "dolt.remote.clone",
     MappingDisposition::kParserSupportUdr, "dolt.udr.remote.clone",
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt clone routes through the Dolt donor UDR and must deny parser-owned server-local file effects.", true, false},
    {"DOLT_FETCH", PatternMatch::kContainsFunctionCall, "remote", "dolt.remote.fetch_sql",
     ...
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt SQL fetch procedure routes through the Dolt donor UDR.", true, false},
    {"DOLT_PUSH", PatternMatch::kContainsFunctionCall, "remote", "dolt.remote.push_sql",
     ...
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt SQL push procedure routes through the Dolt donor UDR.", true, false},
    {"DOLT_PULL", PatternMatch::kContainsFunctionCall, "remote", "dolt.remote.pull_sql",
     ...
     "SBLR_DONOR_DOLT_REMOTE_ROUTE", "ParserSupportRemoteRoute",
     "DOLT.EMULATION.REMOTE_ROUTE",
     "Dolt SQL pull procedure routes through the Dolt donor UDR.", true, false},
    {"DOLT_COMMIT", PatternMatch::kContainsFunctionCall, "version_control", "dolt.version.commit",
     ...
     "SBLR_DONOR_DOLT_VERSION_ROUTE", "ParserSupportDoltVersionRoute", "DOLT.EMULATION.VERSION_ROUTE",
    ...
    {"DOLT_BRANCH", PatternMatch::kContainsFunctionCall, "version_control", "dolt.version.branch",
     ...
     "SBLR_DONOR_DOLT_BRANCH_ROUTE", "ParserSupportDoltBranchRoute", "DOLT.EMULATION.BRANCH_ROUTE",
    ...
    {"DOLT_MERGE", PatternMatch::kContainsFunctionCall, "version_control", "dolt.version.merge",
     ...
     "SBLR_DONOR_DOLT_MERGE_ROUTE", "ParserSupportDoltMergeRoute", "DOLT.EMULATION.MERGE_ROUTE",
    ...
    {"DOLT_DIFF", PatternMatch::kRelationReference, "version_catalog", "dolt.version.diff",
     ...
     "SBLR_DONOR_DOLT_DIFF_ROUTE", "EngineCatalogProjection", "",
     "", false, false},
    {"DOLT_LOG", PatternMatch::kRelationReference, "version_catalog", "dolt.version.log",
     ...
     "SBLR_DONOR_DOLT_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"CREATE USER", PatternMatch::kPrefix, "security", "dolt.security.create_user",
     ...
     "SBLR_DONOR_DOLT_SECURITY_ROUTE", "ParserSupportSecurityRoute", "DOLT.EMULATION.SECURITY_ROUTE",
...
std::string DoltPackageIdentityJson() { return scratchbird::parser::donor::PackageIdentityJson(kProfile); }
std::string DoltSurfaceReportJson() { return scratchbird::parser::donor::SurfaceReportJson(kProfile); }
