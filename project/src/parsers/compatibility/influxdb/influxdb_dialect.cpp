...
constexpr std::string_view kSblrFamily = "sblr.compatibility.influxdb.profile.v1";

constexpr OperationPattern kPatterns[] = {
    {"GET /HEALTH", PatternMatch::kPrefix, "health", "influxdb.http.health",
     MappingDisposition::kCatalogProjection, "influxdb.http.health",
     "SBLR_COMPAT_INFLUXDB_HEALTH", "EngineHealthProjection", "",
     "", false, false},
    {"GET /PING", PatternMatch::kPrefix, "health", "influxdb.http.ping",
     MappingDisposition::kCatalogProjection, "influxdb.http.ping",
     "SBLR_COMPAT_INFLUXDB_HEALTH", "EngineHealthProjection", "",
     "", false, false},
    {"POST /API/V3/QUERY_SQL", PatternMatch::kPrefix, "query", "influxdb.http.query_sql",
     MappingDisposition::kAdmittedSblr, "influxdb.query.select",
     "SBLR_COMPAT_INFLUXDB_SELECT", "EngineTimeSeriesSelect", "",
     "", false, false},
    {"POST /API/V3/QUERY_INFLUXQL", PatternMatch::kPrefix, "query", "influxdb.http.query_influxql",
     MappingDisposition::kAdmittedSblr, "influxdb.query.select",
     "SBLR_COMPAT_INFLUXDB_SELECT", "EngineTimeSeriesSelect", "",
     "", false, false},
    {"POST /API/V3/WRITE_LP", PatternMatch::kPrefix, "write", "influxdb.http.write_lp",
     MappingDisposition::kParserSupportUdr, "influxdb.udr.line_protocol",
     "SBLR_COMPAT_INFLUXDB_LINE_PROTOCOL_ROUTE", "ParserSupportLineProtocolRoute",
     "INFLUXDB.EMULATION.LINE_PROTOCOL_ROUTE",
     "InfluxDB line protocol HTTP writes route through trusted parser support.", true, true},
    ...
    {"FROM", PatternMatch::kPrefix, "flux", "influxdb.flux.from",
     ...
     "SBLR_COMPAT_INFLUXDB_FLUX_ROUTE", "ParserSupportFluxRoute", "INFLUXDB.EMULATION.FLUX_ROUTE",
    ...
    {"INSERT", PatternMatch::kPrefix, "write", "influxdb.write.insert",
     ...
     "SBLR_COMPAT_INFLUXDB_INSERT", "EngineTimeSeriesInsert", "",
     "", false, true},
    {",", PatternMatch::kContains, "write", "influxdb.write.line_protocol",
     MappingDisposition::kParserSupportUdr, "influxdb.udr.line_protocol",
     "SBLR_COMPAT_INFLUXDB_LINE_PROTOCOL_ROUTE", "ParserSupportLineProtocolRoute", "INFLUXDB.EMULATION.LINE_PROTOCOL_ROUTE",
    ...
    {"DELETE", PatternMatch::kPrefix, "dml", "influxdb.dml.delete",
     ...
     "SBLR_COMPAT_INFLUXDB_DELETE", "EngineTimeSeriesDelete", "",
     "", false, true},
    {"CREATE DATABASE", PatternMatch::kPrefix, "database", "influxdb.database.create",
     ...
     "SBLR_COMPAT_INFLUXDB_DATABASE_ROUTE", "EngineDatabaseRoute", "",
     "", true, true},
    ...
    {"CREATE RETENTION POLICY", PatternMatch::kPrefix, "retention_policy", "influxdb.retention_policy.create",
     ...
     "SBLR_COMPAT_INFLUXDB_RETENTION_ROUTE", "ParserSupportRetentionRoute", "INFLUXDB.EMULATION.RETENTION_ROUTE",
    ...
    {"CREATE CONTINUOUS QUERY", PatternMatch::kPrefix, "continuous_query", "influxdb.continuous_query.create",
     ...
     "SBLR_COMPAT_INFLUXDB_CONTINUOUS_QUERY_ROUTE", "ParserSupportContinuousQueryRoute", "INFLUXDB.EMULATION.CONTINUOUS_QUERY_ROUTE",
    ...
    {"CREATE SUBSCRIPTION", PatternMatch::kPrefix, "subscription", "influxdb.subscription.create",
     ...
     "SBLR_COMPAT_INFLUXDB_SUBSCRIPTION_ROUTE", "ParserSupportSubscriptionRoute", "INFLUXDB.EMULATION.SUBSCRIPTION_ROUTE",
    ...
    {"SHOW", PatternMatch::kPrefix, "catalog_overlay", "influxdb.catalog.show",
     ...
     "SBLR_COMPAT_INFLUXDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
};
...
std::string InfluxdbPackageIdentityJson() { return scratchbird::parser::compatibility::PackageIdentityJson(kProfile); }
std::string InfluxdbSurfaceReportJson() { return scratchbird::parser::compatibility::SurfaceReportJson(kProfile); }
