...
constexpr OperationPattern kPatterns[] = {
    {"PING", PatternMatch::kPrefix, "session", "redis.session.ping",
     MappingDisposition::kCatalogProjection, "redis.catalog.ping",
     "SBLR_COMPAT_REDIS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"HELLO", PatternMatch::kPrefix, "session", "redis.session.hello",
     MappingDisposition::kCatalogProjection, "redis.catalog.hello",
     "SBLR_COMPAT_REDIS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"INFO", PatternMatch::kPrefix, "catalog_overlay", "redis.catalog.info",
     MappingDisposition::kCatalogProjection, "redis.catalog.info",
     "SBLR_COMPAT_REDIS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"COMMAND", PatternMatch::kPrefix, "catalog_overlay", "redis.catalog.command",
     MappingDisposition::kCatalogProjection, "redis.catalog.command",
     "SBLR_COMPAT_REDIS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"DBSIZE", PatternMatch::kPrefix, "catalog_overlay", "redis.catalog.dbsize",
     MappingDisposition::kCatalogProjection, "redis.catalog.dbsize",
     "SBLR_COMPAT_REDIS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"SCAN", PatternMatch::kPrefix, "catalog_overlay", "redis.catalog.scan",
     MappingDisposition::kCatalogProjection, "redis.catalog.scan",
     "SBLR_COMPAT_REDIS_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
