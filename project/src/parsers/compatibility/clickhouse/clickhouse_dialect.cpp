...
constexpr std::string_view kSblrFamily = "sblr.compatibility.clickhouse.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    {"SYSTEM", PatternMatch::kPrefix, "system_admin", "clickhouse.system.command",
     ...
     "ClickHouse SYSTEM commands are compatibility low-level utility surfaces and are outside compatibility parser authority.",
     true, false},
    {"KILL", PatternMatch::kPrefix, "system_admin", "clickhouse.system.kill",
     ...
     "", "", "CLICKHOUSE.AUTHORITY.UNSUPPORTED_DENIED",
     "ClickHouse KILL commands are compatibility low-level utility surfaces and are outside compatibility parser authority.",
     true, false},
    ...
    {"INSERT INTO FUNCTION", PatternMatch::kPrefix, "external_io", "clickhouse.external_io.insert_function",
     ...
     "SBLR_COMPAT_CLICKHOUSE_ETL_ROUTE", "ParserSupportEtlRoute",
     "CLICKHOUSE.EMULATION.ETL_ROUTE",
     "ClickHouse INSERT INTO FUNCTION routes through the ClickHouse compatibility UDR.", true, true},
    ...
    {"URL", PatternMatch::kContainsFunctionCall, "external_io", "clickhouse.external_io.url_function",
     ...
     "SBLR_COMPAT_CLICKHOUSE_ETL_ROUTE", "ParserSupportEtlRoute",
     "CLICKHOUSE.EMULATION.ETL_ROUTE",
     "ClickHouse URL table functions route through the ClickHouse compatibility UDR.", true, false},
    {"S3", PatternMatch::kContainsFunctionCall, "external_io", "clickhouse.external_io.s3_function",
     ...
     "SBLR_COMPAT_CLICKHOUSE_ETL_ROUTE", "ParserSupportEtlRoute",
     "CLICKHOUSE.EMULATION.ETL_ROUTE",
     "ClickHouse S3 table functions route through the ClickHouse compatibility UDR.", true, false},
    {"HDFS", PatternMatch::kContainsFunctionCall, "external_io", "clickhouse.external_io.hdfs_function",
     ...
     "SBLR_COMPAT_CLICKHOUSE_ETL_ROUTE", "ParserSupportEtlRoute",
     "CLICKHOUSE.EMULATION.ETL_ROUTE",
     "ClickHouse HDFS table functions route through the ClickHouse compatibility UDR.", true, false},
    {"KAFKA", PatternMatch::kCreateTableEngineClause, "etl", "clickhouse.etl.kafka",
     ...
     "SBLR_COMPAT_CLICKHOUSE_ETL_ROUTE", "ParserSupportEtlRoute",
     "CLICKHOUSE.EMULATION.ETL_ROUTE",
     "ClickHouse Kafka ETL routes through the ClickHouse compatibility UDR.", true, true},
    ...
    {"CREATE USER", PatternMatch::kPrefix, "security", "clickhouse.security.create_user",
     ...
     "SBLR_COMPAT_CLICKHOUSE_SECURITY_ROUTE", "ParserSupportSecurityRoute",
    ...
    {"CREATE FUNCTION", PatternMatch::kPrefix, "routine", "clickhouse.routine.create_function",
     ...
     "SBLR_COMPAT_CLICKHOUSE_ROUTINE_ROUTE", "ParserSupportRoutineRoute",
    ...
    {"OPTIMIZE", PatternMatch::kPrefix, "maintenance", "clickhouse.maintenance.optimize",
     ...
     "", "", "CLICKHOUSE.AUTHORITY.UNSUPPORTED_DENIED",
     "ClickHouse OPTIMIZE is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    ...
    {"EXPLAIN", PatternMatch::kPrefix, "optimizer", "clickhouse.optimizer.explain",
     ...
     "SBLR_COMPAT_CLICKHOUSE_EXPLAIN", "EngineExplainPlan", "", "", false, false},
    {"DESCRIBE", PatternMatch::kPrefix, "catalog_overlay", "clickhouse.catalog_overlay.describe",
     ...
     "SBLR_COMPAT_CLICKHOUSE_CATALOG_PROJECT", "EngineCatalogProjection", "", "", false, false},
    ...
    {"USE", PatternMatch::kPrefix, "session", "clickhouse.session.use_database",
     ...
     "SBLR_COMPAT_CLICKHOUSE_USE_DATABASE", "EngineSessionRoute", "", "", false, false},
    {"SET", PatternMatch::kPrefix, "session", "clickhouse.session.set",
     MappingDisposition::kAdmittedSblr, "clickhouse.session.set",
     "SBLR_COMPAT_CLICKHOUSE_SET", "EngineSessionSet", "", "", false, false},
