...
constexpr std::string_view kSblrFamily = "sblr.compatibility.cassandra.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    {"NODETOOL", PatternMatch::kPrefix, "admin", "cassandra.admin.nodetool",
     ...
     "Cassandra NODETOOL is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    {"REPAIR", PatternMatch::kPrefix, "admin", "cassandra.admin.repair",
     ...
     "", "", "CASSANDRA.AUTHORITY.UNSUPPORTED_DENIED",
     "Cassandra REPAIR is a compatibility repair utility surface and is outside compatibility parser authority.",
     true, false},
    {"COPY", PatternMatch::kPrefix, "bulk_io", "cassandra.cqlsh.copy",
     MappingDisposition::kParserSupportUdr, "cassandra.udr.copy_file",
     "SBLR_COMPAT_CASSANDRA_CLIENT_FILE_ROUTE", "ParserSupportClientFileRoute",
    ...
    {"CONSISTENCY", PatternMatch::kPrefix, "session", "cassandra.session.consistency",
     ...
     "SBLR_COMPAT_CASSANDRA_CONSISTENCY_ROUTE", "ParserSupportConsistencyRoute", "CASSANDRA.EMULATION.CONSISTENCY_ROUTE",
    ...
    {"PAGING", PatternMatch::kPrefix, "session", "cassandra.session.paging",
     ...
     "SBLR_COMPAT_CASSANDRA_SESSION_ROUTE", "ParserSupportSessionRoute", "CASSANDRA.EMULATION.SESSION_ROUTE",
    ...
    {"CREATE KEYSPACE", PatternMatch::kPrefix, "keyspace", "cassandra.keyspace.create",
     ...
     "SBLR_COMPAT_CASSANDRA_KEYSPACE_ROUTE", "ParserSupportKeyspaceRoute", "CASSANDRA.EMULATION.KEYSPACE_ROUTE",
    ...
    {"CREATE MATERIALIZED VIEW", PatternMatch::kPrefix, "materialized_view", "cassandra.materialized_view.create",
     ...
     "SBLR_COMPAT_CASSANDRA_MATERIALIZED_VIEW_ROUTE", "ParserSupportMaterializedViewRoute", "CASSANDRA.EMULATION.MATERIALIZED_VIEW_ROUTE",
    ...
    {"CREATE TYPE", PatternMatch::kPrefix, "type", "cassandra.type.create",
     ...
     "SBLR_COMPAT_CASSANDRA_TYPE_ROUTE", "ParserSupportTypeRoute", "CASSANDRA.EMULATION.TYPE_ROUTE",
    ...
    {"CREATE ROLE", PatternMatch::kPrefix, "security", "cassandra.security.create_role",
     ...
     "SBLR_COMPAT_CASSANDRA_SECURITY_ROUTE", "ParserSupportSecurityRoute", "CASSANDRA.EMULATION.SECURITY_ROUTE",
    ...
    {"DESCRIBE", PatternMatch::kPrefix, "catalog_overlay", "cassandra.catalog.describe",
     ...
     "SBLR_COMPAT_CASSANDRA_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"SELECT JSON", PatternMatch::kPrefix, "query", "cassandra.query.select_json",
     ...
     "SBLR_COMPAT_CASSANDRA_SELECT", "EngineQuerySelect", "",
     "", false, false},
    ...
    {"INSERT JSON", PatternMatch::kPrefix, "dml", "cassandra.dml.insert_json",
     ...
     "SBLR_COMPAT_CASSANDRA_INSERT", "EngineDmlInsert", "",
     "", false, true},
    ...
    {"BEGIN BATCH", PatternMatch::kPrefix, "batch", "cassandra.batch.begin",
     ...
     "SBLR_COMPAT_CASSANDRA_BATCH", "ParserSupportBatchRoute", "CASSANDRA.EMULATION.BATCH_ROUTE",
    ...
    {"USE", PatternMatch::kPrefix, "session", "cassandra.session.use_keyspace",
     ...
     "SBLR_COMPAT_CASSANDRA_USE_KEYSPACE", "EngineSessionRoute", "",
     "", false, false},
};
