...
constexpr std::string_view kSblrFamily = "sblr.compatibility.immudb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"ALTER DATABASE", PatternMatch::kPrefix, "database_lifecycle", "immudb.lifecycle.alter_database",
     ...
     "SBLR_COMPAT_IMMUDB_DATABASE_ROUTE", "ParserSupportDatabaseRoute", "IMMUDB.EMULATION.DATABASE_ROUTE",
    ...
    {"USE DATABASE", PatternMatch::kPrefix, "session", "immudb.session.use_database",
     ...
     "SBLR_COMPAT_IMMUDB_USE_DATABASE", "EngineSessionRoute", "",
     "", false, false},
    ...
    {"SHOW DATABASES", PatternMatch::kPrefix, "catalog_overlay", "immudb.catalog.show_databases",
     ...
     "SBLR_COMPAT_IMMUDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"VERIFIED_SET", PatternMatch::kPrefix, "kv_write", "immudb.kv.verified_set",
     ...
     "SBLR_COMPAT_IMMUDB_VERIFIED_KV_ROUTE", "ParserSupportVerifiedKvRoute", "IMMUDB.EMULATION.VERIFIED_KV_ROUTE",
    ...
    {"SET_REFERENCE", PatternMatch::kPrefix, "kv_write", "immudb.kv.set_reference",
     ...
     "SBLR_COMPAT_IMMUDB_REFERENCE_ROUTE", "ParserSupportReferenceRoute", "IMMUDB.EMULATION.REFERENCE_ROUTE",
    ...
    {"SET", PatternMatch::kPrefix, "kv_write", "immudb.kv.set",
     ...
     "SBLR_COMPAT_IMMUDB_SET", "EngineKvSet", "",
     "", false, true},
    ...
    {"ZADD", PatternMatch::kPrefix, "kv_write", "immudb.sorted_set.zadd",
     ...
     "SBLR_COMPAT_IMMUDB_SORTED_SET_ROUTE", "ParserSupportSortedSetRoute", "IMMUDB.EMULATION.SORTED_SET_ROUTE",
    ...
    {"CREATE USER", PatternMatch::kPrefix, "security", "immudb.security.create_user",
     ...
     "SBLR_COMPAT_IMMUDB_SECURITY_ROUTE", "ParserSupportSecurityRoute", "IMMUDB.EMULATION.SECURITY_ROUTE",
    ...
    {"REPLICATION", PatternMatch::kPrefix, "external_authority", "immudb.replication.admin",
     ...
     "SBLR_COMPAT_IMMUDB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "IMMUDB.EMULATION.REPLICATION_ROUTE",
     "immudb replication administration routes through the immudb compatibility UDR.", true, false},
...
std::string ImmudbPackageIdentityJson() { return scratchbird::parser::compatibility::PackageIdentityJson(kProfile); }
std::string ImmudbSurfaceReportJson() { return scratchbird::parser::compatibility::SurfaceReportJson(kProfile); }
