...
constexpr std::string_view kSblrFamily = "sblr.compatibility.neo4j.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"CREATE CONSTRAINT", PatternMatch::kPrefix, "schema", "neo4j.schema.constraint.create",
     ...
     "SBLR_COMPAT_NEO4J_SCHEMA_ROUTE", "ParserSupportSchemaRoute", "NEO4J.EMULATION.SCHEMA_ROUTE",
    ...
    {"CREATE INDEX", PatternMatch::kPrefix, "schema", "neo4j.schema.index.create",
     ...
     "SBLR_COMPAT_NEO4J_INDEX_ROUTE", "ParserSupportIndexRoute", "NEO4J.EMULATION.INDEX_ROUTE",
    ...
    {"CREATE USER", PatternMatch::kPrefix, "security", "neo4j.security.create_user",
     ...
     "SBLR_COMPAT_NEO4J_SECURITY_ROUTE", "ParserSupportSecurityRoute", "NEO4J.EMULATION.SECURITY_ROUTE",
    ...
    {"CALL", PatternMatch::kPrefix, "procedure", "neo4j.procedure.call",
     ...
     "SBLR_COMPAT_NEO4J_PROCEDURE_ROUTE", "ParserSupportProcedureRoute", "NEO4J.EMULATION.PROCEDURE_ROUTE",
    ...
    {"LOAD CSV", PatternMatch::kPrefix, "client_file", "neo4j.client_file.load_csv",
     ...
     "SBLR_COMPAT_NEO4J_CLIENT_FILE_ROUTE", "ParserSupportClientFileRoute", "NEO4J.EMULATION.CLIENT_FILE_ROUTE",
    ...
    {"DETACH DELETE", PatternMatch::kPrefix, "graph_dml", "neo4j.graph.detach_delete",
     ...
     "SBLR_COMPAT_NEO4J_DELETE", "EngineGraphDelete", "",
     "", false, true},
...
std::string Neo4jPackageIdentityJson() { return scratchbird::parser::compatibility::PackageIdentityJson(kProfile); }
std::string Neo4jSurfaceReportJson() { return scratchbird::parser::compatibility::SurfaceReportJson(kProfile); }
