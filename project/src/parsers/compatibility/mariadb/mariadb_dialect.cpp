...
constexpr std::string_view kSblrFamily = "sblr.compatibility.mariadb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"CREATE SEQUENCE", PatternMatch::kPrefix, "sequence", "mariadb.sequence.create",
     ...
     "SBLR_COMPAT_MARIADB_SEQUENCE_CREATE", "EngineCreateSequence", "", "", true, true},
    {"ALTER SEQUENCE", PatternMatch::kPrefix, "sequence", "mariadb.sequence.alter",
     ...
     "SBLR_COMPAT_MARIADB_SEQUENCE_ALTER", "EngineAlterSequence", "", "", true, true},
    {"DROP SEQUENCE", PatternMatch::kPrefix, "sequence", "mariadb.sequence.drop",
     MappingDisposition::kAdmittedSblr, "mariadb.sequence.drop",
     "SBLR_COMPAT_MARIADB_SEQUENCE_DROP", "EngineDropSequence", "", "", true, true},
    {"NEXT VALUE FOR", PatternMatch::kContains, "sequence", "mariadb.sequence.next_value_for",
     ...
     "SBLR_COMPAT_MARIADB_SEQUENCE_NEXT_VALUE", "EngineNextSequenceValue", "", "", false, true},
    {"RETURNING", PatternMatch::kWord, "dml", "mariadb.dml.returning",
     MappingDisposition::kAdmittedSblr, "mariadb.dml.returning",
     "SBLR_COMPAT_MARIADB_DML_RETURNING", "EngineDmlReturning", "", "", false, true},
    {"HANDLER", PatternMatch::kPrefix, "handler", "mariadb.handler.cursor",
     ...
     "SBLR_COMPAT_MARIADB_HANDLER_ROUTE", "ParserSupportHandlerRoute",
    ...
    {"RESET MASTER", PatternMatch::kPrefix, "replication", "mariadb.replication.reset_master",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Replication reset requests route through the MariaDB compatibility UDR.", true, false},
    {"CREATE OR REPLACE", PatternMatch::kPrefix, "ddl", "mariadb.ddl.create_or_replace",
     ...
     "SBLR_COMPAT_MARIADB_DDL_CREATE_OR_REPLACE", "EngineDdlCreateOrReplace", "", "", true, true},
    {"LOAD DATA LOCAL INFILE", PatternMatch::kLoadDataLocalInfile, "bulk_io", "mariadb.bulk_io.load_data_local_infile",
     ...
     "SBLR_COMPAT_MARIADB_ETL_ROUTE", "ParserSupportEtlRoute",
     "MARIADB.EMULATION.ETL_ROUTE",
     "LOAD DATA LOCAL INFILE routes through the MariaDB compatibility UDR as a client logical ETL stream.",
     true, true},
    ...
    {"CHANGE REPLICATION SOURCE", PatternMatch::kPrefix, "replication", "mariadb.replication.change_source",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Replication source changes route through the MariaDB compatibility UDR.", true, false},
    {"CHANGE MASTER", PatternMatch::kPrefix, "replication", "mariadb.replication.change_master_legacy",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Legacy replication source changes route through the MariaDB compatibility UDR.", true, false},
    {"START REPLICA", PatternMatch::kPrefix, "replication", "mariadb.replication.start_replica",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Replica start requests route through the MariaDB compatibility UDR.", true, false},
    {"STOP REPLICA", PatternMatch::kPrefix, "replication", "mariadb.replication.stop_replica",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Replica stop requests route through the MariaDB compatibility UDR.", true, false},
    {"RESET REPLICA", PatternMatch::kPrefix, "replication", "mariadb.replication.reset_replica",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Replica reset requests route through the MariaDB compatibility UDR.", true, false},
    {"SHOW REPLICA STATUS", PatternMatch::kPrefix, "replication", "mariadb.replication.show_replica_status",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Replica status reports route through the MariaDB compatibility UDR.", false, false},
    {"SHOW SLAVE STATUS", PatternMatch::kPrefix, "replication", "mariadb.replication.show_slave_status_legacy",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Legacy replica status reports route through the MariaDB compatibility UDR.", false, false},
    {"PURGE BINARY LOGS", PatternMatch::kPrefix, "replication", "mariadb.replication.purge_binary_logs",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Binary-log CDC retention requests route through the MariaDB compatibility UDR.", true, false},
    {"RESET BINARY LOGS", PatternMatch::kPrefix, "replication", "mariadb.replication.reset_binary_logs",
     ...
     "SBLR_COMPAT_MARIADB_REPLICATION_ROUTE", "ParserSupportReplicationRoute",
     "MARIADB.EMULATION.REPLICATION_ROUTE",
     "Binary-log reset requests route through the MariaDB compatibility UDR.", true, false},
    {"CREATE USER", PatternMatch::kPrefix, "security", "mariadb.security.create_user",
     ...
     "SBLR_COMPAT_MARIADB_SECURITY_ROUTE", "ParserSupportSecurityRoute",
    ...
    {"CREATE EVENT", PatternMatch::kPrefix, "routine", "mariadb.routine.event.create",
     ...
     "SBLR_COMPAT_MARIADB_ROUTINE_ROUTE", "ParserSupportRoutineRoute",
    ...
    {"USE", PatternMatch::kPrefix, "session", "mariadb.session.use_database",
     ...
     "SBLR_COMPAT_MARIADB_USE_DATABASE", "EngineSessionRoute", "", "", false, false},
    {"SHOW", PatternMatch::kPrefix, "catalog_overlay", "mariadb.catalog_overlay.show",
     ...
     "SBLR_COMPAT_MARIADB_CATALOG_PROJECT", "EngineCatalogProjection", "", "", false, false},
    ...
    {"EXPLAIN", PatternMatch::kPrefix, "optimizer", "mariadb.optimizer.explain",
     ...
     "SBLR_COMPAT_MARIADB_EXPLAIN", "EngineExplainPlan", "", "", false, false},
    {"PREPARE", PatternMatch::kPrefix, "prepared_statement", "mariadb.prepared.prepare",
     ...
     "SBLR_COMPAT_MARIADB_PREPARE", "EnginePrepareStatement", "", "", false, false},
    {"EXECUTE", PatternMatch::kPrefix, "prepared_statement", "mariadb.prepared.execute",
     ...
     "SBLR_COMPAT_MARIADB_EXECUTE", "EngineExecuteStatement", "", "", false, true},
    {"DEALLOCATE", PatternMatch::kPrefix, "prepared_statement", "mariadb.prepared.deallocate",
     ...
     "SBLR_COMPAT_MARIADB_DEALLOCATE", "EngineDeallocateStatement", "", "", false, false},
    {"LOCK TABLES", PatternMatch::kPrefix, "locking", "mariadb.locking.lock_tables",
     ...
     "SBLR_COMPAT_MARIADB_LOCK_TABLES", "EngineLockTables", "", "", true, true},
    {"UNLOCK TABLES", PatternMatch::kPrefix, "locking", "mariadb.locking.unlock_tables",
     ...
     "SBLR_COMPAT_MARIADB_UNLOCK_TABLES", "EngineUnlockTables", "", "", true, true},
    ...
    {"CALL", PatternMatch::kPrefix, "routine", "mariadb.routine.call",
     ...
     "SBLR_COMPAT_MARIADB_ROUTINE_CALL", "ParserSupportRoutineRoute",
     "MARIADB.EMULATION.ROUTINE_ROUTE",
    ...
    {"ANALYZE TABLE", PatternMatch::kPrefix, "maintenance", "mariadb.maintenance.analyze_table",
     ...
     "MariaDB ANALYZE TABLE is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    {"OPTIMIZE TABLE", PatternMatch::kPrefix, "maintenance", "mariadb.maintenance.optimize_table",
     ...
     "", "", "MARIADB.AUTHORITY.UNSUPPORTED_DENIED",
     "MariaDB OPTIMIZE TABLE is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    {"CHECK TABLE", PatternMatch::kPrefix, "maintenance", "mariadb.maintenance.check_table",
     ...
     "", "", "MARIADB.AUTHORITY.UNSUPPORTED_DENIED",
     "MariaDB CHECK TABLE is a compatibility verification utility surface and is outside compatibility parser authority.",
     true, false},
    {"REPAIR TABLE", PatternMatch::kPrefix, "maintenance", "mariadb.maintenance.repair_table",
     ...
     "", "", "MARIADB.AUTHORITY.UNSUPPORTED_DENIED",
     "MariaDB REPAIR TABLE is a compatibility repair utility surface and is outside compatibility parser authority.",
     true, false},
    {"FLUSH", PatternMatch::kPrefix, "maintenance", "mariadb.maintenance.flush",
     ...
     "", "", "MARIADB.AUTHORITY.UNSUPPORTED_DENIED",
     "MariaDB FLUSH is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
