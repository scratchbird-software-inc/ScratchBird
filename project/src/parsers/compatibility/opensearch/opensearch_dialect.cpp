...
constexpr std::string_view kSblrFamily = "sblr.compatibility.opensearch.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"_SEARCH", PatternMatch::kRestPathSegment, "query", "opensearch.search.query",
     ...
     "SBLR_COMPAT_OPENSEARCH_SEARCH_ROUTE", "EngineSearchRoute", "",
     "", false, false},
    {"_MSEARCH", PatternMatch::kRestPathSegment, "query", "opensearch.search.multi",
     ...
     "SBLR_COMPAT_OPENSEARCH_MULTI_SEARCH_ROUTE", "ParserSupportMultiSearchRoute", "OPENSEARCH.EMULATION.MULTI_SEARCH_ROUTE",
    ...
    {"_BULK", PatternMatch::kRestPathSegment, "bulk", "opensearch.bulk.write",
     ...
     "SBLR_COMPAT_OPENSEARCH_BULK_ROUTE", "ParserSupportBulkRoute", "OPENSEARCH.EMULATION.BULK_ROUTE",
    ...
    {"_MGET", PatternMatch::kRestPathSegment, "document", "opensearch.document.multi_get",
     ...
     "SBLR_COMPAT_OPENSEARCH_MULTI_GET_ROUTE", "EngineDocumentMultiGet", "",
     "", false, false},
    {"_MAPPING", PatternMatch::kRestPathSegment, "catalog_overlay", "opensearch.catalog.mapping",
     ...
     "SBLR_COMPAT_OPENSEARCH_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    {"_ALIASES", PatternMatch::kRestPathSegment, "catalog_overlay", "opensearch.catalog.aliases",
     ...
     "SBLR_COMPAT_OPENSEARCH_ALIAS_ROUTE", "ParserSupportAliasRoute", "OPENSEARCH.EMULATION.ALIAS_ROUTE",
    ...
    {"_INGEST/PIPELINE", PatternMatch::kRestPathSegment, "pipeline", "opensearch.ingest.pipeline",
     ...
     "SBLR_COMPAT_OPENSEARCH_PIPELINE_ROUTE", "ParserSupportPipelineRoute", "OPENSEARCH.EMULATION.PIPELINE_ROUTE",
    ...
    {"_SECURITY", PatternMatch::kRestPathSegment, "security", "opensearch.security.route",
     ...
     "SBLR_COMPAT_OPENSEARCH_SECURITY_ROUTE", "ParserSupportSecurityRoute", "OPENSEARCH.EMULATION.SECURITY_ROUTE",
    ...
    {"DELETE", PatternMatch::kPrefix, "document", "opensearch.document.delete",
     ...
     "SBLR_COMPAT_OPENSEARCH_DELETE_ROUTE", "EngineDocumentDelete", "",
     "", false, true},
};
...
std::string OpensearchPackageIdentityJson() { return scratchbird::parser::compatibility::PackageIdentityJson(kProfile); }
std::string OpensearchSurfaceReportJson() { return scratchbird::parser::compatibility::SurfaceReportJson(kProfile); }
