...
constexpr OperationPattern kPatterns[] = {
    ...
    {"COPY|| TO STDOUT", PatternMatch::kPrefixAndContains,
     ...
     "SBLR_COMPATIBILITY_YUGABYTEDB_COPY_ROUTE", "ParserSupportCopyRoute",
    ...
    {"COPY", PatternMatch::kPrefix, "bulk_io", "yugabytedb.bulk_io.copy",
     ...
     "SBLR_COMPATIBILITY_YUGABYTEDB_COPY_ROUTE", "ParserSupportCopyRoute", "YUGABYTEDB.EMULATION.COPY_ROUTE",
