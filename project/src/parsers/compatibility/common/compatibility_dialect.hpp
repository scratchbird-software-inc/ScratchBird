...
// Family-owned transaction/session values consumed by the neutral evidence
...
// Family-owned temporary-object values consumed by the neutral evidence
// renderer.  No parser grammar, lifetime default, or visibility policy is
// selected by the common component.
...
// Parser-owned semantic policy hooks.  The neutral compatibility mechanics
// may invoke these callbacks, but must not select a dialect or define the
// syntax, defaults, diagnostics, or evidence values returned by them.
struct DialectSemanticPolicy {
  bool (*is_system_catalog_defaults_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*system_catalog_defaults_evidence_json)(
      std::string_view operation_id,
      std::span<const SurfaceDescriptor> catalog_surfaces){nullptr};
  bool (*is_session_settings_diagnostics_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*session_settings_diagnostics_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_locks_isolation_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*locks_isolation_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_resource_text_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*resource_text_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_statistics_optimizer_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*statistics_optimizer_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_ddl_transaction_behavior_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*ddl_transaction_behavior_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_dependency_bearing_ddl_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*dependency_bearing_ddl_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_transaction_session_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*transaction_session_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_temporary_session_object_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*temporary_session_object_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_index_semantic_defaults_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*index_semantic_defaults_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_constraint_semantic_defaults_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*constraint_semantic_defaults_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_sequence_identity_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*sequence_identity_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_identifier_name_resolution_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*identifier_name_resolution_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_scalar_expression_semantic_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*scalar_expression_semantic_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  bool (*is_dml_mutation_semantic_statement)(
      std::string_view active_upper_sql){nullptr};
  std::string (*dml_mutation_semantic_evidence_json)(
      std::string_view release_profile,
      std::string_view active_upper_sql){nullptr};
  ProceduralFunctionalEncodingSpanMetadata
      (*procedural_functional_encoding_span_metadata)(
          std::string_view active_upper_sql,
          std::span<const Token> active_tokens){nullptr};
...
struct DialectProfile {
  ...
  int compatibility_alias_rows{0};
  ...
  // Parser-owned dialect variants.  The neutral report renderer only
  // serializes these values; it must not select a family or define variants.
  std::span<const std::string_view> dialect_variants{};
  const DialectSemanticPolicy* semantic_policy{nullptr};
};
...
struct ParseResult {
  ...
  bool real_reference_file_effects{false};
  bool reference_engine_sql_executed{false};
