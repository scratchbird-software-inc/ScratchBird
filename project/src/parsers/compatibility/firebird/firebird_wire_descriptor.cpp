...
const std::unordered_map<std::uint8_t, TagInfo>& DpbTags() {
  static const std::unordered_map<std::uint8_t, TagInfo> tags = {
      ...
      {61, {"isc_dpb_set_page_buffers", "public_create_refusal_policy"}},
      {62, {"isc_dpb_working_directory", "client_environment_descriptor"}},
      {63, {"isc_dpb_sql_dialect", "dialect_profile"}},
      {64, {"isc_dpb_set_db_readonly", "public_create_refusal_policy"}},
      {65, {"isc_dpb_set_db_sql_dialect", "public_create_refusal_policy"}},
      {68, {"isc_dpb_set_db_charset", "public_create_refusal_policy"}},
      ...
      {92, {"isc_dpb_set_db_replica", "public_create_refusal_policy"}},
