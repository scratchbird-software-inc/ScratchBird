...
constexpr std::string_view kSblrFamily = "sblr.compatibility.cockroachdb.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"CREATE CHANGEFEED", PatternMatch::kPrefix, "changefeed", "cockroachdb.changefeed.create",
     ...
     "SBLR_COMPAT_COCKROACHDB_CHANGEFEED_ROUTE", "ParserSupportChangefeedRoute",
     "COCKROACHDB.EMULATION.CHANGEFEED_ROUTE",
     "Changefeed requests route through the CockroachDB compatibility UDR.", true, false},
    {"SHOW RANGES", PatternMatch::kPrefix, "catalog_overlay", "cockroachdb.catalog_overlay.show_ranges",
     ...
     "SBLR_COMPAT_COCKROACHDB_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"ALTER RANGE", PatternMatch::kPrefix, "zone_config", "cockroachdb.zone_config.alter_range",
     ...
     "SBLR_COMPAT_COCKROACHDB_ZONE_ROUTE", "ParserSupportZoneRoute", "COCKROACHDB.EMULATION.ZONE_ROUTE",
    ...
    {"ALTER TABLE", PatternMatch::kPrefix, "ddl", "cockroachdb.ddl.alter_table",
     ...
     "SBLR_COMPAT_COCKROACHDB_DDL_ALTER", "EngineDdlAlter", "",
     "", true, true},
    ...
    {"COPY|| TO STDOUT", PatternMatch::kPrefixAndContains,
     ...
     "SBLR_COMPATIBILITY_COCKROACHDB_COPY_ROUTE", "ParserSupportCopyRoute",
    ...
    {"COPY", PatternMatch::kPrefix, "bulk_io", "cockroachdb.bulk_io.copy",
     ...
     "SBLR_COMPATIBILITY_COCKROACHDB_COPY_ROUTE", "ParserSupportCopyRoute", "COCKROACHDB.EMULATION.COPY_ROUTE",
    ...
    {"CREATE FOREIGN DATA WRAPPER", PatternMatch::kPrefix, "connector", "cockroachdb.connector.fdw.create",
     ...
     "SBLR_COMPAT_COCKROACHDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "COCKROACHDB.EMULATION.CONNECTOR_ROUTE",
     "External connector operations route through the CockroachDB compatibility UDR.", true, false},
    {"CREATE SERVER", PatternMatch::kPrefix, "connector", "cockroachdb.connector.server.create",
     ...
     "SBLR_COMPAT_COCKROACHDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "COCKROACHDB.EMULATION.CONNECTOR_ROUTE",
     "External server operations route through the CockroachDB compatibility UDR.", true, false},
    {"CREATE USER MAPPING", PatternMatch::kPrefix, "connector", "cockroachdb.connector.user_mapping.create",
     ...
     "SBLR_COMPAT_COCKROACHDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "COCKROACHDB.EMULATION.CONNECTOR_ROUTE",
     "External user mapping operations route through the CockroachDB compatibility UDR.", true, false},
    {"CREATE FOREIGN TABLE", PatternMatch::kPrefix, "connector", "cockroachdb.connector.foreign_table.create",
     ...
     "SBLR_COMPAT_COCKROACHDB_CONNECTOR_ROUTE", "ParserSupportConnectorRoute",
     "COCKROACHDB.EMULATION.CONNECTOR_ROUTE",
     "External table creation routes through the CockroachDB compatibility UDR.", true, false},
    {"CREATE ROLE", PatternMatch::kPrefix, "security", "cockroachdb.security.create_role",
     ...
     "SBLR_COMPAT_COCKROACHDB_SECURITY_ROUTE", "ParserSupportSecurityRoute", "COCKROACHDB.EMULATION.SECURITY_ROUTE",
    ...
    {"PREPARE", PatternMatch::kPrefix, "prepared_statement", "cockroachdb.prepared.prepare",
     ...
     "SBLR_COMPAT_COCKROACHDB_PREPARE", "EnginePrepareStatement", "",
     "", false, false},
    {"EXECUTE", PatternMatch::kPrefix, "prepared_statement", "cockroachdb.prepared.execute",
     ...
     "SBLR_COMPAT_COCKROACHDB_EXECUTE", "EngineExecuteStatement", "",
     "", false, true},
    {"DEALLOCATE", PatternMatch::kPrefix, "prepared_statement", "cockroachdb.prepared.deallocate",
     ...
     "SBLR_COMPAT_COCKROACHDB_DEALLOCATE", "EngineDeallocateStatement", "",
     "", false, false},
    {"CREATE", PatternMatch::kPrefix, "ddl", "cockroachdb.ddl.create",
     MappingDisposition::kAdmittedSblr, "cockroachdb.ddl.create",
     "SBLR_COMPAT_COCKROACHDB_DDL_CREATE", "EngineDdlCreate", "",
     "", true, true},
