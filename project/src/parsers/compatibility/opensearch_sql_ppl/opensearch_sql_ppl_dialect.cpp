...
constexpr std::string_view kSblrFamily = "sblr.compatibility.opensearch_sql_ppl.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"GET /_PLUGINS/_SQL||GET /_PLUGINS/_PPL", PatternMatch::kRestMethodRoute, "rest_plugin_api", "opensearch_sql_ppl.rest.get",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_REST_DSL_ROUTE", "ParserSupportRestDslRoute",
    ...
    {"DROP INDEX", PatternMatch::kPrefix, "index_admin", "opensearch_sql_ppl.index.drop",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_INDEX_ROUTE", "ParserSupportIndexRoute",
    ...
    {"CREATE INDEX", PatternMatch::kPrefix, "index_admin", "opensearch_sql_ppl.index.create",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_INDEX_ROUTE", "ParserSupportIndexRoute", "OPENSEARCH_SQL_PPL.EMULATION.INDEX_ROUTE",
    ...
    {"CALL", PatternMatch::kPrefix, "plugin", "opensearch_sql_ppl.plugin.call",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PLUGIN_ROUTE", "ParserSupportPluginRoute", "OPENSEARCH_SQL_PPL.EMULATION.PLUGIN_ROUTE",
    ...
    {"ML ", PatternMatch::kPplPipelineStage, "ml", "opensearch_sql_ppl.ml.command",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_ML_ROUTE", "ParserSupportMlRoute", "OPENSEARCH_SQL_PPL.EMULATION.ML_ROUTE",
    ...
    {"LOOKUP", PatternMatch::kPplPipelineStage, "ppl_pipeline", "opensearch_sql_ppl.ppl.lookup",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_PIPELINE", "ParserSupportPplPipelineRoute", "OPENSEARCH_SQL_PPL.EMULATION.PPL_PIPELINE_ROUTE",
    ...
    {"STATS", PatternMatch::kPplPipelineStage, "ppl_pipeline", "opensearch_sql_ppl.ppl.stats",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_STATS", "EngineAggregatePlan", "",
     "", false, false},
    {"SOURCE", PatternMatch::kPplPipelineStage, "ppl_query", "opensearch_sql_ppl.ppl.source",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_SOURCE", "EngineQuerySelect", "",
     "", false, false},
    {"SEARCH", PatternMatch::kPrefix, "ppl_query", "opensearch_sql_ppl.ppl.search",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_SEARCH", "EngineQuerySelect", "",
     "", false, false},
    {"WHERE", PatternMatch::kPrefix, "ppl_pipeline", "opensearch_sql_ppl.ppl.where",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_FILTER", "EngineQueryFilter", "",
     "", false, false},
    {"FIELDS", PatternMatch::kPrefix, "ppl_pipeline", "opensearch_sql_ppl.ppl.fields",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_PROJECT", "EngineQueryProject", "",
     "", false, false},
    {"SORT", PatternMatch::kPrefix, "ppl_pipeline", "opensearch_sql_ppl.ppl.sort",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_SORT", "EngineQuerySort", "",
     "", false, false},
    {"HEAD", PatternMatch::kPrefix, "ppl_pipeline", "opensearch_sql_ppl.ppl.head",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_LIMIT", "EngineQueryLimit", "",
     "", false, false},
    {"EVAL", PatternMatch::kPrefix, "ppl_pipeline", "opensearch_sql_ppl.ppl.eval",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_PPL_EVAL", "EngineExpressionProject", "",
     "", false, false},
    {"SHOW DATASOURCES", PatternMatch::kPrefix, "catalog_overlay", "opensearch_sql_ppl.catalog.show_datasources",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_CATALOG_PROJECT", "EngineCatalogProjection", "",
     "", false, false},
    ...
    {"EXPLAIN", PatternMatch::kPrefix, "optimizer", "opensearch_sql_ppl.optimizer.explain",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_EXPLAIN", "EngineExplainPlan", "",
     "", false, false},
    {"SELECT", PatternMatch::kPrefix, "sql_query", "opensearch_sql_ppl.sql.select",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_SQL_SELECT", "EngineQuerySelect", "",
     "", false, false},
    {"DELETE", PatternMatch::kPrefix, "sql_dml", "opensearch_sql_ppl.sql.delete",
     ...
     "SBLR_COMPAT_OPENSEARCH_SQL_PPL_SQL_DELETE", "EngineDmlDelete", "",
     "", false, true},
};
