...
constexpr std::string_view kSblrFamily = "sblr.compatibility.sqlite.profile.v1";
...
constexpr OperationPattern kPatterns[] = {
    ...
    {"ATTACH DATABASE", PatternMatch::kPrefix, "database_lifecycle", "sqlite.lifecycle.attach_database",
     ...
     "ATTACH DATABASE would bind a compatibility file outside ScratchBird engine authority.", true, false},
    ...
    {"VACUUM INTO", PatternMatch::kPrefix, "bulk_io", "sqlite.bulk_io.vacuum_into",
     ...
     "SQLite VACUUM INTO is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    ...
    {"PRAGMA " "JOURNAL_MODE", PatternMatch::kPrefix, "pragma", "sqlite.pragma.journal_mode",
     ...
     "SBLR_COMPAT_SQLITE_PRAGMA_ROUTE", "ParserSupportPragmaRoute",
    ...
    {"CREATE TEMP", PatternMatch::kPrefix, "ddl", "sqlite.ddl.create_temp",
     ...
     "SBLR_COMPAT_SQLITE_DDL_CREATE_TEMP", "EngineDdlCreateTemp", "", "", true, true},
    {"CREATE VIRTUAL TABLE", PatternMatch::kPrefix, "virtual_table", "sqlite.virtual_table.create",
     ...
     "SBLR_COMPAT_SQLITE_VIRTUAL_TABLE_ROUTE", "ParserSupportVirtualTableRoute",
    ...
    {"CREATE TRIGGER", PatternMatch::kPrefix, "routine", "sqlite.routine.trigger.create",
     ...
     "SBLR_COMPAT_SQLITE_ROUTINE_ROUTE", "ParserSupportRoutineRoute",
    ...
    {"EXPLAIN QUERY PLAN", PatternMatch::kPrefix, "optimizer", "sqlite.optimizer.explain_query_plan",
     ...
     "SBLR_COMPAT_SQLITE_EXPLAIN", "EngineExplainPlan", "", "", false, false},
    ...
    {"ANALYZE", PatternMatch::kPrefix, "maintenance", "sqlite.maintenance.analyze",
     ...
     "", "", "SQLITE.AUTHORITY.UNSUPPORTED_DENIED",
     "SQLite ANALYZE is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    {"VACUUM", PatternMatch::kPrefix, "maintenance", "sqlite.maintenance.vacuum",
     ...
     "", "", "SQLITE.AUTHORITY.UNSUPPORTED_DENIED",
     "SQLite VACUUM is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
    {"REINDEX", PatternMatch::kPrefix, "maintenance", "sqlite.maintenance.reindex",
     ...
     "", "", "SQLITE.AUTHORITY.UNSUPPORTED_DENIED",
     "SQLite REINDEX is a compatibility low-level utility surface and is outside compatibility parser authority.",
     true, false},
