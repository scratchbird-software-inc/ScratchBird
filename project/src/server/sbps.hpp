...
// Private statement-scoped source-artifact retention. The request carries one
// exact SARQ plus its canonical SAM1 bytes; the success response is one exact
...
enum class MessageType : std::uint16_t {
  ...
  kCoordinateDdlCreatePublicationRequest = 538,
  kCoordinateDdlCreatePublicationResult = 539,
  kCoordinateDdlAlterPublicationRequest = 540,
  kCoordinateDdlAlterPublicationResult = 541,
  kCoordinateDdlDropPublicationRequest = 542,
  kCoordinateDdlDropPublicationResult = 543,
  kCoordinateDdlCreateSubscriptionRequest = 544,
  kCoordinateDdlCreateSubscriptionResult = 545,
  kCoordinateDdlAlterSubscriptionRequest = 546,
  kCoordinateDdlAlterSubscriptionResult = 547,
  kCoordinateDdlDropSubscriptionRequest = 548,
  kCoordinateDdlDropSubscriptionResult = 549,
  kCoordinateDdlCreateOperatorRequest = 550,
  kCoordinateDdlCreateOperatorResult = 551,
  kCoordinateDdlDropOperatorRequest = 552,
  kCoordinateDdlDropOperatorResult = 553,
  kCoordinateDdlCreateOperatorClassRequest = 554,
  kCoordinateDdlCreateOperatorClassResult = 555,
  kCoordinateDdlDropOperatorClassRequest = 556,
  kCoordinateDdlDropOperatorClassResult = 557,
  kCoordinateDdlCreateOperatorFamilyRequest = 558,
  kCoordinateDdlCreateOperatorFamilyResult = 559,
  kCoordinateDdlAlterOperatorFamilyRequest = 560,
  kCoordinateDdlAlterOperatorFamilyResult = 561,
  kCoordinateDdlDropOperatorFamilyRequest = 562,
  kCoordinateDdlDropOperatorFamilyResult = 563,
  ...
  kCoordinateDdlDropExtensionRequest = 578,
  kCoordinateDdlDropExtensionResult = 579,
  kCoordinateClusterCreatePlacementPolicyRequest = 586,
  kCoordinateClusterCreatePlacementPolicyResult = 587,
  kCoordinateClusterAlterPlacementPolicyRequest = 588,
  kCoordinateClusterAlterPlacementPolicyResult = 589,
  kCoordinateClusterDropPlacementPolicyRequest = 590,
  kCoordinateClusterDropPlacementPolicyResult = 591,
  kCoordinateVersionedBranchCreateRequest = 608,
  kCoordinateVersionedBranchCreateResult = 609,
  kCoordinateVersionedBranchDeleteRequest = 610,
  kCoordinateVersionedBranchDeleteResult = 611,
  kCoordinateVersionedDiffRequest = 612,
  kCoordinateVersionedDiffResult = 613,
  kCoordinateVersionedTagRequest = 614,
  kCoordinateVersionedTagResult = 615,
  kCoordinateVersionedRevertRequest = 616,
  kCoordinateVersionedRevertResult = 617,
  kCoordinateVersionedResetRequest = 618,
  kCoordinateVersionedResetResult = 619,
  kCoordinateBitemporalAsOfRequest = 662,
  kCoordinateBitemporalAsOfResult = 663,
  kCoordinateVerifiableHistoryProveRequest = 654,
  kCoordinateVerifiableHistoryProveResult = 655,
  kCoordinateVerifyProofDescriptorRequest = 664,
  kCoordinateVerifyProofDescriptorResult = 665,
  kCoordinateVersionedMergeRequest = 656,
  kCoordinateVersionedMergeResult = 657,
  kCoordinateVersionedHashReadRequest = 658,
  kCoordinateVersionedHashReadResult = 659,
  kCoordinateVersionedStatusReadRequest = 660,
  kCoordinateVersionedStatusReadResult = 661,
  kCoordinateAccelLlvmPolicySetRequest = 620,
  kCoordinateAccelLlvmPolicySetResult = 621,
  kCoordinateAccelLlvmCompileRequest = 622,
  kCoordinateAccelLlvmCompileResult = 623,
  kCoordinateAccelLlvmInspectRequest = 624,
  kCoordinateAccelLlvmInspectResult = 625,
  ...
  kCoordinateDdlDropTimeseriesValueCacheRequest = 296,
  kCoordinateDdlDropTimeseriesValueCacheResult = 297,
  ...
  kSessionSettingSetRequest = 370,
  kSessionSettingSetResult = 371,
  kSessionSettingResetRequest = 372,
  kSessionSettingResetResult = 373,
  kSessionSettingGetRequest = 374,
  ...
  kSessionSnapshotHandleRequest = 380,
  kSessionSnapshotHandleResult = 381,
  kContextSetRequest = 382,
  kContextSetResult = 383,
  kContextUnsetRequest = 384,
