...
struct ServerCursorRecord {
  ...
  // Exact RESULT_PAGE lifecycle. These identities are issued from the
  // cursor-owning statement receipt and never accepted from the parser.
  std::uint64_t result_page_cursor_generation = 1;
  std::uint64_t result_page_result_set_handle_generation = 1;
  std::uint64_t result_page_row_descriptor_generation = 1;
  std::array<std::uint8_t, 16> result_page_redaction_profile_uuid{};
  std::uint64_t result_page_redaction_generation = 0;
  std::array<std::uint8_t, 16> result_page_policy_snapshot_uuid{};
  std::uint64_t result_page_policy_generation = 0;
  std::array<std::uint8_t, 16> result_page_resource_budget_uuid{};
  std::uint64_t result_page_resource_budget_generation = 0;
  std::uint64_t result_page_next_page_number = 0;
  std::array<std::uint8_t, 16> result_page_continuation_uuid{};
  std::uint64_t result_page_continuation_generation = 0;
  std::vector<std::uint8_t> pending_result_page_request;
  std::vector<std::uint8_t> pending_result_page_descriptor;
  std::map<std::uint64_t, std::vector<std::uint8_t>>
      result_page_descriptors_by_occurrence;
  std::vector<std::uint8_t> last_result_page_descriptor;
  std::vector<std::uint8_t> last_result_page_result;
  std::string last_result_page_material;
...
SessionOperationResult HandleCoordinateDdlCreatePublication(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlAlterPublication(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlDropPublication(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlCreateSubscription(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlAlterSubscription(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlDropSubscription(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlCreateOperator(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlDropOperator(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
...
SessionOperationResult HandleCoordinateDdlDropOperatorFamily(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlCreateExtension(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlAlterExtension(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateDdlDropExtension(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
...
SessionOperationResult HandleCoordinateVersionedBranchDelete(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVersionedDiff(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVersionedTag(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
...
SessionOperationResult HandleCoordinateBitemporalAsOf(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVerifiableHistoryProve(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVerifyProofDescriptor(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVersionedMerge(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVersionedHashRead(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleCoordinateVersionedStatusRead(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
...
SessionOperationResult HandleCoordinateAccelLlvmInspect(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
...
SessionOperationResult HandleContextSet(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleContextUnset(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
SessionOperationResult HandleContextGet(ServerSessionRegistry*,const HostedEngineState&,const sbps::Frame&);
