...
constexpr std::array<PairV1, kRequiredPairCountV1> kRequiredPairs{{
    ...
    {740, 7753}, {741, 7754}, {742, 7755}, {743, 7756},
}};
...
std::pair<std::string_view, std::string_view> AuthorityFor(PairV1 pair) {
  ...
  if (pair.payload_schema_id == 7755 || pair.payload_schema_id == 7756) {
    return {"SBLR-SECURITY-ALTER-POLICY-AUTHORITY-V1", kNarrowCorpus};
  }
