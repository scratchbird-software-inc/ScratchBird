...
struct ServerSblrAdmissionRequest {
  ...
  scratchbird::core::platform::Uuid authenticated_principal_uuid;
  scratchbird::core::platform::Uuid catalog_snapshot_uuid;
  scratchbird::core::platform::Uuid engine_mga_statement_uuid;
  scratchbird::core::platform::Uuid engine_mga_snapshot_uuid;
