...
bool HandleClientFrame(IpcSocketHandle client_fd,
  ...
  const bool session_bound_message =
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtPrepareBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteDirectBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtFreeBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtCancelBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kParameterBindPrivateRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateCatalogIntrospectRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDmlDeleteRowsBindRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropPublicationRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateSubscriptionRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterSubscriptionRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropSubscriptionRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateOperatorRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropOperatorRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateOperatorClassRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropOperatorClassRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateOperatorFamilyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterOperatorFamilyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropOperatorFamilyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateExtensionRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterExtensionRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropExtensionRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateClusterCreatePlacementPolicyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateClusterAlterPlacementPolicyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateClusterDropPlacementPolicyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedBranchCreateRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedBranchDeleteRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedDiffRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedTagRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedRevertRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedResetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateBitemporalAsOfRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVerifiableHistoryProveRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVerifyProofDescriptorRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedMergeRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedHashReadRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedStatusReadRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateAccelLlvmPolicySetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateAccelLlvmCompileRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateAccelLlvmInspectRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropCastRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateMaterializedViewRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlRefreshMaterializedViewRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropMaterializedViewRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateTypeRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterTypeRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropTypeRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateTableAsQueryWithDataRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateTableAsQueryWithNoDataRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropTableRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateSynonymRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateForeignTableRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateFdwRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropFdwRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropForeignTableRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropSynonymRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropPackageRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterPackageRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterSequenceRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropSequenceRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlRenameObjectRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityCreateUserRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityAlterUserRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityCreateRoleRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityCreatePolicyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityDropPolicyRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityAlterRoleRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityCreateGroupMappingRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionRoleSwitchRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionSettingSetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionSettingResetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionSettingGetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionDefaultQualifierSetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionDiscardRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kSessionSnapshotHandleRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kContextSetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kContextUnsetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kContextGetRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtPrepareRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteDirectRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtFreeRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kStmtCancelRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kParameterBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kResultPageRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kQueryExplainBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kQueryExplainRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kNameResolveBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kNameResolveRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kParseTextBindRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kParseTextRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kDdlCreateSchemaRecoveryRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateSecurityDropRoleRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateDictionaryRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropDictionaryRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterDictionaryRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateContinuousViewRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterContinuousViewRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropContinuousViewRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDmlAsyncInsertSubmitRequest) ||
      ...
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterTimeseriesValueCacheRequest) ||
      frame.header.message_type == static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropTimeseriesValueCacheRequest) ||
      frame.header.message_type == 276 ||
  ...
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDmlDeleteRowsBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDmlDeleteRowsBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDmlDeleteRowsBind(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDmlUpdateRowsBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDmlUpdateRowsBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDmlUpdateRowsBind(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDmlPlanImportRowsBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDmlPlanImportRowsBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDmlPlanImportRowsBind(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==268&&frame.header.payload_schema_id==sbps::kSchemaCoordinateCatalogIntrospectRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateCatalogIntrospect(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreatePublicationRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreatePublicationRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreatePublication(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterPublicationRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterPublicationRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterPublication(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropPublicationRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropPublicationRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropPublication(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateSubscriptionRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateSubscriptionRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateSubscription(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterSubscriptionRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterSubscriptionRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterSubscription(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropSubscriptionRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropSubscriptionRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropSubscription(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateOperatorRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateOperatorRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateOperator(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropOperatorRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropOperatorRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropOperator(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateOperatorClassRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateOperatorClassRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateOperatorClass(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropOperatorClassRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropOperatorClassRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropOperatorClass(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateOperatorFamilyRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateOperatorFamilyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateOperatorFamily(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterOperatorFamilyRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterOperatorFamilyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterOperatorFamily(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropOperatorFamilyRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropOperatorFamilyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropOperatorFamily(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateExtensionRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateExtensionRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateExtension(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterExtensionRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterExtensionRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterExtension(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropExtensionRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropExtensionRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropExtension(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateClusterCreatePlacementPolicyRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateClusterCreatePlacementPolicyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateClusterCreatePlacementPolicy(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateClusterAlterPlacementPolicyRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateClusterAlterPlacementPolicyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateClusterAlterPlacementPolicy(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateClusterDropPlacementPolicyRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateClusterDropPlacementPolicyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateClusterDropPlacementPolicy(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedBranchCreateRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedBranchCreateRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedBranchCreate(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedBranchDeleteRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedBranchDeleteRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedBranchDelete(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedDiffRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedDiffRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedDiff(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedTagRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedTagRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedTag(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedRevertRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedRevertRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedRevert(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedResetRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedResetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedReset(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateBitemporalAsOfRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateBitemporalAsOfRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateBitemporalAsOf(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVerifiableHistoryProveRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVerifiableHistoryProveRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVerifiableHistoryProve(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVerifyProofDescriptorRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVerifyProofDescriptorRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVerifyProofDescriptor(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedMergeRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedMergeRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedMerge(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedHashReadRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedHashReadRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedHashRead(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateVersionedStatusReadRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateVersionedStatusReadRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateVersionedStatusRead(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateAccelLlvmPolicySetRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateAccelLlvmPolicySetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateAccelLlvmPolicySet(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateAccelLlvmCompileRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateAccelLlvmCompileRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateAccelLlvmCompile(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateAccelLlvmInspectRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateAccelLlvmInspectRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateAccelLlvmInspect(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropCastRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropCastRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropCast(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateMaterializedViewRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateMaterializedViewRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateMaterializedView(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlRefreshMaterializedViewRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlRefreshMaterializedViewRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlRefreshMaterializedView(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropMaterializedViewRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropMaterializedViewRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropMaterializedView(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateTypeRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateTypeRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateType(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterTypeRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterTypeRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterType(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropTypeRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropTypeRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropType(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropTableRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropTableRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropTable(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateTableAsQueryWithDataRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateTableAsQueryWithDataRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateTableAsQueryWithData(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateTableAsQueryWithNoDataRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateTableAsQueryWithNoDataRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateTableAsQueryWithNoData(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==214&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateSynonymRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateSynonym(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==216&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateForeignTableRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateForeignTable(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlCreateFdwRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateFdwRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateFdw(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropFdwRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropFdwRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropFdw(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==324&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropForeignTableRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropForeignTable(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==320&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropSynonymRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropSynonym(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropPackageRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropPackageRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropPackage(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterPackageRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterPackageRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterPackage(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlAlterSequenceRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterSequenceRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterSequence(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kCoordinateDdlDropSequenceRequest)&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropSequenceRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropSequence(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==330&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityCreateUserRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityCreateUser(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==340&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityAlterUserRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityAlterUser(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==342&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityCreateRoleRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityCreateRole(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==344&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityDropRoleRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityDropRole(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==346&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityCreatePolicyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityCreatePolicy(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==348&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityDropPolicyRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityDropPolicy(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==350&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityAlterRoleRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityAlterRole(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==352&&frame.header.payload_schema_id==sbps::kSchemaCoordinateSecurityCreateGroupMappingRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateSecurityCreateGroupMapping(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==368&&frame.header.payload_schema_id==sbps::kSchemaSessionRoleSwitchRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionRoleSwitch(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==370&&frame.header.payload_schema_id==sbps::kSchemaSessionSettingSetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionSettingSet(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==382&&frame.header.payload_schema_id==sbps::kSchemaContextSetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleContextSet(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==384&&frame.header.payload_schema_id==sbps::kSchemaContextUnsetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleContextUnset(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==386&&frame.header.payload_schema_id==sbps::kSchemaContextGetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleContextGet(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtPrepareBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtPrepareBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindStmtPrepare(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtPrepareRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtPrepareRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateStmtPrepare(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteDirectBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtExecuteDirectBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindStmtExecuteDirect(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteDirectRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtExecuteDirectRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateStmtExecuteDirect(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtExecuteRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtExecuteRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateStmtExecute(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtFreeBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtFreeBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindStmtFree(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtFreeRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtFreeRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateStmtFree(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtCancelBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtCancelBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindStmtCancel(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kStmtCancelRequest)&&frame.header.payload_schema_id==sbps::kSchemaStmtCancelRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateStmtCancel(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kParameterBindPrivateRequest)&&frame.header.payload_schema_id==sbps::kSchemaParameterBindPrivateRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindParameterBind(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kParameterBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaParameterBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateParameterBind(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kResultPageRequest)&&frame.header.payload_schema_id==sbps::kSchemaResultPageRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateResultPage(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kQueryExplainBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaQueryExplainBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindQueryExplain(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kQueryExplainRequest)&&frame.header.payload_schema_id==sbps::kSchemaQueryExplainRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateQueryExplain(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kNameResolveBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaNameResolveBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindNameResolve(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kNameResolveRequest)&&frame.header.payload_schema_id==sbps::kSchemaNameResolveRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateNameResolve(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kParseTextBindRequest)&&frame.header.payload_schema_id==sbps::kSchemaParseTextBindRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleBindParseText(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kParseTextRequest)&&frame.header.payload_schema_id==sbps::kSchemaParseTextRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateParseText(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==static_cast<std::uint16_t>(sbps::MessageType::kDdlCreateSchemaRecoveryRequest)&&frame.header.payload_schema_id==sbps::kSchemaDdlCreateSchemaRecoveryRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleRecoverDdlCreateSchema(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==372&&frame.header.payload_schema_id==sbps::kSchemaSessionSettingResetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionSettingReset(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==374&&frame.header.payload_schema_id==sbps::kSchemaSessionSettingGetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionSettingGet(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==376&&frame.header.payload_schema_id==sbps::kSchemaSessionDefaultQualifierSetRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionDefaultQualifierSet(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==378&&frame.header.payload_schema_id==sbps::kSchemaSessionDiscardRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionDiscard(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==380&&frame.header.payload_schema_id==sbps::kSchemaSessionSnapshotHandleRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleSessionSnapshotHandle(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==264&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateDictionaryRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateDictionary(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==266&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropDictionaryRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropDictionary(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==270&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterDictionaryRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterDictionary(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==272&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlCreateContinuousViewRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlCreateContinuousView(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==274&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterContinuousViewRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterContinuousView(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==276&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropContinuousViewRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropContinuousView(session_registry,engine_state,frame)));return true;}
  ...
  if(frame.header.message_type==294&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlAlterTimeseriesValueCacheRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlAlterTimeseriesValueCache(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==296&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDdlDropTimeseriesValueCacheRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDdlDropTimeseriesValueCache(session_registry,engine_state,frame)));return true;}
  if(frame.header.message_type==282&&frame.header.payload_schema_id==sbps::kSchemaCoordinateDmlAsyncInsertCancelRequestV1){WriteAll(client_fd,SessionOperationFrame(frame,HandleCoordinateDmlAsyncInsertCancel(session_registry,engine_state,frame)));return true;}
