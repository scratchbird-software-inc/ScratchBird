...
TypedUuid AuthoritativeDatatypeDescriptorUuid(const CanonicalTypeId type_id,
  ...
  if (type_id == CanonicalTypeId::real64) {
    TypedUuid identity;
    identity.kind = UuidKind::object;
    identity.value = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x31}};
    return identity;
  }
  if (type_id == CanonicalTypeId::uuid) {
    TypedUuid identity;
    identity.kind = UuidKind::object;
    identity.value = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x34}};
    return identity;
  }
  if (type_id == CanonicalTypeId::geometry) {
    TypedUuid identity;
    identity.kind = UuidKind::object;
    identity.value = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x37}};
    return identity;
  }
  if (type_id == CanonicalTypeId::uint64) {
    TypedUuid identity;
    identity.kind = UuidKind::object;
    identity.value = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3a}};
    return identity;
  }
  if (type_id == CanonicalTypeId::json_document) {
    TypedUuid identity;
    identity.kind = UuidKind::object;
    identity.value = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3d}};
    return identity;
  }
  if (type_id == CanonicalTypeId::list) {
    TypedUuid identity;
    identity.kind = UuidKind::object;
...
CurrentDatatypeTypeCodecIdentityRowsV1() {
  ...
  static const std::array<DatatypeTypeCodecIdentityRowV1, 6> rows{{
      {scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}}, 1, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x16}}, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x17}}, 1,
       "datatype.int32.le.v1", 1, 1, 4, true,
       "int32", 2, 1, 2, true, 2, 4, 4, 4,
       static_cast<u32>(CanonicalTypeId::int32),
       {}, false, false, "", "", "", false, false, false, false, false, false, ""},
      {scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}}, 1, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x11}}, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x12}}, 1,
       "datatype.int64.le.v1", 1, 1, 8, false,
       "bigint", 3, 2, 2, true, 2, 8, 8, 8,
       static_cast<u32>(CanonicalTypeId::int64),
       {}, false, false, "", "", "", false, false, false, false, false, false, ""},
      {scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}}, 1, 1,
       scratchbird::core::platform::Uuid{{0xa0, 0x00, 0x00, 0x00, 0x64, 0x65, 0x73, 0x69, 0xad, 0x61, 0x6c, 0x00, 0x00, 0x00, 0x00, 0x00}}, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x13}}, 1,
       "datatype.decimal.base1e9.le.v1", 1, 1, 24, false,
       "decimal", 4, 2, 2, true, 3, 24, 24, 24,
       static_cast<u32>(CanonicalTypeId::decimal),
       {}, false, false, "", "", "", false, false, false, false, false, false, ""},
      {scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}}, 1, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x14}}, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x15}}, 1,
      ...
      {scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}}, 1, 1,
       ...
       {}, false, false, "", "", "", false, false, false, false, false, false, ""},
      {scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}}, 1, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x18}}, 1,
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x19}}, 1,
       "datatype.text.utf8.v1", 1, 1, 0, true,
       "text", 0, 1, 0, false, 0, 0, 16777216, 0,
       static_cast<u32>(CanonicalTypeId::character),
       scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x1a}}, true, true,
       "byte_sequence",
  ...
  static const std::array<DatatypeTypeCodecIdentityRowV1, 18> admitted = [&] {
    ...
    for (std::size_t i = 6; i < 12; ++i) {
      result[i].catalog_snapshot_uuid = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}};
      result[i].catalog_generation = 2;
      result[i].registry_generation = 2;
    }
    result[12] = {
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}}, 2, 2, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x31}}, 1, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x32}}, 1,
      "datatype.real64.ieee754.le.v1", 1, 1, 8, true,
      "real64", 0, 1, 0, false, 0, 8, 8, 8,
      static_cast<u32>(CanonicalTypeId::real64),
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x33}}, false, false,
      "little_endian", "IEEE754_binary64", "",
      false, false, false, false, true, false, "DATATYPE.DESCRIPTOR.INVALID"};
    result[13] = {
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}}, 2, 2, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x34}}, 1, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x35}}, 1,
      "datatype.uuid.binary16.v1", 1, 1, 16, true,
      "uuid", 0, 1, 0, false, 0, 16, 16, 16,
      static_cast<u32>(CanonicalTypeId::uuid),
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x36}}, false, false,
      "byte_sequence", "sixteen_UUID_value_octets", "",
      false, false, false, false, true, false, "DATATYPE.DESCRIPTOR.INVALID"};
    result[14] = {
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}}, 2, 2, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x37}}, 1, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x38}}, 1,
      "datatype.geometry.sbp1.v1", 1, 1, 0, true,
      "geometry", 0, 1, 0, false, 0, 24, 24, 0,
      static_cast<u32>(CanonicalTypeId::geometry),
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x39}}, true, true,
      "byte_sequence", "SBP1_finite_2D_point_big_endian_coordinates", "",
      false, false, false, false, true, true, "DATATYPE.DESCRIPTOR.INVALID"};
    result[15] = {
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}}, 2, 2, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3a}}, 1, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3b}}, 1,
      "datatype.uint64.le.v1", 1, 1, 8, true,
      "uint64", 0, 1, 0, false, 0, 8, 8, 8,
      static_cast<u32>(CanonicalTypeId::uint64), scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3c}}, false, false,
      "little_endian", "unsigned_64_bit_integer", "",
      false, false, false, false, true, false, "DATATYPE.DESCRIPTOR.INVALID"};
    result[16] = {
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}}, 2, 2, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3d}}, 1, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3e}}, 1,
      "datatype.json.utf8.v1", 1, 1, 0, true,
      "json_document", 0, 1, 0, false, 0, 1, 16777216, 0,
      static_cast<u32>(CanonicalTypeId::json_document), scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x3f}}, true, true,
      "byte_sequence", "well_formed_UTF8_JSON_document", "",
      false, false, false, false, true, true, "DATATYPE.DESCRIPTOR.INVALID"};
    result[17] = {
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x02}}, 2, 2, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x40}}, 1, scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x41}}, 1,
      "datatype.list.text.framed.v1", 1, 1, 0, true,
      "list", 0, 1, 0, false, 0, 12, 16777216, 0,
...
DatatypeTypeCodecIdentityLookupV1 LookupDatatypeTypeCodecIdentityV1(
  ...
  const auto rows = CurrentDatatypeTypeCodecIdentityRowsV1();
...
bool IsExactCanonicalTextTypeCodecIdentityV1(
  ...
  return ((row.catalog_snapshot_uuid == scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x01}} &&
         ...
         row.type_uuid == scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x19}} &&
         row.type_generation == 1 &&
         row.codec_uuid == scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x1a}} &&
...
LookupBuiltinOperatorTypeCodecIdentityV1(
  ...
  result.diagnostic_id = "DATATYPE.DESCRIPTOR.INVALID";
  constexpr scratchbird::core::platform::Uuid kSnapshotUuid =
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x20}};
  constexpr scratchbird::core::platform::Uuid kEqualUuid =
      scratchbird::core::platform::Uuid{{0x01, 0x9d, 0xe5, 0xfc, 0x24, 0x00, 0x7b, 0x73, 0x9c, 0x38, 0xdc, 0xf1, 0x02, 0x04, 0xdb, 0xde}};
...
LoadCurrentBuiltinOperatorRegistrySnapshotIdentityV1() {
  ...
  result.ok = true;
  result.snapshot_uuid = scratchbird::core::platform::Uuid{{0x01, 0x9d, 0x00, 0x00, 0x00, 0x00, 0x70, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd7, 0x20}};
