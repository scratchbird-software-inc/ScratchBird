...
const std::map<std::string, FieldList>& PolicySchemaMap() {
  static const std::map<std::string, FieldList> schemas = {
      ...
      {"agent_coordinator_policy",
       {Bool("startup_launch_enabled", "true"),
        Bool("go_no_go_required", "true"),
        TokenList("managed_layers", "L1,L2,L3"),
        Bool("worker_launch_forbidden", "true"),
        Count("max_agents_per_cycle", "128"),
        Count("max_schedule_queue_depth", "1024"),
        DurationMicros("schedule_interval_microseconds", "1000000")}},
      {"coordinator_policy",
       {DurationMicros("heartbeat_interval_microseconds", "1000000"),
        DurationMicros("coordinator_log_poll_interval_microseconds", "10000"),
        Bool("zero_row_short_circuit", "true"),
        Percent("cardinality_surprise_threshold_pct", "50"),
        DurationMicros("cardinality_surprise_repeat_window_microseconds", "5000000"),
        Count("max_observation_queue_depth", "65536"),
        Count("max_active_leg_workers", "64")}},
      {"cleanup_cycle_policy",
       {DurationMicros("coordinator_liveness_window_microseconds", "10000000"),
        Count("max_absences_per_sweep", "10"),
        DurationMicros("orphaned_leg_kill_timeout_microseconds", "1000000"),
        Bool("write_absence_evidence_required", "true"),
        Bool("degrade_on_stale_log", "true")}},
