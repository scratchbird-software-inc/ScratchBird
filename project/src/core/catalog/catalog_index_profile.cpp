  ...
  static const std::vector<CatalogTableProfile> tables = {
      ...
      Table("sys.catalog.column_descriptor",
            ...
            {Column("row_uuid", CatalogColumnRole::row_uuid),
             ...
             Column("security_epoch", CatalogColumnRole::security_epoch),
             Column("lifecycle_state", CatalogColumnRole::lifecycle_state)}),
      Table("sys.catalog.domain_descriptor",
            CatalogRecordKind::domain,
            CatalogRecordScope::local_database,
            CatalogTableSurface::base_catalog,
            {Column("row_uuid", CatalogColumnRole::row_uuid),
             Column("domain_uuid", CatalogColumnRole::object_uuid),
             Column("schema_uuid", CatalogColumnRole::schema_uuid),
             Column("source_type_name", CatalogColumnRole::machine_key),
             Column("base_type_name", CatalogColumnRole::machine_key),
             Column("domain_kind", CatalogColumnRole::machine_key),
             Column("nullable", CatalogColumnRole::null_policy),
             Column("default_expression_envelope",
                    CatalogColumnRole::default_expression_envelope,
                    true),
             Column("check_constraint_envelope",
                    CatalogColumnRole::predicate_sblr_uuid,
                    true),
             Column("catalog_generation_id", CatalogColumnRole::catalog_generation_id),
             Column("created_local_transaction_id", CatalogColumnRole::transaction_id),
             Column("lifecycle_state", CatalogColumnRole::lifecycle_state)}),
