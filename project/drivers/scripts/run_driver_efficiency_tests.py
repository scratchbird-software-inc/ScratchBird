...
"""Run driver efficiency/resource budget corpus checks."""
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "command": "run_driver_efficiency_tests.py",
    ...
    output = args.output or repo_root / "build" / "reports" / "driver_efficiency.json"
    output.parent.mkdir(parents=True, exist_ok=True)
    output.write_text(json.dumps(report, indent=2, sort_keys=True) + "\n", encoding="utf-8")
    print(f"driver_efficiency_tests={report['status']}")
