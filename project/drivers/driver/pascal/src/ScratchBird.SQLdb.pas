...
procedure TScratchBirdSQLConnection.StartTransactionEx(IsolationLevel, AccessMode: Byte; Deferrable, WaitMode: Boolean;
...
procedure TScratchBirdSQLConnection.ExecSQLParams(const Sql: string; const Params: array of TScratchBirdParamInput);
begin
  FClient.ExecSQLParams(Sql, Params);
end;

function TScratchBirdSQLConnection.ExecuteQueryParams(const Sql: string; const Params: array of TScratchBirdParamInput): TScratchBirdResultStream;
begin
...
function TScratchBirdSQLConnection.GetIndexColumns: TScratchBirdResultStream;
begin
...
function TScratchBirdSQLQuery.BuildSql(out Ordered: TArray<TScratchBirdParamInput>): string;
var
