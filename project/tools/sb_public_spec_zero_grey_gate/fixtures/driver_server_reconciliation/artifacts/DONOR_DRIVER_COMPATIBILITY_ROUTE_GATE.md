# Donor Driver Compatibility Route Gate

Search key: `DRIVER_SERVER_DONOR_COMPATIBILITY_ROUTE`.

## Purpose

Make donor compatibility driver evidence prove the full ScratchBird route rather
than only proving parser acceptance or SQL text translation.

## Required Evidence

- Donor family and tool or compatibility driver used.
...
- Original donor expected behavior source.
...
`DSR-045` closes only when donor compatibility lanes run through the admitted
