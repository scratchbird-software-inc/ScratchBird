...
ROWS: list[tuple] = [
    ...
    ("SBSFC-041", "slice", "Reference alias compatibility regression", "1800", "2048", "500", "1024", "2048", "remove_temp_databases_after_fixture_runs_unload_reference_packages", "", "", "estimated", "Reference alias revalidation across families post-SBsql promotion."),
    ...
    ("SBSFC-044", "slice", "Catalog statistics scalar runtime promotion", "120", "512", "10", "64", "128", "remove_temp_database_and_mga_sidecars_after_fixture_runs", "", "", "estimated", "Focused catalog-statistics scalar batch for relation_row_estimate and table_size using engine-owned MGA relation metadata and row/index sidecars; no parser SQL, reference execution, WAL shortcut, or cluster-positive behavior."),
    ("SBSFC-045", "slice", "Privilege predicate scalar runtime promotion", "120", "512", "16", "64", "128", "remove_temp_database_and_mga_sidecars_after_fixture_runs", "", "", "estimated", "Focused privilege predicate scalar batch for has_table_privilege, has_column_privilege, has_function_privilege, and has_schema_privilege using current SBLR security context plus engine-owned MGA relation/builtin/schema metadata; no parser SQL, reference execution, WAL shortcut, or cluster-positive behavior."),
    ("SBSFC-046", "slice", "Session-admin scalar runtime promotion", "120", "512", "12", "64", "128", "none", "", "", "estimated", "Focused session-admin scalar batch for set_config, pid, temp_buffers, pg_cancel_backend, and pg_terminate_backend using SBLR local session runtime config and backend-control evidence vectors; no parser SQL, reference execution, WAL shortcut, external process signal, or cluster-positive behavior."),
    ("SBSFC-047", "slice", "Advisory-lock scalar runtime promotion", "120", "512", "8", "64", "128", "none", "", "", "estimated", "Focused advisory-lock scalar batch for pg_advisory_lock and pg_try_advisory_lock using SBLR local session advisory lock state and acquisition evidence vectors; no parser SQL, reference execution, WAL shortcut, indefinite blocking, or cluster-positive behavior."),
    ("SBSFC-048", "slice", "Advisory-lock release and xact-lock scalar runtime promotion", "120", "512", "8", "64", "128", "none", "", "", "estimated", "Focused advisory-lock scalar batch for pg_advisory_unlock and pg_advisory_xact_lock using separate SBLR local session and transaction-token advisory lock state/evidence vectors; no parser SQL, reference execution, WAL shortcut, indefinite blocking, transaction-finality shortcut, or cluster-positive behavior."),
    ("SBSFC-049", "slice", "Unicode text normalization scalar runtime promotion", "120", "512", "8", "64", "128", "none", "", "", "estimated", "Focused Unicode text scalar batch for normalize, unicode_normalize, and is_alpha using ICU-backed SBLR data-scalar runtime functions; no parser SQL, reference execution, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-052", "slice", "JSON document construction table aggregate runtime promotion", "120", "512", "16", "64", "128", "none", "", "", "estimated", "Focused JSON/document scalar batch for JSON_TABLE descriptor routes, array_to_json, row_to_json, json_object text arrays, and jsonb_agg scalar-harness coverage using bounded in-core nosql.document helpers; no parser SQL, reference execution, storage scan, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-053", "slice", "Rowset table-value set-returning descriptor runtime promotion", "120", "512", "32", "64", "128", "none", "", "", "estimated", "Focused rowset/table-value/set-returning batch for rowset/table_value descriptors, setof, unnest, generate_series, and multiset helpers using bounded in-core rowset.table helpers; no parser SQL, reference execution, storage scan, cursor lifecycle authority, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-054", "slice", "Cursor stream handle descriptor runtime promotion", "120", "512", "32", "64", "128", "none", "", "", "estimated", "Focused cursor/stream/handle batch for cursor descriptors, handle attributes, rowset/table_value/stream conversions, current-row locator descriptors, and close/open descriptor helpers using bounded in-core cursor.stream helpers; no parser SQL, reference execution, storage scan, backend cursor lifecycle authority, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-055", "slice", "LOB locator descriptor runtime promotion", "120", "512", "32", "64", "128", "none", "", "", "estimated", "Focused LOB/locator batch for lob_create/open/close/read/write/append/truncate, locator conversions, locator validity, and current-row locator marker behavior using bounded in-core lob.locator helpers; no parser SQL, reference execution, storage finality, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-056", "slice", "Native surface scalar descriptor runtime promotion", "120", "512", "40", "64", "128", "none", "", "", "estimated", "Focused native surface scalar/descriptor batch for syntax/status/volatility markers, TREAT, accept probes, any_value, collect, at_time_zone, bit_string, bulk_exceptions, domain_stack, reference/private/native markers, match_recognize, integer/void/tabular, NVL, and generic multiset routes; no parser SQL, reference execution, storage finality, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-057", "slice", "Crypto hash pgcrypto scalar runtime promotion", "120", "512", "27", "64", "128", "none", "", "", "estimated", "Focused crypto/hash and pgcrypto batch for OpenSSL EVP SHA3/BLAKE2b/HMAC/RAND/scrypt, in-core xxhash64, deterministic armor/dearmor, bounded ScratchBird PGP envelopes that do not claim OpenPGP compatibility, and exact dependency-unavailable fail-closed argon2/bcrypt/blake3/crypt rows; no parser SQL, reference execution, storage finality, WAL shortcut, external service, or cluster-positive behavior."),
    ("SBSFC-059", "slice", "Expression runtime function cleanup promotion", "120", "512", "7", "64", "128", "none", "", "", "estimated", "Focused expression-runtime cleanup batch for seven remaining month_name/date_sub/epoch/gen_id/day_name/POSITION_REGEX rows using bounded in-core scalar helpers and existing SBLR sequence runtime; no parser SQL, reference execution, storage finality, WAL shortcut, external service, cluster-positive behavior, or transaction finality change."),
    ("SBSFC-060R-xml-grammar-exact-route", "slice", "XML grammar exact-route promotion", "120", "512", "23", "64", "128", "none", "", "", "estimated", "Focused corrected SBSFC-060R XML grammar batch for the accepted xml_forest_element/xml_root_form rows plus 21 additional XML grammar rows using public SBsql parser/bind/lower, server admission, and EngineEvaluateProjection runtime evidence; no generic replay, exact refusal, parser SQL execution, reference execution, WAL/recovery authority, or cluster-positive behavior."),
