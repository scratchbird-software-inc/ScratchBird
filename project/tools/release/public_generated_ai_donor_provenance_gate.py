...
"""Validate generated, AI-assisted, copied-reference, and donor-derived provenance policy."""
...
# PUBLIC_GENERATED_AI_DONOR_PROVENANCE
...
PROVENANCE_CLASSES: tuple[dict[str, Any], ...] = (
    ...
    {
        "class_id": "donor_derived_behavior_docs",
        "release_status": "allowed_as_behavior_mapping_or_refusal_evidence_only",
        "required_evidence": (
            "donor_surface",
            "exact_mapping_or_refusal_policy",
            "no_copied_donor_code",
            "no_donor_runtime_authority",
        ),
        "authority_limit": "donor behavior never owns engine execution or finality",
    },
)
...
EVIDENCE_CHECKS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "tokens": (
            ...
            "category",
            "source_inputs",
            "test_generated_donor_alias",
        ),
    },
    {
        "surface": "donor_alias_fixture_policy",
        "path": "project/tests/sbsql_parser_worker/generated/donor_alias/DONOR_ALIAS_RENDERING_FIXTURES.csv",
        "tokens": (
            "alias_kind",
            "fixture_root",
            "command_tag_policy",
    ...
    {
        "surface": "donor_alias_conformance",
        "path": "project/tests/sbsql_parser_worker/generated/donor_alias/sbsql_donor_alias_rendering_conformance.cpp",
        "tokens": (
            "donor_surface",
            "map_to_native_behavior_or_exact_canonical_refusal",
            "lacks donor rendering",
        ),
    },
    {
    ...
    },
    {
        ...
        "tokens": (
            "PUBLIC_PROVENANCE_POLICY_GATE",
            "public_generated_ai_donor_provenance_gate",
...
def fail(message: str) -> None:
    print(f"public_generated_ai_donor_provenance_gate=fail:{message}", file=sys.stderr)
    raise SystemExit(1)
...
def main(argv: list[str]) -> int:
    ...
    payload = {
        ...
        "marker": "PUBLIC_GENERATED_AI_DONOR_PROVENANCE",
        "status": "pass",
        "checks": records,
    ...
    print(
        "public_generated_ai_donor_provenance_gate=passed "
