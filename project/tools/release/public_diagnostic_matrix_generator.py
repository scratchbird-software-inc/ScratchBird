...
MATRIX_ROWS: tuple[dict[str, str], ...] = (
    {
        "diagnostic_id": "diagnostics.sblr.envelope.invalid",
        "area": "diagnostics",
        "code": "SBLR.ENVELOPE.INVALID",
        "message_key": "sblr.envelope.invalid",
        "redaction_class": "public_code_only",
        "compatibility_status": "fail_closed_stable",
        "source_path": "include/scratchbird/engine/sblr_envelope.hpp",
        "source_token": "SBLR.ENVELOPE.INVALID",
        "public_test_path": "tests/engine_public_abi/public_diagnostic_shape_fixture.cpp",
        "public_test_token": "SBLR.ENVELOPE.INVALID",
    },
    {
        "diagnostic_id": "diagnostics.sblr.envelope.checksum_invalid",
        "area": "diagnostics",
        "code": "SBLR.ENVELOPE.CHECKSUM_INVALID",
        "message_key": "sblr.envelope.checksum_invalid",
        "redaction_class": "public_code_only",
        "compatibility_status": "fail_closed_stable",
        "source_path": "include/scratchbird/engine/sblr_envelope.hpp",
        "source_token": "SBLR.ENVELOPE.CHECKSUM_INVALID",
        "public_test_path": "tests/engine_public_abi/public_diagnostic_shape_fixture.cpp",
        "public_test_token": "SBLR.ENVELOPE.CHECKSUM_INVALID",
    },
    {
        "diagnostic_id": "diagnostics.sblr.version.unsupported",
        "area": "diagnostics",
        "code": "SBLR.VERSION.UNSUPPORTED",
        "message_key": "sblr.version.unsupported",
        "redaction_class": "public_code_only",
        "compatibility_status": "unsupported_stable",
        "source_path": "include/scratchbird/engine/sblr_envelope.hpp",
        "source_token": "SBLR.VERSION.UNSUPPORTED",
        "public_test_path": "tests/engine_public_abi/public_diagnostic_shape_fixture.cpp",
        "public_test_token": "SBLR.VERSION.UNSUPPORTED",
    },
    {
        "diagnostic_id": "diagnostics.sblr.opcode.unknown",
        "area": "diagnostics",
        "code": "SBLR.OPCODE.UNKNOWN",
        "message_key": "sblr.opcode.unknown",
        "redaction_class": "public_code_only",
        "compatibility_status": "unsupported_stable",
        "source_path": "include/scratchbird/engine/sblr_envelope.hpp",
        "source_token": "SBLR.OPCODE.UNKNOWN",
        "public_test_path": "tests/engine_public_abi/public_diagnostic_shape_fixture.cpp",
        "public_test_token": "SBLR.OPCODE.UNKNOWN",
    },
    {
        "diagnostic_id": "diagnostics.sblr.opcode.reference_meta_forbidden",
        "area": "diagnostics",
        "code": "SBLR.OPCODE.REFERENCE_META_FORBIDDEN",
        "message_key": "sblr.opcode.reference_meta_forbidden",
        "redaction_class": "public_code_only",
        "compatibility_status": "unsupported_stable",
        "source_path": "include/scratchbird/engine/sblr_envelope.hpp",
        "source_token": "SBLR.OPCODE.REFERENCE_META_FORBIDDEN",
        "public_test_path": "tests/engine_public_abi/public_diagnostic_shape_fixture.cpp",
        "public_test_token": "SBLR.OPCODE.REFERENCE_META_FORBIDDEN",
    },
    {
        "diagnostic_id": "diagnostics.sblr.descriptor.invalid",
        "area": "diagnostics",
        "code": "SBLR.DESCRIPTOR.INVALID",
        "message_key": "sblr.descriptor.invalid",
        "redaction_class": "public_code_only",
        "compatibility_status": "fail_closed_stable",
        "source_path": "include/scratchbird/engine/sblr_envelope.hpp",
        "source_token": "SBLR.DESCRIPTOR.INVALID",
        "public_test_path": "tests/engine_public_abi/public_diagnostic_shape_fixture.cpp",
        "public_test_token": "SBLR.DESCRIPTOR.INVALID",
    },
    {
