...
REQUIRED_FILES = (
    ...
    *(f"etc/scratchbird/{name}" for name in REQUIRED_CONFIG_FILES),
    ...
    "share/scratchbird/resources/policy-packs/default-local-password/catalog_materialization.json",
    "share/scratchbird/resources/policy-packs/default-local-password/policies/security_providers.json",
    "share/scratchbird/resources/policy-packs/default-local-password/policies/roles.json",
    ...
    "share/scratchbird/resources/policy-packs/default-local-password/policies/policy_defaults.json",
